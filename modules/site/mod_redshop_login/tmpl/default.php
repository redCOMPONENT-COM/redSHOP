                    ...
                    <div class="input-prepend">
                        <span class="add-on">
                            <span class="icon-user hasTooltip"
                                title="<?php echo Text::_('MOD_REDSHOP_LOGIN_VALUE_USERNAME'); ?>"></span>
                            <label for="modlgn-username" class="element-invisible">
                                <?php echo Text::_('MOD_REDSHOP_LOGIN_VALUE_USERNAME'); ?>
                            </label>
                        </span>
                        <input id="modlgn-username" type="text" name="username" class="input-small" tabindex="0"
                            autocomplete="username" size="18"
                            placeholder="<?php echo Text::_('MOD_REDSHOP_LOGIN_VALUE_USERNAME'); ?>" />
                    </div>
                <?php else: ?>
                    ...
                    <?php if (!$params->get('usetext', 0)): ?>
                        <div class="input-prepend input-append">
                            ...
                            <input id="modlgn-secretkey" autocomplete="off" type="text" name="secretkey" class="input-small"
                                tabindex="0" size="18" placeholder="<?php echo Text::_('JGLOBAL_SECRETKEY'); ?>" />
        ...
        <?php if (JPluginHelper::isEnabled('system', 'remember')): ?>
            <div id="form-login-remember" class="control-group checkbox">
                <label for="modlgn-remember" class="control-label">
                    <?php echo Text::_('MOD_REDSHOP_LOGIN_REMEMBER_ME'); ?>
                </label> <input id="modlgn-remember" type="checkbox" name="remember" class="inputbox" value="yes" />
            </div>
        <?php endif; ?>
            ...
            <?php if ($usersConfig->get('allowUserRegistration')): ?>
                <li>
                    <a href="<?php echo Redshop\IO\Route::_('index.php?option=com_users&view=registration'); ?>">
                        <?php echo Text::_('MOD_REDSHOP_LOGIN_REGISTER'); ?> <span class="icon-arrow-right"></span>
                    </a>
                </li>
            <?php endif; ?>
            <li>
                <a href="<?php echo Redshop\IO\Route::_('index.php?option=com_users&view=remind'); ?>">
                    <?php echo Text::_('MOD_REDSHOP_LOGIN_FORGOT_YOUR_USERNAME'); ?>
                </a>
            </li>
            <li>
                <a href="<?php echo Redshop\IO\Route::_('index.php?option=com_users&view=reset'); ?>">
                    <?php echo Text::_('MOD_REDSHOP_LOGIN_FORGOT_YOUR_PASSWORD'); ?>
                </a>
            </li>
        </ul>
