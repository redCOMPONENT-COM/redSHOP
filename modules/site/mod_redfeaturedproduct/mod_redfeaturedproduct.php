					...
					<div>
						<div class='red_product-skin-produkter'>
							<div style='display: block;' class='red_product-container red_product-container-horizontal'>
								...
								<div style='display: block;left:<?php echo $rightarrow; ?>px;'
									 class='red_product-next red_product-next-horizontal'></div>
								<div style='width:<?php echo $this->scrollerwidth; ?>px;'
									 class='red_product-clip red_product-clip-horizontal'>
									<ul id='produkt_carousel' class='red_product-list red_product-list-horizontal'>
										...
										foreach ($rows as $row)
										{
											...
											if (is_file(REDSHOP_FRONT_IMAGES_RELPATH . "product/" . $row->product_full_image))
												$prod_img = $redhelper->watermark('product', $row->product_full_image, $this->thumbwidth, $this->thumbheight, 0, $row->product_id);
											elseif (is_file(REDSHOP_FRONT_IMAGES_RELPATH . "product/" . $row->product_thumb_image))
												$prod_img = $redhelper->watermark('product', $row->product_thumb_image, $this->thumbwidth, $this->thumbheight, 0, $row->product_id);
											else
											...
											<li red_productindex='<?php echo $i; ?>'
												class='red_product-item red_product-item-horizontal'>
								...
								echo "<div class='mod_redproducts_price'>".$product_price_dis."</div>";
												...
												<div class='product-image'
													 style='width:<?php echo $this->thumbwidth; ?>px;height:<?php echo $this->thumbheight; ?>px;'><?php echo $thum_image; ?></div>
