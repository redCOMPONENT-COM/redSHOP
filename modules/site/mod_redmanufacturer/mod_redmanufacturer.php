...
// Prevent double class declaration
	class redManufacturer
	{
		 ...
		 */
		public $NumberOfProducts = 2;
		/**
		 * @var $featuredProducts
		 */
		public $featuredProducts = false;
		/**
		 * // scroll, alternate, slide
		 * @var $ScrollBehavior
		 */
		public $ScrollBehavior = '1';
		/**
		 * @var $PS_DIRECTION
		 */
		public $ScrollDirection = 'no';

		public $ScrollDelay = 'fast';
		/**
		 * @var $ScrollAlign
		 */
		public $ScrollAuto = '1';

		public $ScrollWrap = 'circular';

		public $PageLink = 'detail';

		public $ImageBorder = 'yes';

		public $ImageWidth = '100';

		public $ImageHeight = '100';

		public $ScrollWidth = '130';

		public $ScrollHeight = '120';
		 ...
		 * set mammeters
		 */
		public function redManufacturer(&$params)
		{
			$this->params = $params;
		 ...
		 */
		public function displayredManufacturer($limit = 0)
		{
			...
			<script type="text/javascript">
				...
				var mycarousel_itemList = [
					<?php	for($i=0;$i<count($rows);$i++)
							{	?>
					{url: "<?php echo $redhelper->watermark('manufacturer', $rows[$i]->media_name, $this->ImageWidth, $this->ImageHeight, 0, $rows[$i]->manufacturer_id); ?>", title: '<?php echo $rows[$i]->manufacturer_name; ?>', ahref: '<a href="<?php echo JRoute::_('index.php?option=com_redshop&view=manufacturers&layout='.$this->PageLink.'&mid='.$rows[$i]->manufacturer_id.'&Itemid='.$Itemid);?>"  title="<?php echo $rows[$i]->manufacturer_name; ?>">'}
								...
								<li jcarouselindex="<?php echo $i + 31; ?>"
									...
									<a href='<?php echo $url; ?>index.php?option=com_redshop&view=manufacturers&layout=<?php echo $this->PageLink; ?>&mid=<?php echo $rows[$i]->manufacturer_id; ?>&Itemid=<?php echo $Itemid; ?>'
									   title='<?php echo $rows[$i]->manufacturer_name; ?>'><img
											src='<?php echo $redhelper->watermark('manufacturer', $rows[$i]->media_name, 100, 100, 0, $rows[$i]->manufacturer_id
); ?>'
