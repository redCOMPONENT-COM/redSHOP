...
<div id="icetabs<?php echo $module->id; ?>" class="ice-tabs-candy<?php echo $params->get('moduleclass_sfx','');?> <?php echo $class;?>-sl-candy clearfix" style="height:<?php echo $moduleHeight;?>; width:<?php echo $moduleWidth;?>">
