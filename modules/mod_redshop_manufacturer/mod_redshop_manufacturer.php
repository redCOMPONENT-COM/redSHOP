...
*/
if( !class_exists('redManufacturer')) { // Prevent double class declaration
	...
	class redManufacturer {
		...
		*/
		function displayredManufacturer( $limit=0 )
		{
			...
			JHTML::Script('jquery-1.js', 'modules/mod_redshop_manufacturer/js/',false);
			JHTML::Script('jquery.js', 'modules/mod_redshop_manufacturer/js/',false);
			JHTML::Stylesheet('jquery.css', 'modules/mod_redshop_manufacturer/css/');
		...
		<div class="jcarousel-skin-tango">
			<div style="display: block;" class="jcarousel-container jcarousel-container-horizontal">
				<div>
					...
					{
					?>
						<li jcarouselindex="<?php echo $i+31;?>" class="jcarousel-item jcarousel-item-horizontal jcarousel-item-<?php echo $i+31;?> jcarousel-item-<?php echo $i+31;?>-horizontal">
							<a href='<?php echo $url;?>index.php?option=com_redshop&view=manufacturers&layout=<?php echo $this->PageLink;?>&mid=<?php echo $rows[$i]->manufacturer_id; ?>&Itemid=<?php echo $Itemid;?>'  title='<?php echo $rows[$i]->manufacturer_name; ?>'><img src='<?php echo $url; ?>/components/com_redshop/helpers/thumb.php?filename=manufacturer/<?php echo $rows[$i]->media_name; ?>&newxsize=100&newysize=100' alt='<?php echo $rows[$i]->media_name; ?>' width='100' height='100'></a>
						</li>
