	...
	{ 
		...
		for (var i=0;i<jsondata.results.length;i++)
		{
			if(jsondata.results[i].volume)			
				this.aSug.push(  { 'id':jsondata.results[i].id, 'value':jsondata.results[i].value, 'volume':jsondata.results[i].volume }  );			
			else if(jsondata.results[i].price)			
				this.aSug.push(  { 'id':jsondata.results[i].id, 'value':jsondata.results[i].value, 'price':jsondata.results[i].price }  );
			else
