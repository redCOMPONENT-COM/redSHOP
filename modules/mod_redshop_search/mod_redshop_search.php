...
$lists = array();
$cat = array();
$cat[]   	= JHTML::_('select.option', '0',JText::_('SELECT_CATEGORIES'));
...
$manufacture = array();
$manufacture[]   	= JHTML::_('select.option', '0',JText::_('SELECT_MANUFACTURE'));
...
$searchType = array();
//$searchType[]   = JHTML::_('select.option', '0',JText::_('SELECT'));
...
$searchType[]   = JHTML::_('select.option', 'name_number', JTEXT::_("PRODUCT_NAME_AND_PRODUCT_NUMBER"));
