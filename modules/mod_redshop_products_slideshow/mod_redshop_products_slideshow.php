...
function write_prodgallery_xml_data($cat_arr, $params)
{
	...
	for($k = 0; $k < count ( $rows ); $k ++) {
		...
		if ($params->get ( 'show_price' ) == "yes")
		{
			...
			//with vat price
			$product_price_vat = $product_price + $productVat;//$producthelper->getProductNetPrice ( $rows [$k]->product_id );
...
//			$price_txt .= $params->get ( 'currency', '$' );
		...
		if(!is_file ( JPATH_SITE."/components/com_redshop/assets/images/product/".$rows [$k]->product_full_image ))
		{
...
?>
<div style="background: #ffffff;"><script language="javascript">AC_FL_RunContent = 0;</script>

<script
	src="<?php
	echo JURI::root ()?>modules/mod_redshop_products_slideshow/AC_RunActiveContent.js"
...
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
	...
	<param name="movie"
		value="<?php
		echo JURI::root ()?>modules/mod_redshop_products_slideshow/slideshow.swf" />
	...
	<embed
		...
		pluginspage="http://www.adobe.com/go/getflashplayer_cn" /></object></noscript>
