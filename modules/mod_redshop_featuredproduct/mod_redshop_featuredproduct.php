	...
	class redFeatureproduct
	{
		...
		*/
		function displayredFeature (&$rows)
		{
			...
			JHTML::Stylesheet('jquery.css', 'modules/mod_redshop_featuredproduct/css/');
			//$document->addStyleSheet("modules/mod_redshop_featuredproduct/css/skin.css");
			JHTML::Stylesheet('skin_002.css', 'modules/mod_redshop_featuredproduct/css/');
			//$document->addScript("modules/mod_redshop_featuredproduct/js/jquery-1.js");
			...
			JHTML::Script('jquery.js', 'modules/mod_redshop_featuredproduct/js/',false);
			JHTML::Script('recreativo.js', 'modules/mod_redshop_featuredproduct/js/',false);
