...
if($newprd)
{
	echo $myTabs->startPanel ( JText::_ ( 'NEWEST_PRODUCTS' ), 'tab1' );?>
...
<?php	$row = $newprdlist[$i];
		...
		if($show_readmore)
		{
			echo "<br><a href='".$link."'>".JText::_('TXT_READ_MORE')."</a>&nbsp;";
		}
...
if($ltsprd)
{
	echo $myTabs->startPanel ( JText::_ ( 'LATEST_PRODUCTS' ), 'tab2' );?>
	<table border="0" cellpadding="2" cellspacing="2"><tr>
<?php
//echo '<pre/>';
...
if($soldprd)
{
	echo $myTabs->startPanel ( JText::_ ( 'MOST_SOLD_PRODUCTS' ), 'tab3' );?>
	<table border="0" cellpadding="2" cellspacing="2"><tr>
<?php
...
if($splprd)
{
	...
	echo $myTabs->startPanel ( JText::_ ( 'SPECIAL_PRODUCTS' ), 'tab4' );	?>
	<table border="0" cellpadding="2" cellspacing="2"><tr>
<?php
