   				...
   				if($row->product_on_sale && $product_price_discount > 0)
   				{
					if($product_price > $product_price_discount)
					{
						...
						if($this->show_discountpricelayout)
						{
							...
							$data_add .= "<tr><td id='mod_redsavedprice' class='mod_redsavedprice' style='text-align:".$this->ScrollTextAlign.";font-weight:".$this->ScrollTextWeight.";font-size:".$this->ScrollTextSize."px;'>".JText::_('PRODCUT_PRICE_YOU_SAVED').' '.$producthelper->getProductFormattedPrice($s_price)."</td></tr>";
						} else {
							$product_price = $product_price_discount ;
