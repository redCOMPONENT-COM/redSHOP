...
dom.query(function() {
        ...
        $slider.slider({
            ...
            stop: function(event, ui){//This event is triggered when the user stops sliding.
            	...
            	url = "<?php echo $url;?>index2.php?option=com_redshop&view=price_filter";
...
<div id="pricefilter">
    <div class="left" id="leftSlider">
        <div id="range"><?php echo JText::_('PRICE').": ";?><span id="redamount"></span></div>
	...
	<div class="left" id="productsWrap">
        <div style="display: none;" id="ajaxMessage"><?php echo JText::_('LOADING');?></div>
        <div id="redproducts"><?php echo JText::_('NO_PRODUCT_FOUND');?></div>
    </div>
</div>
