...
<form action="" method="post" name="masscart" id="masscart" >
	...
	<div id="redcart">
		<label for="modlgn_pronumber"><?php if($params->get('title') != ""){ echo $params->get('title'); }else{ echo JText::_('PRODUCT_NUMBER'); } ?></label>
		<?php echo JHTML::_('tooltip',  $params->get('info') ); ?><br />
		<textarea id="numbercart" name="numbercart"  style="width:<?php echo $params->get('textwidth'); ?>px; height:<?php echo $params->get('textheight'); ?>px;" class="inputbox_numbercart" ></textarea>
		
	</div>
	<?php 
	 if($params->get('chk_quantity') == "1") {?>
	<div id="productQuantity">
		<label for="mod_quantity"><?php  echo JText::_('PRODUCT_QUANTITY');  ?></label>
