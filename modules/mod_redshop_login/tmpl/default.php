...
<?php endif; ?>
	<div align="center">
		<input type="submit" name="Submit" class="button" value="<?php echo JText::_('COM_REDSHOP_BUTTON_LOGOUT'); ?>" />
	</div>
	<div align="left" class="accountLink">
		<?php
			$accountPage = JRoute::_('index.php?option=com_redshop&view=account&Itemid='.$Itemid);
		?>
		<a href="<?php echo $accountPage;?>" name="<?php echo JText::_('COM_REDSHOP_MY_ACCOUNT');?>" title="<?php echo JText::_('COM_REDSHOP_MY_ACCOUNT');?>"><?php echo JText::_('COM_REDSHOP_MY_ACCOUNT');?></a>
	</div>
	...
	<div id="form-login-wrapper">
		<div id="input-login-wrapper">
			...
			<div id="form-login-username" style="margin-bottom:5px;">
				<div id="label-login-username"><label for="modlgn_username"><?php echo JText::_('COM_REDSHOP_Username') ?></label></div>
			...
			<div id="form-login-password" style="margin-bottom:5px;">
				<div id="label-login-password"><label for="modlgn_passwd"><?php echo JText::_('COM_REDSHOP_Password') ?></label></div>
				<div id="input-login-password"><input id="modlgn_passwd" type="password" name="password" class="inputbox" size="18" alt="password" /></div>
			</div>
			...
			if($remember_me){
					...
					if(JPluginHelper::isEnabled('system', 'remember')) : ?>
						<div id="form-login-remember" style="margin-bottom:5px;">
							<label for="modlgn_remember"><?php echo JText::_('COM_REDSHOP_REMEMBER_ME') ?></label>
							<input id="modlgn_remember" type="checkbox" name="remember" class="inputbox" value="yes" alt="Remember Me" />
						</div>
					<?php endif; ?>
			<?php } ?>
			<div id="submit-login-button" style="margin-bottom:5px;"><input type="submit" name="Submit" class="button" value="<?php echo JText::_('COM_REDSHOP_LOGIN') ?>" /></div>
			</fieldset>
		</div>
...
<form action="<?php echo JRoute::_( 'index.php', true, $params->get('usesecure')); ?>" method="post" name="login" id="form-login" >
	<?php echo $params->get('pretext'); ?>
	<table>
		<tr><td><label for="modlgn_username"><?php echo JText::_('COM_REDSHOP_Username') ?></label></td>
			<td colspan="2"><label for="modlgn_passwd"><?php echo JText::_('COM_REDSHOP_Password') ?></label></td>
			</tr>
		<tr><td><input id="modlgn_username" type="text" name="username" class="inputbox" alt="username" size="25" /></td>
			...
			<td>&nbsp;<input type="submit" name="Submit" class="button" value="<?php echo JText::_('COM_REDSHOP_LOGIN') ?>" /></td>
		</tr>
