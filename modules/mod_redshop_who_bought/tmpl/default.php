...
if(count($productlists)){
	...
	if(AJAX_CART_BOX)
	{
		...
		if($show_product_image){
			 	echo "<div style='height:".$thumbheight.";  text-align:center;'><img  height='".$thumbheight." width='".$thumbwidth." src='".JURI::base()."components/com_redshop/assets/images/product/".$product->product_full_image."' /></div>";
		}
