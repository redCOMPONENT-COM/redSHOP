...
if ($compare['idx'] > 0){
	...
	?>
		<tr valign="top">
			...
			<td width="5%">
				<span><a href='javascript:void(0);' onClick="javascript:remove_compare(<?php echo $compare[$i]["product_id"] ?>,<?php echo $compare[$i]["category_id"]?>)" ><?php echo JText::_('COM_REDSHOP_DELETE'); ?></a></span>
			</td>
		</tr>
		<?php
				$cnt++;
