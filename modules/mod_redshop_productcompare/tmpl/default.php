...
if ($compare['idx'] > 0){
	...
	?>
		<tr valign="top">
			...
			<td width="5%">
				<span><a href='javascript:void(0);' onClick="javascript:remove_compare(<?php echo $compare[$i]["product_id"] ?>,<?php echo $compare[$i]["category_id"]?>)" ><?php echo JText::_('DELETE'); ?></a></span>
			</td>
		</tr>
		<?php
				$cnt++;
	...
	if(PRODUCT_COMPARISON_TYPE=="category")
	{
		if($cnt==0)
		{
			echo "<tr><td colspan='2'>".JText::_('NO_PRODUCTS_TO_COMPARE')."</td></tr>";
		}
	}else{
		if($catid=="")
		{
...
<div id="mod_compare">
	<a href="<?php echo JRoute::_('index.php?option=com_redshop&view=product&layout=compare&Itemid='.$Itemid.$cid_main) ?>"><?php echo JText::_('COMPARE'); ?></a>
</div>
<?php
}else {
	echo "<div>".JText::_('NO_PRODUCTS_TO_COMPARE')."</div>";
}
?>
