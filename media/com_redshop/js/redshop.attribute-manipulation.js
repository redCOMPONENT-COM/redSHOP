(function ($) {
	$(document).ready(function () {
		...
		function renderProperty(propPref, gh, sh, or) {
			...
			+ '<a href="#" class="showhidearrow">' + Joomla.JText._('COM_REDSHOP_SUB_ATTRIBUTE') + '<img class="arrowimg" src="media/com_redshop/images/arrow.png" alt=""/></a>'

			+ '<div class="attr_tbody form-inline divInspectFromHideShow">'

			+ '<div class="row">'
			+ '<div class="col-sm-4">'
			+ '<div class="form-group"><label>' + Joomla.JText._('COM_REDSHOP_SUB_ATTRIBUTE') + '</label><input type="text" class="input-small" name="' + propPref + '[name]" value=""><input type="hidden"  name="attribute[' + gh + '][property][' + sh + '][mainImage]" value="" id="propmainImage' + gh + sh + '"><input type="hidden" name="attribute[' + gh + '][property][' + sh + '][property_image]" id="propertyImageName' + gh + sh + '" /></div>'
			+ '</div>'

			+ '<div class="col-sm-4">'
			+ '<div class="form-group"><label>' + Joomla.JText._('COM_REDSHOP_PRICE') + '</label><input type="text" class="text-center input-xmini" value="+" name="' + propPref + '[oprand]" onchange="javascript:oprand_check(this);"> <input type="text" class="input-mini" value="" name="' + propPref + '[price]"></div>'
			+ '</div>'
			// row
			+ '</div>'
			...
			+ '<div class="row">'
			+ '<div class="col-sm-4">'
			+ '<div class="form-group"><label>' + Joomla.JText._('COM_REDSHOP_PROPERTY_NUMBER') + '</label><input type="text" name="' + propPref + '[number]" value="" class="vpnrequired input-mini"></div>'
			+ '</div>'

			+ '<div class="col-sm-4">'
			+ '<div class="form-group"><label>' + Joomla.JText._('COM_REDSHOP_ATTRIBUTE_EXTRAFIELD') + '</label><input type="text" class="input-mini" name="' + propPref + '[extra_field]" value="" /></div>'
			+ '</div>'

			+ '<div class="col-sm-4">'
			+ '<div class="form-group"><label>' + Joomla.JText._('COM_REDSHOP_ORDERING') + '</label><input type="text" class="text-center input-xmini" name="' + propPref + '[order]" value="' + or + '"></div>'
			+ '</div>'
			// row
			+ '</div>'
			...
			+ '<div class="col-sm-6">'
			+ '<div class="form-group"><label>' + Joomla.JText._('COM_REDSHOP_TITLE') + '</label><input class="input-small" type="text" name="' + propPref + '[subproperty][title]" value=""></div>'
		...
		$('.add_attribute').on('click', function (e) {
			...
			$('.mainTableAttributes').append(
				...
				+ '<a href="#" class="showhidearrow">' + Joomla.JText._('COM_REDSHOP_TITLE') + '<img class="arrowimg" src="media/com_redshop/images/arrow.png" alt=""/></a>'
				+ '<div class="col-sm-12 oneAttribute">'
				+ '<div class="rowAttribute">'

				+ '<div class="col-sm-5">'
				+ '<div class="form-group"><label>' + Joomla.JText._('COM_REDSHOP_ATTRIBUTE_NAME') + '</label><input type="text" class="input-small" name="' + attrPref + '[name]" value="" /></div>'
				+ '<div class="form-group"><label>' + Joomla.JText._('COM_REDSHOP_DISPLAY_ATTRIBUTE_TYPE') + '</label><select id="attribute_' + gh + '_display_type" name="' + attrPref + '[display_type]" class="input-medium"> <option value="dropdown" selected="selected">' + Joomla.JText._('COM_REDSHOP_DROPDOWN_LIST') + '</option><option value="radio">' + Joomla.JText._('COM_REDSHOP_RADIOBOX') + '</option></select></div>'
				+ '<div class="form-group"><label>' + Joomla.JText._('COM_REDSHOP_DESCRIPTION') + '</label><input class="text-center input-small" type="text" name="' + attrPref + '[attribute_description]" value="" /></div>'
				+ '</div>'

				+ '<div class="col-sm-3">'
				+ '<div class="form-group"><label>' + Joomla.JText._('COM_REDSHOP_ORDERING') + '</label><input class="text-center input-xmini" type="text" name="' + attrPref + '[ordering]" value="' + (gh + 1) + '" /></div>'
				+ '</div>'
		...
		$('#mainTableAttributes').on('click', '.delete_subproperty', function () {
			...
			$this.parents('.attr_tbody').find('.sub_attribute_table').append(
				...
				+ '<div class="col-sm-2">'
				+ '<label>' + Joomla.JText._('COM_REDSHOP_PARAMETER') + '</label><input type="text" name="' + subPref + '[name]"  class="input-small">'
				...
				+ '<div class="col-sm-2">'
				+ '<label>' + Joomla.JText._('COM_REDSHOP_PRICE') + '</label><input type="text" onchange="javascript:oprand_check(this);" name="' + subPref + '[oprand]" value="+" class="input-xmini text-center"><input type="text" name="' + subPref + '[price]" class="input-mini">'
				+ '</div>'

				+ '<div class="col-sm-1">'
				+ '<label>' + Joomla.JText._('COM_REDSHOP_PROPERTY_NUMBER') + '</label><input type="text" name="' + subPref + '[number]" value="" class="vpnrequired input-mini">'
				+ '</div>'

				+ '<div class="col-sm-1">'
				+ '<label>' + Joomla.JText._('COM_REDSHOP_ATTRIBUTE_EXTRAFIELD') + '</label><input type="text" name="' + subPref + '[extra_field]" class="input-mini">'
				+ '</div>'

				+ '<div class="col-sm-3">'
				+ '<label>' + Joomla.JText._('COM_REDSHOP_ORDERING') + '</label><input type="text" value="' + or + '" name="' + subPref + '[order]" class="text-center input-xmini">'
				+ '</div>'
