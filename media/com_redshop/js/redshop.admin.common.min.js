...
;if(null==e)return void alert("Your browser does not support XMLHTTP!");for(var t=new Array,n=document.adminForm.country_code,d=0,r=0;r<n.options.length;r++)1==n.options[r].selected&&(t[d++]=n.options[r].value);var o="index.php?option=com_redshop&view=zipcode_detail&task=getStateDropdown";o=o+"&country_codes="+t.join(","),e.onreadystatechange=function(){4==e.readyState&&(document.getElementById("state_code").innerHTML=e.responseText)},e.open("GET",o,!0),e.setRequestHeader("X-Requested-With","XMLHttpRequest"),e.send(null)}