...
function searchByCVR()
{
	...
	if(value)
	{
		...
		var linktocontroller = redSHOP.RSConfig._('AJAX_BASE_URL') + "index.php?option=com_redshop&view=registration&task=searchUserdetailByCVR&tmpl=component&cvr="+value;
		xmlhttp.open("GET",linktocontroller,true);
		xmlhttp.setRequestHeader("X-Requested-With", "XMLHttpRequest");
		xmlhttp.send(null);
	}
