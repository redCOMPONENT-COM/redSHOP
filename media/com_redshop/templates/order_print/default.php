...
<table style="width: 100%; vertical-align: top;" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td style="vertical-align: top; width: 36%;">
            <p style="color: #332b24;">{order_id_lbl}: <strong>{order_id}</strong> <br/>{order_number_lbl}: <strong>{order_number}</strong>
            </p>
        </td>
        <td style="vertical-align: top; width: 30%;">
            <p style="color: #332b24;">{order_date_lbl}: <strong>{order_date}</strong> <br/>{order_status_lbl}: <strong>{order_status}</strong>
            </p>
        </td>
        <td style="vertical-align: top; width: 33%;"><img style="float: right;" alt="logo"
                                                          src="media/com_redshop/images/redcomponent-logo.jpg"/></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="vertical-align: top;">
            <p style="text-align: right;"><span style="color: #332b24;">redCOMPONENT</span> <br/><span
                        style="color: #332b24;">Blangstedgaardsvej 1</span> <br/><span style="color: #332b24;">5220 Odense SØ<br/></span><span
                        style="color: #332b24;">Danmark</span> <br/><span
                        style="color: #332b24;"> Tlf. +45 23 888 777<br/></span></p>
        </td>
    </tr>
    </tbody>
</table>
...
<table style="width: 100%; vertical-align: middle; border: 1px solid #ded6d0;" cellpadding="5" cellspacing="0">
    ...
    <tr>
        <td style="vertical-align: middle; text-align: center; border-bottom: 1px solid #ded6d0; padding: 10px 0;"
            valign="top">
            {product_thumb_image}
        </td>
    ...
    <tr>
        <td>
            <p style="text-align: right; color: #292a35;">
                <br/>{order_subtotal_lbl}: {order_subtotal}<br/> <!-- {if discount}-->{discount_lbl} {order_discount}
                <br/> <!-- {discount end if}-->{shipping_lbl} {order_shipping} <br/>{order_transfee_label}
                {order_transfee} <br/><strong><br/>{total_lbl}: </strong><strong>{order_total_incl_transfee}</strong>
                <br/> <!-- {if vat} -->{vat_lbl}: {order_tax} <!-- {vat end if} -->
            </p>
        </td>
    </tr>
    </tbody>
