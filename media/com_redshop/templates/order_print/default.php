...
<table style="width: 100%; vertical-align: top;" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			...
			<td style="vertical-align: top; width: 33%;"><img style="float: right;" alt="logo" src="<?php echo JUri::root() ?>'/media/com_redshop/imagesmedia/com_redshop/images/log_red_com.png" /></td>
		</tr>
		<tr>
