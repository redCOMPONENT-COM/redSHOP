        ...
        <table class="table table-striped" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td>
                    ...
                    ({product_number_lbl} - {product_number})<br/>{product_accessory}{product_attribute}{product_userfields}
                </td>
                <td>
                    <div class="product_note">{product_wrapper}</div>
                </td>
                <td>
                    <div class="product_price">{product_price}</div>
                </td>
                <td>
                    <div class="product_quantity">{product_quantity}</div>
                </td>
