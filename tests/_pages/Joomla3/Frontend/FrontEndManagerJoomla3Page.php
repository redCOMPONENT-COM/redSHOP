...
/**
 * Class FrontEndManagerPage
 *
 * @link   http://codeception.com/docs/07-AdvancedUsage#PageObjects
 *
 * @since  1.4
 */
class FrontEndManagerJoomla3Page
{
	public static $allFrontEndPages = array (
		...
		"Category Detailed Templates Menu Type" => "/index.php?option=com_redshop&view=category&layout=detail&cid=3&manufacturer_id=0",
		"Category Detailed CCK and e-Commerce Menu Type" => "/index.php?option=com_redshop&view=category&layout=detail&cid=2&manufacturer_id=0",
		"Category Detailed Events and Forms Menu Type" => "/index.php?option=com_redshop&view=category&layout=detail&cid=1&manufacturer_id=0",
