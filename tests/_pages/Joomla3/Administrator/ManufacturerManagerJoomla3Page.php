...
class ManufacturerManagerJoomla3Page
{
    ...
    public static $manufactureFilter = ['id' => 'filter'];
    public static $manufactureResultPath = "//div[@class='table-responsive']/table/tbody/tr/td[5]";

    public static $selectFirst = "//input[@id='cb0']";

    public static $manufacturerStatePath = "//tbody/tr/td[5]/a";

    public static $manufactureURL = ['id' => "manufacturer_url"];
//	public static $manufacturerStatePath = "//div[@id='editcell']//table[2]//tbody/tr[1]/td[7]/a";
    ...
    public static $manufactureCloseMessage = "Manufacturer Detail Editing Cancelled";
