...
abstract class AdminPage
{
	...
	public function __construct(Webdriver $driver, $test, $url = null)
	{
		...
		$driver->waitForElementUntilIsPresent(By::xPath($this->waitForXpath), 5);
		if (isset($this->url))
		{
	...
	/**
	 * Function to clickMenu and Open the desired view
	 *
	...
	/**
	 * Function to save and Close the Edit View
	 *
	...
	/**
	 * Function to click any button present on the page
	 *
	 * @param $idOrLabel
	 *
	 * @return bool
