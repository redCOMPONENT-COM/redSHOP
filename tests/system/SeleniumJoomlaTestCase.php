...
class SeleniumJoomlaTestCase extends PHPUnit_Extensions_SeleniumTestCase
{
	...
	function doAdminLogin($username = null,$password = null)
	{
		...
		$d->findElement(By::xPath("//div[@id='lang_chzn']/div/div/input"))->sendKeys($language);
		$d->findElement(By::xPath("//div[@id='lang_chzn']//ul[@class='chzn-results']/li[contains(.,'" . $language . "')]"))->click();
