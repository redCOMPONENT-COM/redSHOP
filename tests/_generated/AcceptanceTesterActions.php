<?php  //[STAMP] 1491c3400e44d2115be49b8ec3ca3a4c
...
trait AcceptanceTesterActions
{
	 ...
	 *
	 * @param   string  $configurationName  Name of the Configuration Parameter Needed
	 * @param   string  $moduleName         Name of the Module from which the Configuration has to be fetched
	 *
	 * @return  mixed
	 * @since   1.0.0
	 * @throws  \Exception
     * @see \Codeception\Module\AcceptanceHelper::getConfigFromModule()
     */
    public function getConfigFromModule($configurationName, $moduleName = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getConfigFromModule', func_get_args()));
    }
    ...
    public function verifyState($expected, $actual) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('verifyState', func_get_args()));
    }
    ...
    public function verifyNotices($expected, $actual, $page) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('verifyNotices', func_get_args()));
    }
     ...
     * @see \Codeception\Module\AcceptanceHelper::waitAjaxLoad()
     */
	 ...
	 * @since   5.6.0
	 * @throws  ModuleException
     * @see \Codeception\Module\AcceptanceHelper::waitPageLoad()
     */
	 ...
	 * @throws  ModuleException
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Codeception\Module\AcceptanceHelper::dontSeeJsError()
     */
