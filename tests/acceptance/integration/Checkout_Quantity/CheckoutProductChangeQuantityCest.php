...
class CheckoutProductChangeQuantityCest
{
    ...
    public function __construct()
    {
        ...
        $this->productName         = "Product Name " . rand(1, 100);
        $this->categoryName        = "Category Name " . rand(1, 100);
        $this->productPrice        = 50;
        $this->total               = "DKK 50,00";;
        $this->randomProductNumber = $this->faker->numberBetween(999, 9999);
        $this->randomProductPrice  = 100;
//        $this->quatityChange       = "5";
     ...
     * Step4 : Create user
     * Step5 : Goes on frontend
     * Step6 : Click "Add to cart" for product
     * Step7 : Change quantity and checkout this product (when run configuration we don't show shipping inside cart)
     * Step5 : Delete data
     *
