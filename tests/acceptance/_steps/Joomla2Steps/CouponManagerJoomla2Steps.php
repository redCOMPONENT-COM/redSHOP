...
/**
 * Class CouponManagerJoomla2Steps
 *
 ...
 * @since    1.4
 */
class CouponManagerJoomla2Steps extends AdminManagerJoomla2Steps
{
	/**
	...
	public function editCoupon($couponCode = 'Current Code', $newCouponCode = 'Testing New')
	{
		...
		$I->click('ID');
		$I->see($couponCode, \CouponManagerPage::$firstResultRow);
		$I->click(\CouponManagerPage::$selectFirst);
		$I->click('Edit');
		$I->verifyNotices(false, $this->checkForNotices(), 'Coupon Edit View');
		$I->waitForElement(\CouponManagerPage::$couponCode, 20);
		$I->fillField(\CouponManagerPage::$couponCode, $newCouponCode);
		$I->click('Save & Close');
		$I->waitForText('Coupon Management');
		$I->see('Coupon detail saved');
		$I->see($newCouponCode, \CouponManagerPage::$firstResultRow);
		$I->click('ID');
	}
	...
	public function deleteCoupon($couponCode = 'Test Coupon')
	{
		...
		$I->dontSee($couponCode, \CouponManagerPage::$firstResultRow);
		$I->click('ID');
	}
