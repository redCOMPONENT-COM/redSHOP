...
class ManageProductsAdministratorCest
{
	...
	private function createProduct(AcceptanceTester $I, $productName, $productCategory, $productNumber, $price)
	{
		...
		$I->click('//*[@id="s2id_product_category"]/ul');
		$I->click("//ul[@class='select2-results']/li[last()]/div[@class='select2-result-label']"); 
		//$I->click("//ul[@class='select2-results']/li[text()='- " . $productCategory . "']/div[@class='select2-result-label']"); 
		$I->click("Save & Close");
	...
	private function deleteProduct(AcceptanceTester $I, $productName)
	{
		...
		/** This code is duplicate with step in searchProduct (Can remove it) 
		...
		// $I->see($productName, ['xpath' => "//*[@id='editcell']/div[2]/table/tbody/tr[1]/td[3]/a"]);	

		*/

		$I->click('//*[@id="editcell"]/div[2]/table/tbody/tr/td[2]/div/ins');
		$I->click("Delete");
	...
	private function searchProduct(AcceptanceTester $I, $productName, $functionName = 'Search')
	{
		...
		{
			$I->dontSee($productName, ['xpath' => "//*[@id='editcell']/div[2]/table/tbody/tr[1]/td[3]/a"]);
		}
	}
}
