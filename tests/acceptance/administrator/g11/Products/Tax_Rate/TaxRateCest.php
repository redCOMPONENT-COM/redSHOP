...
//        $client->checkEdit($this->taxRateName);
//        $client->addTAXRatesSave($this->taxRateName2, $this->taxGroupName, $this->taxRateValue, $this->countryName, $this->stateName);
//        $client->checkResetButton($this->taxRateName, $this->taxRateName2);
//        $client->deleteTAXRatesOK($this->taxRateName2);
		$client->checkSearchToolsEUCountry();
	}
