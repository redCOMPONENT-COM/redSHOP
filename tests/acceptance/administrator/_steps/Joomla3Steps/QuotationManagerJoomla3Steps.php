...
class QuotationManagerJoomla3Steps extends AdminManagerJoomla3Steps
{
	...
	public function checkPhoneNumber($firstname, $lastName, $address, $postalCode, $city, $stringPhone, $email, $userName, $passWord)
	{
		...
		$I->waitForElementVisible(UserManagerJoomla3Page::$lastName,30);
		$I->fillField(UserManagerJoomla3Page::$lastName, $lastName);
		$I->waitForElementVisible(UserManagerJoomla3Page::$address,30);
		$I->fillField(UserManagerJoomla3Page::$address, $address);
		$I->waitForElementVisible(UserManagerJoomla3Page::$address,30);
		$I->fillField(UserManagerJoomla3Page::$address, $postalCode);
		$I->waitForElementVisible(UserManagerJoomla3Page::$city,30);
		$I->fillField(UserManagerJoomla3Page::$city, $city);
		$I->waitForElementVisible(UserManagerJoomla3Page::$phone,30);
		$I->fillField(UserManagerJoomla3Page::$phone, $stringPhone);
		$I->waitForElementVisible(UserManagerJoomla3Page::$email,30);
		...
		$I->waitForElementVisible(UserManagerJoomla3Page::$newPassword ,30);
		$I->fillField(UserManagerJoomla3Page::$newPassword, $passWord);
		$I->waitForElementVisible(UserManagerJoomla3Page::$confirmNewPassword,30);
