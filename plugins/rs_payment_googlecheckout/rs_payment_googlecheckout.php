...
class plgRedshop_paymentrs_payment_googlecheckout extends JPlugin
{
    ...
    */
 	function onPaymentCheckoutButton($element, $data)
    {
    	if (empty($this->_plugin))
        {
 		...
 		$paymentpath=JPATH_SITE.DS.'plugins'.DS.'redshop_payment'.DS.'rs_payment_googlecheckout'.DS.'extra_info.php';

		return include_once($paymentpath);
