...
<input type="hidden" name="p3" value="<?php echo JText::_('COM_REDSHOP_ORDER_ID')?>&nbsp;<?php echo $data['order_id']?>">
<input type="hidden" name="p4" value="<?php echo $data['carttotal']; ?>">
<input type="hidden" name="p10" value="<?php echo JURI::base()?>index.php?option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&payment_plugin=rs_payment_netcash&orderid=<?php echo $data['order_id']?>">
<input type="hidden" name="Budget" value="<?php echo $gateway_popup?>">
<input type="hidden" name="m_9" value="<?php echo $user->email?>">
<input type="hidden" name="m_10" value="<?php echo JURI::base()?>index.php?option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&payment_plugin=rs_payment_netcash&orderid=<?php echo $data['order_id']?>">
