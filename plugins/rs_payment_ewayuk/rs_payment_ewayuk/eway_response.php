...
JPlugin::loadLanguage ( 'com_redshop' );
	...
	if($responsecode=="00" || $responsecode=="08" || $responsecode=="10" || $responsecode=="11" || $responsecode=="16")
    {
	 	...
	 	if($debug_mode==1)
	 	{
	 		$values->log=JTEXT::_('ORDER_PLACED')."  ".$trxnresponsemessage;
			$values->msg=JTEXT::_('ORDER_PLACED')."  ".$trxnresponsemessage;
	 	}
	 	else
	 	{
	...
	else
	{
	 	...
	 	if($debug_mode==1)
	 	{
	 		$values->log=JTEXT::_('ORDER_NOT_PLACED')."  ".$trxnresponsemessage;
			$values->msg=JTEXT::_('ORDER_NOT_PLACED')."  ".$trxnresponsemessage;
	 	}
	 	else
	 	{
