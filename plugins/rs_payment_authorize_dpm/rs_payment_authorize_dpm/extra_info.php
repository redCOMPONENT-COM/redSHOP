 ...
 */
	...
	$relay_response_url = JURI::root().'index2.php?option=com_redshop&tmpl=component&view=checkout&format=final&stap=2&oid='.$data["order_id"].'&Itemid='.$Itemid;
        ...
        <form method="post" action="'.$post_url.'" id="authodpmfrm" name="authodpmfrm">
            ...
            <fieldset>
                ...
                <div>
                    ...
                    <input type="hidden" class="hidden" size="4" name="x_card_code" value="'.$redirect_ccdata['credit_card_code'].'"></input>
                </div>
            </fieldset>
