 ...
 * @subpackage  PlgSearchRedshop_Categories
 *
...
/**
 *  PlgSearchRedshop_Categories installer class.
 *
 * @package  Redshopb.Plugin
 * @since    1.7.0
 */
class PlgSearchRedshop_CategoriesInstallerScript
{
	/**
		...
		if ($type == 'update' || $type == 'discover_install')
		{
			...
			$version = $db->setQuery(
				$db->getQuery(true)
					...
					->where($db->qn('element') . ' = ' . $db->q('redshop_categories'))
