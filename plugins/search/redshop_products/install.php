 ...
 * @subpackage  PlgSearchRedshop_Products
 *
...
/**
 *  PlgSearchRedshop_Products installer class.
 *
 * @package  Redshopb.Plugin
 * @since    1.7.0
 */
class PlgSearchRedshop_ProductsInstallerScript
{
	/**
		...
		if ($type == 'update' || $type == 'discover_install')
		{
			...
			$version = $db->setQuery(
				$db->getQuery(true)
					...
					->where($db->qn('element') . ' = ' . $db->q('redshop_products'))
