		...
		<table class="admintable">
			<tr class="row0">
				...
				<td><select class="inputbox" name="AUSTRALIAPOST_AUSEVICETYPE">
					  <option <?php if(AUSTRALIAPOST_AUSEVICETYPE=="Standard") echo "selected=\"selected\"" ?> value="Standard"><?php echo JText::_('COM_REDSHOP_AUS_STANDARD') ?></option>
					  <option <?php if(AUSTRALIAPOST_AUSEVICETYPE=="Express") echo "selected=\"selected\"" ?> value="Express"><?php echo JText::_('COM_REDSHOP_AUS_EXPRESS') ?></option>
					  <option <?php if(AUSTRALIAPOST_AUSEVICETYPE=="Air") echo "selected=\"selected\"" ?> value="Air"><?php echo JText::_('COM_REDSHOP_AUS_AIR') ?></option>
					   <option <?php if(AUSTRALIAPOST_AUSEVICETYPE=="Sea") echo "selected=\"selected\"" ?> value="Sea"><?php echo JText::_('COM_REDSHOP_AUS_SEA') ?></option>
					    <option <?php if(AUSTRALIAPOST_AUSEVICETYPE=="Economy") echo "selected=\"selected\"" ?> value="Economy"><?php echo JText::_('COM_REDSHOP_AUS_ECONOMY') ?></option>
					</select>
				</td>
			...
			<tr class="row0">
				...
				<td><select class="inputbox" name="AUSTRALIAPOST_SEVICETYPE">
					  <option <?php if(AUSTRALIAPOST_SEVICETYPE=="Standard") echo "selected=\"selected\"" ?> value="Standard"><?php echo JText::_('COM_REDSHOP_AUS_STANDARD') ?></option>
					  <option <?php if(AUSTRALIAPOST_SEVICETYPE=="Express") echo "selected=\"selected\"" ?> value="Express"><?php echo JText::_('COM_REDSHOP_AUS_EXPRESS') ?></option>
					  <option <?php if(AUSTRALIAPOST_SEVICETYPE=="Air") echo "selected=\"selected\"" ?> value="Air"><?php echo JText::_('COM_REDSHOP_AUS_AIR') ?></option>
					   <option <?php if(AUSTRALIAPOST_SEVICETYPE=="Sea") echo "selected=\"selected\"" ?> value="Sea"><?php echo JText::_('COM_REDSHOP_AUS_SEA') ?></option>
					    <option <?php if(AUSTRALIAPOST_SEVICETYPE=="Economy") echo "selected=\"selected\"" ?> value="Economy"><?php echo JText::_('COM_REDSHOP_AUS_ECONOMY') ?></option>
					</select>
				</td>
