...
class plgredshop_shippingaustraliapost extends JPlugin
{
	...
	function onShowconfig($ps)
	{
		...
		<table class="admintable">
			<tr class="row0">
				<td><strong><?php echo JText::_('AUSTRALIAPOST_AUSEVICETYPE_LBL') ?></strong></td>
				<td><select class="inputbox" name="AUSTRALIAPOST_AUSEVICETYPE">
					  <option <?php if(AUSTRALIAPOST_AUSEVICETYPE=="Standard") echo "selected=\"selected\"" ?> value="Standard"><?php echo JText::_('AUS_STANDARD') ?></option>
					  <option <?php if(AUSTRALIAPOST_AUSEVICETYPE=="Express") echo "selected=\"selected\"" ?> value="Express"><?php echo JText::_('AUS_EXPRESS') ?></option>
					  <option <?php if(AUSTRALIAPOST_AUSEVICETYPE=="Air") echo "selected=\"selected\"" ?> value="Air"><?php echo JText::_('AUS_AIR') ?></option>
					   <option <?php if(AUSTRALIAPOST_AUSEVICETYPE=="Sea") echo "selected=\"selected\"" ?> value="Sea"><?php echo JText::_('AUS_SEA') ?></option>
					    <option <?php if(AUSTRALIAPOST_AUSEVICETYPE=="Economy") echo "selected=\"selected\"" ?> value="Economy"><?php echo JText::_('AUS_ECONOMY') ?></option>
					</select>
				</td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'AUSTRALIAPOST_AUSEVICETYPE_LBL' ), JText::_ ( 'AUSTRALIAPOST_AUSEVICETYPE_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row0">
				<td><strong><?php echo JText::_('AUSTRALIAPOST_SEVICETYPE_LBL') ?></strong></td>
				<td><select class="inputbox" name="AUSTRALIAPOST_SEVICETYPE">
					  <option <?php if(AUSTRALIAPOST_SEVICETYPE=="Standard") echo "selected=\"selected\"" ?> value="Standard"><?php echo JText::_('AUS_STANDARD') ?></option>
					  <option <?php if(AUSTRALIAPOST_SEVICETYPE=="Express") echo "selected=\"selected\"" ?> value="Express"><?php echo JText::_('AUS_EXPRESS') ?></option>
					  <option <?php if(AUSTRALIAPOST_SEVICETYPE=="Air") echo "selected=\"selected\"" ?> value="Air"><?php echo JText::_('AUS_AIR') ?></option>
					   <option <?php if(AUSTRALIAPOST_SEVICETYPE=="Sea") echo "selected=\"selected\"" ?> value="Sea"><?php echo JText::_('AUS_SEA') ?></option>
					    <option <?php if(AUSTRALIAPOST_SEVICETYPE=="Economy") echo "selected=\"selected\"" ?> value="Economy"><?php echo JText::_('AUS_ECONOMY') ?></option>
					</select>
				</td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'AUSTRALIAPOST_SEVICETYPE_LBL' ), JText::_ ( 'AUSTRALIAPOST_SEVICETYPE_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row0">
				<td><strong><?php echo JText::_('AUSTRALIAPOST_PICKUPZIPCODE_LBL') ?></strong></td>
				<td><input class="inputbox" type="text" name="AUSTRALIAPOST_PICKUPZIPCODE" value="<?php echo AUSTRALIAPOST_PICKUPZIPCODE;?>">
				</td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'AUSTRALIAPOST_PICKUPZIPCODE_LBL' ), JText::_ ( 'AUSTRALIAPOST_PICKUPZIPCODE_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
	...
	function onListRates(&$d)
	{
		...
		if($carttotalWeight > 0)
		{
			...
			if( function_exists( "curl_init" ))
			{
				...
				if( !$result ) {
//					echo JText::_('NOT_GET_SHIPPING_RATES');
					return $shippingrate;
				}
				if($result)
				{
...
//				echo JText::_('NOT_GET_SHIPPING_RATES');
			...
			for($i=0; $i<count($charge); $i++)
			{
				...
				$shippingrate[$rate]->text = $days[$i].JText::_('DAYS');
