...
class plgredshop_shippingusps extends JPlugin
{
	...
	function onShowconfig($ps)
	{
		...
		<table class="admintable">
			<tr class="row0">
				<td><strong><?php echo JText::_('USPS_USERNAME') ?></strong></td>
				<td><input type="text" name="USPS_USERNAME" class="inputbox" value="<?php echo USPS_USERNAME ?>" /></td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'USPS_USERNAME' ), JText::_ ( 'USPS_USERNAME' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row1">
				<td><strong><?php echo JText::_('USPS_PASSWORD') ?></strong></td>
				<td><input type="text" name="USPS_PASSWORD" class="inputbox" value="<?php echo USPS_PASSWORD ?>" /></td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'USPS_PASSWORD' ), JText::_ ( 'USPS_PASSWORD' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row1" >
				<td><strong><?php echo JText::_('USPS_SERVER') ?></strong></td>
				<td><input type="text" name="USPS_SERVER" class="inputbox" value="<?php echo USPS_SERVER ?>" /></td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'USPS_SERVER' ), JText::_ ( 'USPS_SERVER' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row1">
				<td><strong><?php echo JText::_('USPS_PATH') ?></strong></td>
				<td><input type="text" name="USPS_PATH" class="inputbox" value="<?php echo USPS_PATH ?>" /></td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'USPS_PATH' ), JText::_ ( 'USPS_PATH' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row1">
				<td><strong><?php echo JText::_('USPS_SOURCE_ZIP') ?></strong></td>
				<td><input type="text" name="USPS_SOURCE_ZIP" class="inputbox" value="<?php echo USPS_SOURCE_ZIP ?>" /></td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'USPS_SOURCE_ZIP' ), JText::_ ( 'USPS_SOURCE_ZIP' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row0">
				<td><strong><?php echo JText::_('USPS_PACKAGESIZE') ?></strong></td>
				<td><select class="inputbox" name="USPS_PACKAGESIZE">
					  <option <?php if(USPS_PACKAGESIZE=="Regular") echo "selected=\"selected\"" ?> value="Regular">Regular
					  <option <?php if(USPS_PACKAGESIZE=="Large") echo "selected=\"selected\"" ?> value="Large">Large</option>
					  <option <?php if(USPS_PACKAGESIZE=="Oversize") echo "selected=\"selected\"" ?> value="Oversize">Oversize</option>
					</select>
				</td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'USPS_PACKAGESIZE' ), JText::_ ( 'USPS_PACKAGESIZE' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row1">
		        <td colspan='3'>
		        	<hr size='2' />
   			...
   			<tr class="row0">
				<td><strong><?php echo JText::_('USPS_HANDLINGFEE') ?></strong></td>
				<td><input type="text" name="USPS_HANDLINGFEE" class="inputbox" value="<?php echo USPS_HANDLINGFEE ?>" /></td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'USPS_HANDLINGFEE' ), JText::_ ( 'USPS_HANDLINGFEE' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row0">
				<td><strong><?php echo JText::_('USPS_PADDING') ?></strong></td>
				<td><input type="text" name="USPS_PADDING" class="inputbox" value="<?php echo USPS_PADDING ?>" /></td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'USPS_PADDING' ), JText::_ ( 'USPS_PADDING' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row0">
				<td><strong><?php echo JText::_('USPS_INTLLBRATE') ?></strong></td>
				<td><input type="text" name="USPS_INTLLBRATE" class="inputbox" value="<?php echo USPS_INTLLBRATE ?>" /></td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'USPS_INTLLBRATE' ), JText::_ ( 'USPS_INTLLBRATE' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row0">
				<td><strong><?php echo JText::_('USPS_INTLHANDLINGFEE') ?></strong></td>
				<td><input type="text" name="USPS_INTLHANDLINGFEE" class="inputbox" value="<?php echo USPS_INTLHANDLINGFEE ?>" /></td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'USPS_INTLHANDLINGFEE' ), JText::_ ( 'USPS_INTLHANDLINGFEE' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_MACHINABLE') ?></strong></td>
				<td>
					<label>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_SHOW_DELIVERY_QUOTE') ?></strong></td>
				<td>
					<label>
			...
			<tr class="row1">
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_EXPRESS_MAIL_PO_TO_PO') ?></strong></td>
				<td>
					<label>
						<input name="USPS_SHIP0" type="radio" <?php if (USPS_SHIP0 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_SHIP0" type="radio" <?php if (USPS_SHIP0 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_EXPRESS_MAIL') ?></strong></td>
				<td>
					<label>
						<input name="USPS_SHIP1" type="radio" <?php if (USPS_SHIP1 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_SHIP1" type="radio" <?php if (USPS_SHIP1 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_EXPRESS_MAIL_FLAT_RATE_ENVELOPE') ?></strong></td>
				<td>
					<label>
						<input name="USPS_SHIP2" type="radio" <?php if (USPS_SHIP2 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_SHIP2" type="radio" <?php if (USPS_SHIP2 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_PRIORITY_MAIL') ?></strong></td>
				<td>
					<label>
						<input name="USPS_SHIP3" type="radio" <?php if (USPS_SHIP3 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_SHIP3" type="radio" <?php if (USPS_SHIP3 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_PRIORITY_MAIL_FLAT_RATE_ENVELOPE') ?></strong></td>
				<td>
					<label>
						<input name="USPS_SHIP4" type="radio" <?php if (USPS_SHIP4 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_SHIP4" type="radio" <?php if (USPS_SHIP4 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_PRIORITY_MAIL_FLAT_RATE_BOX') ?></strong></td>
				<td>
					<label>
						<input name="USPS_SHIP5" type="radio" <?php if (USPS_SHIP5 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_SHIP5" type="radio" <?php if (USPS_SHIP5 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_FIRST_CLASS_MAIL') ?></strong></td>
				<td>
					<label>
						<input name="USPS_SHIP6" type="radio" <?php if (USPS_SHIP6 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_SHIP6" type="radio" <?php if (USPS_SHIP6 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_PARCEL_POST') ?></strong></td>
				<td>
					<label>
						<input name="USPS_SHIP7" type="radio" <?php if (USPS_SHIP7 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_SHIP7" type="radio" <?php if (USPS_SHIP7 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_BOUND_PRINTED_MATTER') ?></strong></td>
				<td>
					<label>
						<input name="USPS_SHIP8" type="radio" <?php if (USPS_SHIP8 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_SHIP8" type="radio" <?php if (USPS_SHIP8 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_MEDIA_MAIL') ?></strong></td>
				<td>
					<label>
						<input name="USPS_SHIP9" type="radio" <?php if (USPS_SHIP9 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_SHIP9" type="radio" <?php if (USPS_SHIP9 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_LIBRARY_MAIL') ?></strong></td>
				<td>
					<label>
						<input name="USPS_SHIP10" type="radio" <?php if (USPS_SHIP10 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_SHIP10" type="radio" <?php if (USPS_SHIP10 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
			...
			<tr class="row1">
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_GLOBAL_EXPRESS_GUARANTEED') ?></strong></td>
				<td>
					<label>
						<input name="USPS_GLOBAL_EXPRESS_GUARANTEED" type="radio" <?php if (USPS_GLOBAL_EXPRESS_GUARANTEED == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_GLOBAL_EXPRESS_GUARANTEED" type="radio" <?php if (USPS_GLOBAL_EXPRESS_GUARANTEED == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_GLOBAL_EXPRESS_GUARANTEED_NON_DOCUMENT_RECTANGULAR') ?></strong></td>
				<td>
					<label>
						<input name="USPS_INTL1" type="radio" <?php if (USPS_INTL1 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_INTL1" type="radio" <?php if (USPS_INTL1 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_GLOBAL_EXPRESS_RECTANGULAR') ?></strong></td>
				<td>
					<label>
						<input name="USPS_INTL2" type="radio" <?php if (USPS_INTL2 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_INTL2" type="radio" <?php if (USPS_INTL2 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_EXPRESS_MAIL_INTERNATIONAL_(EMS)') ?></strong>
		        </td>
				<td>
					<label>
						<input name="USPS_INTL3" type="radio" <?php if (USPS_INTL3 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_INTL3" type="radio" <?php if (USPS_INTL3 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_EXPRESS_MAIL_INTERNATIONAL_(EMS)_FLAT_RATE_ENVELOPE') ?></strong>
		        </td>
				<td>
					<label>
						<input name="USPS_INTL4" type="radio" <?php if (USPS_INTL4 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_INTL4" type="radio" <?php if (USPS_INTL4 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_PRIORITY_MAIL_INTERNATIONAL') ?></strong></td>
				<td>
					<label>
						<input name="USPS_INTL5" type="radio" <?php if (USPS_INTL5 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_INTL5" type="radio" <?php if (USPS_INTL5 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_PRIORITY_MAIL_INTERNATIONAL_FLAT_RATE_ENVELOPE') ?></strong></td>
				<td>
					<label>
						<input name="USPS_INTL6" type="radio" <?php if (USPS_INTL6 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_INTL6" type="radio" <?php if (USPS_INTL6 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_PRIORITY_MAIL_INTERNATIONAL_FLAT_RATE_BOX') ?></strong></td>
				<td>
					<label>
						<input name="USPS_INTL7" type="radio" <?php if (USPS_INTL7 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_INTL7" type="radio" <?php if (USPS_INTL7 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('USPS_FIRST_CLASS_MAIL_INTERNATIONAL') ?></strong></td>
				<td>
					<label>
						<input name="USPS_INTL8" type="radio" <?php if (USPS_INTL8 == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes
					</label>
					<label>
						<input name="USPS_INTL8" type="radio" <?php if (USPS_INTL8 == 0) echo "checked=\"checked\""; ?> value="0" />
						No
					</label>
				</td>
				<td>
			...
			else
			{
				if( $dest_country=="USA" && in_array($dest_state,$states) )
				{
					...
					if( function_exists( "curl_init" ))
					{
						...
						if( !empty( $error ))
						{
							$html = "<br/><span class=\"message\">".JText::_('PHPSHOP_INTERNAL_ERROR')." USPS.com</span>";
							$error = true;
						}
						else
						{
					...
					else
					{
						...
						{
							$error = true;
							$html = JText::_('PHPSHOP_INTERNAL_ERROR').": $errstr ($errno)";
						}
						else
						{
					...
					if ($matchingNodes != null)
					{
						for ($i = 0; $i < $matchingNodes->getLength(); $i++)
						{
							...
							$ship_postage[$count] = $currNode->getElementsByTagName("Rate");
							$ship_postage[$count] = $ship_postage[$count]->item(0);
							$ship_postage[$count] = $ship_postage[$count]->getText();
...
//							$ship_commit[$count] = $usps_ship_active[$serviceName][0];
							$count++;
						}
					}
				...
				else
				{
					...
					$xmlPost .= "<Country>".$dest_country."</Country>";
					...
					//Edited 08 04 2010
					$count = 0;
					$matchingNodes =& $xmlDoc->getElementsByTagName("Service");
					if ($matchingNodes != null)
					{
						for ($i = 0; $i < $matchingNodes->getLength(); $i++)
						{
							...
							{
								$ship_service[$count] = $serviceName;
								$ship_postage[$count] = $currNode->getElementsByTagName("Postage");
								$ship_postage[$count] = $ship_postage[$count]->item(0);
								$ship_postage[$count] = $ship_postage[$count]->getText();
								...
								$ship_commit[$count] = $currNode->getElementsByTagName("SvcCommitments");
								$ship_commit[$count] = $ship_commit[$count]->item(0);
								$ship_commit[$count] = $ship_commit[$count]->getText();
								$ship_weight[$count] = $currNode->getElementsByTagName("MaxWeight");
								$ship_weight[$count] = $ship_weight[$count]->item(0);
								$ship_weight[$count] = $ship_weight[$count]->getText();
								$count++;
							}
						}
					}
