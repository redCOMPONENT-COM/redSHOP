	...
	function onShowconfig($ps)
	{
		...
		<table class="admintable">
			...
			<tr class="row1">
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JText::_('COM_REDSHOP_USPS_GLOBAL_EXPRESS_GUARANTEED_NON_DOCUMENT_RECTANGULAR') ?></strong></td>
				<td>
					<label>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JText::_('COM_REDSHOP_USPS_PRIORITY_MAIL_INTERNATIONAL_FLAT_RATE_ENVELOPE') ?></strong></td>
				<td>
					<label>
   			...
   			<tr class="row1">
		        <td>
		        	<strong><?php echo JText::_('COM_REDSHOP_USPS_PRIORITY_MAIL_INTERNATIONAL_FLAT_RATE_BOX') ?></strong></td>
				<td>
					<label>
						...
						for ($i = 0; $i < count($totalmatchedchild); $i++)
						{
							...
							$matched_childname 	= $currNode->name();
							 ...
							 {     
								...
								$strTitle= preg_replace('|<sup>(.*?)</sup>|', '', htmlspecialchars_decode($SvcDescription->data(), ENT_QUOTES));$strTitle = str_replace('*','',$strTitle);
