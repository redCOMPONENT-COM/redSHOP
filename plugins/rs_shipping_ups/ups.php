	...
	function onShowconfig($ps)
	{
		...
		<tr class="row1">
			...
			<td><select class="inputbox" name="residential">
					<option <?php if(UPS_RESIDENTIAL=="yes") echo "selected=\"selected\"" ?> value="yes"><?php echo JText::_('UPS_RESIDENTIAL') ?></option>
					<option <?php if(UPS_RESIDENTIAL=="no") echo "selected=\"selected\"" ?> value="no"><?php echo JText::_('UPS_COMMERCIAL') ?></option>
				</select></td>
