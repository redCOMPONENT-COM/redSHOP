...
class plgredshop_shippingups extends JPlugin
{
	...
	function onShowconfig($ps)
	{
		...
		<tr class="row0">
			...
			<td><input type="text" name="UPS_ACCESS_CODE" class="inputbox" value="<?php echo UPS_ACCESS_CODE ?>" /></td>
		...
		<tr class="row1">
			...
			<td><select class="inputbox" name="residential">
					<option <?php if(UPS_RESIDENTIAL=="yes") echo "selected=\"selected\"" ?> value="yes"><?php echo JText::_('COM_REDSHOP_UPS_RESIDENTIAL') ?></option>
					<option <?php if(UPS_RESIDENTIAL=="no") echo "selected=\"selected\"" ?> value="no"><?php echo JText::_('COM_REDSHOP_UPS_COMMERCIAL') ?></option>
				</select></td>
			<td><?php echo JHTML::tooltip ( JText::_('COM_REDSHOP_SHIPPING_METHOD_UPS_TYPE_RESIDENTIAL' ), JText::_('COM_REDSHOP_SHIPPING_METHOD_UPS_TYPE_RESIDENTIAL' ), 'tooltip.png', '', '', false );?></td></tr>
		<tr class="row1">
	...
	<?php // BEGIN CUSTOM CODE ?>
		...
		<tr class="row1">
			...
			<tr class="row1">
			  <td><div align="left"><strong><?php echo JText::_('COM_REDSHOP_SHIPPING_METHOD_LBL' );?></strong></div></td>
			  <td><div align="left"><strong>Enable?</strong></div></td>
			  <td><div align="left"><strong>Fuel SurCharge Rate(%)</strong><?php echo JHTML::tooltip ( JText::_('COM_REDSHOP_SHIPPING_METHOD_LBL' ), JText::_('COM_REDSHOP_SHIPPING_METHOD_LBL_TOOLTIP' ), 'tooltip.png', '', '', false );?></div></td>
			</tr>
			<tr class="row0">
			  <td>UPS Next Day Air</td>
			  <td><div align="center"><input type="checkbox" name="UPS_Next_Day_Air" class="inputbox" <?php if (UPS_Next_Day_Air == 01) echo "checked=\"checked\""; ?> value="01" /></div></td>
			  <td><input class="inputbox" type="text" name="UPS_Next_Day_Air_FSC" value="<?php echo UPS_Next_Day_Air_FSC; ?>" /></td>
			</tr>
			<tr class="row1">
			  <td>UPS 2nd Day Air</td>
			  <td><div align="center"><input type="checkbox" name="UPS_2nd_Day_Air" class="inputbox" <?php if (UPS_2nd_Day_Air == 02) echo "checked=\"checked\""; ?> value="02" /></div></td>
			  <td><input class="inputbox" type="text" name="UPS_2nd_Day_Air_FSC" value="<?php echo UPS_2nd_Day_Air_FSC; ?>" /></td>
			</tr>
			<tr class="row0">
			  <td>UPS Ground</td>
			  <td><div align="center"><input type="checkbox" name="UPS_Ground" class="inputbox" <?php if (UPS_Ground == 03) echo "checked=\"checked\""; ?> value="03" /></div></td>
			  <td><input class="inputbox" type="text" name="UPS_Ground_FSC" value="<?php echo UPS_Ground_FSC; ?>" /></td>
			</tr>
			<tr class="row1">
			  <td>UPS Worldwide Express SM</td>
			  <td><div align="center"><input type="checkbox" name="UPS_Worldwide_Express_SM" class="inputbox" <?php if (UPS_Worldwide_Express_SM == 07) echo "checked=\"checked\""; ?> value="07" /></div></td>
			  <td><input class="inputbox" type="text" name="UPS_Worldwide_Express_SM_FSC" value="<?php echo UPS_Worldwide_Express_SM_FSC; ?>" /></td>
			</tr>
			<tr class="row0">
			  <td>UPS Worldwide Expedited SM</td>
			  <td><div align="center"><input type="checkbox" name="UPS_Worldwide_Expedited_SM" class="inputbox" <?php if (UPS_Worldwide_Expedited_SM == '08') echo "checked=\"checked\""; ?> value="08" /></div></td>
			  <td><input class="inputbox" type="text" name="UPS_Worldwide_Expedited_SM_FSC" value="<?php echo UPS_Worldwide_Expedited_SM_FSC; ?>" /></td>
			</tr>
			<tr class="row1">
			  <td>UPS Standard </td>
			  <td>
			...
			for($t=0;$t<count($matchedchild);$t++)
			{
				...
				{		
					...
					if ( in_array($servicecode,$myservicecodes) )
					{
						...
						switch( $servicecode )
						{
							case "01": $ship_postage[$count]["ServiceName"] = "UPS Next Day Air"; break;
							case "02": $ship_postage[$count]["ServiceName"] = "UPS 2nd Day Air"; break;
							case "03": $ship_postage[$count]["ServiceName"] = "UPS Ground"; break;
							case "07": $ship_postage[$count]["ServiceName"] = "UPS Worldwide Express SM"; break;
							case "08": $ship_postage[$count]["ServiceName"] = "UPS Worldwide Expedited SM"; break;
							case "11": $ship_postage[$count]["ServiceName"] = "UPS Standard"; break;
							case "12": $ship_postage[$count]["ServiceName"] = "UPS 3 Day Select"; break;
							case "13": $ship_postage[$count]["ServiceName"] = "UPS Next Day Air Saver"; break;
							case "14": $ship_postage[$count]["ServiceName"] = "UPS Next Day Air Early A.M."; break;
							case "54": $ship_postage[$count]["ServiceName"] = "UPS Worldwide Express Plus SM"; break;
							case "59": $ship_postage[$count]["ServiceName"] = "UPS 2nd Day Air A.M."; break;
							case "64": $ship_postage[$count]["ServiceName"] = "n/a"; break;
							case "65": $ship_postage[$count]["ServiceName"] = "UPS Saver"; break;
						}
						$count++;
					}
				}
