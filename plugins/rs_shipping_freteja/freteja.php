...
class plgredshop_shippingfreteja extends JPlugin
{
	...
	function onShowconfig($ps)
	{
		...
		<table class="admintable">
			<tr class="row0">
				<td><strong><?php echo JText::_('FJ_HANDLING_FEE_LBL') ?></strong></td>
				<td><input class="inputbox" type="text" name="FJ_Handling_Fee" value="<?php echo FJ_Handling_Fee;?>">
				</td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'FJ_HANDLING_FEE_LBL' ), JText::_ ( 'FJ_HANDLING_FEE_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row0">
				<td><strong><?php echo JText::_('FJ_NCDEMPRESA_LBL') ?></strong></td>
				<td><input class="inputbox" type="text" name="FJ_nCdEmpresa" value="<?php echo FJ_nCdEmpresa;?>">
				</td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'FJ_NCDEMPRESA_LBL' ), JText::_ ( 'FJ_NCDEMPRESA_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>

			<tr class="row0">
				<td><strong><?php echo JText::_('FJ_SDSSENHA_LBL') ?></strong></td>
				<td><input class="inputbox" type="text" name="FJ_sDsSenha" value="<?php echo FJ_sDsSenha;?>">
				</td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'FJ_SDSSENHA_LBL' ), JText::_ ( 'FJ_SDSSENHA_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row0">
				<td><strong><?php echo JText::_('FJ_EMBARCADOR_LBL') ?></strong></td>
				<td><input class="inputbox" type="text" name="FJ_Embarcador" value="<?php echo FJ_Embarcador;?>">
				</td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'FJ_EMBARCADOR_LBL' ), JText::_ ( 'FJ_EMBARCADOR_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row0">
				<td><strong><?php echo JText::_('FJ_TIPOFRETE_LBL') ?></strong></td>
				<td><select name="FJ_TipoFrete">
						<option value="C" <?=(FJ_TipoFrete=='C')?'selected="selected"':''?>>CIF ( Frete pago pelo Cliente )</option>
						<option value="F" <?=(FJ_TipoFrete=='F')?'selected="selected"':''?>>FOB ( Frete pago pela Empresa )</option>
			</select>
				</td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'FJ_TIPOFRETE_LBL' ), JText::_ ( 'FJ_TIPOFRETE_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row0">
				<td><strong><?php echo JText::_('FJ_PICKUPZIPCODE_LBL') ?></strong></td>
				<td><input class="inputbox" type="text" name="FJ_Order_Pickup_Postcode" value="<?php echo FJ_Order_Pickup_Postcode;?>">
				</td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'FJ_PICKUPZIPCODE_LBL' ), JText::_ ( 'FJ_PICKUPZIPCODE_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
 		</table>
