...
class plgredshop_shippingshipwire extends JPlugin
{
	...
	function onShowconfig($ps)
	{
		...
		<table class="admintable">
			<tr class="row0">
				<td><strong><?php echo JText::_('SHIPWIRE_EMAIL_LBL') ?></strong></td>
				<td><input class="inputbox" type="text" name="SHIPWIRE_EMAIL" value="<?php echo SHIPWIRE_EMAIL;?>">
				</td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'SHIPWIRE_EMAIL_LBL' ), JText::_ ( 'SHIPWIRE_EMAIL_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row0">
				<td><strong><?php echo JText::_('SHIPWIRE_PASSWORD_LBL') ?></strong></td>
				<td><input class="inputbox" type="text" name="SHIPWIRE_PASSWORD" value="<?php echo SHIPWIRE_PASSWORD;?>">
				</td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'SHIPWIRE_PASSWORD_LBL' ), JText::_ ( 'SHIPWIRE_PASSWORD_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
