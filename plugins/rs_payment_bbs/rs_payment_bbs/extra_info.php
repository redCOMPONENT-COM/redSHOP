 ...
 */
	...
	//Authnet vars to send
	  ...
	  'token' => $this->_params->get("token_id"),
  	  ...
  	  'accepturl' => JURI::base()."index2.php?option=com_redshop&view=order_detail&controller=order_detail&Itemid=$Itemid&task=notify_payment&payment_plugin=rs_payment_bbs&orderid=".$data['order_id']);
