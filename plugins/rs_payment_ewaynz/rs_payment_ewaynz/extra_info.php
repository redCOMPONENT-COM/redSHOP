 ...
 */
	...
	//$ewayurl.="&CancelURL=".JURI::base()."plugins/redshop_payment/rs_payment_ewayuk/eway_response.php";
 	...
 	$returnurl=JURI::base()."plugins/redshop_payment/rs_payment_ewaynz/eway_response.php";
	$cancelurl=JURI::base()."plugins/redshop_payment/rs_payment_ewaynz/eway_response.php";
