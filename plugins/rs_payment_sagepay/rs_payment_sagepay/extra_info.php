 ...
 */
	...
	if($data['shippinginfo']->address!="" && $data['shippinginfo']->address!="0")
	{
		...
		"SuccessURL" => JURI::base()."index2.php?option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&payment_plugin=rs_payment_sagepay&Itemid=$Itemid&orderid=".$data['order_id'],
		"FailureURL" => JURI::base()."index2.php?option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&payment_plugin=rs_payment_sagepay&Itemid=$Itemid&orderid=".$data['order_id'],
