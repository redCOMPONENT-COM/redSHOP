		...
		if($client){
		    ...
		    try{
		        ...
		        if($r->valid == true){
					...
					echo "<input type='radio' name='veis_status_invalid' id='veis_status_invalid1' value='0' >&nbsp;". JText::_('VEIS_VALIDATION_STATUS1' );
					echo "&nbsp;<input type='radio' name='veis_status_invalid' id='veis_status_invalid2' value='1' checked='checked'>&nbsp;". JText::_('VEIS_VALIDATION_STATUS2' );
