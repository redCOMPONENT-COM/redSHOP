...
require_once ( JPATH_SITE . DS . 'plugins' . DS . 'redshop_payment' . DS . 'rs_payment_payment_express' . DS .'PxPay_Curl.inc.php');
 	...
 	function onPrePayment_rs_payment_payment_express($element, $data)
    {
		...
		// pxpost
	        ...
	        $amount = sprintf("%9.2f",$amount); //convert .8 to .80
			 ...
			 $cmdDoTxnTransaction .= "<TxnData1>".JText::_('ORDER_ID')." : ".$order_number."</TxnData1>";
