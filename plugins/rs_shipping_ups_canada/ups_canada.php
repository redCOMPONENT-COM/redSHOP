...
class plgredshop_shippingups_canada extends JPlugin
{
	...
	function onShowconfig($ps)
	{
		...
		<tr class="row0">
			...
			<td><input type="text" name="UPS_Canada_ACCESS_CODE" class="inputbox" value="<?php echo UPS_Canada_ACCESS_CODE ?>" /></td>
		...
		<tr class="row1">
			...
			<td><input type="text" name="UPS_Canada_USER_ID" class="inputbox" value="<?php echo UPS_Canada_USER_ID ?>" /></td>
		...
		<tr class="row0">
			...
			<td><input type="text" name="UPS_Canada_PASSWORD" class="inputbox" value="<?php echo UPS_Canada_PASSWORD ?>" /></td>
		...
		<tr class="row1">
			...
			<td><select class="inputbox" name="UPS_Canada_pickup_type">
				  <option <?php if(UPS_Canada_PICKUP_TYPE=="01") echo "selected=\"selected\"" ?> value="01">Daily Pickup</option>
				  <option <?php if(UPS_Canada_PICKUP_TYPE=="03") echo "selected=\"selected\"" ?> value="03">Customer Counter</option>
				  <option <?php if(UPS_Canada_PICKUP_TYPE=="06") echo "selected=\"selected\"" ?> value="06">One Time Pickup</option>
				  <option <?php if(UPS_Canada_PICKUP_TYPE=="07") echo "selected=\"selected\"" ?> value="07">On Call Air Pickup</option>
				  <option <?php if(UPS_Canada_PICKUP_TYPE=="19") echo "selected=\"selected\"" ?> value="19">Letter Center</option>
				  <option <?php if(UPS_Canada_PICKUP_TYPE=="20") echo "selected=\"selected\"" ?> value="20">Air Service Center</option>
				</select></td>
		...
		<tr class="row0">
			...
			<td><select class="inputbox" name="UPS_Canada_package_type">
				  <option <?php if(UPS_Canada_PACKAGE_TYPE=="00") echo "selected=\"selected\"" ?> value="00">Unknown
				  <option <?php if(UPS_Canada_PACKAGE_TYPE=="01") echo "selected=\"selected\"" ?> value="01">UPS letter</option>
				  <option <?php if(UPS_Canada_PACKAGE_TYPE=="02") echo "selected=\"selected\"" ?> value="02">Package</option>
				  <option <?php if(UPS_Canada_PACKAGE_TYPE=="03") echo "selected=\"selected\"" ?> value="03">UPS Tube</option>
				  <option <?php if(UPS_Canada_PACKAGE_TYPE=="04") echo "selected=\"selected\"" ?> value="04">UPS Pak</option>
				  <option <?php if(UPS_Canada_PACKAGE_TYPE=="21") echo "selected=\"selected\"" ?> value="21">UPS Express Box</option>
				  <option <?php if(UPS_Canada_PACKAGE_TYPE=="24") echo "selected=\"selected\"" ?> value="24">UPS 25Kg Box</option>
				  <option <?php if(UPS_Canada_PACKAGE_TYPE=="25") echo "selected=\"selected\"" ?> value="25">UPS 10Kg Box</option>
				</select></td>
		...
		<tr class="row1">
			...
			<td><select class="inputbox" name="UPS_Canada_residential">
					<option <?php if(UPS_Canada_RESIDENTIAL=="yes") echo "selected=\"selected\"" ?> value="yes"><?php echo JText::_('UPS_RESIDENTIAL') ?></option>
					<option <?php if(UPS_Canada_RESIDENTIAL=="no") echo "selected=\"selected\"" ?> value="no"><?php echo JText::_('UPS_COMMERCIAL') ?></option>
				</select></td>
			<td><?php echo JHTML::tooltip ( JText::_ ( 'SHIPPING_METHOD_UPS_TYPE_RESIDENTIAL' ), JText::_ ( 'SHIPPING_METHOD_UPS_TYPE_RESIDENTIAL' ), 'tooltip.png', '', '', false );?></td></tr>
		<tr class="row1">
			<td><strong><?php echo JText::_('SHIPPING_METHOD_UPS_HANDLING_FEE') ?></strong></td>
			<td><input class="inputbox" type="text" name="UPS_Canada_handling_fee" value="<?php echo UPS_Canada_HANDLING_FEE ?>" /></td>
	...
	<?php // BEGIN CUSTOM CODE ?>
		<tr class="row1">
			...
			<td><input class="inputbox" type="text" name="UPS_Canada_Override_Source_Zip" value="<?php echo UPS_Canada_Override_Source_Zip ?>" /></td>
		...
		<tr class="row0">
			...
			<td><input class="inputbox" type="checkbox" name="UPS_Canada_Show_Delivery_Days_Quote" <?php if (UPS_Canada_Show_Delivery_Days_Quote == 1) echo "checked=\"checked\""; ?> value="1" /></td>
		...
		<tr class="row1">
			...
			<td><input class="inputbox" type="checkbox" name="UPS_Canada_Show_Delivery_ETA_Quote" <?php if (UPS_Canada_Show_Delivery_ETA_Quote == 1) echo "checked=\"checked\""; ?> value="1" /></td>
		...
		<tr class="row0">
			...
			<td><input class="inputbox" type="checkbox" name="UPS_Canada_Show_Delivery_Warning" <?php if (UPS_Canada_Show_Delivery_Warning == 1) echo "checked=\"checked\""; ?> value="1" /></td>
		...
		<tr class="row1">
			...
			<tr class="row1">
			  <td><div align="left"><strong><?php echo JText::_ ( 'SHIPPING_METHOD_LBL' );?></strong></div></td>
			...
			<tr class="row0">
			  ...
			  <td><input class="inputbox" type="text" name="UPS_Canada_Express_FSC" value="<?php echo UPS_Canada_Express_FSC; ?>" /></td>
			</tr>
			<tr class="row0">
			  <td>UPS Expedited</td>
			  <td><div align="center"><input type="checkbox" name="UPS_Canada_Expedited" class="inputbox" <?php if (UPS_Canada_Expedited == '02') echo "checked=\"checked\""; ?> value="02" /></div></td>
			  <td><input class="inputbox" type="text" name="UPS_Canada_Expedited_FSC" value="<?php echo UPS_Canada_Expedited_FSC; ?>" /></td>
			</tr>
			<tr class="row0">
			  <td>UPS Worldwide Express Plus</td>
			  <td><div align="center"><input type="checkbox" name="UPS_Canada_Worldwide_Express" class="inputbox" <?php if (UPS_Canada_Worldwide_Express == '07') echo "checked=\"checked\""; ?> value="07" /></div></td>
			  <td><input class="inputbox" type="text" name="UPS_Canada_Worldwide_Express_FSC" value="<?php echo UPS_Canada_Worldwide_Express_FSC; ?>" /></td>
			</tr>
			<tr class="row0">
			  <td>UPS Worldwide Expedited</td>
			  <td><div align="center"><input type="checkbox" name="UPS_Canada_Worldwide_Expedited" class="inputbox" <?php if (UPS_Canada_Worldwide_Expedited == '08') echo "checked=\"checked\""; ?> value="08" /></div></td>
			  <td><input class="inputbox" type="text" name="UPS_Canada_Worldwide_Expedited_FSC" value="<?php echo UPS_Canada_Worldwide_Expedited_FSC; ?>" /></td>
			</tr>
			<tr class="row0">
			  <td>UPS Standard</td>
			  <td><div align="center"><input type="checkbox" name="UPS_Canada_Standard" class="inputbox" <?php if (UPS_Canada_Standard == '11') echo "checked=\"checked\""; ?> value="11" /></div></td>
			  <td><input class="inputbox" type="text" name="UPS_Canada_Standard_FSC" value="<?php echo UPS_Canada_Standard_FSC; ?>" /></td>
			</tr>
			<tr class="row0">
			  <td>UPS Three-Day Select</td>
			  <td><div align="center"><input type="checkbox" name="UPS_Canada_ThreeDay_Select" class="inputbox" <?php if (UPS_Canada_ThreeDay_Select == '12') echo "checked=\"checked\""; ?> value="12" /></div></td>
			  <td><input class="inputbox" type="text" name="UPS_Canada_ThreeDay_Select_FSC" value="<?php echo UPS_Canada_ThreeDay_Select_FSC; ?>" /></td>
			</tr>
			<tr class="row0">
			  <td>UPS Saver</td>
			  <td><div align="center"><input type="checkbox" name="UPS_Canada_Saver" class="inputbox" <?php if (UPS_Canada_Saver == '13') echo "checked=\"checked\""; ?> value="13" /></div></td>
			  <td><input class="inputbox" type="text" name="UPS_Canada_Saver_FSC" value="<?php echo UPS_Canada_Saver_FSC; ?>" /></td>
			</tr>
			<tr class="row0">
			  <td>UPS Express Early A.M.</td>
			  <td><div align="center"><input type="checkbox" name="UPS_Canada_Express_Early_AM" class="inputbox" <?php if (UPS_Canada_Express_Early_AM == '14') echo "checked=\"checked\""; ?> value="14" /></div></td>
			  <td><input class="inputbox" type="text" name="UPS_Canada_Express_Early_AM_FSC" value="<?php echo UPS_Canada_Express_Early_AM_FSC; ?>" /></td>
			</tr>
			<tr class="row0">
			  <td>	UPS Worldwide Express Plus</td>
			  <td><div align="center"><input type="checkbox" name="UPS_Canada_Worldwide_Express_Plus" class="inputbox" <?php if (UPS_Canada_Worldwide_Express_Plus == '54') echo "checked=\"checked\""; ?> value="54" /></div></td>
			  <td><input class="inputbox" type="text" name="UPS_Canada_Worldwide_Express_Plus_FSC" value="<?php echo UPS_Canada_Worldwide_Express_Plus_FSC; ?>" /></td>
			</tr><tr class="row0">
			  <td>UPS Saver</td>
			...
			<tr class="row0">
			  ...
			  <td>
			    <div align="center">
			      <input type="checkbox" name="UPS_Canada_na" class="inputbox" <?php if (UPS_Canada_na == '64') echo "checked=\"checked\""; ?> value="64" />
			      </div></td>
			  <td>&nbsp;
			  </td>
			</tr>
			...
			for($t=0;$t<count($matchedchild);$t++)
			{
				...
				{		
					...
					if ( in_array($servicecode,$myservicecodes) )
					{
						...
						switch( $servicecode )
						{
							case "01": $ship_postage[$count]["ServiceName"] = "UPS Canada Express"; break;
							case "02": $ship_postage[$count]["ServiceName"] = "UPS Canada Expedited"; break;
							case "07": $ship_postage[$count]["ServiceName"] = "UPS Canada Worldwide Express"; break;
							case "08": $ship_postage[$count]["ServiceName"] = "UPS Canada Worldwide Expedited"; break;
							case "11": $ship_postage[$count]["ServiceName"] = "UPS Canada Standard"; break;
							case "12": $ship_postage[$count]["ServiceName"] = "UPS Canada Three-Day Select"; break;
							case "13": $ship_postage[$count]["ServiceName"] = "UPS Canada Saver"; break;
