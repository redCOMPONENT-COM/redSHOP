	...
	function onShowconfig($ps)
	{
		...
		?>
			...
			<tr class="row1">
			  ...
			  <td><?php echo JHTML::tooltip ( JText::_ ( 'SHIP_FROM_ZIPCODE_TOOLTIP' ), JText::_ ( 'SHIP_FROM_ZIPCODE' ), 'tooltip.png', '', '', false );?></td>
			</tr>
		    <tr>
			...
			<tr>
			  ...
			  <td>
				<label>
				<input name="USPS_REPORTERRORS" type="radio" <?php if (USPS_REPORTERRORS == 1) echo "checked=\"checked\""; ?> value="1" />
				Yes</label>
				<label>
				<input name="USPS_REPORTERRORS" type="radio" <?php if (USPS_REPORTERRORS == 0) echo "checked=\"checked\""; ?> value="0" />
				No</label>
				</td>
			...
			<tr>
			  ...
			  <td>
				<label>
				<input name="USPS_STANDARDSHIPPING" type="radio" <?php if (USPS_STANDARDSHIPPING == 1) echo "checked=\"checked\""; ?> value="1" />
				Yes</label>
				<label>
				<input name="USPS_STANDARDSHIPPING" type="radio" <?php if (USPS_STANDARDSHIPPING == 0) echo "checked=\"checked\""; ?> value="0" />
				No</label>
				</td>
			...
			<tr><td colspan="3">
				...
				while (defined("USPS_SHIP".$i)):
					...
					<tr class="row<?php echo($i & 1); ?>">
						...
						<td>
						<label>
						<input name="USPS_SHIP<?php echo $i; ?>" type="radio" <?php if ($dom_ship_option_avail  == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes</label>
						<label>
						<input name="USPS_SHIP<?php echo $i; ?>" type="radio" <?php if ($dom_ship_option_avail  == 0) echo "checked=\"checked\""; ?> value="0" />
						No</label>
						</td>
			    	</tr>
					<?php
			...
			<tr>
				<td colspan="3"><hr><strong><?php echo _USPS_INTL; ?></strong><hr></td>
			</tr>
			...
			<tr><td colspan="3">
				...
				while (defined("USPS_INTL".$i)):
					...
					<tr class="row<?php echo($i & 1); ?>">
						...
						<td>
						<label>
						<input name="USPS_INTL<?php echo $i; ?>" type="radio" <?php if ($ship_option_avail  == 1) echo "checked=\"checked\""; ?> value="1" />
						Yes</label>
						<label>
						<input name="USPS_INTL<?php echo $i; ?>" type="radio" <?php if ($ship_option_avail  == 0) echo "checked=\"checked\""; ?> value="0" />
						No</label>
						</td>
			    	</tr>
					<?php
