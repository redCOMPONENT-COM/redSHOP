...
class plgredshop_shippingbring extends JPlugin
{
	...
	function onShowconfig($ps)
	{
		...
		<table class="admintable">
			<tr class="row0">
				<td><strong><?php echo JText::_('BRING_USERCODE_LBL') ?></strong></td>
				<td><input type="text" name="BRING_USERCODE" class="inputbox" value="<?php echo BRING_USERCODE ?>" /></td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'BRING_USERCODE_LBL' ), JText::_ ( 'BRING_USERCODE_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row1">
				<td><strong><?php echo JText::_('BRING_SERVER_LBL') ?></strong></td>
				<td><input type="text" name="BRING_SERVER" class="inputbox" value="<?php echo BRING_SERVER ?>" /></td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'BRING_SERVER_LBL' ), JText::_ ( 'BRING_SERVER_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row1" >
				<td><strong><?php echo JText::_('BRING_PATH_LBL') ?></strong></td>
				<td><input type="text" name="BRING_PATH" class="inputbox" value="<?php echo BRING_PATH ?>" /></td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'BRING_PATH_LBL' ), JText::_ ( 'BRING_PATH_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row1">
				<td><strong><?php echo JText::_('BRING_ZIPCODE_FROM_LBL') ?></strong></td>
				<td><input type="text" name="BRING_ZIPCODE_FROM" class="inputbox" value="<?php echo BRING_ZIPCODE_FROM ?>" /></td>
				<td><?php echo JHTML::tooltip ( JText::_ ( 'BRING_ZIPCODE_FROM_LBL' ), JText::_ ( 'BRING_ZIPCODE_FROM_LBL' ), 'tooltip.png', '', '', false );?></td>
			</tr>
			<tr class="row1">
				<td><strong><?php echo JText::_('BRING_PRICE_SHOW_WITHVAT_LBL') ?></strong></td>
				<td>
					<label>
						<input name="BRING_PRICE_SHOW_WITHVAT" type="radio" <?php if (BRING_PRICE_SHOW_WITHVAT == 1) echo "checked=\"checked\""; ?> value="1" />

						<?php echo JText::_('YES') ?>
					</label>
					<label>
						<input name="BRING_PRICE_SHOW_WITHVAT" type="radio" <?php if (BRING_PRICE_SHOW_WITHVAT == 0) echo "checked=\"checked\""; ?> value="0" />
						<?php echo JText::_('NO') ?>
					</label>
				</td>
			...
			<tr class="row1">
				<td><strong><?php echo JText::_('BRING_PRICE_SHOW_SHORT_DESC_LBL') ?></strong></td>
				<td>
					<label>
						<input name="BRING_PRICE_SHOW_SHORT_DESC" type="radio" <?php if (BRING_PRICE_SHOW_SHORT_DESC == 1) echo "checked=\"checked\""; ?> value="1" />

						<?php echo JText::_('YES') ?>
					</label>
					<label>
						<input name="BRING_PRICE_SHOW_SHORT_DESC" type="radio" <?php if (BRING_PRICE_SHOW_SHORT_DESC == 0) echo "checked=\"checked\""; ?> value="0" />
						<?php echo JText::_('NO') ?>
					</label>
				</td>
			...
			<tr class="row1">
				<td><strong><?php echo JText::_('BRING_PRICE_SHOW_DESC_LBL') ?></strong></td>
				<td>
					<label>
						<input name="BRING_PRICE_SHOW_DESC" type="radio" <?php if (BRING_PRICE_SHOW_DESC == 1) echo "checked=\"checked\""; ?> value="1" />

						<?php echo JText::_('YES') ?>
					</label>
					<label>
						<input name="BRING_PRICE_SHOW_DESC" type="radio" <?php if (BRING_PRICE_SHOW_DESC == 0) echo "checked=\"checked\""; ?> value="0" />
						<?php echo JText::_('NO') ?>
					</label>
				</td>
			...
			<tr class="row1">
		        <td>
		        	<strong><?php echo JTEXT::_('BRING_USE_SHIPPING_BOX_LBL') ?></strong></td>
				<td>
					<label>
						<input name="BRING_USE_SHIPPING_BOX" type="radio" <?php if (BRING_USE_SHIPPING_BOX == 1) echo "checked=\"checked\""; ?> value="1" />
						<?php echo JText::_('YES') ?>
					</label>
					<label>
						<input name="BRING_USE_SHIPPING_BOX" type="radio" <?php if (BRING_USE_SHIPPING_BOX == 0) echo "checked=\"checked\""; ?> value="0" />
						<?php echo JText::_('NO') ?>
					</label>
				</td>
				<td>
   			...
   			<tr class="row1">
				...
				<td>
					...
					<select id="BRING_SERVICE" name="BRING_SERVICE[]" multiple="multiple">
						<option value='SERVICEPAKKE' <?php if(in_array('SERVICEPAKKE',$ArrExlode)) echo 'selected="selected"'; ?>>SERVICEPAKKE</option>
						<option value='A-POST'  	<?php if(in_array('A-POST',$ArrExlode)) echo 'selected="selected"'; ?>>A-POST</option>
						<option value='B-POST'		<?php if(in_array('B-POST',$ArrExlode)) echo 'selected="selected"'; ?>>B-POST</option>
						<option value='PA_DOREN'	<?php if(in_array('PA_DOREN',$ArrExlode)) echo 'selected="selected"'; ?>>PA_DOREN</option>
						<option value='BPAKKE_DOR-DOR'	<?php if(in_array('BPAKKE_DOR-DOR',$ArrExlode)) echo 'selected="selected"'; ?>>BPAKKE_DOR-DOR</option>
						<option value='EKSPRESS09' <?php if(in_array('EKSPRESS09',$ArrExlode)) echo 'selected="selected"'; ?>>EKSPRESS09</option>
					</select>
...
//				$html .= "<br />".JText::_('NORWEGIAN_ERROR_MESSAGE')."<br />";
			}
				...
				for($j=0;$j<count($productchilds);$j++)
				{
					if(strtolower($productchilds[$j]->name()) == "productid" || strtolower($productchilds[$j]->name()) == "guiinformation")
					{
						if(strtolower($productchilds[$j]->name()) == "productid")
						{
							...
							//if(in_array($product_name,$ArrExlode))
		...
		if (!$shippingError)
		{
			...
			for($i=0;$i < count($bring_products);$i++)
			{
				...
				if (($i != count($bring_products)-1) && in_array($product_id,$ArrExlode))
				{
					...
					$Amountwithvat    = $bring_products[$i]->product->AmountWithVAT;
					...
					$shipping_rate_id = $shippinghelper->encryptShipping( __CLASS__."|".$shipping->name."|".$product_name."|".number_format( $cost + $vat, 2, '.', '' )."|".$product_name."|single|".$vat) ;

					$shippingrate[$rate]->text  		= $product_name;//." ".JText::_('DELIVERY')." ".$delivery;
