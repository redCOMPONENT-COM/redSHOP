...
class plgredshop_shippingfedex extends JPlugin
{
		...
		<table class="admintable">
			<tr class="row0">
				...
				<td><select class="inputbox" name="FEDEX_DEVELOPMENT">
					  <option <?php if(FEDEX_DEVELOPMENT=="1") echo "selected=\"selected\"" ?> value="1"><?php echo JText::_('YES') ?></option>
					  <option <?php if(FEDEX_DEVELOPMENT=="0") echo "selected=\"selected\"" ?> value="0"><?php echo JText::_('NO') ?></option>
					</select></td>
			...
			<tr class="row1">
				...
				<td><input type="text" name="FEDEX_PASSWORD" class="inputbox" value="<?php echo FEDEX_PASSWORD ?>" /></td>
			...
			<tr class="row1">
				...
				<td><input type="text" name="FEDEX_SHIPPER_ADDRESS" class="inputbox" value="<?php echo FEDEX_SHIPPER_ADDRESS ?>" /></td>
			...
			<tr class="row0">
				...
				<td><input type="text" name="FEDEX_SHIPPER_CITY" class="inputbox" value="<?php echo FEDEX_SHIPPER_CITY ?>" /></td>
			...
			<tr class="row1">
				...
				<td><input type="text" name="FEDEX_SHIPPER_STATE" class="inputbox" value="<?php echo FEDEX_SHIPPER_STATE ?>" /></td>
			...
			<tr class="row0">
				...
				<td><input type="text" name="FEDEX_SHIPPER_POSTAL_CODE" class="inputbox" value="<?php echo FEDEX_SHIPPER_POSTAL_CODE ?>" /></td>
			...
			<tr class="row1">
				...
				<td><select class="inputbox" name="FEDEX_DISCOUNT">
					  <option <?php if(FEDEX_DISCOUNT=="1") echo "selected=\"selected\"" ?> value="1"><?php echo JText::_('YES') ?></option>
					  <option <?php if(FEDEX_DISCOUNT=="0") echo "selected=\"selected\"" ?> value="0"><?php echo JText::_('NO') ?></option>
					</select></td>
			...
			<tr class="row0">
				...
				<td><select class="inputbox" name="FEDEX_CARRIERCODE">
					  <option <?php if(FEDEX_CARRIERCODE=="FDXE") echo "selected=\"selected\"" ?> value="FDXE"><?php echo JText::_('FDXE_LBL') ?></option>
					  <option <?php if(FEDEX_CARRIERCODE=="FDXG") echo "selected=\"selected\"" ?> value="FDXG"><?php echo JText::_('FDXG_LBL') ?></option>
					</select>
				</td>
			...
			<tr class="row0">
				...
				<td><select class="inputbox" name="FEDEX_SERVICETYPE[]" multiple="multiple">
					  <option <?php if(in_array("PRIORITY_OVERNIGHT",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?> value="PRIORITY_OVERNIGHT"><?php echo JText::_('PRIORITYOVERNIGHT_LBL') ?></option>
					  <option <?php if(in_array("STANDARD_OVERNIGHT",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?> value="STANDARD_OVERNIGHT"><?php echo JText::_('STANDARDOVERNIGHT_LBL') ?></option>
					  <option <?php if(in_array("FIRST_OVERNIGHT",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?> value="FIRST_OVERNIGHT"><?php echo JText::_('FIRSTOVERNIGHT_LBL') ?></option>
						<option <?php if(in_array("FEDEX_2_DAY",unserialize(FEDEX_SERVICETYPE)))  echo "selected=\"selected\"" ?> value="FEDEX_2_DAY"><?php echo JText::_('FEDEX2DAY_LBL') ?></option>
						<option  <?php if(in_array("FEDEX_EXPRESS_SAVER",unserialize(FEDEX_SERVICETYPE)))  echo "selected=\"selected\"" ?> value="FEDEX_EXPRESS_SAVER"><?php echo JText::_('FEDEXEXPRESSSAVER_LBL') ?></option>
						<option  <?php if(in_array("INTERNATIONAL_PRIORITY",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?> value="INTERNATIONAL_PRIORITY"><?php echo JText::_('INTERNATIONALPRIORITY_LBL') ?></option>
						<option  <?php if(in_array("INTERNATIONAL_ECONOMY",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?> value="INTERNATIONAL_ECONOMY"><?php echo JText::_('INTERNATIONALECONOMY_LBL') ?></option>
						<option  <?php if(in_array("INTERNATIONAL_FIRST",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?> value="INTERNATIONAL_FIRST"><?php echo JText::_('INTERNATIONALFIRST_LBL') ?></option>
						<option  <?php if(in_array("FEDEX_1_DAY_FREIGHT",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?> value="FEDEX_1_DAY_FREIGHT"><?php echo JText::_('FEDEX1DAYFREIGHT_LBL') ?></option>
						<option <?php if(in_array("FEDEX_2_DAY_FREIGHT",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?>  value="FEDEX_2_DAY_FREIGHT"><?php echo JText::_('FEDEX2DAYFREIGHT_LBL') ?></option>
						<option  <?php if(in_array("FEDEX_3_DAY_FREIGHT",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?> value="FEDEX_3_DAY_FREIGHT"><?php echo JText::_('FEDEX3DAYFREIGHT_LBL') ?></option>
						<option  <?php if(in_array("FEDEX_GROUND",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?> value="FEDEX_GROUND"><?php echo JText::_('FEDEXGROUND_LBL') ?></option>
						<option  <?php if(in_array("GROUND_HOME_DELIVERY",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?> value="GROUND_HOME_DELIVERY"><?php echo JText::_('GROUNDHOMEDELIVERY_LBL') ?></option>
						<option <?php if(in_array("INTERNATIONAL_PRIORITY_FREIGHT",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?>  value="INTERNATIONAL_PRIORITY_FREIGHT"><?php echo JText::_('INTERNATIONALPRIORITY_FREIGHT_LBL') ?></option>
						<option <?php if(in_array("INTERNATIONAL_ECONOMY_FREIGHT",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?>  value="INTERNATIONAL_ECONOMY_FREIGHT"><?php echo JText::_('INTERNATIONALECONOMY_FREIGHT_LBL') ?></option>
						<option <?php if(in_array("EUROPE_FIRST_INTERNATIONAL_PRIORITY",unserialize(FEDEX_SERVICETYPE))) echo "selected=\"selected\"" ?>  value="EUROPE_FIRST_INTERNATIONAL_PRIORITY"><?php echo JText::_('EUROPEFIRSTINTERNATIONALPRIORITY_LBL') ?></option>
					</select>
				</td>
			...
			<tr class="row0">
				...
				<td><select class="inputbox" name="FEDEX_DROPOFFTYPE">
					  <option <?php if(FEDEX_DROPOFFTYPE=="REGULAR_PICKUP") echo "selected=\"selected\"" ?> value="REGULAR_PICKUP"><?php echo JText::_('REGULARPICKUP_LBL') ?></option>
					  <option <?php if(FEDEX_DROPOFFTYPE=="REQUEST_COURIER") echo "selected=\"selected\"" ?> value="REQUEST_COURIER"><?php echo JText::_('REQUESTCOURIER_LBL') ?></option>
					  <option <?php if(FEDEX_DROPOFFTYPE=="DROP_BOX") echo "selected=\"selected\"" ?> value="DROP_BOX"><?php echo JText::_('DROPBOX_LBL') ?></option>
					  <option <?php if(FEDEX_DROPOFFTYPE=="BUSINESSS_ERVICE_CENTER") echo "selected=\"selected\"" ?> value="BUSINESS_SERVICE_CENTER"><?php echo JText::_('BUSINESSSERVICE_CENTER_LBL') ?></option>
					  <option <?php if(FEDEX_DROPOFFTYPE=="STATION") echo "selected=\"selected\"" ?> value="STATION"><?php echo JText::_('STATION_LBL') ?></option>
					</select>
				</td>
			...
			<tr class="row0">
				...
				<td><select class="inputbox" name="FEDEX_PACKAGINGTYPE">
					  <option <?php if(FEDEX_PACKAGINGTYPE=="FEDEX_ENVELOPE") echo "selected=\"selected\"" ?> value="FEDEX_ENVELOPE"><?php echo JText::_('FEDEXENVELOPE_LBL') ?></option>
					<option  <?php if(FEDEX_PACKAGINGTYPE=="FEDEX_PAK") echo "selected=\"selected\"" ?> value="FEDEX_PAK"><?php echo JText::_('FEDEXPAK_LBL') ?></option>
					<option <?php if(FEDEX_PACKAGINGTYPE=="FEDEX_BOX") echo "selected=\"selected\"" ?>  value="FEDEX_BOX"><?php echo JText::_('FEDEXBOX_LBL') ?></option>
					<option  <?php if(FEDEX_PACKAGINGTYPE=="FEDEX_TUBE") echo "selected=\"selected\"" ?> value="FEDEX_TUBE"><?php echo JText::_('FEDEXTUBE_LBL') ?></option>
					<option  <?php if(FEDEX_PACKAGINGTYPE=="FEDEX_10KG_BOX") echo "selected=\"selected\"" ?> value="FEDEX_10KG_BOX"><?php echo JText::_('FEDEX10KGBOX_LBL') ?></option>
					<option <?php if(FEDEX_PACKAGINGTYPE=="FEDEX_25KG_BOX") echo "selected=\"selected\"" ?>  value="FEDEX_25KG_BOX"><?php echo JText::_('FEDEX25KGBOX_LBL') ?></option>
					<option  <?php if(FEDEX_PACKAGINGTYPE=="YOUR_PACKAGING") echo "selected=\"selected\"" ?> value="YOUR_PACKAGING"><?php echo JText::_('YOURPACKAGING_LBL') ?></option>
					</select>
				</td>
			...
			<tr class="row0">
				...
				<td><select class="inputbox" name="FEDEX_WEIGHTUNITS">
					  <option <?php if(FEDEX_WEIGHTUNITS=="lbs") echo "selected=\"selected\"" ?> value="lbs"><?php echo JText::_('LBS') ?></option>
					  <option <?php if(FEDEX_WEIGHTUNITS=="kg") echo "selected=\"selected\"" ?> value="kg"><?php echo JText::_('KGS') ?></option>
					</select>
				</td>
	...
	function onListRates(&$d)
	{
		...
		{	//$path_to_wsdl='RateService_v9_test.wsdl';
			$path_to_wsdl=JURI::root().'plugins'.DS.'redshop_shipping'.DS.'RateService_v9_test.wsdl';
		}
		else
		{ 	//(JPATH_ROOT.DS.'plugins'.DS.'redshop_shipping'.DS.$this->classname.'.cfg.php');
			$path_to_wsdl=JURI::root().'plugins'.DS.'redshop_shipping'.DS.'RateService_v9.wsdl';
		}
