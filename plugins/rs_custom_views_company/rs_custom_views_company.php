...
class plgredshop_custom_viewsrs_custom_views_company extends JPlugin
{
    ...
    */
    ...
    { 
    	$heading=JText::_('PRODUCT_ORDERED_COMPANY');
	...
	<script>
		...
		var useroptions = {
    			script:"index3.php?&option=com_redshop&view=search&plgcustomview=1&iscompany=1&json=true&",
    			varname:"input",
    			json:true,
    			shownoresults:true,
...
function onSelectedCompanyValue()
    { 
    	$db = JFactory::getDBO();
    	$heading=JText::_('PRODUCT_ORDERED_COMPANY');
	$print=JText::_('PRINT');
...
table.customviewcompany th { padding: 4px; }
...
table.customviewcompany thead a:hover { text-decoration: none; }

table.customviewcompany thead th img { vertical-align: middle; }

table.customviewcompany tbody th { font-weight: bold; }

table.customviewcompany tbody tr			{ background-color: #fff;  text-align: left; }
table.customviewcompany tbody tr.row1 	{ background: #f9f9f9; border-top: 1px solid #fff; }

table.customviewcompany tbody tr.row0:hover td,
table.customviewcompany tbody tr.row1:hover td  { background-color: #ffd ; }

table.customviewcompany tbody tr td 	   { height: 25px; background: #fff; border: 1px solid #fff; }
table.customviewcompany tbody tr.row1 td { background: #f9f9f9; border-top: 1px solid #FFF; }

table.customviewcompany tfoot tr { text-align: center;  color: #333; }
table.customviewcompany tfoot td,
table.customviewcompany tfoot th { background-color: #f3f3f3; border-top: 1px solid #999; text-align: center; }

table.customviewcompany td.order 		{ text-align: center; white-space: nowrap; }
table.customviewcompany td.order span { float: left; display: block; width: 20px; text-align: center; }

table.customviewcompany .pagination { display:table; padding:0;  margin:0 auto;	 }
		</style>
    	...
    	<table bgcolor="#98E273" align='left' width='80%' cellspacing='5' cellpadding='5'>
    		<tr >
    	...
    	<?php 
	    	...
	    	$sel_shopper_group_name = "select * from ".$this->_table_prefix."shopper_group order by shopper_group_name asc";
...
<tr><td>
					<h3 style="padding-left:10px;"><?php echo $params_shopper_group_name[$r]->shopper_group_name;?></h3></td></tr></table>
				    	<table   align='left'  class='customviewcompany' cellspacing='3' cellpadding='3'>
