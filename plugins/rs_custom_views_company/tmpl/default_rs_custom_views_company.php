...
table.customviewcompany .pagination { display:table; padding:0;  margin:0 auto;	 }
		...
		<form action="index.php?json=1&tmpl=component&option=com_redshop&view=customprint&layout=customview&printoption=<?php echo JRequest::getVar('printoption');?>&print=1&popup=2" method="post" name="adminForm1" id="adminForm1">
...
<?php
	...
	<form action="index.php?option=com_redshop&view=customprint&layout=customview&printoption=<?php echo JRequest::getVar('printoption');?>&popup=1" method="post" name="adminForm" id="adminForm">
