	...
	$md5_sign_key = md5($sign_key);
     ...
     // End
  	$post_variables = Array(
		 ...
		 "country" => $country,
		 "tel" => $phone,
    	 "MC_callback" =>    JURI::base()."index.php?option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&payment_plugin=rs_payment_worldpay&accept=1&Itemid=".$_REQUEST['Itemid']."&orderid=".$data['order_id'],
