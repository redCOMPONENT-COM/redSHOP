 ...
 * @subpackage  PlgRedshop_PaymentDotpay
 *
...
/**
 *  PlgRedshop_PaymentDotpay installer class.
 *
 * @package  Redshopb.Plugin
 * @since    1.7.0
 */
class PlgRedshop_PaymentDotpayInstallerScript
{
	/**
		...
		if ($type == 'update' || $type == 'discover_install')
		{
			...
			$version = $db->setQuery(
				$db->getQuery(true)
					...
					->where($db->qn('element') . ' = ' . $db->q('dotpay'))
