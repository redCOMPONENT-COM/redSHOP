...
<?php } ?>
  <input type="hidden" name="referenceId" value="<?php echo JText::_('COM_REDSHOP_MY_TRANSACTION')?>-<?php echo $data['order_id']; ?>" >
  ...
  <input type="hidden" name="ipnUrl" value="<?php echo JURI::base(); ?>index.php?option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&payment_plugin=rs_payment_amazoncheckout&Itemid=<?php echo $_REQUEST['Itemid']; ?>&orderid=<?php echo $data['order_id'] ?>" >
  <input type="hidden" name="returnUrl" value="<?php echo JURI::base(); ?>index.php?option=com_redshop&view=order_detail&controller=order_detail&payment_plugin=rs_payment_amazoncheckout&task=notify_payment&Itemid=<?php echo $_REQUEST['Itemid']; ?>&orderid=<?php echo $data['order_id'] ?>" >
  <input type="hidden" name="processImmediate" value="1" >
  <input type="hidden" name="cobrandingStyle" value="logo" >
  <input type="hidden" name="abandonUrl" value="<?php echo JURI::base(); ?>index.php?option=com_redshop&view=order_detail&controller=order_detail&payment_plugin=rs_payment_amazoncheckout&task=notify_payment&Itemid=<?php echo $_REQUEST['Itemid']; ?>&orderid=<?php echo $data['order_id'] ?>" >
