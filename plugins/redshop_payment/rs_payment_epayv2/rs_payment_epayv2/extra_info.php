...
<?php 
	...
	$form_callback_urls = array(
				...
				'cancelurl' => JURI::base().'index.php?tmpl=component&option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&payment_plugin=rs_payment_epay&accept=0',
				'callbackurl' => JURI::base().'index.php?tmpl=component&option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&payment_plugin=rs_payment_epay&accept=1',
				'accepturl' => JURI::base().'index.php?option=com_redshop&view=order_detail&oid='.$data['order_id'],
	);
	$form_urls = array(
				
				'cancelurl' => JURI::base().'index.php?tmpl=component&option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&payment_plugin=rs_payment_epay&accept=0',
				'accepturl' => JURI::base().'index.php?tmpl=component&option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&payment_plugin=rs_payment_epay&accept=1',
