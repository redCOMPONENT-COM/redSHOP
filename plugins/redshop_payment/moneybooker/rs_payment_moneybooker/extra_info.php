...
value="<?php echo JURI::base()?>index.php?option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&payment_plugin=rs_payment_moneybooker&orderid=<?php echo $data['order_id']?>">
<input type="hidden" name="status_url" value="<?php echo JURI::base()?>index.php?option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&payment_plugin=rs_payment_moneybooker&orderid=<?php echo $data['order_id']?>" />
