...
$login_id         = $this->params->get("access_id");
$trans_id         = $this->params->get("transaction_id");
$is_test          = $this->params->get("is_test");

$relay_response_url = JURI::root() . 'index.php?option=com_redshop&view=order_detail&layout=checkout_final&tmpl=components&oid=' . $data["order_id"] . '&encr=' . $data['order']->encr_key . '&Itemid=' . $Itemid;
