 ...
 * @subpackage  PlgRedshop_PaymentRs_Payment_Paypall
 *
...
/**
 * PlgRedshop_PaymentRs_Payment_Paypall installer class.
 *
 * @package  Redshopb.Plugin
 * @since    1.7.0
 */
class PlgRedshop_PaymentRs_Payment_PaypalInstallerScript
{
	/**
