 ...
 * @subpackage  PlgRedshop_PaymentNganLuong
 *
...
/**
 *  PlgRedshop_PaymentNganLuong installer class.
 *
 * @package  Redshopb.Plugin
 * @since    1.7.0
 */
class PlgRedshop_PaymentNganLuongInstallerScript
{
	/**
		...
		if ($type == 'update' || $type == 'discover_install')
		{
			...
			$version = $db->setQuery(
				$db->getQuery(true)
					...
					->where($db->qn('element') . ' = ' . $db->q('nganluong'))
