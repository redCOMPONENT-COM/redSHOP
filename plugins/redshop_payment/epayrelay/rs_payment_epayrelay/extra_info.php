...
<input type="hidden" name="transfee" value="0"/>
		...
		<tr>
			...
			<td>
				...
				<input type="hidden" name="declineurl" value="<?php echo $url?>index.php?tmpl=component&option=com_redshop&view=order_detail&task=notify_payment&payment_plugin=rs_payment_epayrelay&Itemid=<?php echo $_REQUEST['Itemid'] ?>&orderid=<?php echo $data['order_id'] ?>" />

				<?php

				if ($this->_params->get("activate_callback") == "1")
				{?>
				<input type="hidden" name="callbackurl" value="<?php echo $url?>index.php?tmpl=component&option=com_redshop&view=order_detail&task=notify_payment&payment_plugin=rs_payment_epayrelay&orderid=<?php echo $data['order_id'] ?>">
				...
				<? } else {
				?>
				<input type="hidden" name="accepturl" value="<?php echo $url?>index.php?tmpl=component&option=com_redshop&view=order_detail&task=notify_payment&payment_plugin=rs_payment_epayrelay&Itemid=<?php echo $_REQUEST['Itemid'] ?>&orderid=<?php echo $data['order_id'] ?>" />
				<?php } ?>
		<tr>
			<td>&nbsp;</td>
			<td><input type="submit" value="<?php echo JText::_('COM_REDSHOP_PAY'); ?>" class="button" style="width: 200px;"></td>
