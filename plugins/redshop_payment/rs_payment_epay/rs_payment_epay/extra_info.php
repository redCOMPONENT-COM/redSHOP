...
<script>
	function printCard(cardId) {
		...
		switch (cardId) {
			case 1:
				document.write("<input type=hidden name=cardtype value=1>");
				break;
			case 2:
				document.write("<input type=hidden name=cardtype value=2>");
				break;
			case 3:
				document.write("<input type=hidden name=cardtype value=3>");
				break;
			case 4:
				document.write("<input type=hidden name=cardtype value=4>");
				break;
			case 5:
				document.write("<input type=hidden name=cardtype value=5>");
				break;
			case 6:
				document.write("<input type=hidden name=cardtype value=6>");
				break;
			case 7:
				document.write("<input type=hidden name=cardtype value=7>");
				break;
			case 8:
				document.write("<input type=hidden name=cardtype value=8>");
				break;
			case 9:
				document.write("<input type=hidden name=cardtype value=9>");
				break;
			case 10:
				document.write("<input type=hidden name=cardtype value=10>");
				break;
			case 12:
				document.write("<input type=hidden name=cardtype value=12>");
				break;
			case 13:
				document.write("<input type=hidden name=cardtype value=13>");
				break;
			case 14:
				document.write("<input type=hidden name=cardtype value=14>");
				break;
			case 15:
				document.write("<input type=hidden name=cardtype value=15>");
				break;
			case 16:
				document.write("<input type=hidden name=cardtype value=16>");
				break;
			case 17:
				document.write("<input type=hidden name=cardtype value=17>");
				break;
			case 18:
				document.write("<input type=hidden name=cardtype value=18>");
				break;
			case 19:
				document.write("<input type=hidden name=cardtype value=19>");
				break;
			case 21:
				document.write("<input type=hidden name=cardtype value=21>");
				break;
			case 22:
				document.write("<input type=hidden name=cardtype value=22>");
				break;
		}
...
<form action="https://ssl.ditonlinebetalingssystem.dk/popup/default.asp" method="post" name="ePay" id="ePay">
	...
	<input type="hidden" name="declineurl"
	       value="<?php echo JURI::base(); ?>index.php?tmpl=component&option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&payment_plugin=rs_payment_epay&accept=0&sessionid=<?php echo $sessionid ?>&Itemid=<?php echo $_REQUEST['Itemid'] ?>&orderid=<?php echo $data['order_id'] ?>">
	<?php
	...
	<input type="hidden" name="accepturl"
	       value="<?php echo JURI::base(); ?>index.php?option=com_redshop&view=order_detail&layout=receipt&Itemid=<?php echo $_REQUEST['Itemid'] ?>&oid=<?php echo $data['order_id'] ?>">
	<? } else
	{
		?>
		<input type="hidden" name="accepturl"
	...
	<input type="hidden" name="authmail"
	       value="<?php echo $this->_params->get("epay_authemail") . (strlen($this->_params->get("epay_authemail")) > 0 && $this->_params->get("epay_authemailcustomer") == 1 ? ";" : "") . ($this->_params->get("epay_authemailcustomer") == 1 ? $user->user_email : ""); ?>">
	<input type="hidden" name="windowstate" value="<?php echo $this->_params->get("epay_window_state"); ?>">
	<input type="hidden" name="windowid" value="<?php echo $this->_params->get("windowid"); ?>">
	...
	<input type="hidden" name="MD5Key"
	       value="<?php if ($this->_params->get("epay_md5") == 2) echo md5(calculateePayCurrency($data['order_id']) . round(($data['carttotal']) * 100, 2) . $data['order_id'] . $this->_params->get("epay_paymentkey")) ?>">
	<?php
...
<table border="0" width="100%">
	<tr class="epay_button_row">
		<td class="epay_button_data"><input type="button" onClick="open_ePay_window();"
		                                    value="<?php echo JText::_('COM_REDSHOP_OPEN_EPAY_PAYMENT_WINDOW') ?>"></td>
