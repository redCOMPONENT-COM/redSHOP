 ...
 * @subpackage  PlgRedshop_PaymentDibsdx
 *
...
/**
 *  PlgRedshop_PaymentDibsdx installer class.
 *
 * @package  Redshopb.Plugin
 * @since    1.7.0
 */
class PlgRedshop_PaymentDibsdxInstallerScript
{
	/**
		...
		if ($type == 'update' || $type == 'discover_install')
		{
			...
			$version = $db->setQuery(
				$db->getQuery(true)
					...
					->where($db->qn('element') . ' = ' . $db->q('dibsdx'))
