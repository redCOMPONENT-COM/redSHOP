 ...
 * @subpackage  PlgRedshop_PaymentQuickBook
 *
...
/**
 *  PlgRedshop_PaymentQuickBook installer class.
 *
 * @package  Redshopb.Plugin
 * @since    1.7.0
 */
class PlgRedshop_PaymentQuickBookInstallerScript
{
	/**
		...
		if ($type == 'update' || $type == 'discover_install')
		{
			...
			$version = $db->setQuery(
				$db->getQuery(true)
					...
					->where($db->qn('element') . ' = ' . $db->q('quickbook'))
