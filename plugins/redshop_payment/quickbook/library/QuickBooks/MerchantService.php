...
class Quickbooks_MerchantService
{
	...
	*/
	...
	public function debitCheck($CheckingAccount, $amount, $payment_mode, $check_number = null, $comment = null, $force_new_transaction = true)
	{
		/*
...
*/
	 ...
	 *
	 */
	public function authorize($Card, $amount, $salestax = null, $is_card_present = false, $is_ecommerce = true, $is_recurring = false, $force_new_transaction = true)
	{
		$this->_setError(QuickBooks_MerchantService::ERROR_OK);
	...
	protected function _getBatch($BatchID)
	{
		if (!$BatchID)
		{
			if ($this->_batch)
