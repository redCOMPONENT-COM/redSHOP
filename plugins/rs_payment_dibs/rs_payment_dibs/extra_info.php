...
//
       ...
       //Authnet vars to send
  		...
  		'accepturl' => JURI::base()."index2.php?option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&status=ok&payment_plugin=rs_payment_dibs&Itemid=$Itemid&orderid=".$data['order_id'],
  		'cancelurl' => JURI::base()."index2.php?option=com_redshop&view=order_detail&controller=order_detail&task=notify_payment&status=cancel&payment_plugin=rs_payment_dibs&Itemid=$Itemid&orderid=".$data['order_id'],
