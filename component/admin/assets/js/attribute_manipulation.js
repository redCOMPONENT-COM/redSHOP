(function ($) {
	$(document).ready(function () {
		...
		function renderProperty(propPref, gh, sh, or) {
			...
			+ '<div class="span2"><input type="text" class="input-medium" name="' + propPref + '[name]" value=""><input type="hidden"  name="attribute[' + gh + '][property][' + sh + '][mainImage]" value="" id="propmainImage' + gh + sh + '"><input type="hidden" name="attribute[' + gh + '][property][' + sh + '][property_image]" id="propertyImageName' + gh + sh + '" /></div>'
			...
			+ '<div class="span2"><input class="input-medium" type="text" name="' + propPref + '[subproperty][title]" value=""></div>'
			+ '<div class="span2"><label class="checkbox inline">' + Joomla.JText._('COM_REDSHOP_SUBATTRIBUTE_REQUIRED') + ' <input type="checkbox" value="1" name="' + propPref + '[req_sub_att]" /></label></div>'
		...
		$('.add_attribute').on('click', function (e) {
			...
			$('.mainTableAttributes').append(
				...
				+ '<div class="span2"><input type="text" class="input-medium" name="' + attrPref + '[name]" value="" /></div>'
				...
				+ '<div class="span2"><input class="btn btn-danger delete_attribute btn-small" value="' + Joomla.JText._('COM_REDSHOP_DELETE_ATTRIBUTE') + '" type="button" /></div>'
				+ '</div>'
				...
				+ '<div class="span2"><label class="checkbox inline">' + Joomla.JText._('COM_REDSHOP_ALLOW_MULTIPLE_PROPERTY_SELECTION') + ' <input type="checkbox" value="1" name="' + attrPref + '[allow_multiple_selection]" /></label></div>'
				+ '<div class="span2 offset3"><label class="checkbox inline">' + Joomla.JText._('COM_REDSHOP_HIDE_ATTRIBUTE_PRICE') + ' <input type="checkbox" value="1"  name="' + attrPref + '[hide_attribute_price]" /></label></div>'
