(function ($) {
	$(document).ready(function () {
		...
		function renderProperty(propPref, gh, sh, or) {
			...
			+ '<div class="span2"><label class="checkbox inline" name="' + propPref + '[preselected]">' + Joomla.JText._('COM_REDSHOP_DEFAULT_SELECTED') + ' <input type="checkbox" value="1" name="' + propPref + '[default_sel]" /></label></div>'
		...
		$('.add_attribute').on('click', function (e) {
			...
			$('.mainTableAttributes').append(
				...
				+ '<div class="span3"><label class="checkbox inline" name="' + attrPref + '[allow_multiple_selection]">' + Joomla.JText._('COM_REDSHOP_ALLOW_MULTIPLE_PROPERTY_SELECTION') + ' <input type="checkbox" value="1" name="' + attrPref + '[allow_multiple_selection]" /></label></div>'
