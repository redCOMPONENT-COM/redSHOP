...
//	newTD_multi_0.innerHTML = "<a href=\"javascript:addNewRow_attribute('"+tableRef+"')\">"+new_attrib+"</a>&nbsp;|&nbsp;<a href=\"javascript:addproperty('"+table_pr+"','"+gh+"')\">"+new_prop+"</a>";
	...
	newTD1.innerHTML = '<table  class="grey_solid_area"  width="100%" cellpadding="0" border="0" cellspacing="0" id="property_table'+gh+'">'
	  ...
	  +'<td class="td5" align="right" style="padding-right: 10px;"><div class="remove_attr"><input value="Delete" onclick="javascript:deleteRow_property(\'property_table'+gh+p+'\',\'property_table'+gh+'\',\'sub_attribute_table'+gh+p+'\',\''+gh+p+'\')" class="btn_attribute_remove" type="button" /><input type="hidden" name="attribute['+gh+'][property]['+total_g+'][property_id] value="0" ></div></td>'
	  +'<tr></table></div></td>'
...
function addproperty(tableRef,rh){	
	...
	newTD.innerHTML = '<table id="attribute_table'+h+'" class="attribute_value">'
			...
			+'<td class="td5" align="right" style="padding-right: 10px;"><div class="remove_attr"><input value="Delete" onclick="javascript:deleteRow_property(\'attribute_table'+h+'\',\''+tableRef+'\',\'sub_attribute_table'+rh+h+'\', \''+rh+h+'\')" class="btn_attribute_remove" type="button" /></div></td>'
			+'<tr></table></div></td>'
			+ '</tr><table>';
	...
	newTD2.innerHTML = '<table width="100%" border="0" cellpadding="0" cellspacing="0"  id="sub_property_table'+h+'">'
		+'<tr><td colspan="12" class="td1" style="border-right: 1px solid #CCCCCC;" valign="top"><a href="javascript:addsubproperty(\'sub_attribute_table'+rh+h+'\',\''+rh+'\',\''+h+'\')" class="btn_attribute" align="right">+ '+new_sub_prop+'</a>'
...
//	attribute['+rh+'][property]['+h+'][oprand]
	...
	newTD.innerHTML = '<table id="sub'+rh+orde+'" border="0" align="left" width="100%" cellspacing="0" cellpadding="0" class="subattribute" style="border-bottom: 1px solid #CCCCCC;">'
			...
			+'<td class="td1" style="padding-right: 10px;">&nbsp;</td>'
			 ...
			 +'<td class="td5" align="right"  style="padding-right: 10px;"><div class="remove_attr"><input value="Delete" onclick="javascript:deleteRow_subproperty(\'sub'+rh+orde+'\',\'sub'+rh+sp+'\')" class="btn_attribute_remove" type="button" /></div></td>'
			 +'</tr></table></div>'
			 +'</td>'
			+ '</tr></table>';
