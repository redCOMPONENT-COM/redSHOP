...
//	newTD_multi_0.innerHTML = "<a href=\"javascript:addNewRow_attribute('"+tableRef+"')\">"+new_attrib+"</a>&nbsp;|&nbsp;<a href=\"javascript:addproperty('"+table_pr+"','"+gh+"')\">"+new_prop+"</a>";
	...
	newTD1.innerHTML = '<table  class="grey_solid_area"  width="100%" cellpadding="0" border="0" cellspacing="0" id="property_table'+gh+'">'
	  ...
	  +'<td class="td5" align="right" style="padding-right: 25px;"><span>Published:&nbsp;</span><input type="checkbox" class="text_area" size="55" name="attribute['+gh+'][property]['+total_g+'][published]" checked="checked"  value="1"><div class="remove_attr"><input value="Delete" onclick="javascript:deleteRow_property(\'property_table'+gh+p+'\',\'property_table'+gh+'\',\'sub_attribute_table'+gh+p+'\',\''+gh+p+'\')" class="btn_attribute_remove" type="button" /><input type="hidden" name="attribute['+gh+'][property]['+total_g+'][property_id] value="0" ></div></td>'
	  +'<tr></table></div></td>'
...
function addproperty(tableRef,rh){	
	...
	newTD.innerHTML = '<table id="attribute_table'+h+'" class="attribute_value">'
			...
			+'<td class="td5" align="right" style="padding-right: 25px;"><span>Published:&nbsp;</span><input type="checkbox" class="text_area" size="55" name="attribute['+rh+'][property]['+h+'][published]" checked="checked" value="1"><div class="remove_attr"><input value="Delete" onclick="javascript:deleteRow_property(\'attribute_table'+h+'\',\''+tableRef+'\',\'sub_attribute_table'+rh+h+'\', \''+rh+h+'\')" class="btn_attribute_remove" type="button" /></div></td>'
			+'<tr></table></div></td>'
			+ '</tr><table>';
...
//	attribute['+rh+'][property]['+h+'][oprand]
	...
	newTD.innerHTML = '<table id="sub'+rh+orde+'" border="0" align="left" width="100%" cellspacing="0" cellpadding="0" class="subattribute" style="border-bottom: 1px solid #CCCCCC;">'
			 ...
			 +'<td class="td5" align="right"  style="padding-right: 25px;"><span>Published:&nbsp;</span><input type="checkbox" class="text_area" size="55" name="attribute['+rh+'][property]['+sh+'][subproperty]['+sp+'][published]" checked="checked" value="1"><div class="remove_attr"><input value="Delete" onclick="javascript:deleteRow_subproperty(\'sub'+rh+orde+'\',\'sub'+rh+sp+'\')" class="btn_attribute_remove" type="button" /></div></td>'
			 +'</tr></table></div>'
			 +'</td>'
			+ '</tr></table>';
