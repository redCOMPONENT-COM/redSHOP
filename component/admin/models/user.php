...
class userModeluser extends JModel
{
	...
	function __construct()
	{
		...
		$spgrp_filter = $mainframe->getUserStateFromRequest( $context.'spgrp_filter','spgrp_filter',0);

		$approved_filter = $mainframe->getUserStateFromRequest( $context.'approved_filter','approved_filter',0);

		$tax_exempt_request_filter = $mainframe->getUserStateFromRequest( $context.'tax_exempt_request_filter','tax_exempt_request_filter',0);
