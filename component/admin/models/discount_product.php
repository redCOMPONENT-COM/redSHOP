...
class RedshopModelDiscount_Product extends RedshopModelForm
{
    ...
    {
        $data['category_ids'] = isset($data['category_ids']) && is_array($data['category_ids']) ? implode(
            ',',
            $data['category_ids']
        ) : '';
    ...
    public function getItem($pk = null)
    {
        ...
        $item->shopper_group = \Redshop\Entity\DiscountProduct::getInstance($item->discount_product_id)->getShopperGroups(
        )->ids();
