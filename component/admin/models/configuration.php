...
class RedshopModelConfiguration extends RedshopModel
{
    ...
    private function fileUpload(&$data)
    {
        ...
        $this->fileUploadProgress(
            $data["default_portal_logo"],
            $defaultPortalLogo['name'],
            null,
            $defaultPortalLogo['tmp_name'],
            'shopperlogo/'
        );
        ...
        $this->fileUploadProgress(
            $data["product_outofstock_image"],
            $productOutOfStockImg['name'],
            null,
            $productOutOfStockImg['tmp_name'],
            'product/'
        );
        ...
        $this->fileUploadProgress(
            $data["category_default_image"],
            $categoryImg['name'],
            null,
            $categoryImg['tmp_name'],
            'category/'
        );
        ...
        $this->fileUploadProgress(
            $data["product_detail_lighbox_close_button_image"],
            $imageSlimBox['name'],
            null,
            $imageSlimBox['tmp_name'],
            'slimbox/'
        );
    }
