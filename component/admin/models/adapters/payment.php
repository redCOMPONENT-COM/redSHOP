...
class JInstallerPayment extends JObject
{
	...
	public function install()
	{
		...
		{
			$this->parent->setPath('extension_root', JPATH_COMPONENT_ADMINISTRATOR . DS . 'helpers/payments');
		}
		else
		{
	...
	public function uninstall($id, $clientId)
	{
		...
		$manifestFile = JPATH_COMPONENT_ADMINISTRATOR . DS . 'helpers/payments' . DS . $row->plugin . '.xml';
