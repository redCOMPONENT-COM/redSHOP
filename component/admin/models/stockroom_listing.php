...
class RedshopModelStockroom_Listing extends RedshopModelList
{
    ...
    public function storeStockroomQuantity(
        $stockroom_type,
        $sid,
        $pid,
        $quantity = "",
    ...
    {
        $stockroom_type = $this->getUserStateFromRequest(
            $this->context . '.stockroom_type',
            'stockroom_type',
            'product'
        );
        $search_field   = $this->getUserStateFromRequest(
            $this->context . '.search_field',
            'search_field',
            'product_name'
        );
