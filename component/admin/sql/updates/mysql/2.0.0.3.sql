...
CALL redSHOP_Unique_Index_Add('#__redshop_country', '#__rs_idx_country_3_code', "(`country_3_code` ASC)");
CALL redSHOP_Unique_Index_Add('#__redshop_country', '#__rs_idx_country_2_code', "(`country_2_code` ASC)");
...
CALL redSHOP_Unique_Index_Add('#__redshop_state', '#__rs_idx_state_3_code', "(`country_id` ASC, `state_3_code` ASC)");
CALL redSHOP_Unique_Index_Add('#__redshop_state', '#__rs_idx_state_2_code', "(`country_id` ASC, `state_2_code` ASC)");
