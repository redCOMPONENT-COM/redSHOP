...
CALL redSHOP_Column_Update('#__redshop_manufacturer', 'manufacturer_desc', 'description', "TEXT NOT NULL");
...
CALL redSHOP_Column_Update('#__redshop_manufacturer', 'metakey', 'metakey', "TEXT NOT NULL");
CALL redSHOP_Column_Update('#__redshop_manufacturer', 'metadesc', 'metadesc', "TEXT NOT NULL");
CALL redSHOP_Column_Update('#__redshop_manufacturer', 'metalanguage_setting', 'metalanguage_setting', "TEXT NOT NULL");
CALL redSHOP_Column_Update('#__redshop_manufacturer', 'metarobot_info', 'metarobot_info', "TEXT NOT NULL");
CALL redSHOP_Column_Update('#__redshop_manufacturer', 'pagetitle', 'pagetitle', "TEXT NOT NULL");
CALL redSHOP_Column_Update('#__redshop_manufacturer', 'pageheading', 'pageheading', "TEXT NOT NULL");
CALL redSHOP_Column_Update('#__redshop_manufacturer', 'sef_url', 'sef_url', "TEXT NOT NULL");
...
CALL redSHOP_Column_Update('#__redshop_manufacturer', 'excluding_category_list', 'excluding_category_list', "TEXT NOT NULL");
