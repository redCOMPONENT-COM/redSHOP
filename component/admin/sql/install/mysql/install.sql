...
CREATE TABLE IF NOT EXISTS `#__redshop_category` (
  ...
  `products_per_page` INT(11) NOT NULL DEFAULT '0',
  `category_thumb_image` VARCHAR(250) NOT NULL DEFAULT '',
  `category_full_image` VARCHAR(250) NOT NULL DEFAULT '',
  `metakey` VARCHAR(250) NOT NULL DEFAULT '',
  `metadesc` LONGTEXT,
  `metalanguage_setting` TEXT,
  `metarobot_info` TEXT,
  `pagetitle` TEXT,
  `pageheading` LONGTEXT,
  `sef_url` TEXT,
  `published` TINYINT(4) NOT NULL DEFAULT '0',
  `category_pdate` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ordering` INT(11) NOT NULL DEFAULT '0',
  `canonical_url` TEXT,
  `category_back_full_image` VARCHAR(250) NOT NULL DEFAULT '',
  `compare_template_id` VARCHAR(255) NOT NULL DEFAULT '',
  ...
  `product_filter_params` MEDIUMTEXT,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `#__redshop_product` (
  ...
  `product_on_sale` TINYINT(4) NOT NULL DEFAULT '0',
  `product_special` TINYINT(4) NOT NULL DEFAULT '0',
  `product_download` TINYINT(4) NOT NULL DEFAULT '0',
  `product_template` INT(11) NOT NULL DEFAULT '0',
  `product_name` VARCHAR(250) NOT NULL DEFAULT '',
  `product_price` DOUBLE NOT NULL DEFAULT '0',
  `discount_price` DOUBLE NOT NULL DEFAULT '0',
  `discount_stratdate` INT(11) NOT NULL DEFAULT '0',
  `discount_enddate` INT(11) NOT NULL DEFAULT '0',
  `product_number` VARCHAR(250) NOT NULL DEFAULT '',
  `product_type` VARCHAR(20) NOT NULL DEFAULT '',
  `product_s_desc` LONGTEXT,
  `product_desc` LONGTEXT,
  `product_volume` DOUBLE NOT NULL DEFAULT '0',
  `product_tax_id` INT(11) NOT NULL DEFAULT '0',
  `published` TINYINT(4) NOT NULL DEFAULT '0',
  `product_thumb_image` VARCHAR(250) NOT NULL DEFAULT '',
  `product_full_image` VARCHAR(250) NOT NULL DEFAULT '',
  `publish_date` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
  `update_date` TIMESTAMP NOT NULL ON UPDATE CURRENT_TIMESTAMP DEFAULT '0000-00-00 00:00:00',
  ...
  `pageheading` TEXT,
  `sef_url` TEXT,
  `cat_in_sefurl` INT(11) NOT NULL DEFAULT '0',
  `weight` FLOAT(10,3) NOT NULL DEFAULT '0',
  `expired` TINYINT(4) NOT NULL DEFAULT '0',
  `not_for_sale` TINYINT(4) NOT NULL DEFAULT '0',
  `use_discount_calc` TINYINT(4) NOT NULL DEFAULT '0',
  `discount_calc_method` VARCHAR(255) NOT NULL DEFAULT '',
  `min_order_product_quantity` INT(11) NOT NULL DEFAULT '0',
  `attribute_set_id` INT(11) NOT NULL DEFAULT '0',
  `product_length` DECIMAL(10,2) NOT NULL DEFAULT '0',
  `product_height` DECIMAL(10,2) NOT NULL DEFAULT '0',
  `product_width` DECIMAL(10,2) NOT NULL DEFAULT '0',
  `product_diameter` DECIMAL(10,2) NOT NULL DEFAULT '0',
  `product_availability_date` INT(11) NOT NULL DEFAULT '0',
  `use_range` TINYINT(4) NOT NULL DEFAULT '0',
  `product_tax_group_id` INT(11) NOT NULL DEFAULT '0',
  `product_download_days` INT(11) NOT NULL DEFAULT '0',
  `product_download_limit` INT(11) NOT NULL DEFAULT '0',
  `product_download_clock` INT(11) NOT NULL DEFAULT '0',
  `product_download_clock_min` INT(11) NOT NULL DEFAULT '0',
  `accountgroup_id` INT(11) NOT NULL DEFAULT '0',
  `canonical_url` TEXT,
  `minimum_per_product_total` INT(11) NOT NULL DEFAULT '0',
  `allow_decimal_piece` INT(4) NOT NULL DEFAULT '0',
  `quantity_selectbox_value` VARCHAR(255) NULL DEFAULT NULL,
  `checked_out` INT(11) NOT NULL DEFAULT '0',
  `checked_out_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
  `max_order_product_quantity` INT(11) NOT NULL DEFAULT '0',
  `product_download_infinite` TINYINT(4) NOT NULL DEFAULT '0',
  `product_back_full_image` VARCHAR(250) NOT NULL DEFAULT '',
  `product_back_thumb_image` VARCHAR(250) NOT NULL DEFAULT '',
  `product_preview_image` VARCHAR(250) NOT NULL DEFAULT '',
  `product_preview_back_image` VARCHAR(250) NOT NULL DEFAULT '',
  `preorder` VARCHAR(255) NOT NULL DEFAULT '',
  `append_to_global_seo` ENUM('append', 'prepend', 'replace') NOT NULL DEFAULT 'append',
...
CREATE TABLE IF NOT EXISTS `#__redshop_fields_group` (
  ...
  `created_date` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `checked_out` INT(11) NULL DEFAULT NULL,
  `checked_out_time` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  `modified_by` INT(11) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__redshop_fields` (
  ...
  `publish_up` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `publish_down` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `display_in_product` TINYINT(4) NOT NULL DEFAULT 0,
  `is_searchable` tinyint(4) NOT NULL DEFAULT '0',
  `ordering` INT(11) NOT NULL DEFAULT 0,
  `display_in_checkout` TINYINT(4) NOT NULL DEFAULT 0,
  `checked_out` INT(11) NULL DEFAULT NULL,
  `checked_out_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_date` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_by` INT(11) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__redshop_mass_discount` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `discount_product` LONGTEXT,
  `category_id` LONGTEXT,
  `manufacturer_id` LONGTEXT,
  `type` TINYINT(4) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__redshop_media` (
  ...
  `media_name` VARCHAR(250) NOT NULL DEFAULT '',
  `media_alternate_text` VARCHAR(255) NOT NULL DEFAULT '',
  `media_section` VARCHAR(20) NOT NULL DEFAULT '',
  `section_id` INT(11) NOT NULL DEFAULT 0,
  `media_type` VARCHAR(250) NOT NULL DEFAULT '',
  `media_mimetype` VARCHAR(20) NOT NULL DEFAULT '',
  `published` TINYINT(4) NOT NULL DEFAULT 0,
  `ordering` INT(11) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__redshop_orders` (
  ...
  `invoice_number_chrono` INT(11) NOT NULL DEFAULT 0 COMMENT 'Order invoice number in chronological order',
  `invoice_number` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'Formatted Order Invoice for final use',
  ...
  `special_discount_amount` DECIMAL(12,2) NOT NULL DEFAULT 0,
  `payment_dicount` DECIMAL(12,2) NOT NULL DEFAULT 0,
  `order_status` VARCHAR(5) NULL DEFAULT NULL,
  `order_payment_status` VARCHAR(25) NOT NULL DEFAULT '',
  `cdate` INT(11) NULL DEFAULT NULL,
  `mdate` INT(11) NULL DEFAULT NULL,
  `ship_method_id` VARCHAR(255) NULL DEFAULT NULL,
  `customer_note` TEXT,
  `ip_address` VARCHAR(15) NOT NULL DEFAULT '',
  `encr_key` VARCHAR(255) NOT NULL DEFAULT '',
  `invoice_no` VARCHAR(255) NOT NULL DEFAULT '',
  `mail1_status` TINYINT(1) NOT NULL DEFAULT 0,
  `mail2_status` TINYINT(1) NOT NULL DEFAULT 0,
  `mail3_status` TINYINT(1) NOT NULL DEFAULT 0,
  `special_discount` DECIMAL(10,2) NOT NULL DEFAULT 0,
  `payment_discount` DECIMAL(10,2) NOT NULL DEFAULT 0,
  `is_booked` TINYINT(1) NOT NULL DEFAULT 0,
  `order_label_create` TINYINT(1) NOT NULL DEFAULT 0,
  `vm_order_number` VARCHAR(32) NOT NULL DEFAULT '',
  `requisition_number` VARCHAR(255) NOT NULL DEFAULT '',
  `bookinvoice_number` INT(11) NOT NULL DEFAULT 0,
  `bookinvoice_date` INT(11) NOT NULL DEFAULT 0,
  ...
  `order_discount_vat` DECIMAL(10,3) NOT NULL DEFAULT 0,
  `track_no` VARCHAR(250) NOT NULL DEFAULT '',
  `payment_oprand` VARCHAR(50) NOT NULL DEFAULT '',
  `discount_type` VARCHAR(255) NOT NULL DEFAULT '',
  `analytics_status` INT(1) NOT NULL DEFAULT 0,
  `tax_after_discount` DECIMAL(10,3) NOT NULL DEFAULT 0,
  `recuuring_subcription_id` VARCHAR(500) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__redshop_order_attribute_item` (
  ...
  `section_price` DECIMAL(15,4) NOT NULL DEFAULT '0.0000',
  `section_vat` DECIMAL(15,4) NOT NULL DEFAULT '0.0000',
  `section_oprand` CHAR(1) NOT NULL DEFAULT '',
  `is_accessory_att` TINYINT(4) NOT NULL,
  `stockroom_id` VARCHAR(255) NOT NULL DEFAULT '',
  `stockroom_quantity` VARCHAR(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__redshop_order_item` (
  ...
  `product_accessory` TEXT,
  `delivery_time` INT(11) NOT NULL DEFAULT 0,
  `stockroom_id` VARCHAR(255) NOT NULL DEFAULT '',
  `stockroom_quantity` VARCHAR(255) NOT NULL DEFAULT '',
  `is_split` TINYINT(1) NOT NULL DEFAULT 0,
  `attribute_image` TEXT,
  `is_giftcard` TINYINT(4) NOT NULL DEFAULT 0,
  `wrapper_id` INT(11) NOT NULL DEFAULT 0,
  `wrapper_price` DECIMAL(10,2) NOT NULL DEFAULT 0,
  `giftcard_user_name` VARCHAR(255) NOT NULL DEFAULT '',
  `giftcard_user_email` VARCHAR(255) NOT NULL DEFAULT '',
  `product_item_old_price` DECIMAL(10,4) NOT NULL DEFAULT 0,
  `product_purchase_price` DECIMAL(10,4) NOT NULL DEFAULT 0,
  `discount_calc_data` TEXT,
...
CREATE TABLE IF NOT EXISTS `#__redshop_order_payment` (
  ...
  `order_payment_ccv` BLOB NULL DEFAULT NULL,
  `order_payment_amount` DOUBLE(10,2) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__redshop_order_users_info` (
  ...
  `users_info_id` INT(11) NOT NULL DEFAULT 0,
  `order_id` INT(11) NOT NULL,
  `user_id` INT(11) NOT NULL DEFAULT 0,
  ...
  `tax_exempt_approved` TINYINT(1) NOT NULL DEFAULT 0,
  `approved` TINYINT(1) NOT NULL DEFAULT 0,
  `is_company` TINYINT(4) NOT NULL DEFAULT 0,
  `user_email` VARCHAR(255) NOT NULL DEFAULT '',
  `company_name` VARCHAR(255) NOT NULL DEFAULT '',
  `ean_number` VARCHAR(250) NOT NULL DEFAULT '',
  `requesting_tax_exempt` TINYINT(4) NOT NULL DEFAULT 0,
  `thirdparty_email` VARCHAR(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__redshop_product_accessory` (
  ...
  `accessory_price` DOUBLE NOT NULL DEFAULT 0,
  `oprand` CHAR(1) NOT NULL DEFAULT '',
  `setdefault_selected` TINYINT(4) NOT NULL DEFAULT 0,
  `ordering` INT(11) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__redshop_product_attribute_price` (
  ...
  `product_currency` VARCHAR(10) NOT NULL DEFAULT '0',
  `cdate` INT(11) NOT NULL DEFAULT '0',
  `shopper_group_id` INT(11) NOT NULL,
  `price_quantity_start` INT(11) NOT NULL,
  `price_quantity_end` BIGINT(20) NOT NULL,
  `discount_price` DOUBLE NOT NULL DEFAULT '0',
  `discount_start_date` INT(11) NOT NULL DEFAULT '0',
  `discount_end_date` INT(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `#__redshop_product_attribute_property` (
  ...
  `property_main_image` VARCHAR(255) NOT NULL DEFAULT '',
  `ordering` INT(11) NOT NULL DEFAULT 0,
  `setdefault_selected` TINYINT(4) NOT NULL DEFAULT 0,
  `setrequire_selected` TINYINT(3) NOT NULL DEFAULT 0,
  `setmulti_selected` TINYINT(4) NOT NULL DEFAULT 0,
  `setdisplay_type` VARCHAR(255) NOT NULL DEFAULT '',
  `extra_field` VARCHAR(250) NOT NULL DEFAULT '',
  `property_published` INT(11) NOT NULL DEFAULT '1',
  `property_number` VARCHAR(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__redshop_product_price` (
  ...
  `product_currency` VARCHAR(10) NOT NULL DEFAULT '0',
  `cdate` DATE NOT NULL DEFAULT '0',
  `shopper_group_id` INT(11) NOT NULL,
  `price_quantity_start` INT(11) NOT NULL,
  `price_quantity_end` BIGINT(20) NOT NULL,
  `discount_price` DECIMAL(12,4) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `#__redshop_product_rating` (
  ...
  `favoured` TINYINT(4) NOT NULL DEFAULT 0,
  `published` TINYINT(4) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__redshop_product_subattribute_color` (
  ...
  `subattribute_color_name` VARCHAR(255) NOT NULL DEFAULT '',
  `subattribute_color_price` DOUBLE NOT NULL DEFAULT 0,
  `oprand` CHAR(1) NOT NULL DEFAULT '',
  `subattribute_color_image` VARCHAR(255) NOT NULL DEFAULT '',
  `subattribute_id` INT(11) NOT NULL DEFAULT 0,
  `ordering` INT(11) NOT NULL DEFAULT 0,
  `setdefault_selected` TINYINT(4) NOT NULL DEFAULT 0,
  `extra_field` VARCHAR(250) NOT NULL DEFAULT '',
  `subattribute_published` INT(11) NOT NULL DEFAULT '1',
  `subattribute_color_number` VARCHAR(255) NOT NULL DEFAULT '',
  `subattribute_color_title` VARCHAR(255) NOT NULL DEFAULT '',
  `subattribute_color_main_image` VARCHAR(255) NULL DEFAULT '',
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `#__redshop_promotion` ;
...
CREATE TABLE IF NOT EXISTS `#__redshop_shopper_group` (
  ...
  `published` TINYINT(4) NOT NULL,
  `cart_checkout_itemid` INT(11) NOT NULL,
  `cart_itemid` INT(11) NOT NULL,
  `quotation_mode` TINYINT(4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__redshop_users_info` (
  ...
  `tax_exempt` TINYINT(4) NOT NULL DEFAULT 0,
  `shopper_group_id` INT(11) NOT NULL DEFAULT 0,
  `country_code` VARCHAR(11) NOT NULL DEFAULT 0,
  `address` VARCHAR(255) NOT NULL DEFAULT '',
  ...
  `is_company` TINYINT(4) NOT NULL DEFAULT 0,
  `ean_number` VARCHAR(250) NOT NULL DEFAULT '',
  `braintree_vault_number` VARCHAR(255) NOT NULL DEFAULT '',
  `veis_vat_number` VARCHAR(255) NOT NULL DEFAULT '',
  `veis_status` VARCHAR(255) NOT NULL DEFAULT '',
  `company_name` VARCHAR(255) NOT NULL DEFAULT '',
  `requesting_tax_exempt` TINYINT(4) NOT NULL DEFAULT '0',
  `accept_terms_conditions` TINYINT(4) NOT NULL DEFAULT 0,
