...
CREATE TABLE IF NOT EXISTS `#__redshop_fields` (
  ...
  INDEX `rs_idx_field_published` (`published` ASC),
  INDEX `rs_idx_field_section` (`section` ASC),
  INDEX `rs_idx_field_type` (`type` ASC),
  INDEX `rs_idx_required` (`required` ASC),
  INDEX `rs_idx_field_name` (`name` ASC),
  INDEX `rs_idx_field_show_in_front` (`show_in_front` ASC),
  INDEX `rs_idx_field_display_in_product` (`display_in_product` ASC))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
