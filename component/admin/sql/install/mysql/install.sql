...
CREATE TABLE IF NOT EXISTS `#__redshop_category` (
  ...
  `more_template` VARCHAR(255) NULL,
  `products_per_page` INT(11) NOT NULL,
  `category_thumb_image` VARCHAR(250) NULL,
  `category_full_image` VARCHAR(250) NULL,
  `metakey` VARCHAR(250) NULL,
  `metadesc` LONGTEXT NULL,
  `metalanguage_setting` TEXT NULL,
  `metarobot_info` TEXT NULL,
  `pagetitle` TEXT NULL,
  `pageheading` LONGTEXT NULL,
  `sef_url` TEXT NULL,
  `published` TINYINT(4) NOT NULL,
  `category_pdate` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ordering` INT(11) NOT NULL DEFAULT '0',
  `canonical_url` TEXT NULL,
  `category_back_full_image` VARCHAR(250) NULL,
  `compare_template_id` VARCHAR(255) NULL,
  ...
  `product_filter_params` MEDIUMTEXT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `#__redshop_product` (
  ...
  `published` TINYINT(4) NOT NULL,
  `product_thumb_image` VARCHAR(250) NULL DEFAULT NULL,
  `product_full_image` VARCHAR(250) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__redshop_users_info` (
  ...
  `firstname` VARCHAR(250) NOT NULL,
  `lastname` VARCHAR(250) NOT NULL,
  `vat_number` VARCHAR(250) NULL,
  `tax_exempt` TINYINT(4) NOT NULL,
  `shopper_group_id` INT(11) NOT NULL,
  `country_code` VARCHAR(11) NULL,
  `address` VARCHAR(255) NOT NULL,
  `city` VARCHAR(50) NOT NULL,
  `state_code` VARCHAR(11) NULL,
  `zipcode` VARCHAR(255) NOT NULL,
  `phone` VARCHAR(50) NOT NULL,
  `tax_exempt_approved` TINYINT(1) NOT NULL,
  `approved` TINYINT(1) NOT NULL,
  `is_company` TINYINT(4) NOT NULL,
  `ean_number` VARCHAR(250) NULL,
  `braintree_vault_number` VARCHAR(255) NULL,
  `veis_vat_number` VARCHAR(255) NULL,
  `veis_status` VARCHAR(255) NULL,
