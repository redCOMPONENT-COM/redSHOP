 ...
 * @since		1.5
 */
class JElementcardtypes extends JElement
{
	/**
	 * Element name
	 *
	...
	<?php 	// This might get a conflict with the dynamic translation - TODO: search for better solution
		...
		foreach($cc_list as $key => $valuechk)
		{
			...
			if($key=='ALL'){
				...
				$html.="<input type='checkbox' id='".$key."' name='params[".$name."][]'  value='".$key."' ".$checked." onclick='javascript:enableDisableAll();'  />".$valuechk."&nbsp;<br />";
			}else{
