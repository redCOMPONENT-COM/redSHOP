 ...
 * @since		1.5
 */
class JElementordertemplatelist extends JElement
{
	/**
	 * Element name
	 *
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		array_unshift($options, JHTML::_('select.option', '0', '- '.JText::_('SELECT').' -', 'template_id', 'template_name'));
