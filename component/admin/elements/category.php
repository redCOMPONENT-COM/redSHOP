...
class JElementcategory extends JElement
{
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		array_unshift($categories, JHTML::_('select.option', '0', '- '.JText::_('Select Category').' -', 'category_id', 'category_name'));

		return JHTML::_('select.genericlist',  $categories, ''.$control_name.'['.$name.']', 'class="inputbox"', 'category_id', 'category_name', $value, $control_name.$name );
	}
