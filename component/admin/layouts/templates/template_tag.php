...
switch ($name) {
    ...
    case 'related_product':
        ...
        {relproduct_header} {relproduct_link} {relproduct_image} {relproduct_name} {relproduct_price} {relproduct_number} {relproduct_number_lbl} {read_more} {relproduct_old_price} {relproduct_price_table} {relproduct_price_saving}
        <br/>
