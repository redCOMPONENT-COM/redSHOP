...
switch ($name) {
    ...
    case 'giftcard':
        ?>
        {giftcard_price_lbl} {giftcard_reciver_name_lbl} {giftcard_reciver_email_lbl} {giftcard_price} {giftcard_reciver_name} {giftcard_reciver_email} {giftcard_desc} {giftcard_price}
        <br/>
    ...
    case 'invoice':
        ...
        {invoice_number}
        {order_information_lbl} {order_id_lbl} {order_id} {order_number_lbl} {order_number} {order_date_lbl} {order_date} {order_status_lbl} {order_status}
        <br/>
