...
<table cellpadding="0" cellspacing="5" border="0">
	<tr>
		<th>
			<?php
			echo Text::_('COM_REDSHOP_COLOUR_CODE'); ?> : <input class="inputbox" type="text" name="color_code_1"
				id="color_code_1" />
		</th>
		<td>
		...
		<td>
			<?php
			echo Text::_('COM_REDSHOP_OR'); ?>
		</td>
		<td>
			<?php
			echo Text::_('COM_REDSHOP_COLOUR_IMAGE'); ?> :
		</td>
		<td>
			<?php
			...
			<div class="button2-left">
				...
				echo $ilink; ?>" rel="{handler: 'iframe', size: {x: 570, y: 400}}">Image</a></div>
			</div>
		</td>
		<th>
			<input type="button" name="addvalue" id="addvalue" class="button" Value="<?php
			echo Text::_('COM_REDSHOP_ADD_COLOR'); ?>" onclick="addNewcolor('extra_table');" />
...
<table cellpadding="0" cellspacing="5" border="0" id="extra_table">
	<tr>
		...
		<th>
			<?php
			echo Text::_('COM_REDSHOP_DELETE'); ?>
		</th>
	</tr>
	<?php
