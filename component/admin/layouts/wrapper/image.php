...
<div class="form-group row-fluid ">
	<div class="col-md-10">
		<label id="jform_category_id-lbl" class="col-md-2 control-label hasPopover">
			<?php echo Text::_('COM_REDSHOP_WRAPPER_IMAGE'); ?>
		</label>
	...
	<div class="col-md-10">
		...
		if (null != $item->image): ?>
			<div>
				...
				?>
				<a href="<?php
				echo $imagePath; ?>" id="image_display_href" class="joom-box" rel="{handler: 'image', size: {x: 570, y: 400}}">
					<img src="<?php
	...
	<input type="hidden" name="image" id="image" value="<?php
	echo $item->image; ?>" />
