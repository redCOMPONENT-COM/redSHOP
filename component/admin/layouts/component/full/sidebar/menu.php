    ...
    <ul class="sidebar-menu">
        <li>
            <a href="index.php?option=com_redshop">
                ...
                <span>
                    <?php echo Text::_('COM_REDSHOP_DASHBOARD') ?>
                </span>
            </a>
        </li>
                ...
                <?php if ($sections->disable === false): ?>
                    <li class="<?php echo ($sections->active) ? 'active' : '' ?>">
                        <?php echo JLayoutHelper::render(
                            ...
                            array(
                                'link'   => $sections->link,
                                'title'  => Text::_($sections->title),
                                'active' => Text::_($sections->active),
                    ...
                    <li class="treeview <?php echo ($active[0] == $group ? 'active' : '') ?>">
                        <a href="#">
                            <?php if (strtolower($group) == 'stockroom'): ?>
                                <i class="<?php echo (strtolower($group) == 'stockroom') ? 'fa fa-archive' : strtolower(
                                    $group
                                ) ?>"></i>
                            ...
                            <?php endif; ?>
                            <span>
                                <?php echo Text::_('COM_REDSHOP_' . $group); ?>
                            </span>
                            ...
                            <?php else: ?>
                                <?php foreach ($sections['items'] as $sectionKey => $section): ?>
                                    ...
                                    <?php elseif (count($section->items) > 1): ?>
                                        <li class="treeview <?php echo ($active[1] == $sectionKey || count(
                                            $sections
                                        ) == 1 ? 'active' : '') ?>">
                                            <a href="#">
                                                <span>
                                            ...
                                            <ul class="treeview-menu" <?php echo (
                                                count(
                                                    $sections
