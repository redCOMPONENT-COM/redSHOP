...
// ------------------  standard plugin initialize function - don't change ---------------------------
	...
	$myparams = new JParameter($menu->params);

	/**
	 * set redSHOP prefix
	 */
	if(trim(shGetComponentPrefix($option)) != "")	$title[] = shGetComponentPrefix($option);
