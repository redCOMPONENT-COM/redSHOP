...
CREATE TABLE IF NOT EXISTS `#__redshop_quotation_accessory_item` (
  ...
  `accessory_item_price` decimal(15,4) NOT NULL,
  `accessory_final_price` decimal(15,4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__redshop_quotation_item` (
	...
	`product_excl_price` DECIMAL( 15, 2 ) NOT NULL ,
	`product_final_price` DECIMAL( 15, 2 ) NOT NULL ,
...
CREATE TABLE IF NOT EXISTS `#__redshop_discountArea` (
`discountAreaid` int(11) NOT NULL AUTO_INCREMENT,
`area_start` decimal(10,4) NOT NULL,
`area_end` decimal(10,4) NOT NULL,
`discount_on` int(11) NOT NULL,
`amount` decimal(10,4) NOT NULL,
`product_id` varchar(255) NOT NULL,
`discountstart_date` int(11) NOT NULL,
`discountend_date` int(11) NOT NULL,
`category_id` varchar(255) NOT NULL,
`published` tinyint(4) NOT NULL,
PRIMARY KEY (`discountAreaid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ;
