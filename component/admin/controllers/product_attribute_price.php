...
class product_attribute_priceController extends JController
{
	...
	function saveprice(){
				...
				//return false;
		   		...
		   		if( $price[$i] !='') {
			   		...
			   		$sql = "UPDATE #__redshop_product_attribute_price  SET product_price='".$price[$i]."' ,"
	  						...
	  						." WHERE section_id='".$section_id."' AND section= '".$section."' AND price_id = '".$price_id[$i]."' AND shopper_group_id = '".$shopper_group_id[$i]."' ";
	 ...
	 $link = "index3.php?option=com_redshop&view=product_attribute_price&section_id=".$section_id."&cid=".$cid."&section=".$section;
