...
class orderstatus_detailController extends JController {
	...
	function save()
	{
		...
		if ($model->store ( $post ))
		{
			$msg = JText::_ ( 'ORDERSTATUS_DETAIL_SAVED' );

		}elseif( JFactory::getACL()){

			$msg = JText::_( 'ORDERSTATUS_CODE_IS_ALLREADY' );

		}else{

			$msg = JText::_ ( 'ERROR_SAVING_ORDERSTATUS_DETAIL' );
		}
	...
	function remove() {
		...
		$msg = JText::_ ( 'ORDERSTATUS_DETAIL_DELETED_SUCCESSFULLY' );
	...
	function publish() {
		...
		$msg = JText::_ ( 'ORDERSTATUS_DETAIL_PUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=orderstatus',$msg );
	}
	function unpublish() {
		...
		$msg = JText::_ ( 'ORDERSTATUS_DETAIL_UNPUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=orderstatus',$msg );
	}
	...
	function cancel() {
		...
		$option = JRequest::getVar ('option');
		$msg = JText::_ ( 'ORDERSTATUS_DETAIL_EDITING_CANCELLED' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=orderstatus',$msg );
	}
