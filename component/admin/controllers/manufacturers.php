	...
	public function copy()
	{
		...
		if ($cids)
		{
			foreach ($cids as $cid)
			{
				if (!$model->copy($cid))
				{
					JFactory::getApplication()->enqueueMessage(JText::_('COM_REDSHOP_COPY_MANUFACTURER_FAILED'), 'warning');
				}
			}

			JFactory::getApplication()->enqueueMessage(JText::_('COM_REDSHOP_COPY_MANUFACTURER_SUCCESSFUL'));
