...
class sample_detailController extends JController {
	...
	function save() {		
		...
		if ($model->store ( $post )) {
			...
			$msg = JText::_ ( 'SAMPLE_DETAIL_SAVED' );
				
		} else {
			
			$msg = JText::_ ( 'ERROR_SAVING_SAMPLE_DETAIL' );
		}
	...
	function remove() {
		...
		$msg = JText::_ ( 'SAMPLE_DETAIL_DELETED_SUCCESSFULLY' );
	...
	function publish() {
		...
		$msg = JText::_ ( 'SAMPLE_DETAIL_PUBLISHED_SUCCESFULLY' );
	...
	function unpublish() {
		...
		$msg = JText::_ ( 'SAMPLE_DETAIL_UNPUBLISHED_SUCCESFULLY' );
	...
	function cancel() {
		...
		$option = JRequest::getVar ('option');
		$layout = JRequest::getVar ('layout');
		$msg = JText::_ ( 'SAMPLE_DETAIL_EDITING_CANCELLED' );
