...
class mail_detailController extends JController {
	...
	function save($apply=0) {		
		...
		if ($row) {
			...
			$msg = JText::_ ( 'MAIL_DETAIL_SAVED' );
		
		} else {
			
			$msg = JText::_ ( 'ERROR_SAVING_MAIL_DETAIL' );
		}
	...
	function remove() {
		...
		$msg = JText::_ ( 'MAIL_DETAIL_DELETED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=mail',$msg );
	}
	function publish() { 
		...
		$msg = JText::_ ( 'MAIL_DETAIL_PUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=mail',$msg );
	}
	function unpublish() {
		...
		$msg = JText::_ ( 'MAIL_DETAIL_UNPUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=mail',$msg );
	}
	function cancel() {
		
		$option = JRequest::getVar ('option');
		$msg = JText::_ ( 'MAIL_DETAIL_EDITING_CANCELLED' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=mail',$msg );
	}
