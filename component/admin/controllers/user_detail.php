...
class user_detailController extends JController
{
	...
	function save($apply=0)
	{
		...
		{
			$msg = JText::_ ( 'USER_DETAIL_SAVED' );
		} else {
			$msg = JText::_ ( 'ERROR_SAVING_USER_DETAIL' );
		}
	...
	function remove()
	{
		...
		$msg = JText::_ ( 'USER_DETAIL_DELETED_SUCCESSFULLY' );
		if($shipping)
		{
...
//		$shipping = JRequest::getVar('shipping','','request','string');
		...
		$msg = JText::_ ( 'USER_DETAIL_PUBLISHED_SUCCESSFULLY' );
//		if($shipping)
//		{
//			$info_id = JRequest::getVar('info_id', '', 'request', 'int');
...
//		}
	...
	function unpublish()
	{
		...
		$msg = JText::_ ( 'USER_DETAIL_UNPUBLISHED_SUCCESSFULLY' );
//		if($shipping)
//		{
//			$info_id = JRequest::getVar('info_id', '', 'request', 'int');
//			$this->setRedirect ( 'index.php?option='.$option.'&view=user&shipping=1&cancel=1&cid[]='.$info_id, $msg );
...
//		}
	...
	function cancel()
	{
		...
		$msg = JText::_ ( 'USER_DETAIL_EDITING_CANCELLED' );
		if($shipping)
		{
			$link = 'index.php?option='.$option.'&view=user_detail&task=edit&cancel=1&cid[]='.$info_id;
		}
