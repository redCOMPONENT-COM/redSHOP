...
class supplier_detailController extends JController {
	...
	function save() {	
		...
		if ($row=$model->store ( $post )) {
			...
			$msg = JText::_ ( 'SUPPLIER_DETAIL_SAVED' );
		
		} else {
			
			$msg = JText::_ ( 'ERROR_SAVING_SUPPLIER_DETAIL' );
		}
	...
	function remove() {
		...
		$msg = JText::_ ( 'SUPPLIER_DETAIL_DELETED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=supplier',$msg );
	}
	function publish() {
		...
		$msg = JText::_ ( 'SUPPLIER_DETAIL_PUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=supplier',$msg );
	}
	function unpublish() {
		...
		$msg = JText::_ ( 'SUPPLIER_DETAIL_UNPUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=supplier',$msg );
	}
	function cancel() {
		
		$option = JRequest::getVar ('option');
		$msg = JText::_ ( 'SUPPLIER_DETAIL_EDITING_CANCELLED' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=supplier',$msg );
	}
	function copy(){
		...
		if ($model->copy($cid)) {
			...
			$msg = JText::_ ( 'SUPPLIER_DETAIL_COPIED' );
		
		} else {
			
			$msg = JText::_ ( 'ERROR_COPING_SUPPLIER_DETAIL' );
		}
