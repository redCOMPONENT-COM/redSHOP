...
class RedshopControllerMedia_Detail extends RedshopController
{
        ...
        if (!empty($bulkfile) && $bulkfile['name'] == null && $file[0]['name'] == null && $post['oldmedia'] != "") {
            if ($post['media_bank_image'] == "") {
                ...
                if ($save = $model->store($post)) {
                    ...
                    if ($save->media_section == 'product' && $save->media_type == 'images') {
                        if (isset($post['set']) && $post['media_section'] != 'manufacturer') {
                            if ($apply == 1) {
                                $this->setRedirect(
                                    'index.php?tmpl=component&option=com_redshop&view=media_detail&section_id='
                    ...
                    $msg = Text::_('COM_REDSHOP_ERROR_SAVING_MEDIA_DETAIL');
                ...
                if (isset($post['set']) && $post['media_section'] != 'manufacturer') {
                    ...
                    if ($apply == 1) {
                        $this->setRedirect(
                            'index.php?option=com_redshop&view=media_detail&task=edit&cid[]=' . $row->media_id,
                            $msg
                        );
                    } else {
                        $this->setRedirect('index.php?option=com_redshop&view=media', $msg);
            ...
            if ($post['media_id']) {
                ...
                if ($apply == 1) {
                    $this->setRedirect(
                        'index.php?option=com_redshop&view=media_detail&task=edit&cid[]=' . $post['media_id'],
                        $msg
                    );
                } else {
                    if (isset($post['set']) && $post['media_section'] != 'manufacturer') {
            ...
            if (isset($post['hdn_download_file']) && $post['hdn_download_file'] != "") {
                ...
                if ($save = $model->store($post)) {
                    ...
                    if (isset($post['set'])) {
                        $this->setRedirect(
                            'index.php?tmpl=component&option=com_redshop&view=media_detail&section_id=' . $post['section_id'] . '&showbuttons=1&section_name='
                            . $post['section_name'] . '&media_section=' . $post['media_section'],
                            $msg,
                            'warning'
                        );
            ...
            if ($post['media_bank_image'] != "") {
                ...
                if (isset($post['set']) && $post['media_section'] != 'manufacturer') {
                    if ($apply == 1) {
                        ...
                        $this->setRedirect(
                            'index.php?tmpl=component&option=com_redshop&view=media&section_id=' . $post['section_id'] . '&showbuttons=1&section_name='
                            . $post['section_name'] . '&media_section=' . $post['media_section'],
                            $msg
                        );
                    }
            ...
            if ($bulkfile['name'] != '') {
                if ($bulkfiletype == "zip" || $bulkfiletype == "gz" || $bulkfiletype == "tar" || $bulkfiletype == "tgz" || $bulkfiletype == "gzip") {
                    ...
                    for ($i = 2, $in = count($scan); $i < $in; $i++) {
                        if (is_dir($target . '/' . $scan[$i])) {
                            ...
                            for ($j = 2, $jn = count($newscan); $j < $jn; $j++) {
                                ...
                                if ($post['media_type'] == 'download') {
                                    $post['media_name'] = $product_download_root . RedshopHelperMedia::cleanFileName(
                                        $newscan[$j]
                                    );
                                    ...
                                    if ($filenewtype == 'png' || $filenewtype == 'gif' || $filenewtype == 'jpg' || $filenewtype == 'jpeg') {
                                        if ($row = $model->store($post)) {
                                            $originaldir = JPATH_ROOT . '/components/com_redshop/assets/' . $row->media_type . '/'
                                                . $row->media_section . '/' . RedshopHelperMedia::cleanFileName(
                                                        $newscan[$j]
                                                    );
                    ...
                    $bulkfiletype == 'png' || $bulkfiletype == 'gif' || $bulkfiletype == 'jpg' || $bulkfiletype == 'pdf'
                    || $bulkfiletype != 'mpeg' || $bulkfiletype != 'mp4' || $bulkfiletype != 'avi' || $bulkfiletype != '3gp'
                    || $bulkfiletype != 'swf' || $bulkfiletype != 'jpeg'
                ) {
                    $msg = Text::_('COM_REDSHOP_PLEASE_SELECT_NO');
                    ...
                    $msg = Text::_('COM_REDSHOP_MEDIA_FILE_EXTENSION_WRONG');
            ...
            if ($file[0]['name'] != '') {
                ...
                for ($i = 0; $i < $num; $i++) {
                    ...
                    if (
                        !in_array(
                            $fileType,
                            array('png', 'gif', 'jpeg', 'jpg', 'zip', 'mpeg', 'mp4', 'avi', '3gp', 'swf', 'pdf')
                        )
                        ...
                        $msg = Text::_('COM_REDSHOP_SELECT_MEDIA_SECTION_FIRST');
                        ...
                        $msg = Text::_('COM_REDSHOP_PLEASE_SELECT_BULK_OPTION');
                        ...
                        $msg = Text::_('COM_REDSHOP_YOU_HAVE_SELECTED_NO_OPTION');
    ...
    public function remove()
    {
        ...
        $msg = Text::_('COM_REDSHOP_MEDIA_DETAIL_DELETED_SUCCESSFULLY');

        if ($section_id) {
            $this->setRedirect(
                'index.php?tmpl=component&option=com_redshop&view=media&section_id='
                . $section_id . '&showbuttons=1&media_section=' . $media_section,
                $msg
            );
        } elseif (isset($post['set']) && $post['media_section'] == 'manufacturer') {
            $link = 'index.php?option=com_redshop&view=manufacturer'; ?>
    ...
    {
        $msg = Text::_('COM_REDSHOP_MEDIA_DETAIL_EDITING_CANCELLED');
        $this->setRedirect('index.php?option=com_redshop&view=media', $msg);
    }
    ...
    public function saveorder()
    {
        ...
        if (empty($cid)) {
            throw new Exception(Text::_('COM_REDSHOP_SELECT_ORDERING'));
        }
    ...
    public function orderdown()
    {
        ...
        if ($section_id) {
            $this->setRedirect(
                'index.php?tmpl=component&option=com_redshop&view=media&section_id=' . $section_id . '&showbuttons=1&media_section=' . $media_section,
                $msg
            );
        } elseif (isset($post['set']) && $post['media_section'] == 'manufacturer') {
            $link = 'index.php?option=com_redshop&view=manufacturer'; ?>
