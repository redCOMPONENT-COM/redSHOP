...
//		$post["text_field"]=$text_field;
		...
		{
			$msg = JText::_ ( 'CREATE_ACCOUNT_FOR_QUOTATION' );
...
//		die();
		...
		if ($row) 
		{
			$msg = JText::_ ( 'QUOTATION_DETAIL_SAVED' );
		} else {
			$msg = JText::_ ( 'ERROR_SAVING_QUOTATION_DETAIL' );
		}
		...
		if($send==1)
		{
			...
			{
				$msg = JText::_ ( 'QUOTATION_DETAIL_SENT' );	
			}
		}
	...
	function remove() 
	{
		...
		$msg = JText::_ ( 'QUOTATION_DETAIL_DELETED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=quotation',$msg );
	}
	...
	{	
		...
		$msg = JText::_ ( 'QUOTATION_ITEM_DETAIL_DELETED_SUCCESSFULLY' );
	...
	{
		$option = JRequest::getVar('option','','request','string');
		$msg = JText::_ ( 'QUOTATION_DETAIL_EDITING_CANCELLED' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=quotation',$msg );
	}
	...
	function newQuotationItem()
	{
		...
		{
			$msg = JText::_('QUOTATION_ITEM_ADDED');
		} else {
			$msg = JText::_('ERROR_ADDING_QUOTATION_ITEM');
		}
