...
class container_detailController extends JController {
	...
	//	$post ['container_id'] = $cid [0];
		...
		if ($row=$model->store ( $post )) {
			...
			$msg = JText::_ ( 'CONTAINER_DETAIL_SAVED' );
		
		} else {
			
			$msg = JText::_ ( 'ERROR_SAVING_CONTAINER_DETAIL' );
		}
	...
	function remove() {
		...
		$msg = JText::_ ( 'CONTAINER_DETAIL_DELETED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=container',$msg );
	}
	function publish() {
		...
		$msg = JText::_ ( 'CONTAINER_DETAIL_PUBLISHED_SUCCESFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=container',$msg );
	}
	function unpublish() {
		...
		$msg = JText::_ ( 'CONTAINER_DETAIL_UNPUBLISHED_SUCCESFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=container',$msg );
	}
	function cancel() {
		...
		$model = $this->getModel ( 'container_detail' );
		 ...
		 $model->cancel ();
		$msg = JText::_ ( 'CONTAINER_DETAIL_EDITING_CANCELLED' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=container',$msg );
	}
