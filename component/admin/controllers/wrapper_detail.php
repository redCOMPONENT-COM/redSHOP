...
class wrapper_detailController extends JController {
	...
	function save() 
	{
		...
		$model = $this->getModel ( 'wrapper_detail' );
		if ($model->store ( $post )) {
			$msg = JText::_ ( 'WRAPPER_DETAIL_SAVED' );
		} else {
			$msg = JText::_ ( 'ERROR_SAVING_WRAPPER_DETAIL' );
		}
	...
	function remove() {
		...
		$msg = JText::_ ( 'WRAPPER_DETAIL_DELETED_SUCCESSFULLY' );
		$this->setRedirect ( 'index'.$page.'.php?option='.$option.'&view=wrapper&showall='.$showall.'&product_id='.$product_id,$msg );
	}
	...
	function cancel() {
		...
		$msg = JText::_ ( 'WRAPPER_DETAIL_EDITING_CANCELLED' );
		$this->setRedirect ( 'index'.$page.'.php?option='.$option.'&view=wrapper&showall='.$showall.'&product_id='.$product_id,$msg );
	}
	/**
	 * logic for publish
	...
	function publish()
	{
		...
		$msg = JText::_ ( 'WRAPPER_PUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index'.$page.'.php?option='.$option.'&view=wrapper&showall='.$showall.'&product_id='.$product_id,$msg );
	}
	/**
	 * logic for unpublish
	...
	function unpublish()
	{
		...
		$msg = JText::_ ( 'WRAPPER_UNPUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index'.$page.'.php?option='.$option.'&view=wrapper&showall='.$showall.'&product_id='.$product_id,$msg );
	}
	function enable_defaultpublish() {
		...
		$msg = JText::_ ( 'USE_TO_ALL_ENABLE_SUCCESSFULLY' );
		$this->setRedirect ( 'index'.$page.'.php?option='.$option.'&view=wrapper&showall='.$showall.'&product_id='.$product_id,$msg );
	}
	...
	function enable_defaultunpublish() {
		...
		$msg = JText::_ ( 'USE_TO_ALL_DISABLE_SUCCESSFULLY' );
		$this->setRedirect ( 'index'.$page.'.php?option='.$option.'&view=wrapper&showall='.$showall.'&product_id='.$product_id,$msg );
	}
}	?>