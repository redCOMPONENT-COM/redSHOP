...
class producttags_detailController extends JController {
	...
	function save() 
	{
		...
		if ($model->store ( $post )) 
		{
			$msg = JText::_ ( 'TAGS_DETAIL_SAVED' );
		
		} 
		else 
		{
			$msg = JText::_ ( 'ERROR_SAVING_TAGS_DETAIL' );
		}
	...
	function remove() {
		...
		$msg = JText::_ ( 'TAGS_DETAIL_DELETED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=producttags',$msg );
	}
	function publish() { 
		...
		$msg = JText::_ ( 'TAGS_DETAIL_PUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=producttags',$msg );
	}
	function unpublish() {
		...
		$msg = JText::_ ( 'TAGS_DETAIL_UNPUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=producttags',$msg );
	}
	function cancel() {
		
		$option = JRequest::getVar ('option');
		$msg = JText::_ ( 'TAGS_DETAIL_EDITING_CANCELLED' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=producttags',$msg );
	}
