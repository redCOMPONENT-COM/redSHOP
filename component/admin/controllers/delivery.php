...
class deliverycontroller extends JController
{
	...
	function export_data() 
	{
    	...
    	header('Content-Disposition: attachment; filename=deliverylist.csv');
	        ...
	        $txt = ''; 
	        $txt .= JTEXT::_( 'ORDER_ID' ).$del;
	        $txt .= JTEXT::_( 'NAME' ).$del;
	        $txt .= JTEXT::_( 'ADDRESS' ).$del;
	        $txt .= JTEXT::_( 'TELEPHONE' ).$del;
	        $txt .= JTEXT::_( 'Amount' ).$del;
	        $txt .= JTEXT::_( 'GOOD_NO' ).$del;
	        $txt .= JTEXT::_( 'EDITION_NO' ).$del;
	        $txt .= JTEXT::_( 'PRODUCT' ).$del;
	        $txt .= JTEXT::_( 'CBM' ).$del;
	        $txt .= JTEXT::_( 'EDITION' ).$del;
	        $txt .= JTEXT::_( 'SOLD_FROM_STOCKROOM' ).$del;
	        $txt .= JTEXT::_( 'STATUS' );
	        $txt .= "\n";
