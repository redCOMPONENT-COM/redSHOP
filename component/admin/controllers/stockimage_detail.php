...
class stockimage_detailController extends JController 
{
	...
	function save() 
	{
		...
		{
			$msg = JText::_ ( 'STOCKIMAGE_DETAIL_SAVED' );
		} else {
			$msg = JText::_ ( 'ERROR_SAVING_STOCKIMAGE_DETAIL' );
		}
	...
	function remove() 
	{
		...
		$msg = JText::_ ( 'STOCKIMAGE_DETAIL_DELETED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=stockimage',$msg );
	}
	...
	/*function publish() 
	{
		...
		$msg = JText::_ ( 'STOCKIMAGE_DETAIL_PUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=stockimage',$msg );
	}
	function unpublish() 
	{
		...
		$msg = JText::_ ( 'STOCKIMAGE_DETAIL_UNPUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=stockimage',$msg );
	}*/
	function cancel() 
	{
		$option = JRequest::getVar('option');
		$msg = JText::_ ( 'STOCKIMAGE_DETAIL_EDITING_CANCELLED' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=stockimage',$msg );
	}
}
?>