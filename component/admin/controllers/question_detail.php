...
class question_detailController extends JController
{
	...
	function save($send=0)
	{
		...
		if ($row)
		{
			$msg = JText::_ ( 'QUESTION_DETAIL_SAVED' );
		} else {
			$msg = JText::_ ( 'ERROR_SAVING_QUESTION_DETAIL' );
		}
	...
	function remove()
	{
		...
		$msg = JText::_ ( 'QUESTION_DETAIL_DELETED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=question',$msg );
	}
	...
	{
		$option = JRequest::getVar('option','','request','string');
		$msg = JText::_ ( 'QUESTION_DETAIL_EDITING_CANCELLED' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=question',$msg );
	}
	function publish() {
		...
		$msg = JText::_ ( 'QUESTION_DETAIL_PUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=question',$msg );
	}
	function unpublish() {
		...
		$msg = JText::_ ( 'QUESTION_DETAIL_UNPUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=question',$msg );
	}
	/**
	 * logic for orderup
