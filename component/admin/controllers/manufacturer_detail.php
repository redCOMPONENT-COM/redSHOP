...
class manufacturer_detailController extends JController {
	...
	function save($apply=0) {	
		...
		if ($row=$model->store ( $post )) {
			...
			$msg = JText::_ ( 'MANUFACTURER_DETAIL_SAVED' );
		
		} else {
			
			$msg = JText::_ ( 'ERROR_SAVING_MANUFACTURER_DETAIL' );
		}
	...
	function remove() {
		...
		$msg = JText::_ ( 'MANUFACTURER_DETAIL_DELETED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=manufacturer',$msg );
	}
	function publish() {
		...
		$msg = JText::_ ( 'MANUFACTURER_DETAIL_PUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=manufacturer',$msg );
	}
	function unpublish() {
		...
		$msg = JText::_ ( 'MANUFACTURER_DETAIL_UNPUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=manufacturer',$msg );
	}
	function cancel() {
		
		$option = JRequest::getVar ('option');
		$msg = JText::_ ( 'MANUFACTURER_DETAIL_EDITING_CANCELLED' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=manufacturer',$msg );
	}
	function copy(){
		...
		if ($model->copy($cid)) {
			...
			$msg = JText::_ ( 'MANUFACTURER_DETAIL_COPIED' );
		
		} else {
			
			$msg = JText::_ ( 'ERROR_COPING_MANUFACTURER_DETAIL' );
		}
