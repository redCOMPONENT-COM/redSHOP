...
class shopper_group_detailController extends JController 
{
	...
	function save($apply=0)
	{
		...
		if ($row) 
		{
			$msg = JText::_ ( 'SHOPPER_GROUP_DETAIL_SAVED' );
		} else {
			$msg = JText::_ ( 'ERROR_SAVING_SHOPPER_GROUP_DETAIL' );
		}
		if($apply == 1)
	...
	function remove() 
	{
		...
		if (! is_array ( $cid ) && ( $cid == 1 || $cid == 2 )  ){
			$msg = JText::_ ( 'DEFAULT_SHOPPER_GROUP_CAN_NOT_BE_DELETED' );
			...
			$msg = JText::_ ( 'SHOPPER_GROUP_DETAIL_DELETED_SUCCESSFULLY' );
		}
		$this->setRedirect ( 'index.php?option='.$option.'&view=shopper_group',$msg );
	}
	...
	function publish() 
	{
		...
		$msg = JText::_ ( 'SHOPPER_GROUP_DETAIL_PUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=shopper_group',$msg );
	}
	...
	function unpublish() 
	{
		...
		$msg = JText::_ ( 'SHOPPER_GROUP_DETAIL_UNPUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=shopper_group',$msg );
	}
	...
	{
		$option = JRequest::getVar ('option');
		$msg = JText::_ ( 'SHOPPER_GROUP_DETAIL_EDITING_CANCELLED' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=shopper_group',$msg );
	}
}?>