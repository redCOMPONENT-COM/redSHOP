...
class accountgroup_detailController extends JController
 {
	...
	{	
		...
		if ($row) 
		{
			$msg = JText::_ ( 'ACCOUNTGROUP_DETAIL_SAVED' );
		} 
		else 
		{
			$msg = JText::_ ( 'ERROR_SAVING_ACCOUNTGROUP_DETAIL' );
		}
		if ($apply==1)
		{
	...
	{
		$option = JRequest::getVar ('option');
		$msg = JText::_ ( 'ACCOUNTGROUP_DETAIL_EDITING_CANCELLED' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=accountgroup',$msg );
	}
	...
	{		
		...
		$msg = JText::_ ( 'ACCOUNTGROUP_DETAIL_DELETED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=accountgroup',$msg );
	}
	...
	function publish() 
	{
		...
		$msg = JText::_ ( 'ACCOUNTGROUP_DETAIL_PUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=accountgroup',$msg );
	}
	...
	function unpublish() 
	{
		...
		$msg = JText::_ ( 'ACCOUNTGROUP_DETAIL_UNPUBLISHED_SUCCESSFULLY' );
		$this->setRedirect ( 'index.php?option='.$option.'&view=accountgroup',$msg );
	}
}
?>