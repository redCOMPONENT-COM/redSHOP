...
class attributeprices_detailController extends JController {
	...
	{		
		...
		$this->setRedirect ( 'index3.php?option='.$option.'&view=attributeprices&section='.$section.'&section_id='.$section_id, $msg );
	}
	function remove() {
		...
		$msg = JText::_ ( 'ATTRIBUTE_PRICE_DETAIL_DELETED_SUCCESSFULLY' );
		$this->setRedirect ( 'index3.php?option='.$option.'&view=attributeprices&section='.$section.'&section_id='.$section_id,$msg );
	}
