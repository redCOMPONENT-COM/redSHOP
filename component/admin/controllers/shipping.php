...
class RedshopControllerShipping extends RedshopController
{
    public function importeconomic()
    {
        ...
        if (Redshop::getConfig()->get('ECONOMIC_INTEGRATION') == 1) {
            ...
            for ($i = 0, $in = count($shipping); $i < $in; $i++) {
                $shipping_nshortname = (strlen($shipping[$i]->name) > 15) ? substr(
                    $shipping[$i]->name,
                    0,
                    15
                ) : $shipping[$i]->name;
    ...
    public function publish()
    {
        ...
        $this->setRedirect(
            ...
            JText::_('COM_REDSHOP_SHIPPING_PUBLISHED_SUCCESSFULLY')
        );
    }
    ...
    public function unpublish()
    {
        ...
        $this->setRedirect(
            'index.php?option=com_redshop&view=shipping',
            JText::_('COM_REDSHOP_SHIPPING_UNPUBLISHED_SUCCESSFULLY')
        );
    }
