...
class catalog_detailController extends JController {
	...
	function save() {		
		...
		if ($model->store ( $post )) {
			...
			$msg = JText::_ ( 'CATALOG_DETAIL_SAVED' );
		
		} else {
			
			$msg = JText::_ ( 'ERROR_SAVING_CATALOG_DETAIL' );
		}
	...
	function remove() {
		...
		$msg = JText::_ ( 'CATALOG_DETAIL_DELETED_SUCCESSFULLY' );
	...
	function publish() {
		...
		$msg = JText::_ ( 'CATALOG_DETAIL_PUBLISHED_SUCCESFULLY' );
	...
	function unpublish() {
		...
		$msg = JText::_ ( 'CATALOG_DETAIL_UNPUBLISHED_SUCCESFULLY' );
	...
	function cancel() {
		...
		$option = JRequest::getVar ('option');
		$layout = JRequest::getVar ('layout');
		$msg = JText::_ ( 'CATALOG_DETAIL_EDITING_CANCELLED' );
