...
<table class="adminlist">		 
		<tr>		
			...
			<button onclick="this.form.getElementById('section').value='0';this.form.submit();"><?php echo JTEXT::_('RESET');?></button>
	...
	<thead>
		<tr>
			...
			<th width="5%" class="title">
				<input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo count( $this->textlibrarys ); ?>);" />
			</th >
			<th class="title"  width="30%">
				<?php echo JHTML::_('grid.sort', 'TAG_NAME', 'text_name', $this->lists['order_Dir'], $this->lists['order'] ); ?>				
			</th>					 
			<th width="50%">
				<?php echo JHTML::_('grid.sort','TEXT_DESCRIPTION', 'text_desc', $this->lists['order_Dir'], $this->lists['order']); ?>
			</th>
			<th width="50%">
			...
			<th width="5%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort', 'ID', 'textlibrary_id', $this->lists['order_Dir'], $this->lists['order'] ); ?>	
			</th>
	...
	for ($i=0, $n=count( $this->textlibrarys ); $i < $n; $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
			<a href="<?php echo $link; ?>" title="<?php echo JText::_( 'EDIT_TAG' ); ?>">{<?php echo $row->text_name; ?>}</a>
			</td>			
			<td>
