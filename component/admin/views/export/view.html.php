...
class exportViewexport extends JView
{
	...
	{	
		...
		$document->setTitle( JText::_('EXPORT') );
		
		JToolBarHelper::title(   JText::_( 'EXPORT_MANAGEMENT' ), 'redshop_export48' );
		
		JToolBarHelper :: custom( 'exportfile', 'redshop_export_export32.png' , JText::_('EXPORT') , JText::_('EXPORT'), false, false );
