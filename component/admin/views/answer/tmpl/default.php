...
<thead>
	<tr><th width="5%"><?php echo JText::_( 'NUM' ); ?></th>
		...
		<th class="title" width="50%">
			<?php echo JHTML::_('grid.sort', 'ANSWERS', 'question', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
...
<?php
	...
	<tr class="<?php echo "row$k"; ?>">
		...
		<td><a href="<?php echo $link; ?>" title="<?php echo JText::_( 'VIEW_ANSWER' ); ?>"><?php if(strlen($row->question)>50)
