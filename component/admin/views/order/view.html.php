...
class orderVieworder extends JView
{
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('ORDER') );
   		$model = $this->getModel('order');
   		$layout = JRequest::getVar('layout');

   		if($layout == 'labellisting'){
   		    JToolBarHelper::title(   JText::_( 'DOWNLOAD_LABEL' ), 'redshop_order48' );
   			$this->setLayout('labellisting');
   			JToolBarHelper::cancel('cancel', 'Close');
   		}else{
			JToolBarHelper::custom('multiprint_order','print_f2.png','print_f2.png',JText::_( 'MULTI_PRINT_ORDER_LBL' ),true);
            JToolBarHelper::title(   JText::_( 'ORDER_MANAGEMENT' ), 'redshop_order48' );
	   		JToolBarHelper::addNewX();
	   		JToolBarHelper::custom('allstatus','save.png','save_f2.png',JText::_( 'CHANGE_STATUS_TO_ALL_LBL' ),true);
	   		JToolBarHelper::custom('export_data','save.png','save_f2.png',JText::_( 'EXPORT_DATA_LBL' ),false);
	   		JToolBarHelper::custom('export_fullorder_data','save.png','save_f2.png',JText::_( 'EXPORT_FULL_DATA_LBL' ),false);
	   		if(JPluginHelper::isEnabled('rs_labels_GLS','labels_GLS'))
	   		{
					  JToolBarHelper::custom('gls_export','save.png','save_f2.png',JText::_( 'EXPORT_GLS_LBL' ),false);
					  JToolBarHelper::custom('business_gls_export','save.png','save_f2.png',JText::_( 'EXPORT_GLS_BUSINESS_LBL' ),false);
	   		}
