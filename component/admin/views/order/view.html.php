    ...
    public function display($tpl = null)
    {
        ...
        if ($layout == 'previewlog') {
            ...
            if (Redshop::getConfig()->get('POSTDK_INTEGRATION')) {
                RedshopToolbarHelper::modal(
                    'massOrderStatusPacsoft',
                    'fa fa-gears',
        ...
        $lists['filter_by'] = RedshopHelperOrder::getFilterByList(
            'filter_by',
            $filter_by,
            'class="inputbox" size="1" onchange="document.adminForm.submit();"'
        );

        $lists['filter_status']         = RedshopHelperOrder::getStatusList(
            'filter_status',
            $filter_status,
            'class="inputbox" size="1" onchange="document.adminForm.submit();"'
        );
