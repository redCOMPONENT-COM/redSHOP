...
<script language="javascript" type="text/javascript">
    ...
    Joomla.submitbutton = function (pressbutton) {
        ...
        switch (pressbutton) {
            ...
            case "remove":
                form.view.value = "order_detail";
                var r = confirm('<?php echo Text::_("COM_REDSHOP_ORDER_DELETE_ORDERS_CONFIRM") ?>');
        ...
        <div class="filterTool">
            <div class="filterItem">
                <div class="btn-wrapper input-append">
                    ...
                    <button class="btn" onclick="document.adminForm.submit();">
                        <?php echo Text::_(
                            'COM_REDSHOP_SEARCH'
                        ); ?>
                    </button>
            ...
            <div class="filterItem calendar-div">
                ...
                echo JHtml::_(
                    ...
                    array(
                        'size'        => '15',
                        'maxlength'   => '19',
                        'placeholder' => Text::_('COM_REDSHOP_FROM') . ' ' . Text::_('JDATE')
                    )
                );
                ?>
            </div>
            <div class="filterItem calendar-div">
                ...
                echo JHtml::_(
                    ...
                    array(
                        'size'        => '15',
                        'maxlength'   => '19',
                        'placeholder' => Text::_('COM_REDSHOP_TO') . ' ' . Text::_('JDATE')
                    )
                );
                ?>
            </div>
            <input name="search" class="btn" type="submit" id="search"
                value="<?php echo Text::_('COM_REDSHOP_GO'); ?>" />
            <div class="filterItem">
            ...
            <tr>
                ...
                <?php if (
                    ...
                    <th width="10%">
                        <?php echo JHTML::_(
                            'grid.sort',
                            'COM_REDSHOP_BOOKINVOICE_NUMBER',
                            'bookinvoice_number',
                ...
                <th width="20%">
                    <?php echo Text::_('COM_REDSHOP_ORDERS_CUSTOMER_NOTE') ?>
                </th>
                <th>
                ...
                <?php if (Redshop::getConfig()->get('USE_STOCKROOM') == 1): ?>
                    ...
                    <th width="10%">
                        <?php echo Text::_('COM_REDSHOP_STOCKROOM_DELIVERY_TIME'); ?>
                    </th>
                <?php endif; ?>
        ...
        <tbody>
            ...
            <?php for ($i = 0, $n = count($this->orders); $i < $n; $i++): ?>
                ...
                <tr class="row<?php echo $k; ?>">
                    ...
                    <td>
                        ...
                        <?php else: ?>
                            <span class="text-muted">
                                <?php echo Text::_('COM_REDSHOP_PRIVATE'); ?>
                            </span>
                        <?php endif; ?>
                    </td>
                    <td>
                    ...
                    <td>
                        <span class="label order_status_<?php echo strtolower(
                            $row->order_status
                        ) ?>">
                    ...
                    <td>
                        ...
                        <span class="<?php echo $paymentStatusClass ?>">
                            <?php if ($row->order_payment_status == 'Paid'): ?>
                                <?php echo Text::_('COM_REDSHOP_PAYMENT_STA_PAID') ?>
                            ...
                            <?php elseif ($row->order_payment_status == 'Partial Paid' || $row->order_payment_status == 'PartialPaid'): ?>
                                <?php echo Text::_('COM_REDSHOP_PAYMENT_STA_PARTIAL_PAID') ?>
                            <?php endif; ?>
                        </span>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-default" data-toggle="modal"
                            ...
                            <?php echo Text::_('COM_REDSHOP_UPDATE_STATUS_BUTTON') ?>
                        </button>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h3 class="modal-title" id="order_status_form_label_<?php echo $row->id ?>">
                                            <?php echo Text::_('COM_REDSHOP_ORDER') . ': ' . $row->id ?>
                                        </h3>
                                    </div>
                        ...
                        <?php if ($row->invoice_no != ''): ?>
                            <?php if ($row->is_booked == 0 && $row->bookinvoice_date <= 0): ?>
                                <?php if ($row->is_company == 1 && $row->ean_number != ""): ?>
                                    <?php echo Text::_('COM_REDSHOP_MANUALY_BOOK_INVOICE_FROM_ECONOMIC') ?>
                                <?php else: ?>
                                    <?php
                                    $confirm = 'if(confirm(\'' . Text::_(
                                    ...
                                    ?>
                                    <br />
                                    <input type="button" class="button" value="<?php echo Text::_("COM_REDSHOP_BOOK_INVOICE"); ?>"
                    ...
                    if (Redshop::getConfig()->get('POSTDK_INTEGRATION')) {
                        ...
                        if ($allowPacsoftLabel) {
                            ...
                            if ($row->order_label_create) {
                                echo Text::_("COM_REDSHOP_XML_ALREADY_GENERATED");
                            } else {
                                echo JHtml::_(
                                    'redshopcalendar.calendar',
                                    date($calendarFormat),
                                ...
                                ?>
                                <input type="button" class="button" value="<?php echo Text::_('COM_REDSHOP_CREATE_LABEL'); ?>" onclick="javascript:document.parcelFrm.order_id.value='<?php echo $row->order_id; ?>';
                            ...
                            echo '<td>' . Text::_('COM_REDSHOP_NO_PACSOFT_LABEL') . '</td>';
                        }
                    }
                    ?>
                </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="massOrderStatusChangelabel">
                    <?php echo Text::_(
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="control-label col-md-12">
                                <?php echo Text::_('COM_REDSHOP_ORDER') ?>:
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                $massChangePaymentStatus[] = JHtml::_(
                                    'select.option',
                                    'Paid',
                                    Text::_('COM_REDSHOP_PAYMENT_STA_PAID')
                                );
                                $massChangePaymentStatus[] = JHtml::_(
                                    'select.option',
                                    'Unpaid',
                                    Text::_('COM_REDSHOP_PAYMENT_STA_UNPAID')
                                );
                                $massChangePaymentStatus[] = JHtml::_(
                                    'select.option',
                                    'Partial Paid',
                                    Text::_('COM_REDSHOP_PAYMENT_STA_PARTIAL_PAID')
                                );
                                echo JHtml::_(
                                    'select.genericlist',
            ...
            <div class="modal-footer text-center">
                ...
                <button type="button" class="btn btn-primary" onclick="massStatusChange('allStatusExceptPacsoft');">
                    <?php echo Text::_('COM_REDSHOP_APPLY'); ?>
                </button>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title" id="massOrderStatusPacsoftLabel">
                        <?php echo Text::_('COM_REDSHOP_CHANGE_STATUS_TO_ALL_WITH_PACSOFT_LBL') ?>
                    </h3>
                </div>
                <div class="modal-body form-vertical">
                    <div class="container-fluid">
