...
<script language="javascript" type="text/javascript">
    jQuery(document).ready(function ($) {
        ...
        $("#massOrderStatusChange").on('shown.bs.modal', function(event){
            console.log(event);
            var checks = [];
            var checked = $("input[type='checkbox'][id^='cb'][name^='cid']:checked");
            console.log(checked.length);

            if (!$("table.adminlist input[type='checkbox'][id^='cb'][name^='cid']:checked").length) {
                return false;
            } else {
                $("table.adminlist input[type='checkbox'][id^='cb'][name^='cid']:checked").each(function(index, item){
...
<div class="modal" id="massOrderStatusChange" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title"><?php echo JText::_('COM_REDSHOP_MASS_CHANGE_STATUS_ORDER') ?></h3>
            </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
			                ...
			                echo JHtml::_(
				                'select.genericlist', $massChangePaymentStatus, 'mass_change_payment_status', ' class="form-control" size="1" ', 'value', 'text', ''
			                );
			                ?>
                        </div>
                    </div>
