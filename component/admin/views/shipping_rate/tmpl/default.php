...
$bool = true;
$shippname = JText::_('SHIPPING_RATE_NAME');
if($this->shipper_location) { 
	// FOR SELF PICKUP
	$bool = false;
	$shippname = JText::_('SHIPPING_LOCATION');
}
?>
...
<thead>
	<tr>
		...
		<th width="5%">
			<input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo count( $this->shipping_rates ); ?>);" />
		</th>
		<th class="title">
	...
	<?php if($bool) { ?>
		<th class="title">
			<?php echo JHTML::_('grid.sort', 'SHIPPING_RATE_VALUE', 'shipping_rate_value ', $this->lists['order_Dir'], $this->lists['order'] ); ?>
		</th>
	<?php }	?>	
  		<th width="5%" nowrap="nowrap">
			<?php echo JHTML::_('grid.sort', 'ID', 'shipping_rate_id', $this->lists['order_Dir'], $this->lists['order'] ); ?>
		</th>
	</tr>
</thead>
<?php
...
//	$row->id = $row->shipping_rate_id;
	...
	<tr class="<?php echo "row$k"; ?>">
		...
		<td><a href="<?php echo $link; ?>" title="<?php echo JText::_( 'EDIT_SHIPPING' ); ?>"><?php echo $row->shipping_rate_name ; ?></a></td>
		<?php if($bool) { ?>	
