...
<form action="<?php echo Redshop\IO\Route::_($this->requestUrl) ?>" method="post" name="adminForm" id="adminForm">
    <div class="col50">
            ...
            <table class="admintable table">
                <tr>
                    <td valign="top" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_ACCOUNTGROUP_NAME'); ?>
                    </td>
                ...
                <tr>
                    <td valign="top" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_ECONOMIC_VAT_ACCOUNT_NUMBER'); ?>:
                    </td>
                ...
                <tr>
                    <td valign="top" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_ECONOMIC_NON_VAT_ACCOUNT_NUMBER'); ?>:
                    </td>
                ...
                <tr>
                    <td valign="top" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_ECONOMIC_DISCOUNT_PRODUCT_NUMBER_LBL'); ?>:
                    </td>
                ...
                <tr>
                    <td valign="top" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_ECONOMIC_DISCOUNT_VAT_ACCOUNT'); ?>:
                    </td>
                ...
                <tr>
                    <td valign="top" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_ECONOMIC_DISCOUNT_NONVAT_ACCOUNT'); ?>:
                    </td>
                ...
                <tr>
                    <td valign="top" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_ECONOMIC_SHIPPING_VAT_ACCOUNT'); ?>:
                    </td>
                ...
                <tr>
                    <td valign="top" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_ECONOMIC_SHIPPING_NONVAT_ACCOUNT'); ?>:
                    </td>
