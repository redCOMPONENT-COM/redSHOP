...
<form action="<?php echo JRoute::_($this->requestUrl) ?>" method="post" name="adminForm" id="adminForm"
                ...
                <tr>
                    ...
                    <td><input class="text_area" type="text" name="wrapper_name" id="wrapper_name" size="32"
                        ...
                        <?php echo JHTML::tooltip(
                            JText::_('COM_REDSHOP_TOOLTIP_WRAPPER_NAME'),
                            JText::_('COM_REDSHOP_WRAPPER_NAME'),
                            'tooltip.png',
                            '',
                            '',
                            false
                ...
                <tr>
                    ...
                    <td><input class="text_area" type="text" name="wrapper_price" id="wrapper_price" size="10"
                               ...
                               value="<?php echo RedshopHelperProduct::redpriceDecimal(
                                   $this->detail->wrapper_price
                               ); ?>"/>
                        <?php echo JHTML::tooltip(
                            JText::_('COM_REDSHOP_TOOLTIP_WRAPPER_PRICE'),
                            JText::_('COM_REDSHOP_WRAPPER_PRICE'),
                            'tooltip.png',
                            '',
                            '',
                            false
    ...
    <input type="hidden" name="old_thumb_image" id="old_thumb_image"
           value="<?php echo $this->detail->wrapper_image; ?>">
</form>
