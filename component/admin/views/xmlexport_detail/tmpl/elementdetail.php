...
<script language="javascript" type="text/javascript">
    Joomla.submitbutton = function (pressbutton) {
        ...
        if (form.element_name.value == "") {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_XMLEXPORT_CHILD_ELEMENT_NAME', true); ?>");
        } else {
        ...
        <table class="admintable table">
            <tr>
                <td width="100" align="right" class="key">
                    <?php echo Text::_('COM_REDSHOP_XMLEXPORT_ELEMENT_NAME'); ?>
                    :
                </td>
            ...
            <tr>
                <th>
                    <?php echo Text::_('COM_REDSHOP_FIELD_NAME'); ?>
                </th>
                <th>
                    <?php echo Text::_('COM_REDSHOP_XMLEXPORT_FILE_TAG_NAME'); ?>
                </th>
            </tr>
