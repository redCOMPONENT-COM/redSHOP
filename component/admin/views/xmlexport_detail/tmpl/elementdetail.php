...
{	
	...
	if (form.element_name.value == ""){
		alert( "<?php echo JText::_( 'PLEASE_ENTER_XMLEXPORT_CHILD_ELEMENT_NAME', true ); ?>" );
	} else {
...
<div class="col50">
	...
	<tr><td width="100" align="right" class="key"><?php echo JText::_( 'XMLEXPORT_ELEMENT_NAME' ); ?>:</td>
...
<?php 	}	?>
	<tr><td width="100" align="right" class="key">&nbsp;</td>
		<td><input type="submit" name="btnsubmit" id="btnsubmit" value="<?php echo JText::_('SAVE');?>" /></td></tr>
	</table>
</div>
