...
<script language="javascript" type="text/javascript">
    ...
    Joomla.submitbutton = function (pressbutton) {
        ...
        if (form.display_filename.value == "") {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_XMLEXPORT_FILE_NAME', true); ?>");
        } else if (form.parent_name.value == "") {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_XMLEXPORT_PARENT_NAME', true); ?>");
...
<form action="<?php echo Redshop\IO\Route::_($this->request_url) ?>" method="post" name="adminForm" id="adminForm"
            ...
            <table class="admintable table">
                <tr>
                    <td width="100" align="right"
                        class="key"><?php echo Text::_('COM_REDSHOP_XMLEXPORT_DISPLAY_FILENAME'); ?>:
                    </td>
                ...
                <tr>
                    <td width="100" align="right"
                        class="key"><?php echo Text::_('COM_REDSHOP_XMLEXPORT_PARENT_NAME'); ?>:
                    </td>
                ...
                <tr>
                    ...
                    <td><?php if ($this->detail->filename != "") {
                            echo '<a href="' . JURI::root(
                                ) . 'index.php?option=com_redshop&view=category&tmpl=component&task=download&file=' . $this->detail->filename . '" target="_black">' . JURI::root(
                                ) . 'index.php?option=com_redshop&view=category&tmpl=component&task=download&file=' . $this->detail->filename . '</a>';
                        } ?>
                        <input type="hidden" name="filename" value="<?php echo $this->detail->filename; ?>"/></td>
                </tr>
                <tr>
                    <td width="100" align="right"
                        class="key"><?php echo Text::_('COM_REDSHOP_AUTOGENERATE_XMLFILE'); ?>:
                    </td>
                    <td><?php echo '<a href="' . JURI::root(
                            ) . 'index.php?option=com_redshop&view=category&tmpl=component&task=generateXMLExportFile&xmlexport_id=' . $this->detail->xmlexport_id . '" target="_black">' . JURI::root(
                            ) . 'index.php?option=com_redshop&view=category&tmpl=component&task=generateXMLExportFile&xmlexport_id=' . $this->detail->xmlexport_id . '</a>'; ?></td>
                </tr>
            </table>
        </fieldset>
    </div>
    <div class="col50">
        <fieldset>
            <legend><?php echo Text::_('COM_REDSHOP_XMLEXPORT_ACCESS'); ?></legend>
            <table class="admintable" width="100%" id="tblaccessIp">
                <tr>
                    <td width="100" align="right" class="key"><?php echo Text::_('COM_REDSHOP_USE_TO_ALL_USERS'); ?>:
                    </td>
                    <td><?php echo $this->lists['use_to_all_users']; ?></td>
                </tr>
                <tr>
                    <td colspan="2" align="right"><a
                                href="javascript:addNewRow('tblaccessIp');"><?php echo Text::_(
                                'COM_REDSHOP_ADD'
                            ); ?></a>
                    </td>
                </tr>
                ...
                if (count($this->iparray) > 0) {
                    for ($i = 0; $i < count($this->iparray); $i++) {
                        ?>
                        <tr>
                            <td width="100"><?php echo Text::_('COM_REDSHOP_IP_OR_URL_TO_ACCESS'); ?>:</td>
    ...
    <div class="col50" id="adminresult">
        <fieldset>
            ...
            <table class="admintable" id="tblOrderType" style="display: <?php echo $orderstyle; ?>;">
                <tr>
                    <td><?php echo Text::_('COM_REDSHOP_ADD_ORDER_DETAIL'); ?></td>
                    <td><a class="joom-box"
                           ...
                           rel="{handler: 'iframe', size: {x: 750, y: 500}}">
                            <img src="<?php echo REDSHOP_MEDIA_IMAGES_ABSPATH . 'add.jpg'; ?>"
                                 title="<?php echo Text::_('COM_REDSHOP_ADD_ORDER_DETAIL'); ?>"
                                 alt="<?php echo Text::_('COM_REDSHOP_ADD_ORDER_DETAIL'); ?>">
                        </a></td>
                </tr>
                <tr>
                    <td><?php echo Text::_('COM_REDSHOP_ADD_ORDER_USER_BILLING_INFORMATION'); ?></td>
                    <td><a class="joom-box"
                           ...
                           rel="{handler: 'iframe', size: {x: 750, y: 500}}">
                            <img src="<?php echo REDSHOP_MEDIA_IMAGES_ABSPATH . 'add.jpg'; ?>"
                                 title="<?php echo Text::_('COM_REDSHOP_ADD_ORDER_USER_BILLING_INFORMATION'); ?>"
                                 alt="<?php echo Text::_('COM_REDSHOP_ADD_ORDER_USER_BILLING_INFORMATION'); ?>">
                        </a></td>
                </tr>
                <tr>
                    <td><?php echo Text::_('COM_REDSHOP_ADD_ORDER_USER_SHIPPING_INFORMATION'); ?></td>
                    <td><a class="joom-box"
                           ...
                           rel="{handler: 'iframe', size: {x: 750, y: 500}}">
                            <img src="<?php echo REDSHOP_MEDIA_IMAGES_ABSPATH . 'add.jpg'; ?>"
                                 title="<?php echo Text::_('COM_REDSHOP_ADD_ORDER_USER_SHIPPING_INFORMATION'); ?>"
                                 alt="<?php echo Text::_('COM_REDSHOP_ADD_ORDER_USER_SHIPPING_INFORMATION'); ?>">
                        </a></td>
                </tr>
                <tr>
                    <td><?php echo Text::_('COM_REDSHOP_ADD_ORDERITEMDETAIL'); ?></td>
                    <td><a class="joom-box"
                           ...
                           rel="{handler: 'iframe', size: {x: 750, y: 500}}">
                            <img src="<?php echo REDSHOP_MEDIA_IMAGES_ABSPATH . 'add.jpg'; ?>"
                                 title="<?php echo Text::_('COM_REDSHOP_ADD_ORDERITEMDETAIL'); ?>"
                                 alt="<?php echo Text::_('COM_REDSHOP_ADD_ORDERITEMDETAIL'); ?>">
                        </a></td>
                </tr>
            </table>
            ...
            <table class="admintable" id="tblProductType" style="display: <?php echo $productstyle; ?>;">
                <tr>
                    <td><?php echo Text::_('COM_REDSHOP_CATEGORY_FILTER'); ?></td>
                    <td><?php echo $this->lists['xmlexport_on_category']; ?></td>
                </tr>
                <tr>
                    <td><?php echo Text::_('COM_REDSHOP_ADD_PRODUCT_DETAIL'); ?></td>
                    <td><a class="joom-box"
                           ...
                           rel="{handler: 'iframe', size: {x: 750, y: 500}}">
                            <img src="<?php echo REDSHOP_MEDIA_IMAGES_ABSPATH . 'add.jpg'; ?>"
                                 title="<?php echo Text::_('COM_REDSHOP_ADD_PRODUCT_DETAIL'); ?>"
                                 alt="<?php echo Text::_('COM_REDSHOP_ADD_PRODUCT_DETAIL'); ?>">
                        </a></td>
                </tr>
                <tr>
                    <td><?php echo Text::_('COM_REDSHOP_ADD_PRODUCT_STOCK_DETAIL'); ?></td>
                    <td><a class="joom-box"
                           ...
                           rel="{handler: 'iframe', size: {x: 750, y: 500}}">
                            <img src="<?php echo REDSHOP_MEDIA_IMAGES_ABSPATH . 'add.jpg'; ?>"
                                 title="<?php echo Text::_('COM_REDSHOP_ADD_PRODUCT_STOCK_DETAIL'); ?>"
                                 alt="<?php echo Text::_('COM_REDSHOP_ADD_PRODUCT_STOCK_DETAIL'); ?>">
                        </a></td>
                </tr>
                <tr>
                    <td><?php echo Text::_('COM_REDSHOP_ADD_PRODUCT_FIELD_DETAIL'); ?></td>
                    <td><a class="joom-box"
                           ...
                           rel="{handler: 'iframe', size: {x: 750, y: 500}}">
                            <img src="<?php echo REDSHOP_MEDIA_IMAGES_ABSPATH . 'add.jpg'; ?>"
                                 title="<?php echo Text::_('COM_REDSHOP_ADD_PRODUCT_FIELD_DETAIL'); ?>"
                                 alt="<?php echo Text::_('COM_REDSHOP_ADD_PRODUCT_FIELD_DETAIL'); ?>">
                        </a></td>
                </tr>
                <?php /*?>
    <tr><th><?php echo Text::_('COM_REDSHOP_FIELD_NAME' ); ?></th><th><?php echo Text::_('COM_REDSHOP_XMLEXPORT_FILE_TAG_NAME' ); ?></th></tr>
...
<?php 	}*/ ?>
    ...
    <input type="hidden" name="tdIPText" id="tdIPText"
           value="<?php echo Text::_('COM_REDSHOP_IP_OR_URL_TO_ACCESS'); ?>">
