...
class xmlexport_detailVIEWxmlexport_detail extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(JText::_( 'XML_EXPORT_MANAGEMENT' ).': <small><small>[ '.$text.' ]</small></small>', 'redshop_export48' );
		JToolBarHelper::custom( 'xmlexport','redshop_export32.png',JText::_('XML_EXPORT') , JText::_('XML_EXPORT'), false, false);
		JToolBarHelper::save();
		if ($isNew)  {
