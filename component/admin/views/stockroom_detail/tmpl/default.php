                ...
                <tr>
                    ...
                    <td>
                        <input class="text_area" type="number" name="min_stock_amount" id="min_stock_amount" size="32"
                               min="0"
                               maxlength="250" oninput="validity.valid || (value='');"
                               value="<?php echo $this->detail->min_stock_amount; ?>"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo JHTML::tooltip(
                            JText::_('COM_REDSHOP_TOOLTIP_MINIMUM_DELIVERY_TIME'),
                            JText::_('COM_REDSHOP_MINIMUM_DELIVERY_TIME'),
                            'tooltip.png',
                            '',
                            '',
                            false
                ...
                <tr>
                    ...
                    <td>
                        <input class="text_area" type="number" name="max_del_time" id="max_del_time" min="0"
                               ...
                               oninput="validity.valid || (value='');"/>
                        <?php echo JHTML::tooltip(
                            JText::_('COM_REDSHOP_TOOLTIP_MAXIMUM_DELIVERY_TIME'),
                            JText::_('COM_REDSHOP_MAXIMUM_DELIVERY_TIME'),
                            'tooltip.png',
                            '',
                            '',
                            false
