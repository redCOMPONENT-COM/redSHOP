...
function sendrsImportStock(cnt)
{
	...
	{
		alert("<?php echo JText::_('SELECT_STOCKROOM_NAME');?>");
		return false;
	}
}
</script>
...
<div class="col50">
	<fieldset class="adminform">
		...
		<tr><td valign="top" align="right" class="key"><?php echo JText::_('STOCKROOM_NAME');?></td><td><?php echo $this->lists['stockroom_id'];?>&nbsp;&nbsp;&nbsp;<input type="button" value="<?php echo JText::_('IMPORT');?>" onclick="sendrsImportStock(0);" /></td></tr>
	</table>
	</fieldset>	
	<fieldset class="adminform">
		<legend><?php echo JText::_( 'IMPORT_LOG' ); ?></legend>
		<table class="admintable">
		<tr><td><div id="divpreviewlog"></div></td></tr>
		<tr><td><div id="divLoading" style="display: none;"><img src="components/com_redshop/assets/images/preloader.gif" ></div></td></tr>
	</table>
	</fieldset>
</div>
