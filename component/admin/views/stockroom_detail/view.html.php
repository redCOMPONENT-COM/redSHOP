    ...
    public function display($tpl = null)
    {
        ...
        if ($layout == 'importstock') {
            ...
            JToolBarHelper::title(
                JText::_('COM_REDSHOP_STOCKROOM') . ': <small><small>[ ' . $text . ' ]</small></small>',
                'redshop_stockroom48'
            );
            ...
            $lists['show_in_front'] = JHtml::_(
                'select.booleanlist',
                'show_in_front',
                'class="inputbox"',
                $detail->show_in_front
            );
            ...
            $booleanlist = RedshopHelperExtrafields::booleanList(
                'delivery_time',
                'class="inputbox"',
                $detail->delivery_time,
                JText::_('COM_REDSHOP_DAYS'),
                JText::_('COM_REDSHOP_WEEKS')
            );
