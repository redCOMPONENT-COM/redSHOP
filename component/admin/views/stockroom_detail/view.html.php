...
class stockroom_detailVIEWstockroom_detail extends JView
{
	function display($tpl = null)
	{
		...
		if($layout=='importstock')
		{
			...
			JToolBarHelper::title(   JText::_( 'IMPORT_STOCK_FROM_ECONOMIC' ) , 'redshop_stockroom48'  );
		...
		else
		{
			...
			JToolBarHelper::title(   JText::_( 'STOCKROOM' ).': <small><small>[ ' . $text.' ]</small></small>' , 'redshop_stockroom48'  );
			...
			$booleanlist = $extra_field->booleanlist('delivery_time',  'class="inputbox"', $detail->delivery_time ,$yes=JText::_('DAYS'),$no=JText::_('WEEKS'));
