...
//		if(!$shipping)
//		{
			JToolBarHelper::title ( JText::_ ( 'USER_MANAGEMENT' ), 'redshop_user48' );
//		}
//		else
//		{
//			JToolBarHelper::title ( JText::_ ( 'USER_SHIPPING_DETAIL' ), 'redshop_user48' );
//		}
...
//	 	$lists ['shipping'] = $shipping;
		...
		$optiontax_req = array();		
		$optiontax_req[]   	= JHTML::_('select.option', 'select',JText::_('SELECT'));
		$optiontax_req[]   	= JHTML::_('select.option', '1', JText::_('yes'));
		$optiontax_req[]   	= JHTML::_('select.option', '0', JText::_('no'));
