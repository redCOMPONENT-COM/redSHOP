...
class shopper_group_detailVIEWshopper_group_detail extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'SHOPPER_GROUP_MANAGEMENT_DETAIL' ), 'redshop_manufact48' );
		...
		JToolBarHelper::title(   JText::_( 'SHOPPER_GROUP' ).': <small><small>[ ' . $text.' ]</small></small>' , 'redshop_manufact48' );
		...
		$optioncustomer[]   	= JHTML::_('select.option', '-1',JText::_('SELECT'));
		$optioncustomer[]   	= JHTML::_('select.option', '0', JText::_('COMPANY'));
		$optioncustomer[]   	= JHTML::_('select.option', '1', JText::_('PRIVATE'));
...
//		$lists['apply_product_price_vat'] = JHTML::_('select.booleanlist','apply_product_price_vat', 'class="inputbox"', $detail->apply_product_price_vat );
		...
		//$shoppergrp_type = array (JHTML::_('select.option','', JText::_('SELECT')),JHTML::_('select.option','B2B customers',JText::_('B2B_CUSTOMERS')), JHTML::_('select.option','Large business',JText::_('B2B_LARGE_BUSINESS')), JHTML::_('select.option','Small business',JText::_('B2B_SMALL_BUSINESS')),  JHTML::_('select.option','B2C customers',JText::_('B2C_CUSTOMERS')), JHTML::_('select.option','Local customers',JText::_('B2C_LOCAL_CUSTOMERS')), JHTML::_('select.option','International customers',JText::_('B2C_INTERNATIONAL_CUSTOMERS')) );
