...
$td_style = ($this->item->product_download_infinite == 0) ? 'style="display:table-row;"' : 'style="display:none;"';

$optionPeriod = array();
?>

<?php // Subscription
$subscription        = $this->producthelper->getSubscription($this->item->product_id);
...
<div class="row">
    <div class="col-sm-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
				<?php if (($this->item->product_type == 'file') || ($this->item->product_download == 1)) : ?>
                    <div id="div_file">
                            ...
                            <tr>
                                ...
                                <td>
									...
									echo JHtml::_('select.booleanlist',
										...
										$this->item->product_download_infinite
									);
									?>
                                </td>
                            </tr>
                            ...
                            <tr id="download_limit" <?php echo $td_style; ?> >
                                ...
                                <td>
                                    <input type="text"
                                           ...
                                           class="input"
                                           size="10"
                                           value="<?php echo $this->item->product_download_limit; ?>"
                                    />
                                </td>
                            </tr>
                            ...
                            <tr id="download_days" <?php echo $td_style; ?> >
                                ...
                                <td>
                                    <input type="text"
                                           ...
                                           class="input"
                                           size="10"
                                           value="<?php echo $this->item->product_download_days; ?>"
                                    />
                                </td>
                            </tr>
                            ...
                            <tr id="download_clock" <?php echo $td_style; ?> >
                                ...
                                <td>
                                    <input type="text"
                                           ...
                                           size="2"
                                           maxlength="2"
                                           value="<?php echo $this->item->product_download_clock; ?>"
                                    />
                                    <input type="text"
                                           name="product_download_clock_min"
                                           class="input" size="2"
                                           maxlength="2"
                                           value="<?php echo $this->item->product_download_clock_min; ?>"
                                    />
                                </td>
                            </tr>
						...
						<?php if ($total_serial > 0) : ?>
                            <table class="adminlist table table-striped">
								...
								for ($si = 0; $si < $total_serial; $si++)
								{
                                    ...
                                    <tr>
                                        <td>
                                            <a href='index.php?option=com_redshop&view=product_detail&task=deleteProdcutSerialNumbers&serial_id=<?php echo $serial_row->serial_id ?>&product_id=<?php echo $this->item->product_id; ?>'><img
                                                        class="delete_item"
				...
				<?php elseif ($this->item->product_type == 'subscription') : ?>
                    <div id="div_subscription">
                        ...
                        <table id="tbl_scbscription" class="adminlist">
                            ...
                            <tr>
                                <td colspan="4">
                                    <input type="button" value="<?php echo JText::_('COM_REDSHOP_ADD'); ?>"
