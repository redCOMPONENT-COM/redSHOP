						...
						<?php if ($total_serial > 0) : ?>
                            <table class="adminlist table table-striped">
								...
								for ($si = 0; $si < $total_serial; $si++)
								{
                                    ...
                                    <tr>
                                        <td>
                                            <a href='index.php?option=com_redshop&view=product&task=deleteProdcutSerialNumbers&serial_id=<?php echo $serial_row->serial_id ?>&product_id=<?php echo $this->item->product_id; ?>'><img
                                                        class="delete_item"
