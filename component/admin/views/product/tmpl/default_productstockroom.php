                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="button"
                                       ...
                                       onclick="location.href = 'index.php?option=com_redshop&view=product&task=ResetPreorderStock&stockroom_type=product&product_id=<?php echo $this->item->product_id ?>&stockroom_id=<?php echo $s->stockroom_id ?>' ; ">
