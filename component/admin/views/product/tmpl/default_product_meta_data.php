            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="pageheading" id="pageheading" size="75"
                           value="<?php echo $this->item->pageheading; ?>"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="sef_url" id="sef_url" size="75"
                           value="<?php echo $this->item->sef_url; ?>"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input
                            ...
                            id="canonical_url"
                            size="75"
                            value="<?php echo isset($this->item->canonical_url) ? $this->item->canonical_url : ""; ?>"
                    />
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <textarea class="text_area" name="metakey" id="metakey" rows="4"
                              cols="40"><?php echo $this->item->metakey; ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="text_area" name="metadesc" id="metadesc" rows="4"
                              cols="40"><?php echo htmlspecialchars($this->item->metadesc); ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="text_area"
                              ...
                              rows="4"
                              cols="40"><?php echo $this->item->metalanguage_setting; ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="text_area" name="metarobot_info" id="metarobot_info" rows="4"
                              cols="40"><?php echo $this->item->metarobot_info; ?></textarea>
                </div>
            </div>
        </div>
    </div>
