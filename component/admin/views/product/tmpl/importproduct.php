...
{
	setTimeout('sendProductToEconomic(0)', 1000);
}
function sendProductToEconomic(cnt)
{
		...
		if(xmlhttp.readyState == 4)
		{
			if(document.getElementById('divpreviewlog'))
			{
				...
				if(totalusers!=0)
				{
					...
					cnt = parseInt(cnt) + 10;
					setTimeout('sendProductToEconomic('+cnt+')', 1000);
				} else {
					document.getElementById('divpreviewlog').innerHTML += newlog;
				}
			}
...
<div id="editcell">
<fieldset>
	<legend><?php echo JText::_('IMPORT_PRODUCT_TO_ECONOMIC_LOG');?></legend>
	<table class="admintable" cellpadding="3" cellspacing="0" border="0">
		<tr><td><div id="divpreviewlog"></div></td></tr>
		<tr><td><div id="divLoading"><img src="components/com_redshop/assets/images/preloader.gif" ></div></td></tr>
	</table>
</fieldset>
</div>
