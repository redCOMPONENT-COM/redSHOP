...
<tr>
	<td>
		<form action="<?php echo 'index.php?option=com_redshop&view=product&amp;task=element&amp;tmpl=component&amp;object='.JRequest::getVar('object'); ?>" method="post" name="adminForm2" >
...
<form action="<?php echo 'index.php?option='.$option.'&amp;view=product&amp;task=element&amp;tmpl=component&amp;object='.JRequest::getVar('object'); ?>" method="post" name="adminForm" >
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th class="title">
		 	...
		 	<th>
				<?php echo JHTML::_('grid.sort',  'NUMBER_OF_VIEWS', 'visited', $this->lists['order_Dir'], $this->lists['order'] ); ?>
		 	</th>
			...
			<th width="5%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort', 'ID', 'product_id', $this->lists['order_Dir'], $this->lists['order'] ); ?>	
			</th>			
		</tr>
	</thead>
	<?php
	...
	for ($i=0, $n=count( $this->products ); $i < $n; $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>			
			<a style="cursor: pointer;" onclick="window.parent.jSelectProduct('<?php echo $row->product_id; ?>', '<?php echo str_replace(array("'", "\""), array("\\'", ""),$row->product_name); ?>', '<?php echo JRequest::getVar('object'); ?>');">
