        ...
        <div class="filterTool">
            ...
            <div class="filterItem">
                <select id="search_field" name="search_field" onchange="javascript:document.adminForm.submit();">
                    ...
                    <option
                            value="c.name" <?php if ($this->search_field == 'c.category_name') {
                        echo "selected='selected'";
                    } ?>>
                    ...
                    <option
                            value="p.name_number" <?php if ($this->search_field == 'p.name_number') {
                        echo "selected='selected'";
                    } ?>
                    ...
                    <option
                            value="pa.property_number" <?php if ($this->search_field == 'pa.property_number') {
                        echo "selected='selected'";
                    } ?>>
                            ...
                            if (isset($product->children)) {
                                ...
                                if ($product->product_parent_id == 0) {
                                    ...
                                    <a href="<?php echo $link; ?>"
                                       title="<?php echo JText::_(
                                           'COM_REDSHOP_EDIT_PRODUCT'
                                       ); ?>"><?php echo $product->treename; ?> </a>[child: <?php echo $pro_array->product_name; ?>]
                                    <?php
                                }
                            }
                        } else {
