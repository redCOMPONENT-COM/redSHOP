...
$canEdit = $user->authorise('product.edit', 'backend');
?>
        ...
        <table class="adminlist table table-striped">
			...
			for ($i = 0, $n = count($this->products); $i < $n; $i++)
			{
                ...
                <tr class="<?php echo "row$k"; ?>">
                    ...
                    <td>
						<?php if (!$canEdit): ?>
							<?php if (!$row->product_parent_id): ?>
								<?php echo $row->treename ?>
							<?php else: ?>
								<?php $parentProducts = Redshop::product((int) $row->product_parent_id); ?>
								<?php echo $row->treename; ?> </a>[child: <?php echo $parentProducts->product_name ?>]
							<?php endif; ?>
						<?php else: ?>
							<?php
                    ...
                    <td align="center" width="8%">
						<?php if ($user->authorise('product.edit', 'backend')): ?>
