                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="button" class="btn btn-small"
                                           ...
                                           onclick="location.href = 'index.php?option=com_redshop&view=product&task=ResetPreorderStockBank&stockroom_type=<?php echo $section ?>&section_id=<?php echo $section_id ?>&cid=<?php echo $cid ?>&product_id=<?php echo $this->item->product_id ?>&stockroom_id=<?php echo $s->stockroom_id ?>' ; "
                                    />
                                </td>
                                <td>
