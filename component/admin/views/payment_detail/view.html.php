...
class payment_detailViewpayment_detail extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'TEMPLATES_MANAGEMET' ), 'redshop_payment48' );
		
		JSubMenuHelper::addEntry( JText::_( 'REDSHOP' ), 'index.php?option=com_redshop', true);
		
   		JSubMenuHelper::addEntry( JText::_( 'FIELDS' ), 'index.php?option=com_redshop&view=fields');
   		
   		JSubMenuHelper::addEntry( JText::_( 'PRODUCTS' ), 'index.php?option=com_redshop&view=product');
   		
   		JSubMenuHelper::addEntry( JText::_( 'CATEGORIES' ), 'index.php?option=com_redshop&view=category');
   		
   		JSubMenuHelper::addEntry( JText::_( 'CONTAINER' ), 'index.php?option=com_redshop&view=container');
   		
   		JSubMenuHelper::addEntry( JText::_( 'STOCKROOM' ), 'index.php?option=com_redshop&view=stockroom');
   		
   		JSubMenuHelper::addEntry( JText::_( 'USER' ), 'index.php?option=com_redshop&view=user');
   		
   		JSubMenuHelper::addEntry( JText::_( 'ORDER' ), 'index.php?option=com_redshop&view=order');
   		
   		JSubMenuHelper::addEntry( JText::_( 'PAYMENT' ), 'index.php?option=com_redshop&view=payment');
   		
   		JSubMenuHelper::addEntry( JText::_( 'SHIPPING' ), 'index.php?option=com_redshop&view=shipping');
   		
        JSubMenuHelper::addEntry( JText::_( 'TEMPLATES' ), 'index.php?option=com_redshop&view=template');
		...
		JToolBarHelper::title(   JText::_( 'PAYMENTS' ).': <small><small>[ ' . $text.' ]</small></small>' , 'redshop_payment48' );
		...
		if ($isNew)  {
	        ...
	        include_once ($paymentcfg);
	 	   	...
	 	   	$myparams = new JParameter($detail->params,$paymentxml);  
