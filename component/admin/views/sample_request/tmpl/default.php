...
<div id="editcell">	 
	...
	<thead>
		<tr>
			...
			<th>
			<?php echo JText::_( 'SAMPLE_DETAIL' ); ?>
			</th>
			<th>
	...
	for ($i=0, $n=count( $this->catalog ); $i < $n; $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
			<a class="modal" href="index3.php?option=<?php echo $option;?>&amp;view=sample_catalog&amp;cid[]=<?php echo $row->request_id;?>&amp;showbuttons=1" rel="{handler: 'iframe', size: {x: 400, y: 400}}" title="">
