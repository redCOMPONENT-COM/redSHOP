...
class RedshopViewShipping_rate_detail extends RedshopViewAdmin
{
    ...
    public function display($tpl = null)
    {
        ...
        $lists['shipping_rate_country'] = JHTML::_(
            ...
            'class="inputbox" multiple="multiple" onchange="getStateList()" ',
            'value',
            'text',
            $detail->shipping_rate_country
        );

        $detail->shipping_rate_on_category = explode(',', $detail->shipping_rate_on_category);

        $lists['shipping_rate_on_category'] = RedshopHelperCategory::listAll(
            "shipping_rate_on_category[]",
            0,
            $detail->shipping_rate_on_category,
            10,
            false,
            true
        );
