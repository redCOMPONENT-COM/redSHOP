            ...
            <table class="admintable table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo JHTML::tooltip(
                            JText::_('COM_REDSHOP_TOOLTIP_RATING_USER'),
                            JText::_('COM_REDSHOP_USER'),
                            'tooltip.png',
                            '',
                            '',
                            false
                ...
                <tr>
                    ...
                    <td><?php
                        ...
                        } elseif (isset($this->detail->product_id) && ($productInfo = \Redshop\Product\Product::getProductById(
                        ...
                        ?>
                        <?php echo JHTML::tooltip(
                            JText::_('COM_REDSHOP_TOOLTIP_RATING_PRODUCT'),
                            JText::_('COM_REDSHOP_PRODUCT'),
                            'tooltip.png',
                            '',
                            '',
                            false
                            ...
                            <ul class="images-rating">
                                <?php foreach ($images as $image) : ?>
                                    <li class="item-image-rating">
                                        <a target="_blank"
                                           href="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH . 'product_rating/' . $image ?>">
                                            <img src="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH . 'product_rating/' . $image ?>"
