...
<script language="javascript" type="text/javascript">
    Joomla.submitbutton = function (pressbutton) {
        ...
        if (form.stock_amount_image_tooltip.value == "") {
            alert("<?php echo Text::_('COM_REDSHOP_STOCKIMAGE_TOOLTIP_MUST_HAVE_A_NAME', true); ?>");
        } else if (form.stock_option.value == 0) {
            alert("<?php echo Text::_('COM_REDSHOP_STOCKIMAGE_OPTION_MUST_HAVE_VALUE', true); ?>");
        } else if (form.stock_quantity.value == "") {
            alert("<?php echo Text::_('COM_REDSHOP_STOCKIMAGE_QUANTITY_MUST_HAVE_VALUE', true); ?>");
        } else if (isNaN(form.stock_quantity.value) || form.stock_quantity.value < 0) {
            alert("<?php echo Text::_('COM_REDSHOP_STOCKIMAGE_QUANTITY_INVALID_INPUT_MSG', true); ?>");
        } else {
            Joomla.submitform(pressbutton);
        }
    }
            ...
            <table class="admintable table">
                <tr>
                    <td valign="top" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_STOCK_AMOUNT_IMAGE_TOOLTIP_LBL'); ?>:
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $this->lists['stockroom_id']; ?>
                    </td>
                </tr>
                <tr>
                    <td width="100" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_STOCK_AMOUNT_OPTION_LBL'); ?>:
                    </td>
                    <td>
                        <?php echo $this->lists['stock_option']; ?>
                    </td>
                </tr>
                <tr>
                    <td valign="top" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_STOCK_AMOUNT_QUANTITY_LBL'); ?>:
                    </td>
