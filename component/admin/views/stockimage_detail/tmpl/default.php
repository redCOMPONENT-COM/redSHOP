...
function submitbutton(pressbutton) 
{
	...
	if (form.stock_amount_image_tooltip.value == ""){
		alert( "<?php echo JText::_( 'STOCKIMAGE_TOOLTIP_MUST_HAVE_A_NAME', true ); ?>" );
	} else if (form.stock_option.value == 0){
		alert( "<?php echo JText::_( 'STOCKIMAGE_OPTION_MUST_HAVE_VALUE', true ); ?>" );
	} else if (form.stock_quantity.value == "" || isNaN(form.stock_quantity.value)){
		alert( "<?php echo JText::_( 'STOCKIMAGE_QUANTITY_MUST_HAVE_VALUE', true ); ?>" );
	}  else {
		submitform( pressbutton );
	}
}
...
<div class="col50">
	<fieldset class="adminform">
		...
		<tr>
			<td valign="top" align="right" class="key"><?php echo JText::_( 'STOCK_AMOUNT_IMAGE_TOOLTIP_LBL' ); ?>:</td>
		...
		<tr>
			<td width="100" align="right" class="key"><?php echo JText::_( 'STOCKROOM_NAME' ); ?>:</td>
			<td><?php echo $this->lists['stockroom_id'];?></td>
		</tr>
		<tr>
			<td width="100" align="right" class="key"><?php echo JText::_( 'STOCK_AMOUNT_OPTION_LBL' ); ?>:</td>
			<td><?php echo $this->lists['stock_option'];?></td>
		</tr>
		<tr>
			<td valign="top" align="right" class="key"><?php echo JText::_( 'STOCK_AMOUNT_QUANTITY_LBL' ); ?>:</td>
			<td><input type="text" name="stock_quantity" id="stock_quantity" value="<?php echo $this->detail->stock_quantity;?>"></td>
		</tr>
		<tr>
			<td valign="top" align="right" class="key"><?php echo JText::_( 'STOCK_AMOUNT_IMAGE_LBL' ); ?>:</td>
			<td><input type="file" name="stock_amount_image" />
				<div><img src="<?php echo $url.'components/com_redshop/assets/images/stockroom'.DS.$this->detail->stock_amount_image; ?>" width="150px" height="90px" /></div>
