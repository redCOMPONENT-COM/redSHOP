...
class stockimage_detailVIEWstockimage_detail extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'STOCKIMAGE_MANAGEMENT_DETAIL' ), 'redshop_stockroom48' );
		...
		JToolBarHelper::title(   JText::_( 'STOCKIMAGE' ).': <small><small>[ ' . $text.' ]</small></small>' , 'redshop_stockroom48'  );
