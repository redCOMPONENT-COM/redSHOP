		...
		<div class="imgOutline">
			<div class="imgTotal">
				<div align="center" class="imgBorder" style=''>
					<a class="img-preview" href="javascript:window.parent.jimage_insert('<?php echo 'components/com_redshop/assets'.DS.'images'.DS.$this->_tmp_img->path_relative; ?>','<?php echo $fid;?>','<?php echo $fsec;?>');window.parent.document.getElementById('sbox-window').close();" title="<?php echo $this->_tmp_img->name; ?>" style="display: block; width: 100%; height: 100%">
						<div class="image"  >						
