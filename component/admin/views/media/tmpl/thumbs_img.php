...
elseif($this->_tmp_img->size <= 100000)
{
	$thumb_path = JURI::root() . "components/com_redshop/assets/images/" . $this->_tmp_img->path_relative;
}
else
...
$size = redMediahelper::parseSize($this->_tmp_img->size);
?>
	...
	<div class="imgTotal">
		<div align="center" class="imgBorder" style=''>
			<a class="img-preview"
			   ...
			   title="<?php echo $this->_tmp_img->name; ?> - <?php echo $size; ?>" style="display: block; width: 100%; height: 100%">
				<div class="image">
					<?php if ($thumb_path != ''): ?>
						<img src="<?php echo $thumb_path; ?>" width="<?php echo $this->_tmp_img->width_60; ?>"
							 height="<?php echo $this->_tmp_img->height_60; ?>"
							 alt="<?php echo $this->_tmp_img->name; ?> - <?php echo $size; ?>"
							 border="0"/>
					<?php else: ?>
						<?php echo $this->_tmp_img->name; ?> - <?php echo $size; ?>
					<?php endif; ?>
				</div>
			</a>
		</div>
