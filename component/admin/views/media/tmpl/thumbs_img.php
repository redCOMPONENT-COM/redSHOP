...
<div class="imgOutline">
               ...
               title="<?php echo $this->_tmp_img->name; ?>" style="display: block; width: 100%; height: 100%">
                <div class="image">
                    <img src="<?php echo $thumb_path; ?>" width="<?php echo $this->_tmp_img->width_60; ?>"
                         ...
                         alt="<?php echo $this->_tmp_img->name; ?> - <?php echo RedshopHelperMedia::parseSize(
                             $this->_tmp_img->size
                         ); ?>"
                         border="0"/>
                </div>
    ...
    <div class="imginfoBorder">
        <a href="<?php echo JURI::root() . $basePath . $this->_tmp_img->path_relative; ?>"
           class="preview"
           onclick="window.parent.jimage_insert('<?php echo $basePath . $this->_tmp_img->path_relative; ?>','<?php echo $fid; ?>','<?php echo $fsec; ?>');window.parent.SqueezeBox.close();"><?php echo $this->escape(
