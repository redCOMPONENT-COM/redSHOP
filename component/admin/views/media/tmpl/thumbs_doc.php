...
$extra_link = "";
if($fdownload)
	$extra_link = "href=\"javascript:window.parent.jdownload_file('".$this->_tmp_doc->path_relative."','".$this->_tmp_doc->name."');window.parent.document.getElementById('sbox-window').close();\"";
?>
