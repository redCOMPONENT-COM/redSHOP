...
class mediaViewmedia extends JView {
	...
	function display($tpl = null) {
		...
		$document->setTitle ( JText::_ ( 'MEDIA' ) );
		...
		JToolBarHelper::title ( JText::_ ( 'MEDIA_MANAGEMENT' ), 'redshop_media48' );
		...
		$optionsection[]   = JHTML::_('select.option', 'property', JText::_('PROPERTY'));
		$optionsection[]   = JHTML::_('select.option', 'subproperty', JText::_('SUBPROPERTY'));
