...
<script type="text/javascript">
    ...
    function addNewproductRow(tblid) {
        ...
        newTD.innerHTML = '<img onclick="deleteOfflineProductRow(' + rowCount + ');" src="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH; ?>cross.png" title="<?php echo Text::_(
               'COM_REDSHOP_DELETE'
    ...
    function validateUserDetail() {
        ...
        if (form.country_code.value == '') {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_COUNTRY') ?>");
                            ...
                            <tbody>
                                <tr>
                                    <td width="100" align="right">
                                        <?php echo Text::_('COM_REDSHOP_SELECT_USER'); ?>:
                                    </td>
                                    <td>
                                        <?php
                                        echo JHTML::_(
...
?>
                    <table width="100%" class="adminlist">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="city" id="city" value="<?php echo $billing->city; ?>" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="phone" id="phone" value="<?php echo $billing->phone; ?>" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <?php echo $this->lists['quotation_extrafield']; ?>
                                </td>
                            </tr>
                    ...
                    if ($this->detail->user_id <= 0) {
                        ...
                        <table id="tblcreat" style="display:<?php echo $style; ?>;">
                            ...
                            <tr>
                                <td width="100" align="right">
                                    <?php echo Text::_('COM_REDSHOP_NEW_PASSWORD_LBL'); ?>:
                                </td>
                            ...
                            <tr>
                                <td width="100" align="right">
                                    <?php echo Text::_('COM_REDSHOP_VERIFIED_PASSWORD_LBL'); ?>
                                    :
                                </td>
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="adminlist">
                            <tbody>
                                ...
                                <tr>
                                    <td align="right"><a href="javascript:addNewproductRow('tblproductRow');">
                                            <?php echo Text::_(
                                                'COM_REDSHOP_NEW'
                                            ); ?>
                                        </a>
                                ...
                                <tr>
                                    ...
                                    <th width="10%" align="right">
                                        <?php echo Text::_('COM_REDSHOP_TAX'); ?>
                    </td>
                    <th width="10%" align="right">
                ...
                <tr id="trPrd1">
                    ...
                    <td align="right">
                        ...
                        <input name="productpriceproduct1" id="productpriceproduct1" type="hidden" value="0" />
                    </td>
                    ...
                    <tbody>
                        <tr align="left">
                            <td align="right" width="70%">
                                <strong>
                                    <?php echo Text::_('COM_REDSHOP_QUOTATION_SUBTOTAL'); ?>:
                                </strong>
                            </td>
                        ...
                        <tr align="left">
                            <td align="right" width="70%">
                                <strong>
                                    <?php echo Text::_('COM_REDSHOP_QUOTATION_TAX'); ?>:
                                </strong>
                            </td>
                            <td align="right" width="30%">
                                <div id="divTax"></div>
                                <input name="order_tax" id="order_tax" type="hidden" value="0" />
                            </td>
                        </tr>
                        ...
                        <tr align="left">
                            ...
                            <td align="right" width="30%">
                                ...
                                <input name="order_total" id="order_total" type="hidden" value="0" />
                            </td>
                        </tr>
                        <tr align="left">
                            <td colspan="2" align="left">
