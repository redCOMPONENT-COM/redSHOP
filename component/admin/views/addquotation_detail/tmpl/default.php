...
function validateUserDetail()
{
	...
	var patt=new RegExp("([a-z0-9_]+)@([a-z0-9_-]+)[.][a-z]");
	...
	if(patt.test(form.user_email.value) == false){
		...
		<tbody>
			<tr><td width="100" align="right"><?php echo JText::_( 'SELECT_USER' ); ?>:</td>
				<td><?php echo $this->lists['userlist']; ?>
				 <a href="<?php echo JRoute::_('index.php?option='.$option.'&view=addquotation_detail&user_id=0&uid=add');?>"><?php echo JText::_('ADD_USER');?></a></td>
				</tr>
	...
	<table width="100%" class="adminlist">
			<tbody>
				...
				<tr><td width="25%"><?php echo JText::_( 'FIRSTNAME' ); ?>:</td>
					<td><input type="text" name="firstname" id="firstname" value="<?php echo $billing->firstname; ?>"/></td></tr>
				<tr><td><?php echo JText::_( 'LASTNAME' ); ?>:</td>
					<td><input type="text" name="lastname" id="lastname" value="<?php echo $billing->lastname; ?>"/></td></tr>
				<tr><td><?php echo JText::_( 'ADDRESS' ); ?>:</td>
					<td><input type="text" name="address" id="address" value="<?php echo $billing->address; ?>"/></td></tr>
				<tr><td><?php echo JText::_( 'ZIP' ); ?>:</td>
					<td><input type="text" name="zipcode" id="zipcode" value="<?php echo $billing->zipcode; ?>"/></td></tr>
				<tr><td><?php echo JText::_( 'CITY' ); ?>:</td>
					<td><input type="text" name="city" id="city" value="<?php echo $billing->city; ?>"/></td></tr>
				<tr><td><?php echo JText::_( 'COUNTRY' ); ?>:</td>
					<td><?php echo $this->lists['country_code']; ?></td></tr>
				<tr><td><?php echo JText::_( 'STATE' ); ?>:</td>
					<td><?php echo $this->lists['state_code']; ?></td></tr>
				<tr><td><?php echo JText::_( 'PHONE' ); ?>:</td>
					<td><input type="text" name="phone" id="phone" value="<?php echo $billing->phone; ?>" /></td></tr>
				<tr><td><?php echo JText::_( 'EMAIL' ); ?>:</td>
					<td><input type="text" name="user_email" id="user_email" value="<?php echo $billing->user_email; ?>" /></td></tr>
				<tr><td colspan="2"><?php echo $this->lists['quotation_extrafield'];?>	</td></tr>
			...
			<tbody>
				...
				<tr><td>
					<table class="adminlist" id="tblproductRow" width="100%">
						<tr><th width="5%"><?php echo JText::_( 'ACTION' ); ?></th>
							<th width="30%"><?php echo JText::_( 'PRODUCT_NAME' ); ?></th>
							<th width="20%"><?php echo JText::_( 'ORDER_PRODUCT_NOTE' ); ?></th>
							<th width="10%"><?php echo JText::_( 'PRODUCT_PRICE_WITHOUT_VAT' ); ?></td>
							<th width="10%" align="right"><?php echo JText::_( 'TAX' ); ?></td>
							<th width="10%" align="right"><?php echo JText::_( 'PRODUCT_PRICE' ); ?></th>
							<th width="5%"><?php echo JText::_( 'PRODUCT_QTY' ); ?></th>
				...
				<tr><td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="adminlist">
						<tbody>
							<tr align="left">
								<td align="right" width="70%"><strong><?php echo JText::_( 'QUOTATION_SUBTOTAL' ); ?>:</strong></td>
								<td align="right" width="30%"><div id="divSubTotal"></div><input name="order_subtotal" id="order_subtotal" type="hidden" value="0" /></td>
							</tr>
							<tr align="left">
								<td align="right" width="70%"><strong><?php echo JText::_( 'QUOTATION_TAX' ); ?>:</strong></td>
							...
							<tr align="left">
								<td align="right" width="70%"><strong><?php echo JText::_( 'QUOTATION_TOTAL' ); ?>:</strong></td>
