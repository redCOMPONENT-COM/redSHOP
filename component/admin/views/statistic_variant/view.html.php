...
class RedshopViewStatistic_Variant extends RedshopViewAdmin
{
    ...
    public function display($tpl = null)
    {
        ...
        $document->setTitle(Text::_('COM_REDSHOP_STATISTIC_PRODUCT_VARIANT'));
    ...
    {
        $title = Text::_('COM_REDSHOP_STATISTIC_PRODUCT_VARIANT');
        JFactory::getApplication()->input->set('hidemainmenu', true);
        JToolBarHelper::title(
            Text::_('COM_REDSHOP_STATISTIC_PRODUCT_VARIANT') . " :: " . $title,
