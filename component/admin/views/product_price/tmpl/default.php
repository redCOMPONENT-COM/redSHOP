...
<thead><tr> 
	...
	<?php	$k = 0;
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td align="center" width="5%"><input type="hidden" name="price_id[]" value="<?php echo $row->id; ?>"><input type="hidden" name="shopper_group_id[]" value="<?php echo $row->shopper_group_id; ?>"><input type="text" name="price[]" value="<?php echo $producthelper->redpriceDecimal($row->product_price);?>"></input></td></tr>
	<?php		$k = 1 - $k;
		}	?>	
