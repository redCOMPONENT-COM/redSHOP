...
class sample_detailVIEWsample_detail extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'PRODUCT_SAMPLE' ), 'redshop_colorsample48' );
		...
		JToolBarHelper::title(   JText::_( 'PRODUCT_SAMPLE' ).': <small><small>[ ' . $text.' ]</small></small>' , 'redshop_catalogmanagement48');
