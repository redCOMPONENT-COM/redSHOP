...
<script language="javascript" type="text/javascript">
	function submitbutton(pressbutton) {
		...
		{
			alert( "<?php echo JText::_('ENTER_SAMPLE_NAME', true ); ?>" );
			return false;
		} 
		else 
		{
...
<div class="col50">
		...
		<tr>
			<td valign="top" align="right" class="key">
				<label for="volume">
					<?php echo JText::_( 'SAMPLE_NAME' ); ?>:
				</label>
			</td>
			<td>
				<input class="text_area" type="text" name="sample_name" id="sample_name" size="75" maxlength="250" value="<?php echo $this->detail->sample_name;?>" />
			</td>
		</tr>		 
		<tr>
			<td valign="top" align="right" class="key">
...
<fieldset class="adminform">
		<legend><?php echo JText::_( 'CATALOG_COLOUR' ); ?></legend>

		
		
		<table cellpadding="0" cellspacing="5" border="0">		 
		<tr>
		<th><?php echo JText::_( 'COLOUR_CODE' ); ?> : <input class="inputbox" type="text" name="color_code_1" id="color_code_1" />
		</th><td>
		<div id="colorSelector"><div style="background-color: #0000ff"></div></div>
		</td>		
		<TD><?php echo JText::_( 'OR' ); ?></TD>
		<td><?php echo JText::_( 'COLOUR_IMAGE' ); ?> : </td><td><?php $ilink 	= JRoute::_( 'index.php?option=com_media&view=images&tmpl=component&e_name=text' );  ?>
		<div class="button2-left"><div class="image"><a class="modal" title="Image" href="<?php echo $ilink;?>" rel="{handler: 'iframe', size: {x: 570, y: 400}}">Image</a></div></div>				
		</td>
		<th>
		<input type="button" name="addvalue" id="addvalue" class="button"  Value="<?php echo JText::_( 'ADD_COLOR' ); ?>" onclick="addNewcolor('extra_table');" />
	...
	<tr><th><?php echo JText::_( 'COLOUR_IMAGE' ); ?></th>
