...
class mail_detailVIEWmail_detail extends JView
{
	...
	{
		JToolBarHelper::title(   JText::_( 'MAIL_MANAGEMENT_DETAIL' ), 'redshop_mailcenter48' );
		...
		JToolBarHelper::title(   JText::_( 'MAIL' ).': <small><small>[ ' . $text.' ]</small></small>' , 'redshop_mailcenter48' );
		...
		if($detail->mail_section == 'order_status' && $detail->mail_section!='0')
		{
			...
			$select = array();
			$select[]   = JHTML::_('select.option', '0', JText::_('Select'));
