...
<div class="col50">
	<fieldset class="adminform">
		...
		<tr><td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_MAIL_NAME' ); ?>:</td>
			<td><input class="text_area" type="text" name="mail_name" id="mail_name" size="32" maxlength="250" value="<?php echo $this->detail->mail_name;?>" />
				<?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_MAIL_NAME' ), JText::_('COM_REDSHOP_MAIL_NAME' ), 'tooltip.png', '', '', false); ?></td></tr>
		<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_MAIL_SUBJECT' ); ?>:</td>
			<td><input class="text_area" type="text" name="mail_subject" id="mail_subject" size="80" maxlength="255" value="<?php echo $this->detail->mail_subject;?>" />
				<?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_MAIL_SUBJECT' ), JText::_('COM_REDSHOP_MAIL_SUBJECT' ), 'tooltip.png', '', '', false); ?></td></tr>
		<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_MAIL_SECTION' ); ?>:</td>
			<td><?php echo $this->lists['type'];?>
				...
				<input type="hidden" id="please" value="<?php echo JText::_('COM_REDSHOP_PLEASE_SELECT_MAIL_SECTION');?>"></td></tr>
		<tr id="order_state" <?php if($this->detail->mail_section !='order_status' || $this->detail->mail_section=="0"){?>	style="display: none;"	<?php }?>>
			<td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_MAIL_ORDER_STATUS' ); ?>:</td>
			<td><div id="responce"></div><div id="order_state_edit"><?php echo $this->lists['order_status'];?>	</div></td>
		</tr>
		<tr><td valign="top" align="right" class="key"><?php echo JText::_( 'COM_REDSHOP_MAIL_BCC' ); ?>:</td>
			<td><input class="text_area" type="text" name="mail_bcc" id="mail_bcc" size="80" maxlength="255" value="<?php echo $this->detail->mail_bcc;?>" />
				<?php echo JHTML::tooltip( JText::_( 'COM_REDSHOP_TOOLTIP_MAIL_BCC' ), JText::_( 'COM_REDSHOP_LBL_MAIL_BCC_TOOLTIP' ), 'tooltip.png', '', '', false); ?></td></tr>
...
<div class="col50">
	...
	<?php	$title = JText::_('COM_REDSHOP_STSTUS_OF_PASSWORD_RESET' );
		...
		<tr><td><?php echo JText::_("COM_REDSHOP_STATUS_OF_RESET_PASSWORD_HINT");?></td></tr>
		</table>
<?php	echo $this->pane->endPanel();
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_REGISTRATION_MAIL_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
	...
	$newshippingtag = '{shipping_address_start}
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_ORDER_MAIL_HINT'); ?></td></tr>
		<tr>
				<td>
	...
	$title = JText::_('COM_REDSHOP_INVOICE_MAIL' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_INVOICE_MAIL_HINT'); ?></td></tr>
		<tr>
				<td>
					<?php	$tags=$extra_field->getSectionFieldList(14,1);
					if(count($tags) == 0) echo JText::_("COM_REDSHOP_NO_FIELDS_AVAILABLE"); else echo JText::_("COM_REDSHOP_CUSTOMER_SHIPPING_ADDRESS");
	...
	$title = JText::_('COM_REDSHOP_ORDER_STATUS_MAIL' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_ORDER_STATUS_MAIL_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
	...
	$title = JText::_('COM_REDSHOP_CATALOG_SEND_MAIL' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_CATALOG_SEND_MAIL_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
	...
	$title = JText::_('COM_REDSHOP_CATALOG_FIRST_REMINDER' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_CATALOG_FIRST_REMINDER_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
	...
	$title = JText::_('COM_REDSHOP_CATALOG_SECOND_REMINDER' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_CATALOG_SECOND_REMINDER_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
	...
	$title = JText::_('COM_REDSHOP_CATALOG_COUPON_REMINDER' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_CATALOG_COUPON_REMINDER_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
	...
	$title = JText::_('COM_REDSHOP_CATALOG_SAMPLE_FIRST_REMINDER' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_CATALOG_SAMPLE_FIRST_REMINDER_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
	...
	$title = JText::_('COM_REDSHOP_CATALOG_SAMPLE_SECOND_REMINDER' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_CATALOG_SAMPLE_SECOND_REMINDER_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
	...
	$title = JText::_('COM_REDSHOP_CATALOG_SAMPLE_THIRD_REMINDER' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_CATALOG_SAMPLE_THIRD_REMINDER_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
	...
	$title = JText::_('COM_REDSHOP_CATALOG_SAMPLE_COUPON_REMINDER' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_CATALOG_SAMPLE_COUPON_REMINDER_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
	...
	$title = JText::_('COM_REDSHOP_ECONOMIC_INVOICE' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_ECONOMIC_INVOICE_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
	...
	$title = JText::_('COM_REDSHOP_ASK_QUESTION_MAIL' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_ASK_QUESTION_MAIL_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
	...
	$title = JText::_('COM_REDSHOP_QUOTATION_MAIL' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_QUOTATION_MAIL_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
	...
	$title = JText::_('COM_REDSHOP_REVIEW_MAIL' );
		...
		<table class="adminlist">
		<tr><td><?php echo JText::_('COM_REDSHOP_REVIEW_PRODUCT_MAIL_HINT'); ?></td></tr>
		</table>
	<?php	echo $this->pane->endPanel();
