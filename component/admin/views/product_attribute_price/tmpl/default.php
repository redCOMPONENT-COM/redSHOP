...
<thead><tr> 
		...
		<th width="15%"><?php echo JText::_('COM_REDSHOP_PRODUCT_PRICE' ); ?>&nbsp;&nbsp;<img style="cursor:pointer" src="images/filesave.png" onclick="Joomla.submitbutton('saveprice')"></th></tr></thead>
	<?php	$k = 0;
