...
?>		   window.location = '<?php echo $link;?>';
		...
		if (form.order_status_code.value == '0'){
			alert( "<?php echo JText::_( 'ORDERSTATUS_CODE_MUST_FILLED', true ); ?>" );
		}else if(form.order_status_name.value == ""){
			alert( "<?php echo JText::_( 'ORDERSTATUS_NAME_MUST_FILLED', true ); ?>" );
		}else {
		...
		<table class="admintable">
			<tr>
				<td width="100" align="right" class="key">
					<label for="name">
						<?php echo JText::_( 'ORDERSTATUS_CODE' ); ?>:
					</label>
				</td>
				<td>
...
<?php 				}?>
					...
					<?php echo JHTML::tooltip( JText::_( 'TOOLTIP_ORDERSTATUS_CODE' ), JText::_( 'ORDERSTATUS_CODE' ), 'tooltip.png', '', '', false); ?>
				</td>
			</tr>
			<tr>
				<td width="100" align="right" class="key">
					<label for="name">
						<?php echo JText::_( 'ORDERSTATUS_NAME' ); ?>:
					</label>
				</td>
				<td>
					...
					<?php echo JHTML::tooltip( JText::_( 'TOOLTIP_ORDERSTATUS_NAME' ), JText::_( 'ORDERSTATUS_NAME' ), 'tooltip.png', '', '', false); ?>
				</td>
			</tr>
			<tr>
