...
class coupon_detailVIEWcoupon_detail extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'COUPON_MANAGEMENT_DETAIL' ), 'redshop_coupon48' );
		...
		JToolBarHelper::title(   JText::_( 'COUPON' ).': <small><small>[ '.$text.' ]</small></small>','redshop_coupon48' );
		...
		$percent_or_total = array (JHTML::_('select.option','no', JText::_('SELECT')),JHTML::_('select.option',0 , JText::_('TOTAL')), JHTML::_('select.option',1, JText::_('PERCENTAGE')));
		...
		$coupon_type = array (JHTML::_('select.option','no', JText::_('SELECT')),JHTML::_('select.option',0,JText::_('GLOBAL')), JHTML::_('select.option',1,JText::_('USER_SPECIFIC')));
