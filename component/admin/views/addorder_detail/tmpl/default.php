...
<script type="text/javascript">
    ...
    function addNewproductRow(tblid) {
        ...
        newTD.innerHTML = '<input type="button" value="<?php echo Text::_(
    ...
    submitbutton = function (pressbutton) {
        ...
        if (pressbutton == 'save' || pressbutton == 'save_without_sendmail') {
            if (form.user_id.value == 0) {
                alert("<?php echo Text::_('COM_REDSHOP_SELECT_USER'); ?>");
                return;
            }
            ...
            if (form.order_status.value == 0 || form.order_status.value == '') {
                alert("<?php echo Text::_('COM_REDSHOP_TABLE_ORDER_REDSHOP_INVALID_ORDER_STATUS'); ?>");
                return false;
            }
            if (form.shipping_rate_id) {
                if (form.shipping_rate_id.value == '' || form.shipping_rate_id.value == 0) {
                    alert("<?php echo Text::_('COM_REDSHOP_SELECT_SHIPPING'); ?>");
                    return;
                }
            } else {
    ...
    function validateUserDetail() {
        ...
        if (form.firstname.value == '') {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_FIRST_NAME') ?>");
            form.firstname.focus();
            return false;
        }
        if (form.lastname.value == '') {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_LAST_NAME') ?>");
            form.lastname.focus();
            return false;
        }
        if (form.address.value == '' && requiredAddress) {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_ADDRESS') ?>");
            form.address.focus();
            return false;
        }
        if (form.zipcode.value == '' && requiredPostCode) {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_ZIPCODE') ?>");
            form.zipcode.focus();
            return false;
        }
        if (form.city.value == '') {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_CITY') ?>");
            form.city.focus();
            return false;
        }
        if (form.phone.value == '' && requiredPhone) {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_PHONE') ?>");
            form.phone.focus();
            return false;
        }
        ...
        if (rad_val == 1) {
            if (document.getElementById('password')) {
                if (form.password.value == '') {
                    alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_PASSWORD') ?>");
                    form.password.focus();
                    return false;
                }
...
<?php if (!JFactory::getApplication()->input->getCmd('ajaxtask', '')): ?>
            <form action="<?php echo Redshop\IO\Route::_($this->request_url) ?>" method="post" name="adminForm" id="adminForm">
                <div class="row">
                    <div class="col-md-4">
                        <?php echo Text::_('COM_REDSHOP_SELECT_USER_OR_ADD_NEW_USER_IN_BOTTOM_FIELDS'); ?>:
                    </div>
                    <div class="col-md-8">
                        <?php
                ...
                <table class="adminlist table">
                    ...
                    <tr style="background-color: #cccccc">
                        <th><?php echo Text::_('COM_REDSHOP_BILLING_ADDRESS_INFORMATION'); ?></th>
                        <th><?php echo Text::_('COM_REDSHOP_SHIPPING_ADDRESS_INFORMATION'); ?></th>
                    </tr>
                    <tr valign="top">
                        <td width="50%">
                            <table class="adminlist table" border="0">
                                <tr>
                                    <td width="30%" align="right"><?php echo Text::_('COM_REDSHOP_REGISTER_AS'); ?>:
                                    </td>
                                    <td><?php echo $this->lists['is_company']; ?></td>
                                </tr>
                                <tr id="trCompanyName" <?php echo $allowCompany; ?>>
                                    <td align="right"><?php echo Text::_('COM_REDSHOP_COMPANY_NAME'); ?>:</td>
                                    <td><input class="inputbox" type="text" name="company_name" id="company_name"
                                               size="32"
                                               maxlength="250" value="<?php echo $billing->company_name; ?>"/></td>
                                </tr>
                                <tr>
                                    <td align="right" class="key"><?php echo Text::_('COM_REDSHOP_FIRSTNAME'); ?>
                                        :
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><input class="inputbox" type="text" name="email" id="email" size="32"
                                               ...
                                               <?php if ($this->detail->user_id <= 0 && $style == "block") { ?>onblur="validate(2);"<?php } ?> />
                                ...
                                <?php if (Redshop::getConfig()->get('USE_TAX_EXEMPT') == 1) {
                                    ?>
                                                ...
                                                <tr id="trTaxExemptRequest" <?php echo $allowCompany; ?>>
                                                    <td align="right"><?php echo Text::_(
                                                ...
                                                <tr id="trTaxExemptApproved" <?php echo $allowCompany; ?>>
                                                    <td align="right"><?php echo Text::_('COM_REDSHOP_TEX_EXEMPT_APPROVED'); ?>
                                                        :
                                                    </td>
                                                    <td><?php echo JHTML::_(
                                                        'select.booleanlist',
                        ...
                        <td width="50%" style="vertical-align: top;">
                            <table class="adminlist table" border="0" width="100%">
                                <tr>
                                    <td width="30%" align="right">
                                        <?php echo Text::_('COM_REDSHOP_SHIPPING_SAME_AS_BILLING') ?>:
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td width="100" align="right"><?php echo Text::_('COM_REDSHOP_SELECT_SHIPPING'); ?>
                                        :
                                    </td>
                            ...
                            <div id="order_shipping_div" style="display:<?php echo $shippingblock; ?>;">
                                <table class="adminlist" border="0" width="100%" align="center">
                                    <tr>
                                        <td width="100" align="right"><?php echo Text::_('COM_REDSHOP_FIRSTNAME'); ?>
                                            :
                                        </td>
                                    ...
                                    <tr>
                                        <td width="100" align="right"><?php echo Text::_('COM_REDSHOP_PHONE'); ?>:</td>
                                    ...
                                    <tr>
                                        <td width="50%">
                                            <table id="tblcreat" style="display:<?php echo $style; ?>;" class="adminlist table">
                                                <tr>
                                                    <td width="30%" align="right"><?php echo Text::_('COM_REDSHOP_USERNAME'); ?>:
                                                    </td>
                                                ...
                                                <tr>
                                                    <td align="right"><?php echo Text::_('COM_REDSHOP_NEW_PASSWORD_LBL'); ?>:</td>
                                                    <td><input class="inputbox" type="password" name="password" id="password"
                                                               size="32" maxlength="250"
                                                               value=""/></td>
                                                </tr>
                                                <tr>
                                                    <td align="right"><?php echo Text::_('COM_REDSHOP_VERIFIED_PASSWORD_LBL'); ?>
                                                        :
                                                    </td>
        ...
        <?php if ($err == "" && property_exists($billing, "users_info_id") && $billing->users_info_id): ?>
                        <tr>
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="adminlist">
                                    <tbody>
                                    <tr style="background-color: #cccccc">
                                        <th align="left"><?php echo Text::_('COM_REDSHOP_ORDER_DETAILS'); ?></th>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table class="adminlist" id="tblproductRow" width="100%">
                                                <tr>
                                                    ...
                                                    <th width="30%">
                                                    <?php echo Text::_('COM_REDSHOP_PRODUCT_NAME'); ?></td>
                                                    <th width="20%">
                                                    <?php echo Text::_('COM_REDSHOP_ORDER_PRODUCT_NOTE'); ?></td>
                                                    <th width="10%">
                                                    <?php echo Text::_('COM_REDSHOP_PRODUCT_PRICE_WITHOUT_VAT'); ?></td>
                                                    <th width="10%" align="right">
                                                    <?php echo Text::_('COM_REDSHOP_TAX'); ?></td>
                                                    <th width="10%" align="right">
                                                    <?php echo Text::_('COM_REDSHOP_PRODUCT_PRICE'); ?></td>
                                                    <th width="5%">
                                                    <?php echo Text::_('COM_REDSHOP_PRODUCT_QTY'); ?></td>
                                                    <th width="10%" align="right">
                                                    <?php echo Text::_('COM_REDSHOP_TOTAL_PRICE'); ?></td>
                                                </tr>
                                                <tr id="trPrd1">
                                                    <td align="center"></td>
                                                    <td><?php
                                    ...
                                    <tr>
                                        <td align="right"><a class="btn btn-success"
                                                             href="javascript:addNewproductRow('tblproductRow');"><?php echo Text::_(
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" class="adminlist">
                                                ...
                                                <tr align="left">
                                                    <td align="right" width="70%">
                                                        <strong><?php echo Text::_('COM_REDSHOP_ORDER_SUBTOTAL'); ?>:</strong></td>
                                                ...
                                                <tr align="left">
                                                    <td align="right" width="70%"><strong><?php echo Text::_(
                                                ...
                                                <tr align="left">
                                                    <td align="right" width="70%">
                                                        <strong><?php echo Text::_('COM_REDSHOP_ORDER_DISCOUNT_LBL'); ?>:</strong>
                                                    </td>
                                                    <td align="right" width="30%">
                                                ...
                                                <tr align="left">
                                                    <td align="right" width="70%">
                                                        <strong><?php echo Text::_('COM_REDSHOP_SPECIAL_DISCOUNT'); ?>:</strong>
                                                    </td>
                                                    <td align="right" width="30%">
                                                ...
                                                <tr align="left">
                                                    <td align="right" width="70%">
                                                        <strong><?php echo Text::_('COM_REDSHOP_ORDER_SHIPPING'); ?>:</strong></td>
                                                    <td align="right" width="30%">
                        ...
                        <tr>
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0" class="adminlist">
                                    <tr style="background-color: #cccccc">
                                        <th colspan="2" align="left"><?php echo Text::_('COM_REDSHOP_ORDER_INFORMATION'); ?></th>
                                    </tr>
                                    <tr>
                                        <td><?php echo Text::_('COM_REDSHOP_ORDER_DATE'); ?></td>
                                        <td><?php echo RedshopHelperDatetime::convertDateFormat(time()); ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><?php echo Text::_('COM_REDSHOP_COMMENT'); ?></td>
                                    ...
                                    <?php //}?>
                                    <tr>
                                        <td><?php echo Text::_('COM_REDSHOP_ORDER_STATUS'); ?></td>
                                        <td><?php
                                    ...
                                    <tr>
                                        <td><?php echo Text::_('COM_REDSHOP_SHIPPING_METHOD'); ?></td>
                                        <td id="tdShipping">
                                    </tr>
                                </table>
                            </td>
