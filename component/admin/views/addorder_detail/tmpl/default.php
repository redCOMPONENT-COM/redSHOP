...
<script type="text/javascript">
	...
	//	var rowCount = table.rows.length;
		...
		newTD5.align = 'right';
		newTD6.innerHTML = '<input type="number" min="0" name="quantityproduct' + rowCount + '" id="quantityproduct' + rowCount + '" onchange="changeOfflineQuantityBox(\'product' + rowCount + '\');" value="1" size="<?php echo $DEFAULT_QUANTITY;?>" maxlength="<?php echo $DEFAULT_QUANTITY;?>" >';
