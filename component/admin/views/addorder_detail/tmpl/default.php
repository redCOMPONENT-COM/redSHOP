...
function validateUserDetail()
{
	...
	/*if(form.ean_number.value=='' && form.requisition_number.value!=''){
 		alert("<?php echo JText::_('COM_REDSHOP_PLEASE_ENTER_EAN_NUMBER')?>");
 		form.ean_number.focus();
 		return false;
 	}
	if(form.ean_number.value!='' && form.requisition_number.value==''){
 		alert("<?php echo JText::_('COM_REDSHOP_PLEASE_ENTER_REQUISITION_NUMBER')?>");
 		form.ean_number.focus();
 		return false;
 	}*/
...
<tbody>
	<tr><td>
		<table border="0" cellspacing="0" cellpadding="0" class="adminlist">
		<tbody>
			<tr><td width="100" align="right"><?php echo JText::_( 'COM_REDSHOP_SELECT_USER' ); ?>:</td>
				...
				<a href="<?php echo JRoute::_('index.php?option='.$option.'&view=addorder_detail&user_id=0&uid=add');?>"><?php echo JText::_('COM_REDSHOP_ADD_USER');?></a></td></tr>
			<tr><td width="100" align="right"><?php echo JText::_( 'COM_REDSHOP_CREATE_ACCOUNT' ); ?>:</td>
...
<?php }	?>
			...
			<tbody>
				<tr style="background-color: #cccccc">
					...
					<th><?php echo JText::_('COM_REDSHOP_SHIPPING_ADDRESS_INFORMATION' ); ?></th></tr>
				<tr valign="top">
				<td width="50%">
					<table class="adminlist" border="0" width="100%">
						<tr><td width="100" align="right"><?php echo JText::_( 'COM_REDSHOP_REGISTER_AS' ); ?>:</td>
							<td><?php echo $this->lists['is_company'];?></td></tr>
						<tr id="trCompanyName" <?php echo $allowCompany;?>><td width="100" align="right"><?php echo JText::_('COM_REDSHOP_COMPANY_NAME' ); ?>:</td>
						...
						<tr><td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_FIRSTNAME' ); ?>:</td>
						...
						<tr><td width="100" align="right"><?php echo JText::_('COM_REDSHOP_PHONE' ); ?>:</td>
							<td><input class="inputbox" type="text" name="phone" id="phone" size="32" maxlength="250" value="<?php echo $billing->phone; ?>" /></td></tr>
						<tr><td width="100" align="right"><?php echo JText::_('COM_REDSHOP_EMAIL' ); ?>:</td>
						...
						<tr id="trVatNumber" <?php echo $allowCompany;?>><td width="100" align="right"><?php echo JText::_('COM_REDSHOP_VAT_NUMBER' ); ?>:</td>
						...
						<tr id="trEANnumber" <?php echo $allowCompany;?>><td width="100" align="right"><?php echo JText::_('COM_REDSHOP_EAN_NUMBER' ); ?>:</td>
					...
					<?php	if(USE_TAX_EXEMPT == 1)
							{	?>
						<tr id="trTaxExempt" <?php echo $allowCompany;?>><td width="100" align="right"><?php echo JText::_('COM_REDSHOP_TAX_EXEMPT' ); ?>:</td>
							<td><?php echo JHTML::_('select.booleanlist',  'tax_exempt', 'class="inputbox"', $billing->tax_exempt ); ?></td></tr>
						<tr id="trTaxExemptRequest" <?php echo $allowCompany;?>><td width="100" align="right"><?php echo JText::_('COM_REDSHOP_USER_REQUEST_TAX_EXEMPT_LBL' ); ?>:</td>
				...
				<td width="50%">
					<table class="adminlist" border="0" width="100%">
				          <tr>
				            <td width="100" align="right"><?php echo JText::_('COM_REDSHOP_SHIPPING_SAME_AS_BILLING' ); ?>:</td>
				            <td><input type="checkbox" id="billisship" name="billisship" value="1" <?php echo $billisshipcheck;?> onchange="getShippinginfo(<?php echo $billing->users_info_id;?>);" /></td>
				         </tr>
				         <tr>
						...
						<tr><td width="100" align="right"><?php echo JText::_('COM_REDSHOP_FIRSTNAME' ); ?>:</td>
						...
						<tr><td width="100" align="right"><?php echo JText::_('COM_REDSHOP_STATE' ); ?>:</td>
...
<?php if($this->detail->user_id<=0) {	?>
		<table id="tblcreat" style="display:<?php echo $style;?>;">
			<tr><td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_USERNAME' ); ?>:</td>
			...
			<tr><td width="100" align="right"><?php echo JText::_('COM_REDSHOP_NEW_PASSWORD_LBL' ); ?>:</td>
				<td><input class="inputbox" type="password" name="password" id="password" size="32" maxlength="250" value="" /></td></tr>
			<tr><td width="100" align="right"><?php echo JText::_('COM_REDSHOP_VERIFIED_PASSWORD_LBL' ); ?>:</td>
...
<?php	}
	...
	<tr><td align="right"><input type="button" value="<?php echo JText::_('COM_REDSHOP_SAVE_USER_INFORMATION');?>" name="next" id="next" onclick="validateUserDetail();" /></td></tr>
<?php if($err=="" && array_key_exists("users_info_id",$billing) && $billing->users_info_id) {	?>
		<tr><td>
			...
			<tbody>
				<tr style="background-color: #cccccc"><th align="left"><?php echo JText::_('COM_REDSHOP_ORDER_DETAILS' ); ?></th></tr>
				<tr><td align="right"><a href="javascript:addNewproductRow('tblproductRow');" ><?php echo JText::_('COM_REDSHOP_NEW' ); ?></a></td></tr>
				<tr><td>
					<table class="adminlist" id="tblproductRow" width="100%">
						<tr><th width="5%"><?php echo JText::_('COM_REDSHOP_ACTION' ); ?></th>
		...
		<tr><td>
			<table border="0" cellspacing="0" cellpadding="0" class="adminlist">
			<tr style="background-color: #cccccc"><th colspan="2" align="left"><?php echo JText::_('COM_REDSHOP_ORDER_INFORMATION' ); ?></th></tr>
			<tr><td><?php echo JText::_('COM_REDSHOP_ORDER_DATE');?></td>
				<td><?php echo $redconfig->convertDateFormat(time());?></td></tr>
			<tr><td><?php echo JText::_('COM_REDSHOP_CUSTOMER_IP_ADDRESS');?></td>
				<td><?php echo $ip;?></td></tr>
			<tr><td><?php echo JText::_('COM_REDSHOP_COMMENT');?></td>
...
//					$linkupdate = JRoute::_( 'index.php?option='.$option.'&view=order&task=update_status&return=order_detail&order_id[]='. $this->detail->order_id );
				...
				<tr><td><?php echo JText::_('COM_REDSHOP_ORDER_PAYMENT_METHOD');?></td>
					<td id="tdPayment"></tr>
				<tr><td><?php echo JText::_('COM_REDSHOP_SHIPPING_METHOD');?></td>
					<td id="tdShipping"></tr>
			</table>
		</td></tr>
<?php }	?>
