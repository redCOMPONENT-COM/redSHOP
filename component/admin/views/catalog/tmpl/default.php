...
<div id="editcell" style="background-color: ">	 
	...
	for ($i=0, $n=count( $this->catalog ); $i < $n; $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<a class="modal" href="index.php?tmpl=component&option=<?php echo $option;?>&amp;view=media&amp;section_id=<?php echo $row->id;?>&amp;showbuttons=1&amp;media_section=catalog&amp;section_name=<?php echo $row->catalog_name;?>" rel="{handler: 'iframe', size: {x: 1050, y: 450}}" title=""><img src="<?php echo REDSHOP_ADMIN_IMAGES_ABSPATH;?>media16.png" align="absmiddle" alt="media" >(<?php  echo count($mediadetail);?>)</a>
			</td>			
			<td align="center">
				<?php echo $published;?>
			</td>
