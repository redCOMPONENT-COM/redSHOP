...
class template_detailVIEWtemplate_detail extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'TEMPLATES_MANAGEMET' ), 'redshop_templates48' );
		...
		JToolBarHelper::title( JText::_( 'TEMPLATES' ).': <small><small>[ '.$text.' ]</small></small>' , 'redshop_templates48');
