...
$default_template = JText::_( 'DEFAULT_TEMPLATE_DETAIL' );
...
echo $this->pane->startPane( 'stat-pane' );
				...
				if($this->detail->template_section=="category")
				{
					...
					if(count($tags) == 0) echo JTEXT::_("NO_FIELDS_AVAILABLE");
					...
					<tr><td><?php echo JText::_('CATEGORY_TEMPLATE_HINT'); ?></td></tr>
					<tr><td>
					<?php	$availableaddtocart = $model->availableaddtocart('add_to_cart');
					if(count($availableaddtocart) == 0) echo JTEXT::_("NO_ADD_TO_CART_AVAILABLE");
					for($i=0;$i<count($availableaddtocart);$i++)
					{
						echo '<span style="margin-left:10px;">{form_addtocart:'.$availableaddtocart[$i]->template_name.'} -- '.JText::_('ADD_TO_CART_TEMPLATE_AVAILABLE_HINT').'</span>';
					}	?>
					</td></tr>
					<tr>
						<td>
							...
							if(count($related_product) == 0) echo JTEXT::_("NO_RELATED_PRODUCT_LIGHTBOX_TEMPLATE_AVAILABLE"); else echo JTEXT::_("RELATED_PRODUCT_LIGHTBOX_TEMPLATE_AVAILABLE_HINT")."<br />";
			...
			//Giftcard Template Start
			 ...
			 {
					$title = JText::_( 'GIFTCARD_LIST_HINT' );
					echo $this->pane->startPanel( $title, 'events' );	?>
					<table class="adminlist">
					<tr><td>
					<?php
					...
					<tr><td>
					<?php	echo JText::_('GIFTCARD_LIST_TAGES');?>
					</td></tr>
					</table>
			 ...
			 if($this->detail->template_section=="product")
			 {
					...
					<tr><td><?php echo JText::_('PRODUCT_TEMPLATE_HINT'); ?></td></tr>
					<tr><td>
					<?php	$availableaddtocart = $model->availableaddtocart('add_to_cart');
							if(count($availableaddtocart) == 0) echo JTEXT::_("NO_ADD_TO_CART_AVAILABLE");
					...
					<?php	$availableAttTemp = $model->availableaddtocart('attribute_template');
							if(count($availableAttTemp) == 0) echo JTEXT::_("ATTRIBUTE_TAGS_AVAILABLE");

							for($i=0;$i<count($availableAttTemp);$i++)
							{
								echo '<span style="margin-left:10px;">{attribute_template:'.$availableAttTemp[$i]->template_name.'} -- '.JText::_('ATTRIBUTE_TEMPLATE').'</span>';
							}	?>
						</td></tr>
						<tr><td>
					<?php	$availableAttcartTemp = $model->availableaddtocart('attributewithcart_template');
							if(count($availableAttcartTemp) == 0) echo JTEXT::_("ATTRIBUTE_TAGS_AVAILABLE");

							for($i=0;$i<count($availableAttcartTemp);$i++)
							{
								echo '<span style="margin-left:10px;">{attributewithcart_template:'.$availableAttcartTemp[$i]->template_name.'} -- '.JText::_('ATTRIBUTE_WITH_CART_TEMPLATE').'</span>';
							}	?>
						</td></tr>
						<tr><td>
					<?php	$availableaddtocart = $model->availableaddtocart('related_product');
							if(count($availableaddtocart) == 0) echo JTEXT::_("RELATED_PRODUCT_TEMPLATE");

							for($i=0;$i<count($availableaddtocart);$i++)
							{
								echo '<span style="margin-left:10px;">{related_product:'.$availableaddtocart[$i]->template_name.'} -- '.JText::_('RELATED_PRODUCT_TEMPLATE').'</span>';
							}	?>
						</td></tr>
						<tr><td>
					<?php	$wrappertemplate = $model->availableaddtocart('wrapper_template');
							if(count($wrappertemplate) == 0) echo JTEXT::_("NO_WRAPPER_TEMPLATE_AVAILABLE");
							for($i=0;$i<count($wrappertemplate);$i++)
							{
								echo '<span style="margin-left:10px;">{wrapper_template:'.$wrappertemplate[$i]->template_name.'} -- '.JText::_('WRAPPER_TEMPLATE').'</span>';
							}	?>
						</td></tr>
						</table>
					<?php	echo $this->pane->endPanel();
			 ...
			 {
				$title = JText::_( 'PRODUCT_SAMPLE_FIELDS' );
				echo $this->pane->startPanel( $title, 'events' );	?>
				<table class="adminlist">
				<tr><td>
				<?php
				...
				<tr><td><?php echo JText::_('PRODUCT_SAMPLE_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			...
			//Manufacturer Template Start
	         ...
	         {
				$title = JText::_( 'MANUFACTURER_FIELDS' );
				echo $this->pane->startPanel( $title, 'events' );	?>
				<table class="adminlist">
				<tr><td>
				<?php
				...
				<tr><td><?php echo JText::_('MANUFACTURER_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
...
//Manufacturer Products Template Start
	         ...
	         {
				$title = JText::_( 'MANUFACTURER_PRODUCTS_FIELDS' );
				echo $this->pane->startPanel( $title, 'events' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('MANUFACTURER_PRODUCTS_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
				$title = JText::_( 'CART_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'cart' );		?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('CART_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
...
//Checkout Template Start
			 ...
			 {
				$title = JText::_( 'CHECKOUT_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'checkout' );		?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('CHECKOUT_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
					$title = JText::_( 'CATALOG_CART_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'catalog_cart' );		?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('CATALOG_CART_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
...
//Catalog Order Detail Template Start
			 ...
			 {
			 	$title = JText::_( 'CATALOG_ORDER_DETAIL_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'catalog_order_detail' );		?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('CATALOG_ORDER_DETAIL_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
			 		$title = JText::_( 'CATALOG_ORDER_RECEIPT_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'catalog_order_receipt' );		?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('CATALOG_ORDER_RECEIPT_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
			 		$title = JText::_( 'CATEGORY_PRODUCT_TEMPLATE' );
					echo $this->pane->startPanel( $title, 'category_product_template' );		?>
					<table class="adminlist">
					<tr><td><?php echo JText::_('CATEGORY_PRODUCT_TEMPLATE_HINT'); ?></td></tr>
					</table>
					<?php	echo $this->pane->endPanel();
			...
			//Clicktell Message Template Start
			 ...
			 {
			 		$title = JText::_( 'CLICKTELL_SMS_MESSAGE_TEMPLATE' );
					echo $this->pane->startPanel( $title, 'clicktell_sms_template' );		?>
					<table class="adminlist">
					<tr><td><?php echo JText::_('CLICKTELL_SMS_MESSAGE_TEMPLATE_HINT'); ?></td></tr>
					</table>
					<?php	echo $this->pane->endPanel();
			 ...
			 {
			 		$title = JText::_( 'FRONTPAGE_CATEGORY_TEMPLATE' );
			 		echo $this->pane->startPanel( $title, 'frontpage_category_detail' );	?>
			 		<table class="adminlist">
					<tr><td><?php echo JText::_('FRONTPAGE_CATEGORY_TEMPLATE_HINT'); ?></td></tr>
					</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
			 		$title = JText::_( 'GIFTCARD_LIST_TEMPLATE' );
			 		echo $this->pane->startPanel( $title, 'manufacturer detail' );	?>
			 		<table class="adminlist">
					<tr><td><?php echo JText::_('GIFTCARD_LIST_TEMPLATE_HINT'); ?></td></tr>
					</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
			 		$title = JText::_( 'MANUFACTURER_DETAIL_TEMPLATE' );
			 		echo $this->pane->startPanel( $title, 'manufacturer detail' );	?>
			 		<table class="adminlist">
					<tr><td><?php echo JText::_('MANUFACTURER_DETAIL_TEMPLATE_HINT'); ?></td></tr>
					</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
				$title = JText::_( 'CATALOG_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'catalog' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('CATALOG_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
				$title = JText::_( 'ORDER_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'order_template' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('ORDER_DETAIL_TEMPLATE_HINT'); ?></td></tr>
				<tr>
				<td>
					<?php
					...
					if(count($tags) == 0) echo JTEXT::_("NO_FIELDS_AVAILABLE"); else echo JTEXT::_("CUSTOMER_SHIPPING_ADDRESS");
					for($i=0;$i<count($tags);$i++)
					{
						echo '<span style="margin-left:10px;">{'.$tags[$i]->field_name.'} -- '.$tags[$i]->field_title.'</span>';
					}	?>
		...
		<tr>
				<td>
					...
					if(count($tags) == 0) echo JTEXT::_("NO_FIELDS_AVAILABLE"); else echo JTEXT::_("COMPANY_SHIPPING_ADDRESS");
					for($i=0;$i<count($tags);$i++)
					{
						echo '<span style="margin-left:10px;">{'.$tags[$i]->field_name.'} -- '.$tags[$i]->field_title.'</span>';
					}	?>
				...
				<tr><td><?php echo htmlentities($newbillingtag)."<br><br>".htmlentities($newshippingtag); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 if($this->detail->template_section=="order_receipt")
			 {
				...
				echo $this->pane->startPanel( $title, 'order_template' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('ORDER_RECEIPT_TEMPLATE_HINT'); ?></td></tr>
				<tr>
				<td>
					<?php
					$tags_front=$extra_field->getSectionFieldList(14,1);
		...
		<tr>
			 ...
			 {
				$title = JText::_( 'QUOTATION_DETAIL_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'Quotation_detail_template' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('QUOTATION_DETAIL_TEMPLATE_HINTS'); ?></td></tr>
				</table><?php
				echo $this->pane->endPanel();
			 ...
			 {
				$title = JText::_( 'QUOTATION_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'Quotation_template' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('QUOTATION_TEMPLATE_HINTS'); ?></td></tr>
				</table><?php
				echo $this->pane->endPanel();
			 ...
			 if($this->detail->template_section=="order_print")
			 {
				...
				<tr><td><?php echo JText::_('ORDER_PRINT_TEMPLATE_HINT'); ?></td></tr>
				<tr><td><?php echo htmlentities($newbillingtag)."<br><br>".htmlentities($newshippingtag); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
				$title = JText::_( 'ORDERLIST_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'orderlist_template' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('ORDERLIST_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			...
			/*  if($this->detail->template_section=="stockroom_list")
			 {
				$title = JText::_( 'STOCKROOM_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'stockroom_template' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('STOCKROOM_TEMPLATE_HINT'); ?></td></tr>
				<tr><td><?php echo JText::_('STOCKROOM_PRODUCTS_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			...
			//Newsletter Template Start
			 ...
			 {
				$title = JText::_( 'NEWSLETTER_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'catalog' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('NEWSLETTER_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
				$title = JText::_( 'NEWSLETTER_PRODUCTS_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'catalog' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('NEWSLETTER_PRODUCTS_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
				$title = JText::_( 'RELATED_PRODUCT_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'catalog' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('RELATED_PRODUCT_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
				$title = JText::_( 'ADD_TO_CART_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'catalog' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('ADD_TO_CART_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			...
			{
				$title = JText::_( 'REVIEW_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'review' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('REVIEW_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			...
			//Review Template End
			 ...
			 {
				$title = JText::_( 'ATTRIBUTE_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'catalog' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('ATTRIBUTE_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
				$title = JText::_( 'ATTRIBUTE_WITH_CART_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'attributewithcart' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('ATTRIBUTE_WITH_CART_TEMPLATE_HINT'); ?></td></tr>
    			<tr><td>
				<?php	$availableaddtocart = $model->availableaddtocart('add_to_cart');
				if(count($availableaddtocart) == 0) echo JTEXT::_("NO_ADD_TO_CART_AVAILABLE");
				for($i=0;$i<count($availableaddtocart);$i++)
	        ...
	        {
				$title = JText::_( 'ACCESSORY_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'catalog' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('ACCESSORY_TEMPLATE_HINT'); ?></td></tr>
				</table>
	<?php		echo $this->pane->endPanel();
	        ...
	        {
				$title = JText::_( 'WRAPPER_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'wrapper' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('WRAPPER_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
	        ...
	        {
				$title = JText::_( 'WISHLIST_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'wishlist' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('WISHLIST_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
	        ...
	        {
				$title = JText::_( 'WISHLIST_MAIL_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'wishlist' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('WISHLIST_MAIL_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			...
			{
				$title = JText::_( 'SHIPPING_PDF_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'shipping' );?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('SHIPPING_PDF_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			...
			//Shipping PDF Template End
			 ...
			 {
				$title = JText::_( 'ASK_QUESTION_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'askquestion' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('ASK_QUESTION_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			...
			//Ajax Cart Box Template Start
 			 ...
 			 {
				$title = JText::_( 'AJAX_CART_BOX_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'wrapper' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('AJAX_CART_BOX_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
 			 ...
 			 {
				$title = JText::_( 'AJAX_CART_BOX_DETAIL_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'wrapper' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('AJAX_CART_BOX_DETAIL_TEMPLATE_HINT'); ?></td></tr>
				<tr><td>
				<?php	$availableaddtocart = $model->availableaddtocart('add_to_cart');
				if(count($availableaddtocart) == 0) echo JTEXT::_("NO_ADD_TO_CART_AVAILABLE");
					...
					<tr><td><?php echo JText::_('AJAX_PRODUCT_TEMPLATE_HINT'); ?></td></tr>
					<tr><td>
					<?php	//$availableAttTemp = $model->availableaddtocart('attribute_template ');
					if(count($availableAttTemp) == 0) echo JTEXT::_("ATTRIBUTE_TAGS_AVAILABLE");
 			  ...
 			  {
					$title = JText::_( 'REDPRODUCTFINDER_TEMPLATE' );
					echo $this->pane->startPanel( $title, 'redPRODUCTFINDER' );	?>
					<table class="adminlist">
					<tr><td><?php echo JText::_('REDPRODUCTFINDER_TEMPLATE_HINT'); ?></td></tr>
					<tr><td>
					<?php	$availableaddtocart = $model->availableaddtocart('add_to_cart');
						if(count($availableaddtocart) == 0) echo JTEXT::_("NO_ADD_TO_CART_AVAILABLE");
	        ...
	        {
				$title = JText::_( 'ACCOUNT_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'account_detail' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('ACCOUNT_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
	        ...
	        //Compare Product Template Start
	         ...
	         {
				$title = JText::_( 'COMPARE_PRODUCT_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'compare_product' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('COMPARE_PRODUCT_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
	        ...
	        if($this->detail->template_section=="redshop_payment")
	         {
				$title = JText::_( 'PAYMENT_METHOD_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'redshop_payment' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('PAYMENT_METHOD_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
	         ...
	         {
				$title = JText::_( 'SHIPPING_METHOD_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'redshop_shipping' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('SHIPPING_METHOD_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
	         ...
	         {
				$title = JText::_( 'SHIPPING_BOX_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'shippingbox' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('SHIPPING_BOX_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
			 ...
			 {
				$title = JText::_( 'ONESTEP_CHECKOUT_TEMPLATE' );
				echo $this->pane->startPanel( $title, '1stepcheckout' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('ONESTEP_CHECKOUT_TEMPLATE_HINT'); ?></td></tr>
				<tr><td><?php echo htmlentities($newbillingtag);?></td></tr>
				<tr><td>
				<?php	$availablecheckout = $model->availableaddtocart('checkout');
				if(count($availablecheckout) == 0) echo JTEXT::_("ATTRIBUTE_TAGS_AVAILABLE");
				for($i=0;$i<count($availablecheckout);$i++)
				{
					echo '<span style="margin-left:10px;">{checkout_template:'.$availablecheckout[$i]->template_name.'} -- '.JText::_('CHECKOUT_TEMPLATE').'</span>';
				}	?>
				</td></tr>
				<tr><td>
				<?php	$availableshippingbox = $model->availableaddtocart('shippingbox');
				if(count($availableshippingbox) == 0) echo JTEXT::_("ATTRIBUTE_TAGS_AVAILABLE");
				for($i=0;$i<count($availableshippingbox);$i++)
				{
					echo '<span style="margin-left:10px;">{shippingbox_template:'.$availableshippingbox[$i]->template_name.'} -- '.JText::_('SHIPPING_BOX_TEMPLATE').'</span>';
				}	?>
				</td></tr>
				<tr><td>
				<?php	$availableshipping = $model->availableaddtocart('redshop_shipping');
				if(count($availableshipping) == 0) echo JTEXT::_("ATTRIBUTE_TAGS_AVAILABLE");
				for($i=0;$i<count($availableshipping);$i++)
				{
					echo '<span style="margin-left:10px;">{shipping_template:'.$availableshipping[$i]->template_name.'} -- '.JText::_('SHIPPING_METHOD_TEMPLATE').'</span>';
				}	?>
				</td></tr>
				<tr><td>
				<?php	$availablepayment = $model->availableaddtocart('redshop_payment');
				if(count($availablepayment) == 0) echo JTEXT::_("ATTRIBUTE_TAGS_AVAILABLE");
				for($i=0;$i<count($availablepayment);$i++)
				{
					echo '<span style="margin-left:10px;">{payment_template:'.$availablepayment[$i]->template_name.'} -- '.JText::_('PAYMENT_METHOD_TEMPLATE').'</span>';
				}	?>
				</td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
	        ...
	        {
				$title = JText::_( 'CHANGE_CART_ATTRIBUTE_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'cartattribute' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('CHANGE_CART_ATTRIBUTE_TEMPLATE_HINT'); ?></td></tr>
				<tr><td>
				<?php	$availableaddtocart = $model->availableaddtocart('attribute_template ');
				if(count($availableaddtocart) == 0) echo JTEXT::_("ATTRIBUTE_TAGS_AVAILABLE");
				for($i=0;$i<count($availableaddtocart);$i++)
				{
					echo '<span style="margin-left:10px;">{attribute_template:'.$availableaddtocart[$i]->template_name.'} -- '.JText::_('ATTRIBUTE_TEMPLATE').'</span>';
				}	?>
				</td></tr>
				<tr><td>
				<?php	$availableAttcartTemp = $model->availableaddtocart('attributewithcart_template');
	        ...
	        {
				$title = JText::_( 'LETTER_SEARCH_TEMPLATE' );
				...
				<tr><td><?php echo JText::_('LETTER_SEARCH_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
	        ...
	        //Product Content Template Start
	         ...
	         {
				$title = JText::_( 'PRODUCT_CONTENT_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'product_content' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('PRODUCT_CONTENT_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
	        ...
	        //Quotation Cart Template Start
	         ...
	         {
				$title = JText::_( 'QUOTATION_CART_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'product_content' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('QUOTATION_CART_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
	        ...
	        //Quotation Cart Template End
	         ...
	         {
				$title = JText::_( 'BILLING_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'billing_template' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('BILLING_TEMPLATE_HINT'); ?></td></tr>
				<tr><td>
				<?php	$available = $model->availableaddtocart('private_billing_template ');
				if(count($available) == 0) echo JTEXT::_("PRIVATE_BILLING_TEMPLATE");
				...
				if(count($available) == 0) echo JTEXT::_("COMPANY_BILLING_TEMPLATE");
				for($i=0;$i<count($available);$i++)
				{
	        ...
	        //Private Billing Template Start
	         ...
	         {
				$title = JText::_( 'PRIVATE_BILLING_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'private_billing_template' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('PRIVATE_BILLING_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
	        ...
	        //Billing Template Start
	         ...
	         {
				$title = JText::_( 'COMPANY_BILLING_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'company_billing_template' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('COMPANY_BILLING_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
	        ...
	        //Billing Template End
	         ...
	         {
				$title = JText::_( 'SHIPPING_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'shipping_template' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('SHIPPING_TEMPLATE_HINT'); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
	        ...
	        //Shipping Template End
	         ...
	         {
				$title = JText::_( 'STOCK_NOTE_TEMPLATE' );
				echo $this->pane->startPanel( $title, 'stock_note' );	?>
				<table class="adminlist">
				<tr><td><?php echo JText::_('STOCK_NOTE_TEMPLATE_HINT'); ?></td></tr>
				<tr><td><?php echo htmlentities($newbillingtag)."<br><br>".htmlentities($newshippingtag); ?></td></tr>
				</table>
				<?php	echo $this->pane->endPanel();
