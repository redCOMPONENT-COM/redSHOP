...
<script language="javascript" type="text/javascript">
	...
	function submitbutton(pressbutton) {
		...
		if (form.template_name.value == ""){
			alert( "<?php echo JText::_( 'TEMPLATE_MUST_HAVE_A_NAME', true ); ?>" );
		} else if (form.template_section.value == "0"){
			alert( "<?php echo JText::_( 'YOU_MUST_HAVE_A_SELECT_SECTION', true ); ?>" );
		} else {
			submitform( pressbutton );
		}
	}
...
<div class="col50">
	<fieldset class="adminform">
		...
		<tr><td width="100" align="right" class="key"><?php echo JText::_( 'TEMPLATE_NAME' ); ?>: </td>
			<td><input class="text_area" type="text" name="template_name" id="template_name" size="32" maxlength="250" value="<?php echo $this->detail->template_name;?>" /></td></tr>
		<tr><td valign="top" align="right" class="key"><?php echo JText::_( 'TEMPLATE_SECTION' ); ?>: </td>
		...
		<tr><td colspan="2">
			...
			<?php echo JText::_( 'PAYMENT_METHOD' ); ?>: </td>
				<td><?php echo $this->lists['payment_methods']; ?><?php echo $this->lists['shipping_methods']; ?>
				</td></tr>

			<tr><td valign="top" align="right" class="key"><?php echo JText::_( 'ORDER_STATUS' ); ?>: </td>
			<td><?php echo $this->lists['order_status']; ?></td></tr>
...
<div class="col50">
<fieldset class="adminform">
	<legend><?php echo JText::_( 'AVAILABLE_DYNAMIC_FIELDS' ); ?></legend>
...
<div class="col50">
<fieldset class="adminform">
	<legend><?php echo JText::_( 'AVAILABLE_TEXTLIBRARY_ITEMS' ); ?></legend>
