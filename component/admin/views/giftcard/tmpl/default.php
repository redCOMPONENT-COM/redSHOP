...
--><table class="adminlist">
	...
	for($i = 0, $n = count ( $this->giftcard ); $i < $n; $i ++) {
		...
		<?php $giftcard_path = 'giftcard/'.$row->giftcard_image;
				...
				<a class="modal" href="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH.$giftcard_path;?>"	title="<?php echo JText::_('COM_REDSHOP_VIEW_IMAGE' );?>"  rel="{handler: 'image', size: {}}">
		...
		<?php $giftcard_bgpath = 'giftcard/'.$row->giftcard_bgimage;
				...
				<a class="modal" href="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH.$giftcard_bgpath;?>"	title="<?php echo JText::_('COM_REDSHOP_VIEW_IMAGE' );?>"  rel="{handler: 'image', size: {}}">
