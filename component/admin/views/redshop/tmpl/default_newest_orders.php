        ...
        <table class="adminlist table table-striped" width="100%">
            <thead>
                <tr>
                    ...
                    <th align="center">
                        <?php echo Text::_('COM_REDSHOP_STATUS'); ?>
                    </th>
                    <th align="center">
            ...
            for ($i = 0, $n = count($this->neworders); $i < $n; $i++) {
                ...
                <tr class="<?php echo "row$k"; ?>" onclick="window.location.href='<?php echo $link; ?>'">
                    <td align="center"><a href="<?php echo $link; ?>" style="color:black;">
                            <?php echo $i + 1; ?>
                        </a>
                    </td>
                    ...
                    <td align="center">
                        <div class="label order_status_<?php echo strtolower(
                            $row->order_status
                        ); ?>">
                    ...
                    <td align="center">
                        <div class="label order_payment_status_<?php echo strtolower(
                            $row->order_payment_status
                        ); ?>">
                            <?php echo $row->order_payment_status; ?>
                        </div>
                    </td>
                </tr>
                <?php $k = 1 - $k;
