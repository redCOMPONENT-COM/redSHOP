...
<div id="editcell">
	...
	<thead>
		<tr>
		    ...
		    <th align="center"><?php echo JText::_( 'NUMBER_OF_ORDERS' ); ?></th>
		    <th align="center"><?php echo JText::_( 'AVG_AMOUNT_OF_ORDERS' ); ?></th>
			<th align="center"><?php echo JText::_( 'TOTAL_AMOUNT_OF_ORDERS' ); ?></th>
	  </tr>
	</thead>
	<?php
	$k = 0;
