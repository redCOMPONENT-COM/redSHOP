...
class redshopViewredshop extends JView
{
   	...
   	function display ($tpl=null)
   	{
        ...
        $layout = JRequest::getVar('layout');
   		...
   		JToolBarHelper::title( JText::_( '&nbsp;' ), 'redshop_261-x-88' );

   		if($layout != "noconfig"){
	   		JToolBarHelper :: custom( 'statistic', 'redshop_statistic32' , JText::_('STATISTIC') , JText::_('STATISTIC'), false, false );
	   		JToolBarHelper :: custom( 'wizard', 'redshop_configwizrd32' , JText::_('WIZARD') , JText::_('WIZARD'), false, false );
	        JToolBarHelper :: custom( 'configuration', 'redshop_icon-32-settings' , JText::_('CONFIG') , JText::_('CONFIG'), false, false );
	  		//JToolBarHelper :: custom( 'remote_update', 'redshop_mailcenter32' , JText::_('REMOTE_UPDATE') , JText::_('REMOTE_UPDATE'), false, false );
		...
		$lists= array();
		$option = array();
		$option[]   = JHTML::_('select.option', '0"selected"',JText::_('Select'));
		$option[]   = JHTML::_('select.option', '1', JText::_('DAILY'));
		$option[]   = JHTML::_('select.option', '2', JText::_('WEEKLY'));
		$option[]   = JHTML::_('select.option', '3', JText::_('MONTHLY'));
		$option[]   = JHTML::_('select.option', '4', JText::_('YEARLY'));
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				...
				<?php
					...
					echo JHTML::_('image', 'administrator/components/com_redshop/assets/images/'.$image, $text );
				?>
