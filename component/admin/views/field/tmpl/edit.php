...
<script language="javascript" type="text/javascript">
    Joomla.submitbutton = function (task) {
        ...
        if (task == "field.cancel") {
            ...
            if (document.getElementById("jform_name").value == "") {
                alert("<?php echo Text::_('COM_REDSHOP_FIELDS_ITEM_MUST_HAVE_A_NAME', true); ?>");
                document.getElementById("jform_name").focus();
                return false;
            } else if (document.getElementById("jform_title").value == "") {
                alert("<?php echo Text::_('COM_REDSHOP_FIELDS_ITEM_MUST_HAVE_A_TITLE', true); ?>");
                ...
                alert("<?php echo Text::_('COM_REDSHOP_FIELDS_ITEM_MUST_HAVE_A_SECTION'); ?>");
                return false;
            } else if (document.getElementById("jform_type").value == 0) {
                alert("<?php echo Text::_('COM_REDSHOP_FIELDS_ITEM_MUST_HAVE_A_TYPE'); ?>");
                return false;
            }
            if (field_type == 3 || field_type == 4 || field_type == 5 || field_type == 6 || field_type == 11 || field_type == 13) {
                ...
                for (var i = 0; i < chks.length; i++) {
                    if (chks[i].value == "") {
                        ...
                        alert("<?php echo Text::_('COM_REDSHOP_CUSTOM_FIELD_NO_ENTER_SPACE'); ?>")
                        chks[i].focus();
                        return false;
                    }
                }
    ...
    function showMessage(type) {
        ...
        if (type === "9") {
            ...
            var jmsgs = ['<?php echo Text::_("COM_REDSHOP_FIELDS_MEDIA_DEPRECATED") ?>'];
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <?php if ($this->item->id)
                        $this->form->setFieldAttribute('type', 'disabled', 'disabled') ?>
                    <?php echo $this->form->renderField('type') ?>
                    <?php if ($this->item->id)
                        $this->form->setFieldAttribute('section', 'disabled', 'disabled') ?>
            ...
            <div class="box box-primary" id="field_data">
                ...
                <div class="box-body">
                    ...
                    <div class="alert alert-warning alert-dismissible" role="alert">
                        ...
                        <?php echo Text::_('COM_REDSHOP_CUSTOM_FIELD_WARNING_CHANGE_OPTION_VALUE') ?>
                    </div>
                    </p>
                        ...
                        <tbody>
                                ...
                                <?php foreach ($this->lists['extra_data'] as $index => $extraData): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" value="<?php echo htmlentities($extraData->value_id); ?>"
                                                name="value_id[]" id="value_id<?php echo $index ?>" />
                                        </td>
                                        <td>
                                            <?php if (
                                                file_exists(
                                                ...
                                                <img width="100" height="100" class="img-polaroid"
                            ...
                            <?php else: ?>
                                ...
                                <tr>
                                    <td>
                                        <input type="text" class="divfieldText hide form-control" name="extra_name[]"
                                            id="extra_name1" value="field_temp_opt_1" />
                                        <input type="file" class="divfieldFile hide" name="extra_name_file[]" />
                                    </td>
                                    <td>
                                        <input type="text" name="extra_value[]" class="form-control" />
