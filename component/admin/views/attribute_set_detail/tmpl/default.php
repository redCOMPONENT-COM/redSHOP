...
function submitbutton(pressbutton) {
	...
	if (form.attribute_set_name.value == ""){
		...
		alert( "<?php
		echo JText::_ ( 'PRODUCT_ITEM_MUST_HAVE_A_NAME', true );
		?>" );
	}
	else {
...
function oprand_check(s){
	...
	if(oprand != '+' && oprand != '-' && oprand != '=' ){
		alert( "<?php
		echo JText::_ ( 'WRONG OPRAND', true );
		?>" );
...
echo JText::_ ( 'ATTRIBUTE_SET_INFORMATION' );
?></legend>
		...
		<table>
			<tr>
				<td width="100" align="right" class="key">
					<label for="name"> <?php echo JText::_ ( 'ATTRIBUTE_SET_NAME' ); ?>: </label>
				</td>
				<td>
					<input class="text_area" type="text" name="attribute_set_name" id="attribute_set_name" size="32" maxlength="250"
						value="<?php echo $this->detail->attribute_set_name;?>" />
                	<?php
						echo JHTML::tooltip ( JText::_ ( 'TOOLTIP_ATTRIBUTE_SET_NAME' ), JText::_ ( 'ATTRIBUTE_SET_NAME' ), 'tooltip.png', '', '', false );
?> 				</td>
			</tr>
			<tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td>
		<fieldset class="adminform"><legend><?php echo JText::_( 'PRODUCT_ATTRIBUTES' ); ?></legend>
		<table class="admintable" width="100%" border="0" cellspacing="0" cellpadding="0" >
			<tr>
				<td colspan="2">
				<div><?php echo JText::_('HINT_ATTRIBUTE');?></div>
				</td>
			</tr>
			<tr>
				<td colspan="2"><?php echo JText::_('COPY_ATTRIBUTES_FROM_ATTRIBUTE_SET');?></td>
			</tr>

			<tr>
				<td colspan="2">
					<a class="btn_attribute" href="javascript:addNewRow_attribute('attribute_table')">
						<span id="new_attribute"><?php echo "+ "; echo JText::_( 'NEW_ATTRIBUTE' ); ?></span>
					</a>
				</td>
			</tr>
		</table>
	...
	<tr>
		<td>
			...
			<tr>
				<td colspan="5" align="right"><span id="atitle" style="display: none;">
				<?php echo JText::_( 'TITLE' ); ?> </span> <span id="atitlerequired"
					style="display: none;"> <?php echo JText::_('ATTRIBUTE_REQUIRED');?>
				</span> <span id="atitlepublished" style="display: none;"> <?php echo JText::_ ( 'PUBLISHED' ); ?>
				</span> <span id="spn_allow_multiple_selection" style="display: none;">
				<?php echo JText::_('ALLOW_MULTIPLE_PROPERTY_SELECTION');?> </span> <span
					id="spn_hide_attribute_price" style="display: none;"> <?php echo JText::_('HIDE_ATTRIBUTE_PRICE');?>
				</span> <span id="spn_display_type" style="display: none;"> <?php echo JText::_('DISPLAY_ATTRIBUTE_TYPE');?>
				</span> <span id="aproperty" style="display: none;"> <?php echo JText::_( 'SUB_ATTRIBUTE' ); ?>
				</span> <span id="aprice" style="display: none;"> <?php echo JText::_( 'PRICE' ); ?>
				</span> <span id="new_property" style="display: none;"> <?php echo JText::_( 'SUB_ATTRIBUTE' ); ?>
				</span> <span id="new_sub_property" style="display: none;"> <?php echo JText::_( 'NEW_SUB_PROPERTY' ); ?>
				</span> <span id="sub_atitlerequired" style="display: none;"> <?php echo JText::_('SUBATTRIBUTE_REQUIRED');?>
				</span> <span id="sub_multiselected" style="display: none;"> <?php echo JText::_ ( 'SUBATTRIBUTE_MULTISELECTED' );?>
				</span> <span id="delete_attribute" style="display: none;"> <?php echo JText::_( 'DELETE_ATTRIBUTE' ); ?>
				</span> <span id="aimage" style="display: none;"> <?php echo JText::_( 'IMAGE_UPLOAD' ); ?>
				</span> <span id="aordering" style="display: none;"> <?php echo JText::_( 'ORDERING' ); ?>
				</span> <span id="adselected" style="display: none;"> <?php echo JText::_( 'DEFAULT_SELECTED' ); ?>
				</span> <span id="showpropertytitlespan" style="display: none;"> <?php echo JText::_( 'SUBPROPERTY_TITLE' ); ?></span>
				<span id="showsingleselectlanguagetxt" style="display: none;"><?php echo JText::_( 'SINGLE_SELECT_BOX' ); ?></span>
				</td>
			</tr>
			...
			<?php
				...
				if($this->lists['attributes'] != '')
				{
					...
					<tr>
						<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="0" id="<?php echo "attribute_table".$attribute_id;?>">
								<tr>
									<td>
									...
									<table width="100%" border="0" cellspacing="0"
											...
											<tr>
												<td class="red_blue_blue td1" align="left">
													<img class="arrowimg" id="arrowimg<?php echo $k ?>" onclick="showhidearrow('attribute_table_pro', '<?php echo $k ?>')" src="../administrator/components/com_redshop/assets/images/arrow.png" alt="img" />
													<span><?php echo JText::_( 'TITLE' ); ?></span>
												</td>
												
												<td align="right" class="td2">
													<input type="text" class="text_area input_t1" size="22" name="attribute[<?php echo $k;?>][name]" value="<?php echo htmlspecialchars(urldecode($attibute_data['attribute_name'])); ?>">
												</td>
												
												<td align="right" nowrap="nowrap" class="td3">
													<span><?php echo JText::_( 'ORDERING' ); ?>:&nbsp;</span>
													<input class="input_t4" type="text" name="attribute[<?php echo $k;?>][ordering]" size="2" value="<?php echo $attibute_data['ordering']; ?>">
												</td>
												
												<td align="right" class="td4">
													<span><?php echo JText::_('ATTRIBUTE_REQUIRED');?>:&nbsp;</span>
													<input type="checkbox" class="text_area" size="55" name="attribute[<?php echo $k;?>][required]" <?php echo $checked_required;?> value="1">
												</td>
												
												<td align="right" class="td5">
													<span><?php echo JText::_('PUBLISHED');?>:&nbsp;</span>
													<input type="checkbox" class="text_area" size="55" name="attribute[<?php echo $k;?>][published]" <?php echo $attribute_published;?> value="1"></td>
												...
												<td align="right" class="td7">
													<input
														...
														value="<?php echo JText::_( 'DELETE_ATTRIBUTE' ); ?>"
								...
								<tr>
									<td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="grey_area" id="attribute_table_pro<?php echo $k;?>">
											<tr>
												<td class="td1" align="left" style="padding-left: 0px !important;">
													<a class="btn_attribute" href="javascript:addproperty('property_table<?php echo $k;?>','<?php echo $k;?>')">
														<span><?php echo "+ "; echo JText::_( 'ADD_SUB_ATTRIBUTE' ); ?></span>
													</a>
												</td>
												
												<td align="right" class="td2">
													<span> <?php echo JText::_('ALLOW_MULTIPLE_PROPERTY_SELECTION');?>:&nbsp;</span>
													<input type="checkbox" size="5" 
													name="attribute[<?php echo $k;?>][allow_multiple_selection]"
													<?php echo $multiple_selection;?>><!-- &nbsp;&nbsp;<?php echo JHTML::tooltip(JText::_( 'TOOLTIP_ALLOW_MULTIPLE_PROPERTY_SELECTION' ), JText::_( 'ALLOW_MULTIPLE_PROPERTY_SELECTION' ), 'tooltip.png', '', '', false); ?> -->
												...
												<td align="right" class="td5">
													<span> <?php echo JText::_('HIDE_ATTRIBUTE_PRICE');?>:&nbsp;</span>
													<input type="checkbox" size="5"
												...
												<td align="right" class="td6" nowrap="nowrap">
													<?php echo JText::_('DISPLAY_ATTRIBUTE_TYPE');?>:&nbsp;
													<select
														name="attribute[<?php echo $k;?>][display_type]">
															<option value="dropdown"
															<?php if($display_type =="dropdown") { echo "selected";}?>>
																Dropdown List
															</option>
															<option value="radio"
															<?php if($display_type =="radio") {echo "selected";}?>>
																<?php echo JText::_('RADIOBOX');?>
															</option>
													</select>
												</td>
												...
												<td colspan="12">
													<div class="speac-area">
														<table width="100%" border="0" cellspacing="0"
															...
															<tr valign="top"  class="attr_tbody" id="attr_tbody<?php echo $k.$g;?>">
																<td>
																	<table class="attribute_value" width="100%" border="0"
																		...
																		<tr valign="top">
																			<td class="red_blue_blue td1" align="left">
																				<img class="arrowimg" id="arrowimg<?php echo $k ?><?php echo $g;?>" onclick="showhidearrow('attribute_parameter_tr', '<?php echo $k ?><?php echo $g;?>'); showhidearrow('sub_property', '<?php echo $k ?><?php echo $g;?>')" src="../administrator/components/com_redshop/assets/images/arrow.png" alt="img" /> 
																				<span> <?php echo JText::_( 'SUB_ATTRIBUTE' ); ?></span>
																			</td>
																			...
																			<td nowrap="nowrap" align="right" class="td4">
																				<span> <?php echo JText::_( 'DEFAULT_SELECTED' ); ?>:</span>
																				<input type="checkbox"name="attribute[<?php echo $k;?>][property][<?php echo $g;?>][default_sel]"
																				<?php
																			...
																			if($property_id)
																			{
																				?> <span> <?php echo JText::_( 'PROPERTY_NUMBER' ); ?>:&nbsp;
																			</span> <?php 
																			}
																			?>
																			<?php
																			...
																			if($property_id)
																			{
																				...
																				class="vpnrequired input_t5" size="14"><!-- &nbsp;&nbsp;<?php echo JHTML::tooltip(JText::_( 'TOOLTIP_PROPERTY_NUMBER' ), JText::_( 'PROPERTY_NUMBER' ), 'tooltip.png', '', '', false); ?> -->
	
																				<?php } 
																				$ilink = JRoute::_('index.php?tmpl=component&option=com_redshop&view=media&fsec=property&fid='.$k.$g.'&layout=thumbs');
																				?>
																			</td>
																			<input type="hidden" name="attribute[<?php echo $k;?>][property][<?php echo $g;?>][property_id]" value="<?php echo $property_id;?>">
																			<input type="hidden" name="imagetmp[<?php echo $k;?>][value][]" value="<?php echo $property->property_image;?>">
																			<input type="hidden" name="attribute[<?php echo $k;?>][property][<?php echo $g;?>][mainImage]" id="propmainImage<?php echo $k.$g;?>" value="">
																			...
																			<td align="left" colspan="12" class="td7">
																				...
																				<table width="100%" border="0" cellspacing="0"
																					...
																					<tr valign="top">
																						...
																						<td rowspan="1" align="right" nowrap="nowrap" class="td1" style="padding-right: 10px;"><a class="modal"
																							rel="{handler: 'iframe', size: {x: 950, y: 500}}"
																							title="" href="<?php echo $medialink;?>"> <img
																								src="../administrator/components/com_redshop/assets/images/media16.png"
																							...
																							href="index.php?tmpl=component&option=com_redshop&amp;view=attributeprices&amp;section_id=<?php echo $property_id;?>&amp;cid=<?php echo $this->detail->product_id; ?>&amp;section=property">
																								<img
																								src="../administrator/components/com_redshop/assets/images/discountmanagmenet16.png"
																								align="absmiddle" alt="media">
																						</a> <a class="modal"
																							rel="{handler: 'iframe', size: {x: 950, y: 500}}"
																							title=""
																							href="index.php?tmpl=component&option=com_redshop&amp;view=product_detail&amp;section_id=<?php echo $property_id;?>&amp;cid=<?php echo $this->detail->product_id; ?>&amp;layout=productstockroom&amp;property=property">
																								<img
																								src="../administrator/components/com_redshop/assets/images/stockroom16.png"
																								align="absmiddle" alt="media">
																						</a>
																						</td>
																						...
																						<td class="td2" align="left"><span>
																								<div class="button2-left">
																									<div class="image">
																										<a class="modal" title="Image"
																											href="<?php echo $ilink;?>"
																											rel="{handler: 'iframe', size: {x: 900, y: 500}}"></a>
																									</div>
																								</div>
																						</span> <span> <input type="file"
																						...
																						<td class="td3" align="left"><?php $is_img = true;
																							if ($property->property_image != "")
																							{
																								...
																								<a class="modal" title="<?php echo $property->property_image;?>" rel="{handler: 'image', size: {}}" href="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH.'product_attributes/'.$property->property_image; ?>">
																									<img  id="propertyImage<?php echo $k.$g;?>" alt='' title='' src='<?php echo $url?>components/com_redshop/helpers/thumb.php?filename=product_attributes/<?php echo $property->property_image?>&newxsize=50&newysize=0&swap=1'>
																								</a>
																							</span> 
																						</td>
																						<td class="td4" align="left">
																							<input id="btn_attribute_remove_property_<?php echo $property->property_id;?>" value="Remove"
															...
															<tr class="attribute_parameter_tr" id="attribute_parameter_tr<?php echo $k.$g;?>" <?php echo ($total_subattr == 0 ? 'style="display:none"' : '') ?>>
																<td>
																	<table width="100%" border="0" cellspacing="0"
																		cellpadding="0" class="attribute_parameter"  id="attribute_parameter<?php echo $property->property_id;?>">
																		<tr>
																			<td>
																				<table width="100%" border="0" cellspacing="0"
																					cellpadding="0">
																					<tr valign="top">
																						...
																						<div <?php echo $style?>
																							...
																							<td class="red_blue_blue td1" align="left">
																								<span style="padding-left: 10px;"><?php echo JText::_( 'TITLE' ); ?></span>
																							...
																							<td class="td3">&nbsp;</td>
																							<td nowrap="nowrap" align="right" class="td4">
																								<span><?php echo JText::_('SUBATTRIBUTE_REQUIRED');?>:</span>
																								<input type="checkbox"
																								...
																								?>><!-- &nbsp;&nbsp;<?php echo JHTML::tooltip(JText::_( 'TOOLTIP_SUBATTRIBUTE_REQUIRED' ), JText::_( 'SUBATTRIBUTE_REQUIRED' ), 'tooltip.png', '', '', false); ?> -->
																							</td>
																							<td nowrap="nowrap" class="td5" align="right">
																								<span><?php echo JText::_('SUBATTRIBUTE_MULTISELECTED');?>:</span>
																								<input
																								type="checkbox"
																								...
																								?>><!-- &nbsp;&nbsp;<?php echo JHTML::tooltip(JText::_( 'TOOLTIP_SUBATTRIBUTE_MULTISELECTED' ), JText::_( 'SUBATTRIBUTE_MULTISELECTED' ), 'tooltip.png', '', '', false); ?> -->
																							</td>
																							<td align="right" class="td6"><span><?php echo JText::_('DISPLAY_ATTRIBUTE_TYPE');?>:</span>
																							<select
																								name="attribute[<?php echo $k;?>][property][<?php echo $g;?>][setdisplay_type]">
																									<option value="dropdown"
																									<?php if($property->setdisplay_type =="dropdown") { echo "selected";}?>>
																										Dropdown List
																									</option>
																									<option value="radio"
																									<?php if($property->setdisplay_type =="radio") {echo "selected";}?>>
																										<?php echo JText::_('RADIOBOX');?>
																									</option>
																		...
																		<tr>
																			<td valign="top"
																				...
																				href="javascript:showpropertytitle('<?php echo $k.$g;?>'); addsubproperty('sub_attribute_table<?php echo $k.$g;?>','<?php echo $k;?>','<?php echo $g;?>')">
																					<span id="new_sub_property"> <?php echo "+ "; echo JText::_( 'NEW_SUB_PROPERTY' ); ?>
																				</span>
																			</a>
																			</td>
																			<td style="padding:0px;">
																							...
																							<table width="100%" border="0"
																								...
																								<tr valign="top">
																									...
																									<td class="td4" align="right" nowrap="nowrap">
																										...
																										<?php if($subvalue->setdefault_selected==1){echo "checked";}?>
																										value="1" /></td>
																									...
																									<!-- START MY CODE -->
																									<td  align="right"  class="td6" nowrap="nowrap"><?php if($subvalue->subattribute_color_id != 0)
																									{?> <?php echo JText::_( 'SUBPROPERTY_NUMBER' ); ?>:&nbsp;
																										<?php } ?>
																									...
																									{?> <input type="text" size="14"
																										...
																										class="vpnrequired input_t5"><!-- &nbsp;&nbsp;<?php echo JHTML::tooltip(JText::_( 'TOOLTIP_SUBPROPERTY_NUMBER' ), JText::_( 'SUBPROPERTY_NUMBER' ), 'tooltip.png', '', '', false); ?> -->
																									...
																									<td align="left" colspan="12" class="td7">
																										...
																										<table width="100%" border="0" cellspacing="0"
																											...
																											<tr valign="top">
																												...
																												<td rowspan="3" align="right" nowrap="nowrap" class="td1" style="padding-right: 10px;"><?php if($subvalue->subattribute_color_id != 0)
																												{
										...
										/*index3.php?option=com_redshop&amp;view=product_detail&amp;fsec=subproperty&amp;section_id=<?php echo $subvalue->subattribute_color_id;?>&amp;cid=<?php echo $this->detail->product_id; ?>&amp;layout=property_images&amp;showbuttons=1*/	?>
																												...
																												<td class="td4" align="left">
																													...
																													title="<?php echo JText::_('REMOVE_IMAGE');?>"
																													class="btn_attribute_remove" id="btn_attribute_remove_subproperty_<?php echo $subvalue->subattribute_color_id;?>" />
																													
																												<?php } else {?>
																													&nbsp;</td><td class="td4" align="left">
	...
	?>
																					...
																					<tr style="display: none;">
																						...
																						<td><span><?php echo JText::_( 'PRICE' ); ?>
																						</span>
																						</td>
	...
	?>
				...
				<span id="delete_attribute" style="display: none;"><?php echo JText::_( 'DELETE_ATTRIBUTE' ); ?></span>
				<span id="aimage" style="display: none"><?php echo JText::_( 'IMAGE_UPLOAD' ); ?>
				</span>
				<span id="aproperty" style="display: none"><?php echo JText::_( 'SUB_ATTRIBUTE' ); ?>
				</span>
				<span id="aprice" style="display: none"><?php echo JText::_( 'PRICE' ); ?>
				</span>
				<tr>
					<td colspan="5"><input type="hidden" name="total_table"
						id="total_table" value="<?php echo $k;?>"> <input type="hidden"
						name="total_g" id="total_g" value="<?php echo $g;?>"> <input
