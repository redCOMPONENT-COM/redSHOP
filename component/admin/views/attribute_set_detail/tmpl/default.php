...
<form action="<?php
                echo JRoute::_($this->request_url) ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
    <div class="col50">
                    ...
                    <td width="50%">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input class="text_area" type="text" name="attribute_set_name" id="attribute_set_name" size="32" maxlength="250" value="<?php echo $this->detail->attribute_set_name; ?>" />
                                    <?php
                                    echo JHTML::tooltip(
