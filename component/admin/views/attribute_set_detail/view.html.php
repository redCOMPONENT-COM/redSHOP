...
class attribute_set_detailVIEWattribute_set_detail extends JView
{
	...
	{ 
		...
		JToolBarHelper::title(JText::_( 'ATTRIBUTE_SET_DETAIL' ),'redshop_attribute_bank48');
		...
		JToolBarHelper::title(   JText::_( 'ATTRIBUTE_SET' ).': <small><small>[ ' . $text.' ]</small></small>' , 'redshop_attribute_bank48' );
