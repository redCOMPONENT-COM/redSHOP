    ...
    <div id="editcell">
        ...
        <table class="adminlist table table-striped">
            ...
            <tr>
                ...
                <th width="15%"><?php echo JHTML::_(
                        'grid.sort',
                        'COM_REDSHOP_MINIMUM_DELIVERY_TIME',
                        'min_del_time',
                        $this->lists ['order_Dir'],
                        $this->lists ['order']
                    ); ?></th>
                <th width="15%"><?php echo JHTML::_(
                        'grid.sort',
                        'COM_REDSHOP_MAXIMUM_DELIVERY_TIME',
                        'max_del_time',
                        $this->lists ['order_Dir'],
                        $this->lists ['order']
                    ); ?></th>
            ...
            for ($i = 0, $n = count($this->stockroom); $i < $n; $i++) {
                ...
                $link = JRoute::_(
                    'index.php?option=com_redshop&view=stockroom_detail&task=edit&cid[]=' . $row->stockroom_id
                ); ?>
