			...
			<div>
				<div>
					...
					echo '<font color=green>';
						echo $product_inserted." ".JTEXT::_('PRODUCT_SYNC')."<br />&nbsp;&nbsp;".$product_updated." ".JTEXT::_('PRODUCT_SYNC_UPDATED')."<br />";
						echo $category_total." ".JTEXT::_('CATEGORY_SYNC')."<br />";
						echo $shopper_total." ".JTEXT::_('SHOPPER_SYNC')."<br />";
						echo $customer_total." ".JTEXT::_('CUSTOMER_SYNC')."<br />";
						echo $orders_total." ".JTEXT::_('ORDER_SYNC')."<br />";
						echo $status_total." ".JTEXT::_('STATUS_SYNC')."<br />";
						echo $manufacturer_total." ".JTEXT::_('MANUFACTURER_SYNC')."<br />";	
						echo '</font>';
					}else{
						echo '<font color=red>';
						echo JTEXT::_('NO_VM');
