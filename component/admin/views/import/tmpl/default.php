...
/** @scrutinizer ignore-deprecated */JHtml::script('com_redshop/jquery.iframe-transport.min.js', false, true);
/** @scrutinizer ignore-deprecated */JHtml::script('com_redshop/jquery.fileupload.min.js', false, true);
