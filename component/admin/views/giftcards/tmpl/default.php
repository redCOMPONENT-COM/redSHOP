...
<script>
    Joomla.submitbutton = function (pressbutton) {
        ...
        if (pressbutton === "giftcards.delete") {
            if (confirm("<?php echo Text::_('COM_REDSHOP_DELETE_CONFIRM') ?>")) {
                form.submit();
            } else {
...
<form action="<?php echo Redshop\IO\Route::_('index.php?option=com_redshop&view=giftcards'); ?>" method="post"
            ...
            <thead>
                <tr>
                    ...
                    <th width="10%" class="hidden-phone">
                        <?php echo Text::_('COM_REDSHOP_GIFTCARD_IMAGE'); ?>
                    </th>
                    <th width="15%" class="hidden-phone">
                        <?php echo Text::_('COM_REDSHOP_GIFTCARD_BGIMAGE'); ?>
                    </th>
                    <th width="10%" class="center">
                        <?php echo JHtml::_(
                            'grid.sort',
                            'COM_REDSHOP_GIFTCARD_PRICE',
                            'giftcard_price',
                            $listDirn,
                            $listOrder
                        ); ?>
                    ...
                    <th width="1%" style="min-width:55px" class="nowrap center">
                        <?php echo JHtml::_(
                            'grid.sort',
                            'COM_REDSHOP_GIFTCARD_PUBLISHED',
                            'published',
                            $listDirn,
                            $listOrder
                        ); ?>
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td class="has-context">
                            <div class="pull-left break-word">
                                <a class="hasTooltip" href="<?php echo Redshop\IO\Route::_(
