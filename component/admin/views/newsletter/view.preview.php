...
class newsletterViewnewsletter extends JView
{
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('NEWSLETTER') );

   		JToolBarHelper::title(   JText::_( 'NEWSLETTER_MANAGEMENT' ), 'redshop_newsletter48' );
		...
		$optionoprand = array();
		$optionoprand[]   	= JHTML::_('select.option', 'select', JText::_('SELECT'));
		$optionoprand[]   	= JHTML::_('select.option', '>=', JText::_('>='));
		$optionoprand[]   	= JHTML::_('select.option', '<=', JText::_('<='));
		$optionoprand[]   	= JHTML::_('select.option', '=', JText::_('='));
		$lists['oprand'] 	= JHTML::_('select.genericlist',$optionoprand,  'oprand', 'class="inputbox" size="1" ' , 'value', 'text',  $oprand );

		$country_option = array();
		$country_option[]   	= JHTML::_('select.option', '', JText::_('SELECT_COUNTRY'));
		...
		$shopper_option[]   	= JHTML::_('select.option', '', JText::_('SELECT'));
