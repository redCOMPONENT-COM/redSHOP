...
$sel[0]         = new stdClass;
$sel[0]->id     = 0;
$sel[0]->text   = Text::_('COM_REDSHOP_SELECT');
...
<script language="javascript" type="text/javascript">
	...
	function drawChart() {
		...
		data.addColumn('string', '<?php echo Text::_('COM_REDSHOP_NEWSLETTER'); ?>');
		data.addColumn('number', '<?php echo Text::_('COM_REDSHOP_NO_OF_READ_NEWSLETTER'); ?>');
...
<form action="index.php?option=com_redshop&view=newsletter&layout=statistics" method="post" name="adminForm"
	id="adminForm">
	<fieldset class="adminform">
		<legend>
			<?php echo Text::_('COM_REDSHOP_STATISTICS_FILTER'); ?>
		</legend>
	...
	<fieldset class="adminform">
		<legend>
			<?php echo Text::_('COM_REDSHOP_NEWSLETTER_STATISTICS'); ?>
		</legend>
