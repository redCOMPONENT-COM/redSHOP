...
<script language="javascript" type="text/javascript">
	function submitbutton(pressbutton) 
	{
		...
		if (form.tags_name.value == ""){
			alert( "<?php echo JText::_( 'TAGS_NAME_MUST_FILLED', true ); ?>" );
		} else {
			submitform( pressbutton );
		}
	}
