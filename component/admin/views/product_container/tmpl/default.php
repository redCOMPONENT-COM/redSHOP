...
$print_link=JRoute::_ ( 'index3.php?option=com_redshop&view=product_container&showbuttons=1&container='.$container.'&filter_manufacturer='.$filter_manufacturer.'&filter_container='.$filter_container );	
...
<?php } ?>
	...
	<thead>
		<tr>
			...
			<th>
				<?php echo JHTML::_('grid.sort',  'PRODUCT_DESCRIPTION', 'p.product_description', $this->lists['order_Dir'], $this->lists['order'] ); ?>
		 	</th>
		 	<th>
				<?php echo JTEXT::_('CATEGORY'); ?>
		 	</th>
			<th>
				<?php echo JTEXT::_('CONTAINER_NO'); ?>
		 	</th>
			<th>
	...
	?>	
 <tr><td  align="right" colspan="8">Total volume</td><td><?php echo $totvolume; ?>
 </td></tr>
 <?php if($showbuttons != 1){ ?>
<tfoot>
		<td colspan="12">
