...
class product_containerViewproduct_container extends JView
{
	...
	{	
		...
		if($container == 1)
		{
			$document->setTitle( JText::_('CONTAINER_ORDER_PRODUCTS'));
			JToolBarHelper::title(   JText::_( 'CONTAINER_ORDER_PRODUCTS' ), 'redshop_container48' );
		...
		{
			JToolBarHelper::title(   JText::_( 'CONTAINER_PRE_ORDER' ) , 'redshop_container48' );
			$document->setTitle( JText::_('CONTAINER_PRE_ORDER') );
