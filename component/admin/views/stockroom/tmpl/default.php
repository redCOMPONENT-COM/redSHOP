...
<div id="editcell">
<table width="100%"> 
	<tr><td valign="top" align="left" class="key">
...
<table class="adminlist">
	<thead>
		<tr><th width="5%"><?php echo JText::_ ( 'NUM' );?></th>
			<th width="5%"><input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo count ( $this->stockroom );?>);" /></th>
			<th class="title"><?php echo JHTML::_ ( 'grid.sort', 'STOCKROOM_NAME', 'stockroom_name', $this->lists ['order_Dir'], $this->lists ['order'] );?></th>
			<th width="10%"><?php echo JHTML::_ ( 'grid.sort', 'MINIMUM_DELIVERY_TIME', 'min_del_time', $this->lists ['order_Dir'], $this->lists ['order'] );?></th>
			<th width="10%"><?php echo JHTML::_ ( 'grid.sort', 'MAXIMUM_DELIVERY_TIME', 'max_del_time', $this->lists ['order_Dir'], $this->lists ['order'] );?></th>
			<th width="5%" nowrap="nowrap"><?php echo JHTML::_ ( 'grid.sort', 'PUBLISHED', 'published', $this->lists ['order_Dir'], $this->lists ['order'] );?></th>
			<th width="5%" nowrap="nowrap"><?php echo JHTML::_ ( 'grid.sort', 'SHOW_ON_FRONTEND', 'show_in_front', $this->lists ['order_Dir'], $this->lists ['order'] );?></th>
			<th width="5%" nowrap="nowrap"><?php echo JHTML::_ ( 'grid.sort', 'ID', 'stockroom_id', $this->lists ['order_Dir'], $this->lists ['order'] );?></th>
		</tr>
	</thead>
<?php
	$k = 0;
	for($i = 0, $n = count ( $this->stockroom ); $i < $n; $i ++) 
	{
		...
		<tr class="<?php echo "row$k";?>">
			...
			<td><a href="<?php echo $link;?>" title="<?php echo JText::_ ( 'EDIT_STOCKROOM' );?>">
