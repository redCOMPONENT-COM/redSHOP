...
<div align="right"><a href="<?php echo $addlink;?>" style="text-decoration: none;"><?php echo JTEXT::_('ADD');?></a></div>
<table class="adminlist">
<thead>
<tr><th class="title"><?php echo JTEXT::_ ( 'FIRST_NAME');?></th>
	<th><?php echo JTEXT::_ ( 'LAST_NAME' );?></th>
	<th><?php echo JTEXT::_ ( 'ID' );?></th>
	<th><?php echo JTEXT::_ ( 'DELETE' );?></th></tr></thead>
<?php
	$x = 0;
	for($j=0,$n=count($shipping_data);$j<$n;$j++)
	{
		...
		<tr class="<?php echo "row$x";?>">
			<td align="center"><a href="<?php echo $link;?>" title="<?php echo JText::_ ( 'EDIT_USER' );?>"><?php echo $row->firstname;?></a></td>
			<td align="center"><?php echo $row->lastname;?></td>
			<td align="center"><?php echo $row->users_info_id;?></td>
			<td align="center"><a href="<?php echo $link_delete;?>" title="<?php echo JText::_ ( 'DELETE_SHIPPING_DETAIL' );?>"><?php echo JText::_ ( 'DELETE' );?></a></td></tr>
<?php
	$x = 1 - $x;
	}?>
</table>
