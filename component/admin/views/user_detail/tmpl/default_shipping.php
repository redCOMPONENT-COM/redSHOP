...
<div id="editcell">
    ...
    <div align="right"><a href="<?php echo $addlink; ?>" class="btn btn-success" style="text-decoration: none;">
    ...
    <table class="adminlist table table-striped">
        <thead>
            <tr>
                <th class="title">
                    <?php echo Text::_('COM_REDSHOP_FIRST_NAME'); ?>
                </th>
                <th>
                    <?php echo Text::_('COM_REDSHOP_LAST_NAME'); ?>
                </th>
                <th>
                    <?php echo Text::_('COM_REDSHOP_ID'); ?>
                </th>
                <th>
        ...
        for ($j = 0, $n = count($shipping_data); $j < $n; $j++) {
            ...
            <tr class="<?php echo "row$x"; ?>">
                <td align="center"><a href="<?php echo $link; ?>" title="<?php echo Text::_(
                ...
                <td align="center">
                    <?php echo $row->users_info_id; ?>
                </td>
                <td align="center"><a href="<?php echo $link_delete; ?>" title="<?php echo Text::_(
                       'COM_REDSHOP_DELETE_SHIPPING_DETAIL'
                   ); ?>">
                        <?php echo Text::_('COM_REDSHOP_DELETE'); ?>
                    </a>
                </td>
