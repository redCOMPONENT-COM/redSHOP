                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo JHTML::tooltip(
                            JText::_('COM_REDSHOP_TOOLTIP_SUBJECT'),
                            JText::_('COM_REDSHOP_SUBJECT'),
                            'tooltip.png',
                            '',
                            '',
                            false
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($this->detail->template_id != 0) {
                            ?>
                            <span style="width:10%;">
					<a href="index.php?option=com_redshop&task=template.edit&id=<?php echo $this->detail->template_id ?>"
                       target="_blank">
