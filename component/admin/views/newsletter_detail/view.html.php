...
class newsletter_detailVIEWnewsletter_detail extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'NEWSLETTER_MANAGEMENT_DETAIL' ), 'redshop_newsletter48' );
		...
		JToolBarHelper::title(   JText::_( 'NEWSLETTER' ).': <small><small>[ ' . $text.' ]</small></small>' , 'redshop_newsletter48' );
		if($layout!="statistics")
		{
