...
class addressfields_listingViewaddressfields_listing extends JView
{
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('FIELDS') );
   		...
   		JToolBarHelper::title(   JText::_( 'ADDRESS_FIELD_MANAGEMENT' ), 'redshop_fields48' );
		...
		$sectionlist = array(
		  JHTML::_('select.option', '7', JText::_('CUSTOMER_ADDRESS') ),
		  JHTML::_('select.option', '8', JText::_('COMPANY_ADDRESS') ),
		  JHTML::_('select.option', '14', JText::_('CUSTOMER_SHIPPING_ADDRESS') ),
		  JHTML::_('select.option', '15', JText::_('COMPANY_SHIPPING_ADDRESS') )
		);
