...
{ 
   	...
   	{ 
		...
		$document->setTitle( JText::_('STATISTIC') );
//		$document->addScript('http://www.google.com/jsapi');
   	    
   		JToolBarHelper::title(   JText::_( 'STATISTIC' )." :: ".$title, 'redshop_statistic48' );
