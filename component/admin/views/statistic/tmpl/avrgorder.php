...
<table width="100%">
	...
	<?php if($this->filteroption) {	?>
			<th width="60%" align="center"><?php echo JText::_( 'DATE' ); ?></th>
	<?php }	?>
			<th width="40%" align="center"><?php echo JText::_( 'AVG_ORDER_AMOUNT_CUSTOMER' ); ?></th></tr></thead>
<?php 		for ($i=$start,$j=0;$i<($start+$end);$i++,$j++)
		...
		<tr><td align="center"><?php echo $i+1;?></td>
			...
			<?php }		?>
       		<td align="center"><?php echo $producthelper->getProductFormattedPrice($row->avg_order);//CURRENCY_SYMBOL.number_format($row->avg_order,2,PRICE_SEPERATOR,THOUSAND_SEPERATOR);?></td></tr>
	<?php }	?>
