...
<!--<fieldset class="adminform">
	...
	<thead>
		<tr><th width="60%" align="center"><?php if($this->filteroption!=0) {echo JText::_('COM_REDSHOP_DATE');}else{echo JText::_('COM_REDSHOP_HASH');}?></th>
			<th width="40%" align="center"><?php echo JText::_('COM_REDSHOP_TOTAL_VISITORS' ); ?></th></tr></thead>
<?php   for ($i=$start,$j=0;$i<($start+$end);$i++,$j++)
		...
		<tr><td align="center"><?php if($this->filteroption!=0) {echo $row->viewdate;}else{echo JText::_('COM_REDSHOP_HASH');}?></td>
