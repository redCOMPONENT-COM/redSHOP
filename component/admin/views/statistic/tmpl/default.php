...
<!--<fieldset class="adminform">
	...
	<thead>
		<tr><th width="60%" align="center"><?php if($this->filteroption) {echo JText::_('COM_REDSHOP_DATE');}else{echo JText::_('COM_REDSHOP_HASH');}?></th>
...
<?php   for ($i=$start,$j=0;$i<($start+$end);$i++,$j++)
		...
		<tr><td align="center"><?php if($this->filteroption) {echo $row->viewdate;}else{echo JText::_('COM_REDSHOP_HASH');}?></td>
