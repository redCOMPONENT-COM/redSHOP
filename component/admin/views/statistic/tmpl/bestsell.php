...
<table width="100%">
	...
	<table class="adminlist" width="100%"><thead>
		...
		<tr><th align="center"><?php echo JText::_( '#' ); ?></th>
			<th align="center"><?php echo JText::_( 'PRODUCT_NAME' ); ?></th>
			<th align="center"><?php echo JText::_( 'PRODUCT_PRICE' ); ?></th>
			<th align="center"><?php echo JText::_( 'NUMBER_OF_TIMES_SOLD' ); ?></th></tr></thead>
<?php 	$disdate = "";
		...
		<tr><td colspan="4"><?php echo JText::_("DATE").": ".$disdate;?></td></tr>
	<?php 	}
		...
		<tr><td align="center"><?php echo $i+1; ?></td>
			<td><a href="<?php echo $link; ?>" title="<?php echo JText::_( 'EDIT_PRODUCT' ); ?>">
			...
			<td align="center"><?php  echo $row->totalproduct;?></td></tr>
	<?php	}
		}	?>
		<tfoot><td colspan="4"><?php echo $this->pagination->getListFooter(); ?></td></tfoot>
	</table>
</div>
