...
<table class="admintable table">
    ...
    <tr>
        <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_CURRENCY_NAME'); ?>::<?php echo JText::_(
    ...
    <tr>
        <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_CURRENCY_SYMBOL'); ?>::<?php echo JText::_(
    ...
    <tr>
        <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_PRICE_SEPERATOR_LBL'); ?>::<?php echo JText::_(
    ...
    <tr>
        <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_THOUSAND_SEPERATOR_LBL'); ?>::<?php echo JText::_(
    ...
    <tr>
        <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_PRICE_DECIMAL_LBL'); ?>::<?php echo JText::_(
