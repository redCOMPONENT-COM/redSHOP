    ...
    <div>
        <form action="?option=com_redshop" method="POST" name="installform" id="installform">
			...
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_SHOP_NAME_LBL'); ?>::<?php echo JText::_(
			...
			<label for="name"><?php echo JText::_('COM_REDSHOP_SHOP_NAME_LBL'); ?></label></span>
                ...
                <tr style="display: none;">
                    <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_WELCOME_MESSAGE'); ?>::<?php echo JText::_(
			...
			<label for="name"><?php echo JText::_('COM_REDSHOP_WELCOME_MESSAGE'); ?></label></span>
                ...
                <tr>
                    <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_ADMINISTRATOR_EMAIL_LBL'); ?>::<?php echo JText::_(
			...
			<label for="name"><?php echo JText::_('COM_REDSHOP_ADMINISTRATOR_EMAIL_LBL'); ?></label></span>
                ...
                <tr>
                    <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_SHOP_COUNTRY'); ?>::<?php echo JText::_(
			...
			<label for="name"><?php echo JText::_('COM_REDSHOP_DEFAULT_SHIPPING_COUNTRY_LBL'); ?></label></span>
                ...
                <tr>
                    <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_COUNTRY_LIST_LBL'); ?>::<?php echo JText::_(
			...
			<label for="countryList"><?php echo JText::_('COM_REDSHOP_COUNTRY_LIST_LBL'); ?></label></span>
                ...
                <tr>
                    <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_DEFAULT_DATEFORMAT_LBL'); ?>::<?php echo JText::_(
			...
			<?php echo JText::_('COM_REDSHOP_DEFAULT_DATEFORMAT_LBL'); ?></span>
                ...
                <tr>
                    <td width="100" align="right" class="key">
		<span class="editlinktip hasTip"
              title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_INVOICE_MAIL_ENABLE'); ?>::<?php echo JText::_(
		...
		<label for="invoice_mail_enable"><?php echo JText::_('COM_REDSHOP_INVOICE_MAIL_ENABLE_LBL'); ?></label></span>
                ...
                <tr id="is_invoice_mail_enable">
                    <td width="100" align="right" class="key">
		<span class="editlinktip hasTip"
              title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_INVOICE_MAIL_SEND_OPTION'); ?>::<?php echo JText::_(
                  'COM_REDSHOP_INVOICE_MAIL_SEND_OPTION_LBL'
              ); ?>">
		<label for="invoice_mail_send_option"><?php echo JText::_(
                'COM_REDSHOP_INVOICE_MAIL_SEND_OPTION_LBL'
            ); ?></label></span>
                    </td>
