    ...
    <table class="admintable table">
        ...
        <tr>
			...
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_DISCOUNT_ENABLE_LBL'); ?>::<?php echo JText::_(
...
<fieldset>
    <table class="admintable table">
        ...
        <tr>
            <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_COUPONS_ENABLE_LBL'); ?>::<?php echo JText::_(
...
<fieldset>
    <table class="admintable table">
        ...
        <tr>
            <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_VOUCHERS_ENABLE_LBL'); ?>::<?php echo JText::_(
...
<fieldset>
    <table class="admintable table">
        ...
        <tr>
            <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_DISCOUNT_TYPE_LBL'); ?>::<?php echo JText::_(
...
<fieldset>
    <table class="admintable table">
        ...
        <tr>
            <td width="100" align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_SHIPPING_AFTER_LBL'); ?>::<?php echo JText::_(
