...
<table class="admintable">
	...
	<tr>
		<td width="100" align="right" class="key"><span
			...
			title="<?php
			echo JText::_ ( 'TOOLTIP_DEFAULT_VAT_COUNTRY' );
			?>::<?php
	...
	<tr>
		<td width="100" align="right" class="key"><span
			class="editlinktip hasTip"
			title="<?php
			echo JText::_ ( 'TOOLTIP_DEFAULT_VAT_STATE' );
			?>::<?php
	...
	<tr>
		<td width="100" align="right" class="key"><span
			class="editlinktip hasTip"
			title="<?php
			echo JText::_ ( 'TOOLTIP_CALCULATE_VAT_BASED_ON_LBL' );
			?>::<?php
...
?></label></span></td>
	...
	<tr>
		...
		<?php
		echo JText::_ ( 'VAT_RATES_INTRO_TEXT' );
		?>
	</td>
	</tr>
	<tr>
		<td width="100" align="right" class="key"><span
			class="editlinktip hasTip"
			title="<?php
			echo JText::_ ( 'ADD_VAT_RATES_LBL' );
			?>::<?php
			echo JText::_ ( 'TOOLTIP_ADD_VAT_RATES_LBL' );
			?>">
		<label for="name"><?php
		echo JText::_ ( 'ADD_VAT_RATES_LBL' );
		?></label></span></td>
	...
	<tr>
		...
		<?php echo JText::_ ( 'VAT_DISCOUNT_INTRO_TEXT' );?>
		</td>
	</tr>
	<tr>
		<td width="100" align="right" class="key"><span
			class="editlinktip hasTip"
			title="<?php
			echo JText::_ ( 'TOOLTIP_APPLY_VAT_ON_DISCOUNT' );
			?>::<?php
