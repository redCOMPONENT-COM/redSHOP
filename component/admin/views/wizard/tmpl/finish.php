...
<table class="admintable">
	<tr>
		<td>
			<div class="wizard_intro_text"><?php echo JText::_('FINISH_WIZARD_INTRO_TEXT');?></div>
		</td>
	</tr>
	<tr>
		<td><strong><?php echo JText::_('INSTALL_DEMO_CONTENT');?></strong><input type="checkbox" name="installcontent" value="1"></td>
	</tr>
	<tr>
		<td>
