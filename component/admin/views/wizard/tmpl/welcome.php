...
<div class="welcome_wizard">
	<div class="wizard_intro_text"><?php echo JText::_('WELCOME_WIZARD_INTRO_TEXT');?></div>
	<div>&nbsp;</div>
	<?php
	...
	?>
	<div class="wizard_redshop_feature"><?php echo sprintf(JText::_('WELCOME_REDSHOP_FEATURE_TEXT'),$doc_link,$forum_link,$contact_link,$learn_more_link);?></div>
	<div>&nbsp;</div>
	<div class="wizard_basic_info"><?php echo JText::_('WIZARD_BASIC_INFO_TEXT');?></div>
	<div>&nbsp;</div>
</div>
<div>
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	<tr>
		<td valign="top">
    		<img src="components/com_redshop/assets/images/261-x-88.png" alt="redSHOP Logo" align="left">
		</td>
