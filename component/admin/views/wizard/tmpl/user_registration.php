	...
	<table class="admintable">
		...
		<tr>
			<td align="right" class="key">
				<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_REGISTER_METHOD_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_REGISTER_METHOD_LBL' ); ?>">
...
<fieldset class="adminform">
	<table class="admintable">
		...
		<tr>
			<td align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_WELCOMEPAGE_INTROTEXT_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_WELCOMEPAGE_INTROTEXT_LBL' ); ?>">
...
<fieldset class="adminform">
	<table class="admintable">
		...
		<tr>
			<td align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_REGISTRATION_PAGE_INTRO_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_REGISTRATION_PAGE_INTRO_LBL' ); ?>">
...
<fieldset class="adminform">
	<table class="admintable">
		...
		<tr>
			<td align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_REGISTRATION_PAGE_COMP_INTRO_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_REGISTRATION_PAGE_COMP_INTRO_LBL' ); ?>">
