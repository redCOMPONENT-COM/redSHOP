        ...
        <tr>
            <td align="right" class="key">
				<span class="editlinktip hasTip"
                      title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_REGISTER_METHOD_LBL'); ?>::<?php echo JText::_(
...
<fieldset class="adminform">
    <table class="admintable table">
        ...
        <tr>
            <td align="right" class="key">
			<span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_WELCOMEPAGE_INTROTEXT_LBL'); ?>::<?php echo JText::_(
