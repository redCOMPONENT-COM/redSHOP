	...
	<form action="?option=com_redshop" method="POST" name="installform" id="installform">
		...
		function jSelectArticle_terms_article_id(id, title, catid) {
			...
			SqueezeBox.close();
					...
					$html .= '<div class="button2-left"><div class="blank"><a class="jmodal" title="' . JText::_('COM_CONTENT_SELECT_AN_ARTICLE') . '"  href="' . $link . '" rel="{handler: \'iframe\', size: {x: 650, y: 375}}">' . JText::_('COM_REDSHOP_Select') . '</a></div></div>' . "\n";
