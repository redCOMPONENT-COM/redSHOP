...
<table class="admintable">
	...
	<tr>
		<td align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_TERMS_AND_CONDITIONS_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TERMS_AND_CONDITIONS_LBL' ); ?>">
	...
	<tr>
		<td align="right" class="key">
			<label for="showprice"><?php echo JText::_('COM_REDSHOP_ADD_TERMS_AND_CONDITIONS_LBL' );?></label></span>
		</td>
		<td>
			<a href="index.php?option=com_content&task=edit&cid[]=0" target="_blank" name="<?php echo JText::_('COM_REDSHOP_ADD_TERMS_AND_CONDITIONS_LBL' );?>"><?php echo JText::_('COM_REDSHOP_ADD')?></a>
		</td>
	</tr>
	<tr>
		<td colspan="2">
