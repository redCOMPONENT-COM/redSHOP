...
class wizardViewwizard extends JViewLegacy
{
	...
	{
		$config = JPATH_BASE . DS . 'components/com_redshop/helpers/wizard/redshop.cfg.php';
		...
		$temparray_config = JPATH_BASE . DS . 'components/com_redshop/helpers/wizard/redshop.cfg.tmp.php';
