...
class RedshopViewWizard extends RedshopViewAdmin
{
    public function display($tpl = null)
    {
        ...
        $lists['default_shipping_country'] = JHtml::_(
            ...
            'value',
            'text',
            $this->temparray['DEFAULT_SHIPPING_COUNTRY']
        );
        ...
        $lists['default_dateformat'] = JHtml::_(
            ...
            'value',
            'text',
            $this->temparray['DEFAULT_DATEFORMAT']
        );
        ...
        $lists['country_list'] = JHtml::_(
            ...
            $countries,
            'country_list[]',
            'class="inputbox disableBootstrapChosen" multiple="multiple" size="5"',
            'value',
            'text',
            $country_list
        );
        ...
        $lists['invoice_mail_enable'] = JHtml::_(
            ...
            'invoice_mail_enable',
            'class="inputbox" onchange="enableInvoice(this.value);"',
            $this->temparray['INVOICE_MAIL_ENABLE']
        );
        ...
        $lists['invoice_mail_send_option'] = JHtml::_(
            ...
            'value',
            'text',
            $this->temparray['INVOICE_MAIL_SEND_OPTION']
        );
        ...
        $lists['register_method'] = JHtml::_(
            ...
            $register_methods,
            'register_method',
            'class="inputbox" id="register_method"',
            'value',
            'text',
            $this->temparray['REGISTER_METHOD']
        );
        ...
        $lists['discount_type']   = JHtml::_(
            ...
            'value',
            'text',
            $this->temparray['DISCOUNT_TYPE']
        );
        $lists['discount_enable'] = JHtml::_(
            'redshopselect.booleanlist',
            'discount_enable',
            'class="inputbox" ',
            $this->temparray['DISCOUNT_ENABLE']
        );
        $lists['coupons_enable']  = JHtml::_(
            'redshopselect.booleanlist',
            'coupons_enable',
            'class="inputbox" ',
            $this->temparray['COUPONS_ENABLE']
        );
        $lists['vouchers_enable'] = JHtml::_(
            'redshopselect.booleanlist',
            'vouchers_enable',
            'class="inputbox" ',
            $this->temparray['VOUCHERS_ENABLE']
        );
        ...
        $lists['default_vat_country'] = JHtml::_(
            ...
            $default_vat_country,
            'default_vat_country',
            'class="inputbox" onchange="changeStateList();"',
            'value',
            'text',
            $this->temparray['DEFAULT_VAT_COUNTRY']
        );
        ...
        $lists['apply_vat_on_discount'] = JHtml::_(
            ...
            'class="inputbox" size="1"',
            $this->temparray['APPLY_VAT_ON_DISCOUNT']
        );
