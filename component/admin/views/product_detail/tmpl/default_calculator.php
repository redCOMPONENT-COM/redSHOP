                                ...
                                <table class="admintable" id="discount_calc_table" border="0">
                                    ...
                                    for ($i = 0, $in = count($calc_data); $i < $in; $i++) {
                                        ...
                                        $options[]                   = JHtml::_(
                                            'select.option',
                                            'mm',
                                            JText::_('COM_REDSHOP_MILLIMETER')
                                        );
                                        $options[]                   = JHtml::_(
                                            'select.option',
                                            'cm',
                                            JText::_('COM_REDSHOP_CENTIMETER')
                                        );
                                        $options[]                   = JHtml::_(
                                            'select.option',
                                            'm',
                                            JText::_('COM_REDSHOP_METER')
                                        );
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="area_start[]"
                                                       value="<?php echo $calc_data[$i]->area_start; ?>"/>
                                            </td>
                                            <td>
                                                <input type="text" name="area_end[]"
                                                       value="<?php echo $calc_data[$i]->area_end; ?>"/>
                                            </td>
                                            <td>
                                                <input type="text" name="area_price[]"
                                                       value="<?php echo $calc_data[$i]->area_price; ?>"/>
                                            </td>
                                            <td>
                                                <input value="<?php echo JText::_('COM_REDSHOP_DELETE'); ?>"
                                                       ...
                                                       type="button"
                                                />
                                                <input type="hidden" name="discount_calc_id[]"
                                ...
                                <table class="admintable" id="pdc_extra_table" border="0">
                                    ...
                                    for ($i = 0, $in = count($calc_data); $i < $in; $i++) {
                                        ...
                                        $options[]                     = JHtml::_(
                                            'select.option',
                                            '+',
                                            JText::_('COM_REDSHOP_PLUS')
                                        );
                                        $options[]                     = JHtml::_(
                                            'select.option',
                                            '-',
                                            JText::_('COM_REDSHOP_MINUS')
                                        );
                                        $options[]                     = JHtml::_(
                                            'select.option',
                                            '%',
                                            JText::_('COM_REDSHOP_PERCENTAGE')
                                        );
                                        $lists['discount_calc_oprand'] = JHtml::_(
                                            'select.genericlist',
                                            $options,
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" name="pdc_option_name[]"
                                                       value="<?php echo $calc_data[$i]->option_name; ?>"/>
                                            </td>
                                            <td>
                                                <?php echo $lists['discount_calc_oprand']; ?>
                                            </td>
                                            <td>
                                                <input type="text" name="pdc_price[]"
                                                       value="<?php echo $calc_data[$i]->price; ?>"/>
                                            </td>
                                            <td>
                                                <input value="<?php echo JText::_('COM_REDSHOP_DELETE'); ?>"
                                                       onclick="deleteDiscountElementExtra(this)" class="button"
                                                       type="button"/>
                                                <input type="hidden" name="pdcextra_id[]" id="pdcextra_id"
