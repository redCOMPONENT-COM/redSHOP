...
<table width="100%" cellpadding="2" border="0" cellspacing="2">
	<tr>
		<td>
		<fieldset class="adminform"><legend><?php echo JText::_( 'COM_REDSHOP_DISCOUNT_CALCULATOR' ); ?></legend>
	...
	<tr>
		...
		<table class="admintable" id="discount_calc_table" border="0"
			...
			<tr>
				...
				<td class="key"><a href="javascript:addDiscountElement();"><?php echo JText::_('COM_REDSHOP_ADD');?></a>
				</td>
			</tr>
			<?php
	...
	<tr>
		...
		<table class="admintable" id="pdc_extra_table" border="0" width="100%">
			<tr>
				...
				<td class="key"><?php echo JText::_('COM_REDSHOP_PRICE');?></td>
				<td class="key"><a href="javascript:addDiscountElementExtra();"><?php echo JText::_('COM_REDSHOP_ADD');?></a>
				</td>
			</tr>
			<?php
