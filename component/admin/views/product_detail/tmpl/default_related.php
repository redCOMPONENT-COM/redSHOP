...
?>
<fieldset class="adminform"><legend><?php echo JText::_( 'RELATED_PRODUCT' ); ?></legend>
<table class="admintable">
	<tr>
		...
		<input type="button" value="Down"
			...
			title="MoveLeft"></td>
		<td VALIGN="TOP" align="center" class="key"><?php echo JText::_( 'RELATED_PRODUCT' ); ?><br />
		<br />
		<?php
	...
	<tr>
		<td><label><?php echo JText::_('CHILD_PRODUCT_AS_RELATED_PRODUCT_TEXT');?></label></td>
		<td><input type="checkbox" value="1" name="fetch_child_for_related_product" onclick="updateRelatedProduct(this);"></td>
	</tr>
</table>
</fieldset>
<script>
