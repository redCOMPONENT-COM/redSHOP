...
<table width="100%" cellpadding="2" border="0" cellspacing="2">
	<tr>
		<td>
		<fieldset class="adminform"><legend><?php echo JText::_( 'NAVIGATOR_PRODUCT' ); ?></legend>
    <table class="admintable">
      ...
      <tr>
        <td colspan="2">
            ...
            <thead>
              <tr>
                <th  width="35%" align="left"><?php echo JText::_('PRODUCT_NAME' ); ?></th>
                <th  width="15%" align="left"><?php echo JText::_('DISPLAY_NAME' ); ?></th>
                <th width="15%" align="left"><?php echo JText::_('ORDERING' ); ?></th>
                <th  width="15%" align="left"><?php echo JText::_('DELETE' ); ?></th>
              </tr>
            </thead>
            <tbody>
