...
<div style="float: right">
  ...
  <button type="button" onclick="window.parent.SqueezeBox.close();"> <?php echo JText::_('COM_REDSHOP_CANCEL' ); ?> </button>
</div>
<div class="configuration"><?php echo JText::_('COM_REDSHOP_ADD_PRODUCT' ); ?></div>
</fieldset>
<?php } ?>
<form action="<?php echo JRoute::_($this->request_url) ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" onSubmit="return selectAll_related(this.elements['related_product[]'],this);">
  <?php
  ...
  <div class="col50">
    ...
    <table class="admintable" border="0" width="100%">
      <tr valign="top">
        <td width="50%"><table>
            <tr>
              <td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_NAME' ); ?>:
              </td>
              <td><input class="text_area" type="text" name="product_name" id="product_name" size="32" maxlength="250" value="<?php echo htmlspecialchars($this->detail->product_name);?>" />
              </td>
            <td> <?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_NAME' ), JText::_('COM_REDSHOP_PRODUCT_NAME' ), 'tooltip.png', '', '', false); ?></td>
            </tr>
            <tr>
              <td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_NUMBER' ); ?>:
              </td>
              <td><input class="text_area" type="text" name="product_number" id="product_number" size="32" maxlength="250" value="<?php echo $this->detail->product_number;?>" />
              </td>
              ...
              <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_TEMPLATE' ); ?>: </td>
            ...
            <tr>
              <td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PARENT_PRODUCT' ); ?>:
              </td>
              <td><?php $list = $producthelper->getProductByID($this->detail->product_parent_id);
                ...
                <input class="text_area" type="hidden" name="product_parent_id" id="product_parent_id" size="32" maxlength="250" value="<?php echo $this->detail->product_parent_id;?>" />
                </td>
            ...
            <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_CATEGORY' ); ?>: </td>
            ...
            <tr><td colspan="2"><hr /></td></tr>
             <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_MANUFACTURER' ); ?>: </td>
            ...
            <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_SUPPLIER' ); ?>: </td>
             ...
             <tr><td colspan="2"><hr /></td></tr>
            <tr><td style="font-weight:bold;"><?php echo JText::_( 'COM_REDSHOP_SHORT_DESCRIPTION' ); ?></td></tr>
            <tr>
				<td valign="top" colspan="2"><?php echo $editor->display("product_s_desc",$this->detail->product_s_desc,'$widthPx','$heightPx','100','20'); ?></td>
			</tr>
			 <tr><td style="font-weight:bold;"><?php echo JText::_( 'COM_REDSHOP_FULL_DESCRIPTION' ); ?></td></tr>
			<tr>
				<td valign="top" colspan="2"><?php echo $editor->display("product_desc",$this->detail->product_desc,'$widthPx','$heightPx','100','20'); ?></td>
			</tr>
            <tr><td colspan="2"><hr /></td></tr>
            ...
            ?>
            <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_FRONTEND_LINK' ); ?>: </td>
          ...
          <td width="50%" valign="top"><table>
            <tr>
              <td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_PRICE' ); ?>:
              </td>
              <td><input class="text_area" type="text" name="product_price" id="product_price" size="10" maxlength="10" value="<?php echo $this->detail->product_price;?>" />
              </td>
             ...
             <tr>
              <td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_TAX_GROUP' );//echo JText::_('COM_REDSHOP_PRODUCT_TAX' ); ?>:
              </td>
            ...
            <tr>
              ...
              <td><input class="text_area" type="text" name="discount_price" id="discount_price" size="10" maxlength="10" value="<?php echo $this->detail->discount_price;?>" />
               </td>
            ...
            <tr><td align="right" class="key"><?php echo JText::_('COM_REDSHOP_DISCOUNT_START_DATE' ); ?>:</td>
				<td><?php	$sdate = "";
			...
			<tr><td align="right" class="key"><?php echo JText::_('COM_REDSHOP_DISCOUNT_END_DATE' ); ?>:</td>
				<td><?php $edate = "";
           ...
           <tr><td colspan="2"><hr /></td></tr>
             <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_ON_SALE' ); ?>: </td>
            ...
            <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_SPECIAL' ); ?>: </td>
            ...
            <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_EXPIRED' ); ?>: </td>
            ...
            <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_NOT_FOR_SALE' ); ?>: </td>
              ...
              <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_PREORDER' ); ?>: </td>
            ...
            <tr><td colspan="2"><hr /></td></tr>
            <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_MINIMUM_ORDER_PRODUCT_QUANTITY_LBL' ); ?>: </td>
              <td><input class="text_area" type="text" name="min_order_product_quantity" id="min_order_product_quantity" size="10" maxlength="10" value="<?php echo $this->detail->min_order_product_quantity;?>" />
              </td>
            ...
            <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_MAXIMUM_ORDER_PRODUCT_QUANTITY_LBL' ); ?>: </td>
              <td><input class="text_area" type="text" name="max_order_product_quantity" id="max_order_product_quantity" size="10" maxlength="10" value="<?php echo @$this->detail->max_order_product_quantity;?>" />
              </td>
	        ...
	        <tr>
              <td style="color: red;" valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_AVAILABILITY_DATE_LBL' ); ?>: </td>
...
<fieldset class="adminform"><legend><?php echo JText::_( 'COM_REDSHOP_PRODUCT_DATA' ); ?></legend>
<table class="admintable" border="0" width="100%">
	<tr valign="top">
		<td width="50%">
		<table>
			...
			<tr>
              ...
              <td><input class="text_area" type="text" name="product_volume" id="product_volume" size="10" maxlength="10" value="<?php echo $producthelper->redunitDecimal($this->detail->product_volume);?>" />
                <?php echo DEFAULT_VOLUME_UNIT; ?>3 </td>
            ...
            <tr>
              ...
              <td><input class="text_area" type="text" name="product_length" id="product_length" size="10" maxlength="10" value="<?php echo $producthelper->redunitDecimal($this->detail->product_length);?>" />
            ...
            <tr>
              ...
              <td><input class="text_area" type="text" name="product_width" id="product_width" size="10" maxlength="10" value="<?php echo $producthelper->redunitDecimal($this->detail->product_width);?>" />
                <?php echo DEFAULT_VOLUME_UNIT; ?></td>
            ...
            <tr>
              ...
              <td><input class="text_area" type="text" name="product_height" id="product_height" size="10" maxlength="10" value="<?php echo $producthelper->redunitDecimal($this->detail->product_height);?>" />
                <?php echo DEFAULT_VOLUME_UNIT; ?></td>
            ...
            <tr>
              <td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_DIAMETER' ); ?>: </td>
              <td><input class="text_area" type="text" name="product_diameter" id="product_diameter" size="10" maxlength="10" value="<?php echo $producthelper->redunitDecimal($this->detail->product_diameter);?>" />
                <?php echo DEFAULT_VOLUME_UNIT; ?> <?php //echo JHTML::tooltip(JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_DIAMETER' ), JText::_('COM_REDSHOP_PRODUCT_DIAMETER' ), 'tooltip.png', '', '', false); ?></td>
            ...
            <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_WEIGHT_LBL' ); ?>: </td>
              <td><input class="text_area" type="text" name="weight" id="weight" size="10" maxlength="10" value="<?php echo $producthelper->redunitDecimal($this->detail->weight);?>" />
...
if($this->detail->product_template!=0) ?>
	<fieldset class="adminform"><legend><?php echo JText::_( 'COM_REDSHOP_FIELDS' ); ?></legend>
...
?>
 <fieldset class="adminform"><legend><?php echo JText::_( 'COM_REDSHOP_PRODUCT_IMAGES' ); ?></legend>
  <table class="admintable">
    <tr>
      ...
      <td valign="top"><input type="file" name="product_full_image" id="product_full_image" size="25">
          <?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_IMAGE' ), JText::_('COM_REDSHOP_PRODUCT_IMAGE' ), 'tooltip.png', '', '', false); ?> </td>
    ...
    <tr>
        ...
        <div class="button2-left">
          <div class="image"><a class="modal" title="Image" href="<?php echo $ilink;?>" rel="{handler: 'iframe', size: {x: 900, y: 500}}">Image</a></div>
        </div>
        <?php
	...
	if($this->detail->product_id > 0){
        ...
        <div class="button2-left">
          <div class="image"><a class="modal" title="Image" href="<?php echo $ilink;?>" rel="{handler: 'iframe', size: {x: 950, y: 500}}"><?php echo JText::_('COM_REDSHOP_ADD_ADDITIONAL_IMAGES');?></a></div>
        </div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top"><input type="file" name="product_thumb_image" id="product_thumb_image" size="25">
          <?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_THUMB_IMAGE' ), JText::_('COM_REDSHOP_PRODUCT_THUMB_IMAGE' ), 'tooltip.png', '', '', false); ?> </td></tr>
    <tr>
      <td valign="top" align="right" class="key">&nbsp;</td>
      <td align="left">
    ...
    <tr>
      ...
      <td align="left"><?php
		if(file_exists(REDSHOP_FRONT_IMAGES_RELPATH.$image_path)){	?>
		<label><?php echo JText::_('COM_REDSHOP_DELETE_CURRENT_THUMB_IMAGE');?></label><input type="checkbox" name="thumb_image_delete" >
	<?php 	}	?>
      </td>
    </tr>
     <tr>
      ...
      <td valign="top"><input type="file" name="product_back_full_image" id="product_back_full_image" size="25">
        <?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_BACK_IMAGE' ), JText::_('COM_REDSHOP_PRODUCT_BACK_IMAGE' ), 'tooltip.png', '', '', false); ?> </td>
    </tr>
    <tr>
      <td valign="top" align="right" class="key">&nbsp;</td>
      <td align="left">
    ...
    <tr>
      <td valign="top" align="right" class="key">&nbsp;</td>
      <td align="left">
			<input type="checkbox" name="back_image_delete" ><label><?php echo JText::_('COM_REDSHOP_DELETE_CURRENT_IMAGE');?>
			</label>
    ...
    <tr>
      ...
      <td valign="top"><input type="file" name="product_back_thumb_image" id="product_back_thumb_image" size="25">
        <?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_BACK_THUMB_IMAGE' ), JText::_('COM_REDSHOP_PRODUCT_BACK_THUMB_IMAGE' ), 'tooltip.png', '', '', false); ?> </td></tr>
    <tr>
      <td valign="top" align="right" class="key">&nbsp;</td>
      <td align="left"><?php
    ...
    <tr>
      <td valign="top" align="right" class="key">&nbsp;</td>
      <td align="left">
			<input type="checkbox" name="back_thumb_image_delete" ><label><?php echo JText::_('COM_REDSHOP_DELETE_CURRENT_THUMB_IMAGE');?>
			</label>
      </td>
    </tr>
    <?php 	}	?>
     ...
     <tr>
      ...
      <td valign="top"><input type="file" name="product_preview_image" id="product_preview_image" size="25">
        <?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_PREVIEW_IMAGE' ), JText::_('COM_REDSHOP_PRODUCT_PREVIEW_IMAGE' ), 'tooltip.png', '', '', false); ?> </td></tr>
    <tr>
      <td valign="top" align="right" class="key">&nbsp;</td>
      <td align="left"><?php
    ...
    <tr>
      <td valign="top" align="right" class="key">&nbsp;</td>
      <td align="left">
			<input type="checkbox" name="preview_image_delete" ><label><?php echo JText::_('COM_REDSHOP_DELETE_CURRENT_IMAGE');?>
			</label>
      </td>
    </tr>
    <?php 	}	?>
 	<tr>
      ...
      <td valign="top"><input type="file" name="product_preview_back_image" id="product_preview_back_image" size="25">
        <?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_PREVIEW_BACK_IMAGE' ), JText::_('COM_REDSHOP_PRODUCT_PREVIEW_BACK_IMAGE' ), 'tooltip.png', '', '', false); ?> </td></tr>
    <tr>
      <td valign="top" align="right" class="key">&nbsp;</td>
      <td align="left"><?php
    ...
    <tr>
      <td valign="top" align="right" class="key">&nbsp;</td>
      <td align="left">
			<input type="checkbox" name="preview_back_image_delete" ><label><?php echo JText::_('COM_REDSHOP_DELETE_CURRENT_IMAGE');?>
			</label>
      </td>
    </tr>
    <?php 	}	?>
...
?>
  <fieldset class="adminform"><legend><?php echo JText::_( 'COM_REDSHOP_META_DATA_TAB' ); ?></legend>
  <table class="admintable">
  	<tr>
    ...
    <tr>
      ...
      <td><input class="text_area" type="text" name="pagetitle" id="pagetitle" size="75" value="<?php echo htmlspecialchars($this->detail->pagetitle);?>" />
      </td>
    ...
    <tr>
      ...
      <td><input class="text_area" type="text" name="pageheading" id="pageheading" size="75" value="<?php echo $this->detail->pageheading;?>" />
      </td>
    ...
    <tr>
      ...
      <td><input class="text_area" type="text" name="sef_url" id="sef_url" size="75" value="<?php echo $this->detail->sef_url;?>" />
      </td>
    ...
    <tr>
      ...
      <td><textarea class="text_area" type="text" name="metakey" id="metakey" rows="4" cols="40" /><?php echo $this->detail->metakey;?></textarea>
      </td>
    ...
    <tr>
      ...
      <td><textarea class="text_area" type="text" name="metadesc" id="metadesc" rows="4" cols="40" /><?php echo htmlspecialchars($this->detail->metadesc);?></textarea>
      </td>
    ...
    <tr>
      ...
      <td><textarea class="text_area" type="text" name="metalanguage_setting" id="metalanguage_setting" rows="4" cols="40" /><?php echo $this->detail->metalanguage_setting;?></textarea>
      </td>
    ...
    <tr>
      ...
      <td><textarea class="text_area" type="text" name="metarobot_info" id="metarobot_info" rows="4" cols="40" /><?php echo $this->detail->metarobot_info;?></textarea>
      </td>
...
<fieldset class="adminform"><legend><?php echo JText::_( 'COM_REDSHOP_ECONOMIC_SETTINGS' ); ?></legend>
<table class="admintable" border="0" width="100%">
	<tr valign="top">
		<td width="50%">
		<table>
			<tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_ECONOMIC_ACCOUNTGROUP_LBL' ); ?>: </td>
             ...
             <tr>
              <td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_DEFAULT_QUANTITY_SELECTBOX_VALUE_LBL' ); ?>: </td>
              <td><input class="text_area" type="text" name="quantity_selectbox_value" id="quantity_selectbox_value" size="10"  value="<?php echo $this->lists['QUANTITY_SELECTBOX_VALUE'];?>" />
              </td>
