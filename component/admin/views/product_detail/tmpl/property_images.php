...
<div class="configuration"><?php
	echo JText::_ ( 'PROPERTY_MORE_IMAGES_INFORMATION' );
	?></div>
</fieldset>
...
<table class="admintable" border="0" width="100%" id="admintable">
	<tr>
		...
		<label for="name"><?php echo JText::_ ( 'PROPERTY_MAIN_IMAGE' ); ?>:</label>
		</td>
		<td>
		<input type="file" name="property_main_img" id="property_main_img" value="" size="75" />
		<?php echo JHTML::tooltip ( JText::_ ( 'TOOLTIP_PROPERTY_MAIN_IMAGE' ), JText::_ ( 'PROPERTY_MAIN_IMAGE' ), 'tooltip.png', '', '', false );	?>
		</td>
	</tr>
	<tr>
		<td valign="top" align="right" class="key">
		<label for="name"><?php echo JText::_ ( 'PROPERTY_SUB_IMAGE' ); ?>:</label>
		</td>
		<td>
		<input type="file" name="property_sub_img[]" id="property_sub_img[]" value="" size="75" />
		<input type="button" name="addvalue" id="addvalue" class="button" Value="<?php echo JText::_( 'ADD' ); ?>" onclick="addNewRowOfProp('admintable');" />
		<?php echo JHTML::tooltip ( JText::_ ( 'TOOLTIP_PROPERTY_SUB_IMAGE' ), JText::_ ( 'PROPERTY_SUB_IMAGE' ), 'tooltip.png', '', '', false );	?>
		</td>
	</tr>
</table>
</fieldset>
...
<?php
	...
	$mainimg = '';
	if(file_exists(JPATH_COMPONENT_SITE."/assets/images/".$rs_folder."/".$thumb) && $thumb!='')
	 {
		 ...
		 $mainimg .="<img  height='50' width='50' src='".$url."/components/".$option."/assets/images/".$rs_folder."/".$thumb."'> ";
		 $mainimg .="</div>";
		...
		if(file_exists(JPATH_COMPONENT_SITE."/assets/images/property/".$thumb) && $thumb!='')
		 {
			 ...
			 $more_images .="<img  height='50' width='50' src='".$url."/components/".$option."/assets/images/property/".$thumb."'/>
