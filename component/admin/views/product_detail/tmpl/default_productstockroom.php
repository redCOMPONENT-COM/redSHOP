			...
			<table id="accessory_table" class="adminlist table table-striped" border="0">
				...
				?>
							<tr>
								...
								<td>
									<input type="number" name="quantity[]" size="5" class="text_area" value="<?php echo $quantity; ?>"/>
								...
								<td>
									<input type="number" name="preorder_stock[]" size="5" class="text_area" value="<?php echo $preorder_stock; ?>"/>
									<input type="button"
										   name="preorder_reset"
