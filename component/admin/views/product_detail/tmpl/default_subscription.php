...
$subs_period_unit_opt[] = JHTML::_(
	'select.option',
	'year',
	JText::_('COM_REDSHOP_SUBSCRIPTION_YEAR')
);

$subs_period_unit_opt[] = JHTML::_(
	'select.option',
	'month',
	JText::_('COM_REDSHOP_SUBSCRIPTION_MONTH')
);

$subs_period_unit_opt[] = JHTML::_(
	'select.option',
	'day',
	JText::_('COM_REDSHOP_SUBSCRIPTION_YEAR_DAY')
);
...
$subs_period_unit = JHTML::_(
	'select.genericlist',
	$subs_period_unit_opt,
	'subscription[subscription_period_unit]',
	'class="inputbox" size="1" ',
	'value',
	'text',
	@$getSubsctiption->subscription_period_unit
);

$subs_period_lifetime = JHTML::_(
	'select.booleanlist',
	'subscription[subscription_period_lifetime]',
	'class="inputbox"',
	(int) @$getSubsctiption->subscription_period_lifetime
);
...
$shopper_group = JHTML::_(
	'select.genericlist',
	$shopper_detail,
	'subscription[subs_plan_shopper_group_id]',
	'',
	'value',
	'text',
	(int) @$getSubsctiption->shoppergroup
);

$fallback_shopper_group = JHTML::_(
	'select.genericlist',
	$shopper_detail_fallback,
	'subscription[fallback_subs_plan_shopper_group_id]',
	'',
	'value',
	'text',
	(int) @$getSubsctiption->fallback_shoppergroup
);
...
$acl_group = JHtml::_(
	'access.usergroups',
	'subscription[acl_group]',
	@explode("|",
	$getSubsctiption->joomla_acl_groups),
	true
);

$user_acl_group = JHtml::_(
	'access.usergroups',
	'subscription[fallback_acl_group]',
	@explode("|", $getSubsctiption->fallback_joomla_acl_groups),
	true
);
?>
