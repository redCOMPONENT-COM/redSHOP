    ...
    <div class="col-sm-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <?php echo Text::_('COM_REDSHOP_TEMPLATE_PAYMENT_METHOD'); ?>
                </h3>
            </div>
            <div class="box-body">
                <div class="form-group">
                    <label class="col-md-3" for="use_individual_payment_method">
                        <?php echo Text::_('COM_REDSHOP_USE_INDIVIDUAL_PAYMENT_METHOD'); ?>
                    </label>
                    <div class="col-md-9">
                ...
                <div class="form-group" id="payment_method_wrapper" style="display: <?php echo $paymentBlock ?>;">
                    <label class="col-md-3" for="payment_method[]">
                        <?php echo Text::_('COM_REDSHOP_SELECT_PAYMENT_METHOD'); ?>
                    </label>
                    <div class="col-md-9">
