	...
	<tr>
		<td>
			<fieldset class="adminform" style="background-color: white;">
				<legend>
					<?php echo JText::_( 'PRODUCT_ATTRIBUTES' ); ?>
				</legend>
				<table class="admintable" width="100%" border="0" cellspacing="0"
					cellpadding="0">
					<tr>
						<td colspan="2">
							<div>
								<?php echo JText::_('HINT_ATTRIBUTE');?>
							</div>
						</td>
					</tr>
					<tr>
						<td colspan="2" class="red_blue_blue"><?php echo JText::_('COPY_ATTRIBUTES_FROM_ATTRIBUTE_SET');?>
						</td>
					</tr>
					<tr>
						<td align="left" width="140px;"><?php echo JText::_('COPY');?>
						</td>
						<td><?php echo $this->lists['copy_attribute'];?></td>
					</tr>
					<tr>
						<td valign="top" align="left" width="140px;"><?php echo JText::_( 'PRODUCT_ATTRIBUTE_SET_LBL' ); ?>:
						</td>
					...
					<tr>
						<td colspan="2" style="padding: 20px 0;"><a class="btn_attribute"
							...
							id="new_attribute"> <?php echo "+ "; echo JText::_( 'NEW_ATTRIBUTE' ); ?>
						</a><br> <br>
						</td>
					</tr>
			...
			<table width="100%" cellpadding="2" border="0" id="attribute_table"
				...
				<tr>
					<td colspan="5" align="right"><span id="atitle"
						style="display: none;"><?php echo JText::_('TITLE' ); ?></span> 
					<span id="atitlerequired" style="display: none;"> <?php echo JText::_('ATTRIBUTE_REQUIRED');?></span> 
					<span id="atitlepublished" style="display: none;"> <?php echo JText::_('PUBLISHED' ); ?></span> 
					<span id="spn_allow_multiple_selection"	style="display: none;"> <?php echo JText::_('ALLOW_MULTIPLE_PROPERTY_SELECTION');?></span> 
					<span id="spn_hide_attribute_price" style="display: none;"><?php echo JText::_('HIDE_ATTRIBUTE_PRICE');?></span> 
					
					<span id="spn_display_type" style="display: none;"> <?php echo JText::_('DISPLAY_ATTRIBUTE_TYPE');?></span>
					<span id="aproperty" style="display: none;"> <?php echo JText::_('SUB_ATTRIBUTE' ); ?></span> 
					<span id="aprice" style="display: none;"> <?php echo JText::_('PRICE' ); ?></span> 
					<span id="new_property" style="display: none;"> <?php echo JText::_('SUB_ATTRIBUTE' ); ?></span> 
					<span id="new_sub_property" style="display: none;"> <?php echo JText::_('NEW_SUB_PROPERTY' ); ?></span> 
					<span id="sub_atitlerequired" style="display: none;"> <?php echo JText::_('SUBATTRIBUTE_REQUIRED');?></span> 
					<span id="sub_multiselected" style="display: none;"> <?php echo JText::_ ( 'SUBATTRIBUTE_MULTISELECTED' );?></span> 
					<span id="delete_attribute" style="display: none;"> <?php echo JText::_('DELETE_ATTRIBUTE' ); ?></span> 
					<span id="aimage" style="display: none;"> <?php echo JText::_('IMAGE_UPLOAD' ); ?></span> 
					<span id="aordering" style="display: none;"> <?php echo JText::_('ORDERING' ); ?></span> 
					<span id="adselected" style="display: none;"> <?php echo JText::_('DEFAULT_SELECTED' ); ?></span> 
					<span id="showpropertytitlespan" style="display: none;"> <?php echo JText::_('SUBPROPERTY_TITLE' ); ?>					</span>
					
					
					<span id="pathimages" style="display: none;">../administrator/components/com_redshop/assets/images/</span>
