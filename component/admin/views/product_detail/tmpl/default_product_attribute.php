																								...
																								<a class="modal"
																								   ...
																								   href="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH . 'product_attributes/' . $property->property_image; ?>">
																									<img
																										...
																										alt='' title='' width="50"
																										src='<?php echo $redhelper->watermark('product_attributes', $property->property_image, PRODUCT_ADDITIONAL_IMAGE, PRODUCT_ADDITIONAL_IMAGE_HEIGHT, WATERMARK_PRODUCT_ADDITIONAL_IMAGE, $property->property_id) ?>'>
																								</a>
																							</span>
							</td>
																															...
																															<a class="modal"
																															   ...
																															   href="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH . 'subcolor/' . $subvalue->subattribute_color_image; ?>">
																																<img
																																	...
																																	src='<?php echo $redhelper->watermark('subcolor', $subvalue->subattribute_color_image, PRODUCT_ADDITIONAL_IMAGE, PRODUCT_ADDITIONAL_IMAGE_HEIGHT, WATERMARK_PRODUCT_ADDITIONAL_IMAGE, $subvalue->subattribute_color_id); ?>'
																																	alt=''
																																	title=''
																																	width="50">
													...
													<td align="right" class="td5" style="padding-right: 25px;">
														...
														<div>
															...
															<input type="checkbox" class="text_area" size="55"
																   ...
																   value="1">
															<span><?php echo JText::_('COM_REDSHOP_ATTRIBUTE_EXTRAFIELD'); ?>
																&nbsp;</span>
															<input type="text" class="text_area" size="8"
