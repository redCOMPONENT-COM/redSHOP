											...
											<td>
												...
												<table border="0" class="blue_area" id="attribute_table">
													...
													<tr>
														...
														<td class="td6">&nbsp;</td>
														<td class="td7">
															<input style="cursor: pointer; float: right;"
																   class="btn_attribute"
											...
											<table border="0" class="grey_area" id="attribute_table_pro<?php echo $k; ?>">
												...
												<tr>
													...
													<td class="td6">
														...
														?>
														<?php echo JText::_('COM_REDSHOP_DISPLAY_ATTRIBUTE_TYPE'); ?>&nbsp;
														<select name="attribute[<?php echo $k; ?>][display_type]">
																	...
																	<td>
																		...
																		<table class="attribute_value" border="0" id="property_table<?php echo $property->property_id; ?>">
																			...
																			<tr>
																				<td class="red_blue_blue td1">
																					<img class="arrowimg"
																						 id="arrowimg<?php echo $k ?><?php echo $g; ?>"
																				...
																				<td colspan="12" class="td7">
																					<div class="repon">
																						...
																						?>
																							...
																							<tr>
																								<td rowspan="1" class="td1" style="padding-right: 10px;">
																									<a class="modal"
																									   rel="{handler: 'iframe', size: {x: 950, y: 500}}"
																									   title=""
																									   href="<?php echo $medialink; ?>"
																										>
																										<img src="<?php echo REDSHOP_ADMIN_IMAGES_ABSPATH; ?>media16.png"
																											 align="absmiddle"
																											 alt="media"
																											/>
																									</a>
																								...
																								<td class="td5" style="padding-right: 25px;">
																			...
																			<tr>
																				<td>
																					...
																					<table border="0">
																						...
																						<tr>
																							<div <?php echo $style ?> id='showsubproperty<?php echo $k . $g; ?>'>
																								<td class="red_blue_blue td1">
																									<span>
																										<?php echo JText::_('COM_REDSHOP_TITLE'); ?>
																									</span>
																								...
																								<td class="td6">
																									...
																									<select name="attribute[<?php echo $k; ?>][property][<?php echo $g; ?>][setdisplay_type]">
																										<option value="dropdown" <?php  echo $selected_1; ?>>
																											<?php echo JText::_('COM_REDSHOP_DROPDOWN_LIST'); ?>
																										</option>
																										<option value="radio" <?php  echo $selected_2; ?>>
