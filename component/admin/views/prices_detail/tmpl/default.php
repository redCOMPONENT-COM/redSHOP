...
<script language="javascript" type="text/javascript">
    Joomla.submitbutton = function (pressbutton) {
        ...
        if (form.product_price.value == "" || isNaN(form.product_price.value) || form.product_price.value == 0) {
            alert("<?php echo Text::_('COM_REDSHOP_PRODUCT_PRICE_INVALID', true); ?>");
        ...
        <fieldset class="adminform">
            ...
            <table class="admintable table">
                <tr>
                    ...
                    <td>
                        <?php echo $this->lists['product_name']; ?>
                    </td>
                </tr>
                <tr>
                    <td valign="top" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_SHOPPER_GROUP_NAME'); ?>
                        :
                    </td>
                    <td>
                        <?php echo $this->lists['shopper_group_name']; ?>
                    </td>
                </tr>
                <tr>
                    <td width="100" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_PRODUCT_PRICE_LBL'); ?>
                        :
                    </td>
                    <td><input class="text_area" type="number" name="product_price" id="product_price" size="10"
                            maxlength="10" min="0" value="<?php echo RedshopHelperProduct::redpriceDecimal(
                ...
                <tr>
                    <td width="100" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_QUANTITY_START_LBL'); ?>
                        :
                    </td>
                ...
                <tr>
                    <td width="100" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_QUANTITY_END_LBL'); ?>:
                    </td>
                    <td><input class="text_area" type="number" name="price_quantity_end" id="price_quantity_end"
                            size="10" maxlength="20" min="0" value="<?php echo $this->detail->price_quantity_end; ?>" />
                    </td>
                </tr>
                <tr>
                    <td width="100" align="right" class="key">
                ...
                <tr>
                    <td width="100" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_DISCOUNT_START_DATE'); ?>
                        :
                    </td>
                    <td>
                        <?php
                ...
                <tr>
                    <td width="100" align="right" class="key">
                        <?php echo Text::_('COM_REDSHOP_DISCOUNT_END_DATE'); ?>
                        :
                    </td>
                    <td>
                        <?php
