...
class prices_detailVIEWprices_detail extends JView
{
	...
	{		
		$db = jFactory::getDBO();
		JToolBarHelper::title(   JText::_( 'PRICE_MANAGEMENT_DETAIL' ), 'redshop_vatrates48' );
		...
		JToolBarHelper::title(   JText::_( 'PRICE' ).': <small><small>[ ' . $text.' ]</small></small>' , 'redshop_vatrates48' );
		JToolBarHelper::save();
