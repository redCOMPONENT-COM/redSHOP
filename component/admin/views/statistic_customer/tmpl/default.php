...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var options = {
            title: '<?php echo Text::_("COM_REDSHOP_STATISTIC_CUSTOMER"); ?>',
            bars: 'vertical',
            height: 500,
            vAxis: {
                format: 'decimal'
            ...
            <tbody>
                <?php foreach ($this->customers as $i => $row): ?>
                    <tr>
                        <td align="center">
                            <a
                                href="index.php?option=com_redshop&view=user_detail&task=edit&user_id=<?php echo $row->user_id ?>&cid[]=<?php echo $row->users_info_id ?>">
