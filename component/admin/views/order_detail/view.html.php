...
class order_detailVIEWorder_detail extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'ORDER' ).': <small><small>[ ' . $text.' ]</small></small>', 'redshop_order48' );
		...
		JToolBarHelper::back(JText::_( 'ORDERLIST' ) ,  'javascript:location.href=\''.$new_link.'\';');
