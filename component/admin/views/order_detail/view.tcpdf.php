...
class order_detailVIEWorder_detail extends JView
{
	function display($tpl = null)
	{
		...
		$html_template = str_replace("{order_information_lbl}",JText::_('ORDER_INFORMATION'),$html_template);
		$html_template = str_replace("{order_id_lbl}",JText::_('ORDER_ID'),$html_template);
		$html_template = str_replace("{order_number_lbl}",JText::_('ORDER_NUMBER'),$html_template);
		$html_template = str_replace("{order_date_lbl}",JText::_('ORDER_DATE'),$html_template);
		$html_template = str_replace("{order_status_lbl}",JText::_('ORDER_STATUS'),$html_template);
		$html_template = str_replace("{shipping_address_info_lbl}",JText::_('SHIPPING_ADDRESS_INFORMATION'),$html_template);
		$html_template = str_replace("{shipping_firstname_lbl}",JText::_('FIRSTNAME'),$html_template);
		$html_template = str_replace("{shipping_lastname_lbl}",JText::_('LASTNAME'),$html_template);
		$html_template = str_replace("{shipping_address_lbl}",JText::_('ADDRESS'),$html_template);
		$html_template = str_replace("{shipping_zip_lbl}",JText::_('ZIP'),$html_template);
		$html_template = str_replace("{shipping_city_lbl}",JText::_('CITY'),$html_template);
		$html_template = str_replace("{shipping_country_lbl}",JText::_('COUNTRY'),$html_template);
		$html_template = str_replace("{shipping_state_lbl}",JText::_('STATE'),$html_template);
		$html_template = str_replace("{shipping_phone_lbl}",JText::_('PHONE'),$html_template);
		...
		if ($billing->is_company && $billing->company_name != ""){
			...
			$html_template = str_replace("{company_name_lbl}",JText::_('COMPANY_NAME'),$html_template);
		}else{ 
