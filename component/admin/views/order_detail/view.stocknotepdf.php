	       ...
	       if(strstr($html_template,"{product_loop_start}") && strstr($html_template,"{product_loop_end}"))
			{
			    ...
			    $html_template = str_replace("{product_name_lbl}",JText::_('PRODUCT_NAME'),$html_template);
                $html_template = str_replace("{product_number_lbl}",JText::_('PRODUCT_NUMBER'),$html_template);
                $html_template = str_replace("{product_quantity_lbl}",JText::_('QUANTITY') ,$html_template);
