...
if (strstr($ordersprint_template, 'media/com_redshop/images/redcomponent-logo.jpg'))
{
	$ordersprint_template = str_replace("media/com_redshop/images/redcomponent-logo.jpg", JUri::root().'media/com_redshop/images/redcomponent-logo.jpg', $ordersprint_template);
}
