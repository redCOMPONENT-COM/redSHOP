...
<form action="index.php?option=com_redshop" method="post" name="updateBillingAdd" id="updateBillingAdd">
    <div class="col50">
        <fieldset class="adminform">
            <legend>
                <?php echo Text::_('COM_REDSHOP_BILLING_INFORMATION'); ?>
            </legend>
            <table class="admintable table table-striped">
                <tr>
                    <td width="100" align="right" class="key"><label>
                            <?php echo Text::_('COM_REDSHOP_REGISTER_AS'); ?>
                            :
                        </label></td>
                    <td>
                        <?php echo $this->lists['is_company']; ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr id="trEANnumber" <?php echo $allowCompany; ?>>
                    ...
                    <td><input class="form-control" type="text" name="ean_number"
                            value="<?php echo $billing->ean_number; ?>" size="32" maxlength="250" /></td>
                </tr>
                <?php
                if (Redshop::getConfig()->get('USE_TAX_EXEMPT') == 1) {
                    ...
                    <tr id="trTaxExempt" <?php echo $allowCompany; ?>>
                        ...
                        <td>
                            <?php echo $this->lists['tax_exempt'];
                            echo JHtml::_(
                                'redshop.tooltip',
                    ...
                    <tr id="trTaxExemptRequest" <?php echo $allowCompany; ?>>
                        <td valign="top" class="key"><label>
                                <?php echo Text::_(
                                    'COM_REDSHOP_USER_REQUEST_TAX_EXEMPT_LBL'
                                ); ?>:
                            </label></td>
                        <td>
                            <?php echo $this->lists['requesting_tax_exempt']; ?>
                            <?php echo JHtml::_(
                                'redshop.tooltip',
                    ...
                    <tr id="trTaxExemptApproved" <?php echo $allowCompany; ?>>
                        ...
                        <td>
                            <?php echo $this->lists['tax_exempt_approved']; ?>
                            <?php echo JHtml::_(
                                'redshop.tooltip',
                ...
                if ($isCompany) {
                    echo RedshopHelperExtrafields::listAllField(
                ...
                <tr>
                    <td></td>
                    <td>
                        <input type="submit" name="submit" value="<?php echo Text::_('COM_REDSHOP_SAVE'); ?>"
                            class="btn btn-primary" onclick="return validateInfo();">
                    </td>
                </tr>
            </table>
        </fieldset>
