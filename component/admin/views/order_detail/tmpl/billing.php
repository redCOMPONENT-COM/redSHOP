...
<div class="col50">
	<fieldset class="adminform">
		<legend><?php echo JText::_( 'BILLING_INFORMATION' ); ?></legend>
		<table class="admintable" border="0">
			...
			<tr>
				...
				<td>
					<input class="inputbox" type="text" name="firstname" size="32" maxlength="250" value="<?php echo $billing->firstname; ?>" />
				</td>
			</tr>
			<tr>
				<td width="100" align="right" class="key">
				...
				<td>
					<input class="inputbox" type="text" name="lastname" size="32" maxlength="250" value="<?php echo $billing->lastname; ?>" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input class="inputbox" type="text" name="address"  size="32" maxlength="250" value="<?php echo @$billing->address;?>"  />
				</td>
			</tr>
			 <tr>
				<td width="100" align="right" class="key">
				...
				<td>
					<input class="inputbox" type="text" name="zipcode"  size="32" maxlength="250" value="<?php echo @$billing->zipcode;?>"  />
				</td>
			</tr>
			<tr>
				<td width="100" align="right" class="key">
				...
				<td>
					<input class="inputbox" type="text" name="city"  size="32" maxlength="250" value="<?php echo @$billing->city;?>"  />
				</td>
			</tr>
			...
			<tr>
				<td width="100" align="right" class="key">
					...
					<td>
						<input class="inputbox" type="text" name="phone"   size="32" maxlength="250" value="<?php echo @$billing->phone;?>"  />
					</td>
			</tr>
			<tr>
								<td width="100" align="right" class="key"><?php echo JText::_( 'EMAIL' ); ?>:</td>
								<td><input class="inputbox" type="text" name="user_email"   size="32" maxlength="250" value="<?php echo @$billing->user_email;?>"  /></td>
								</tr>
								<?php
								if($is_company)
								{ ?>
								<tr>
									<td width="100" align="right" class="key"><?php echo JText::_( 'VAT_NUMBER' ); ?>:</td>
									<td><input class="inputbox" type="text" name="vat_number"   size="32" maxlength="250" value="<?php echo $billing->vat_number; ?>"  /></td>
								</tr>
								<tr>
									<td width="100" align="right" class="key"><?php echo JText::_( 'EAN_NUMBER' ); ?>:</td>
									<td><input class="inputbox" type="text" name="ean_number"   size="32" maxlength="250" value="<?php echo $billing->ean_number; ?>"  /></td>
								</tr>
								<!-- <tr>
