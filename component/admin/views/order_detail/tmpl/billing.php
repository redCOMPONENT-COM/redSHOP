    ...
    <div class="col50">
        <fieldset class="adminform">
            ...
            <table class="admintable table table-striped">
                <tr>
                    <td width="100" align="right" class="key"><label><?php echo JText::_('COM_REDSHOP_REGISTER_AS'); ?>
                            :</label></td>
                ...
                <tr>
                    <td width="100" align="right" class="key"><label><?php echo JText::_('COM_REDSHOP_EMAIL'); ?>
                            :</label></td>
                ...
                <tr id="trEANnumber" <?php echo $allowCompany; ?>>
                    <td width="100" align="right" class="key"><label><?php echo JText::_('COM_REDSHOP_EAN_NUMBER'); ?>
                            :</label></td>
                    <td><input class="form-control" type="text" name="ean_number"
                               value="<?php echo $billing->ean_number; ?>"
                ...
                if (Redshop::getConfig()->get('USE_TAX_EXEMPT') == 1) {
                    ...
                    <tr id="trVatNumber" <?php echo $allowCompany; ?>>
                        <td valign="top" align="right" class="key"><label><?php echo JText::_(
                    ...
                    <tr id="trTaxExemptRequest" <?php echo $allowCompany; ?>>
                        <td valign="top" class="key"><label><?php echo JText::_(
