				...
				<tbody>
					<tr>
	                   ...
	                   &nbsp;
						...
						<img src="<?php echo JSYSTEM_IMAGES_PATH.'printButton.png';?>" alt="<?php echo JText::_('COM_REDSHOP_PRINT' );?>" title="<?php echo JText::_('COM_REDSHOP_PRINT' );?>" /></a>
						...
						&nbsp;<?php if($tmpl){ ?><a href="<?php echo JRoute::_('index.php?option='.$option.'&view=order_detail&task=send_downloadmail&cid[]='.$order_id);?>&tmpl=<?php echo $tmpl;?>"><?php } else { ?><a href="<?php echo JRoute::_('index.php?option='.$option.'&view=order_detail&task=send_downloadmail&cid[]='.$order_id);?>"><?php }  echo JText::_('COM_REDSHOP_SEND_DOWNLOEADMAIL' ); ?></a>
						&nbsp;<?php if($tmpl){ ?><a href="<?php echo JRoute::_('index.php?option='.$option.'&view=order_detail&task=send_invoicemail&cid[]='.$order_id);?>&tmpl=<?php echo $tmpl;?>"><?php } else { ?><a href="<?php echo JRoute::_('index.php?option='.$option.'&view=order_detail&task=send_invoicemail&cid[]='.$order_id);?>"><?php }  echo JText::_( 'COM_REDSHOP_SEND_INVOICEMAIL' ); ?></a>
						&nbsp;
						<?php }	?>
					...
					<tr>
						...
						<?php if(count($model->getccdetail($order_id))>0) { ?>
							<a href="<?php echo JRoute::_('index.php?option='.$option.'&view=order_detail&task=ccdetail&cid[]='.$order_id);?>" class="modal" rel="{handler: 'iframe', size: {x: 550, y: 200}}"><?php echo JText::_('COM_REDSHOP_CLICK_TO_VIEW_CREDIT_CARD_DETAIL');?></a>
						<?php } ?>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<?php
							 ...
							 <?php  } ?>
							 <input type="checkbox" <?php echo $send_mail_to_customer;?>  value="true" name="order_sendordermail" id="order_sendordermail" /><?php echo JText::_('COM_REDSHOP_SEND_ORDER_MAIL' ); ?>
							 <input class="button" onclick="this.form.submit();" name="order_status" value="<?php echo JText::_('COM_REDSHOP_UPDATE_STATUS_BUTTON');?>" type="button">
							 <br /><br />
							 <?php
					...
					<tr valign="top">
						...
						<table class="adminlist" border="0">
						  ...
						  <?php 	$fields=$extra_field->list_all_field_display(8,$billing->users_info_id);
								...
								<td colspan="2">
								<?php if(!$tmpl) {?>
									<a class="modal" href="index.php?tmpl=component&option=com_redshop&view=order_detail&layout=billing&cid[]=<?php echo $order_id;?>" rel="{handler: 'iframe', size: {x: 500, y: 450}}"><?php echo JText::_('COM_REDSHOP_EDIT');?></a>
                                <?php } ?>
								</td>
							</tr>
								</table>
						...
						<table class="adminlist" border="0">
							...
							<tr>
								...
								<?php if(!$tmpl) {?>
                                	...
                                	<a class="modal" href="index.php?tmpl=component&option=com_redshop&view=order_detail&layout=shipping&cid[]=<?php echo $order_id;?>" rel="{handler: 'iframe', size: {x: 500, y: 450}}"><?php echo JText::_('COM_REDSHOP_EDIT');?></a>
                                <?php } ?>
								</td>
							</tr>
						</table>
				...
				<tbody>
							...
							<tbody>
								...
								<td>
									<table border="0" cellspacing="0" cellpadding="0" class="adminlist" width="100%" >
										...
										<td  width="5%">
											<img class="delete_item" src="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH;?>cross.jpg" title="<?php echo JText::_('COM_REDSHOP_DELETE'); ?>" alt="<?php echo JText::_('COM_REDSHOP_DELETE');?>" onclick="if(confirm('<?php echo JText::_('COM_REDSHOP_CONFIRM_DELETE_ORDER_ITEM');?>')) { document.itemForm<?php echo $order_item_id;?>.task.value='delete_item';document.itemForm<?php echo $order_item_id;?>.submit();}">
											<img class="update_price" src="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH; ?>update.jpg" title="<?php echo JText::_('COM_REDSHOP_UPDATE'); ?>" alt="<?php echo JText::_('COM_REDSHOP_UPDATE');?>" onclick="document.itemForm<?php echo $order_item_id;?>.task.value='updateItem';document.itemForm<?php echo $order_item_id;?>.submit();">
										</td>
										</tr>
										</table>
									...
									<td>
										...
										?>
											<tr>
												<th colspan="2" align="center"><?php echo JText::_('COM_REDSHOP_TOKEN_ID').": ".$download_id;?></th>
											</tr>
											<?php
											if($limit_over)
											{
											?> <tr>
													<td colspan="2" align="center" ><?php echo JText::_('COM_REDSHOP_DOWNLOAD_LIMIT_OVER');?></td>
												</tr>
											<?php
											}
											?>
										...
										<tr>
											...
											<input type="button" name="update" value="<?php echo JText::_('COM_REDSHOP_UPDATE');?>" onclick="document.download_token<?php echo $order_item_id;?>.submit();" >
											<input type="hidden" name="option" value="<?php echo $option ;?>" />
											<input type="hidden" name="view" value="order" />
					...
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
								<tr align="left">
									<td align="right" width="70%"><strong><?php echo JText::_('COM_REDSHOP_ORDER_SUBTOTAL' ); ?>:</strong></td>
								...
								<tr align="left">
									...
									<td align="right" width="30%">
										<form action="<?php echo 'index.php?option='.$option; ?>" method="post" name="update_discount<?php echo $order_id; ?>">
											...
											&nbsp;<img class="update_price" align="absmiddle" src="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH; ?>update.jpg" title="<?php echo JText::_('COM_REDSHOP_UPDATE'); ?>" alt="<?php echo JText::_('COM_REDSHOP_UPDATE');?>" onclick="document.update_discount<?php echo $order_id;?>.submit();">
											</label>
								...
								<tr align="left">
									...
									<td align="right" width="30%">
										<form action="<?php echo 'index.php?option='.$option; ?>" method="post" name="special_discount<?php echo $order_id; ?>">
											...
											&nbsp;<img class="update_price" align="absmiddle" src="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH; ?>update.jpg" title="<?php echo JText::_('COM_REDSHOP_UPDATE'); ?>" alt="<?php echo JText::_('COM_REDSHOP_UPDATE');?>" onclick="document.special_discount<?php echo $order_id;?>.submit();">
											</label>
											<?php
								...
								<tr align="left">
									<td align="right" width="70%"><strong><?php echo JText::_('COM_REDSHOP_ORDER_SHIPPING' ); ?>:</strong></td>
					...
					<tr><td><?php echo JText::_('COM_REDSHOP_ADD_PRODUCT');?>
					...
					<form action="<?php echo 'index.php?option='.$option; ?>" method="post" name="adminFormAdd" id="adminFormAdd">
						<table border="0" cellspacing="0" cellpadding="0" class="adminlist">
							...
							<td align="right"><div id="tdtotalprdproduct1"></div>
								...
								<td><input type="button" name="add" id="add" style="display: none;" value="<?php echo JText::_('COM_REDSHOP_ADD');?>" onclick="javascript:submitbutton('add',this.form);" /></td>
						</tr>
					...
					<tr><td>
				      ...
				      <tr>
						...
						<tr>
	    					  <td align="left">
	    					    <div id="rs_glslocationId" <?php echo $disp_style?>><?php //echo JText::_('COM_REDSHOP_SHIPPING_MODE') ?>
						<?php
		    				...
		    				<tr><td><input type="submit" name="add" id="add" value="<?php echo JText::_('COM_REDSHOP_ADD');?>" />
					...
					<tr valign="top">
						...
						<table class="adminlist" border="0">
							<tr>
								...
								<td width="15%" align="center"><b><?php echo JText::_('COM_REDSHOP_MODIFIED_DATE');?></b></td>
								<td width="20%" align="center"><b><?php echo JText::_('COM_REDSHOP_STATUS');?></b></td>
								<td width="20%" align="center"><b><?php echo JText::_('COM_REDSHOP_PAYMENT_STATUS');?></b></td>
							...
							<tr>
								...
								<td width="20%" align="center"><?php echo $log_row->order_status_name; ?></td>
									<td width="20%" align="center"><?php if($log_row->order_payment_status !="") { echo  JText::_('COM_REDSHOP_PAYMENT_STA_'.strtoupper($log_row->order_payment_status));} ?></td>
		 ...
		 if($CheckRedDesign)
	     {
			 ...
			 <tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%" class="adminlist">
					<tbody>
						<tr style="background-color: #cccccc">
							<th><?php echo JText::_('COM_REDSHOP_DESIGN' ); ?></th>
						</tr>
						<?php
						...
						<tr valign="top">
							<td>
							<span><b> <?php echo JText::_('COM_REDSHOP_BACKGROUND_IMAGE');?></b>:<span> <?php echo $RedDesignpro[$design_i]->image_name;?></span>
							</td>
						</tr>
						<tr valign="top">
							<td>
