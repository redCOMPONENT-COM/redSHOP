    ...
    <div id="editcell">
        <div class="filterTool">
            <div class="filterItem">
                <div class="btn-wrapper input-append">
                    <input type="text" name="comment_filter" id="comment_filter"
                           value="<?php echo $this->state->get('comment_filter'); ?>">
        ...
        <table class="adminlist table table-striped">
            ...
            for ($i = 0, $n = count($this->ratings); $i < $n; $i++) {
                ...
                $link     = JRoute::_(
                    'index.php?option=com_redshop&view=rating_detail&task=edit&cid[]=' . $row->rating_id
                );
                $prodlink = JRoute::_(
