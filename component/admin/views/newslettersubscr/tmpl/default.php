        ...
        <div class="filterTool">
            <div class="filterItem">
                <div class="btn-wrapper input-append">
                    <input placeholder="<?php echo JText::_('COM_REDSHOP_NEWSLETTER_FILTER'); ?>" type="text"
                           name="filter" id="filter" value="<?php echo $this->state->get('filter'); ?>">
        ...
        <table class="adminlist table table-striped">
            ...
            <tr>
                ...
                <th>
                    <?php echo JHTML::_(
                        'grid.sort',
                        'COM_REDSHOP_NEWSLETTER_USERNAME',
                        'user_id',
                ...
                <th>
                    <?php echo JHTML::_(
                        'grid.sort',
                        'COM_REDSHOP_NEWSLETTER_SUBSCR_DATE',
                        'date',
                        $this->lists['order_Dir'],
                        $this->lists['order']
                    ); ?>
            ...
            for ($i = 0, $n = count($this->newslettersubscrs); $i < $n; $i++) {
                ...
                $link = JRoute::_(
                    'index.php?option=com_redshop&view=newslettersubscr_detail&task=edit&cid[]=' . $row->subscription_id
                );
                    ...
                    <td>
                        <a href="<?php echo $link; ?>"
                           title="<?php echo JText::_(
                               'COM_REDSHOP_EDIT_NEWSLETTER_SUBSCR'
                           ); ?>"><?php $row->user_id == 0 ? $name = $row->name : $name = RedshopHelperOrder::getUserFullName(
                                $row->user_id
                            );
                            echo $name; ?></a>
                    </td>
