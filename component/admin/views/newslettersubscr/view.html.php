...
class newslettersubscrViewnewslettersubscr extends JView
{
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('NEWSLETTER_SUBSCR') );

   		JToolBarHelper::title(   JText::_( 'NEWSLETTER_SUBSCR_MANAGEMENT' ), 'redshop_newsletter48' );
		$task = JRequest::getVar('task');

   		if( $task != 'import_data'){

	   		JToolBarHelper::custom('import_data','upload.png','upload_f2.png','IMPORT_DATA',false);
	   		JToolBarHelper::custom('export_data','save.png','save_f2.png','EXPORT_DATA',false);
		...
		if( $task == 'import_data'){
			...
			JToolBarHelper::custom('importdata','save.png','save_f2.png','IMPORT',false);

			JToolBarHelper::custom('back','back.png','back_f2.png','BACK',false);
