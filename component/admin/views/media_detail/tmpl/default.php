				...
				<tr>
					...
					<td>
						...
						if ($this->detail->media_name)
						{
							...
							{
								switch ($this->detail->media_section)
								{
									case 'category':
										$thWidth = THUMB_WIDTH;
										$thHeight = THUMB_HEIGHT;
										$watermark = WATERMARK_CATEGORY_THUMB_IMAGE;
										break;

									case 'manufacturer':
										$thWidth = MANUFACTURER_THUMB_WIDTH;
										$thHeight = MANUFACTURER_THUMB_HEIGHT;
										$watermark = WATERMARK_MANUFACTURER_THUMB_IMAGE;
										break;

									default:
										$thWidth = THUMB_WIDTH;
										$thHeight = THUMB_HEIGHT;
										$watermark = WATERMARK_PRODUCT_THUMB_IMAGE;
										break;
								}
								?>
								<a class="modal"
								   ...
								   rel="{handler: 'image', size: {}}">
									<img
										src="<?php echo $redhelper->watermark($this->detail->media_section, $this->detail->media_name, $thWidth, $thHeight, $watermark, $this->detail->section_id); ?>"
										alt="image"/></a>
							<?php
							}
						}
