...
class question_detailVIEWquestion_detail extends JView
{
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('QUESTION') );
		...
		JToolBarHelper::title(JText::_( 'QUESTION_DETAIL' ).': <small><small>[ '.$text.' ]</small></small>', 'redshop_question48' );
		JToolBarHelper::save();
		...
		$optionsection[0]->product_name = Jtext::_('SELECT');
		if(count($option)>0)
		{
