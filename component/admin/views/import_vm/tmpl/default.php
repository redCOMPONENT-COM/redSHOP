...
<?php if (!$this->checkVirtuemart): ?>
    <div class="row">
        <div class="alert alert-danger">
            <p>
                <?php echo Text::_("COM_REDSHOP_NO_VM") ?>
            </p>
        </div>
    </div>
<?php else: ?>
                ...
                $.post(
                    ...
                    .always(function () {
                        if (next < categories) {
                            ...
                            $slide.css("width", "100%").removeClass('progress-bar-striped active').html("<?php echo Text::_(
                    ...
                    .always(function () {
                        if (next < manufacturers) {
                            ...
                            $slide.css("width", "100%").removeClass('progress-bar-striped active')
                                .html("<?php echo Text::_('COM_REDSHOP_IMPORT_VM_DONE') ?>")
                                .addClass("progress-bar-success");
                            syncShopperGroup(0);
                        }
                    })
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="btn btn-primary btn-large" id="start_import">
                <?php echo Text::_('COM_REDSHOP_IMPORT_VM_START') ?>
            </div>
        </div>
    </div>
    <hr />
        ...
        <div class="col-md-12">
            <table class="table table-striped table-bordered table-import-vm">
                <thead>
                    <tr>
                        <th width="10%">
                            <?php echo Text::_('COM_REDSHOP_IMPORT_VM_DATA') ?>
                        </th>
                        <th width="10%">
                            <?php echo Text::_('COM_REDSHOP_IMPORT_VM_COUNT') ?>
                        </th>
                        <th>
                            <?php echo Text::_('COM_REDSHOP_IMPORT_VM_PROGRESS') ?>
                        </th>
                        <th width="40%">
                            <?php echo Text::_('COM_REDSHOP_IMPORT_VM_RESULT') ?>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <?php echo $this->model->countCategories() ?>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $this->model->countManufacturers() ?>
                        </td>
                        <td>
                            <div class="progress hidden">
                                <div id="manufacturer_sync" class="progress-bar progress-bar-striped active"
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $this->model->countShopperGroups() ?>
                        </td>
                        <td>
                            <div class="progress hidden">
                                <div id="shoppergroup_sync" class="progress-bar progress-bar-striped active"
                                    role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"
                                    style="width: 0%;">0%
                                </div>
                            </div>
                    ...
                    <tr>
                        <td>
                            <?php echo Text::_('COM_REDSHOP_CUSTOMER') ?>
                        </td>
                        <td>
                            <?php echo $this->model->countUsers() ?>
                        </td>
                        <td>
                            <div class="progress hidden">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $this->model->countOrderStatuses() ?>
                        </td>
                        <td>
                            <div class="progress hidden">
                                <div id="orderstatus_sync" class="progress-bar progress-bar-striped active"
                                    role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"
                                    style="width: 0%;">0%
                                </div>
                            </div>
                    ...
                    <tr>
                        <td>
                            <?php echo Text::_('COM_REDSHOP_PRODUCT') ?>
                        </td>
                        <td>
                            <?php echo $this->model->countProducts() ?>
                        </td>
                        <td>
                            <div class="progress hidden">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $this->model->countOrders() ?>
                        </td>
                        <td>
                            <div class="progress hidden">
