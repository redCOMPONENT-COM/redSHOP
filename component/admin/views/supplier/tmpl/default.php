...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th class="title">
				<?php
				echo JHTML::_ ( 'grid.sort', 'SUPPLIER_NAME', 'supplier_name', $this->lists ['order_Dir'], $this->lists ['order'] );
				?>
				
			</th>
			<th width="20%">
				<?php
				echo JHTML::_ ( 'grid.sort', 'SUPPLIER_EMAIL', 'supplier_email', $this->lists ['order_Dir'], $this->lists ['order'] );
				?>
		 	</th>
			...
			<th width="5%" nowrap="nowrap">
				<?php
				echo JHTML::_ ( 'grid.sort', 'ID', 'supplier_id', $this->lists ['order_Dir'], $this->lists ['order'] );
				?>	
			</th>
