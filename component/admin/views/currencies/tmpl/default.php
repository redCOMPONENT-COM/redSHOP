...
<form 
	...
	<table class="adminlist table table-striped">
		...
		<tr>
			...
			<th><?php echo JHTML::_('grid.sort', JText::_('COM_REDSHOP_CURRENCY_NAME'), 'currency_name', $listOrder, $listDirn);?></th>
			<th><?php echo JHTML::_('grid.sort', JText::_('COM_REDSHOP_CURRENCY_CODE_LBL'), 'currency_code', $listOrder, $listDirn);?></th>
			<th><?php echo JHTML::_('grid.sort', JText::_('COM_REDSHOP_ID'), 'id', $listOrder, $listDirn); ?></th>
		</tr>
		</thead>
		<tbody>
		<?php
