...
<script language="javascript" type="text/javascript">
    function checkSourcePath() {
        ...
        if (form.xmlimport_url.value == "" && form.filename_url.value == "") {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_XMLIMPORT_URL_OR_UPLOAD_XMLFILE', true); ?>");
            return false;
        }
        if (form.section_type.value == "" || form.section_type.value == 0) {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_SELECT_XMLEXPORT_SECTION_TYPE', true); ?>");
            return false;
        }
        if (form.element_name.value == "") {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_ELEMENT_NAME', true); ?>");
    ...
    submitbutton = function (pressbutton) {
        ...
        if (document.getElementsByName("xmlfiletag[]")) {
            ...
            idval = idval.unique();
            if (firstlen == 0) {
                alert("<?php echo Text::_('COM_REDSHOP_SELECT_FIELDNAME', true); ?>");
                return false;
            }
            if (idval.length != firstlen) {
                alert("<?php echo Text::_('COM_REDSHOP_DUPLICATE_FIELDNAME', true); ?>");
                return false;
            }
        }
        ...
        if (form.display_filename.value == "") {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_XMLIMPORT_FILE_NAME', true); ?>");
        } else if (form.cntxmlfiletag.value == 0) {
            alert("<?php echo Text::_('COM_REDSHOP_NO_DATA_TO_IMPORT', true); ?>");
        } else {
            Joomla.submitform(pressbutton);
        }
    }
...
<form action="<?php echo Redshop\IO\Route::_($this->request_url) ?>" method="post" name="adminForm" id="adminForm"
            ...
            <table class="admintable table">
                <tr>
                    <td width="100" align="right"
                        class="key"><?php echo Text::_('COM_REDSHOP_XMLIMPORT_DISPLAY_FILENAME'); ?>:
                    </td>
                    <td><input type="text" name="display_filename" id="display_filename"
                               value="<?php echo $this->detail->display_filename; ?>"/></td>
                </tr>
                <tr>
                    <td width="100" align="right" class="key"><?php echo Text::_('COM_REDSHOP_XMLIMPORT_FILE_URL'); ?>
                        :
                    </td>
                ...
                <tr>
                    <td width="100" align="right" class="key"><?php echo Text::_('COM_REDSHOP_XMLFILE'); ?>:</td>
                    <td><input type="file" name="filename_url" id="filename_url" value=""/></td>
                </tr>
                <tr>
                    <td width="100" align="right" class="key"><?php echo Text::_('COM_REDSHOP_SECTION_TYPE'); ?>:</td>
                    <td><?php echo $this->lists['section_type']; ?></td>
                </tr>
                <tr>
                    <td width="100" align="right" class="key"><span id="prdelement_name"
                                                                    style="display: <?php echo $productstyle; ?>;"><?php echo Text::_(
                                'COM_REDSHOP_PRODUCT_ELEMENT_NAME'
                            ); ?>
                            :</span><span id="ordelement_name"
                                          style="display: <?php echo $orderstyle; ?>;"><?php echo Text::_(
                    ...
                    <td><span id="tdelement_name" style="display: <?php echo $style; ?>"><input type="text"
                                                                                                name="element_name"
                                                                                                id="element_name"
                                                                                                value="<?php echo $this->detail->element_name; ?>"/><?php echo Text::_(
                                'COM_REDSHOP_XML_ELEMENT_NOTE'
                            ); ?></span>
                    </td>
                </tr>
                <tr id="trStockdetail" style="display: <?php echo $productstyle; ?>;">
                    <td width="100" align="right"
                        class="key"><?php echo Text::_('COM_REDSHOP_STOCKDETAIL_ELEMENT_NAME'); ?>:
                    </td>
                    <td><input type="text" name="stock_element_name" id="stock_element_name"
                               value="<?php echo $this->detail->stock_element_name; ?>"/><?php echo Text::_(
                            'COM_REDSHOP_XML_ELEMENT_NOTE'
                        ); ?>
                    </td>
                </tr>
                <tr id="trExtrafield" style="display: <?php echo $productstyle; ?>;">
                    <td width="100" align="right"
                        class="key"><?php echo Text::_('COM_REDSHOP_EXTRAFIELD_ELEMENT_NAME'); ?>:
                    </td>
                    <td><input type="text" name="prdextrafield_element_name" id="prdextrafield_element_name"
                               value="<?php echo $this->detail->prdextrafield_element_name; ?>"/><?php echo Text::_(
                            'COM_REDSHOP_XML_ELEMENT_NOTE'
                        ); ?>
                    </td>
                </tr>
                <tr id="trBillingdetail" style="display: <?php echo $orderstyle; ?>;">
                    <td width="100" align="right"
                        class="key"><?php echo Text::_('COM_REDSHOP_BILLING_ELEMENT_NAME'); ?>:
                    </td>
                    <td><input type="text" name="billing_element_name" id="billing_element_name"
                               value="<?php echo $this->detail->billing_element_name; ?>"/><?php echo Text::_(
                            'COM_REDSHOP_XML_ELEMENT_NOTE'
                        ); ?>
                    </td>
                </tr>
                <tr id="trShippingdetail" style="display: <?php echo $orderstyle; ?>;">
                    <td width="100" align="right"
                        class="key"><?php echo Text::_('COM_REDSHOP_SHIPPING_ELEMENT_NAME'); ?>:
                    </td>
                    <td><input type="text" name="shipping_element_name" id="shipping_element_name"
                               value="<?php echo $this->detail->shipping_element_name; ?>"/><?php echo Text::_(
                            'COM_REDSHOP_XML_ELEMENT_NOTE'
                        ); ?>
                    </td>
                </tr>
                <tr id="trOrderitem" style="display: <?php echo $orderstyle; ?>;">
                    <td width="100" align="right"
                        class="key"><?php echo Text::_('COM_REDSHOP_ORDERITEM_ELEMENT_NAME'); ?>:
                    </td>
                    <td><input type="text" name="orderitem_element_name" id="orderitem_element_name"
                               value="<?php echo $this->detail->orderitem_element_name; ?>"/><?php echo Text::_(
                            'COM_REDSHOP_XML_ELEMENT_NOTE'
                        ); ?>
                    </td>
                </tr>
                <tr>
                    <td width="100" align="right" class="key"><?php echo Text::_('COM_REDSHOP_AUTO_SYNCHRONIZE'); ?>:
                    </td>
                    <td><?php echo $this->lists['auto_sync']; ?></td>
                </tr>
                <tr>
                    <td width="100" align="right"
                        class="key"><?php echo Text::_('COM_REDSHOP_SYNCHRONIZE_ON_REQUEST'); ?>:
                    </td>
                    <td><?php echo $this->lists['sync_on_request']; ?></td>
                </tr>
                <tr>
                    <td width="100" align="right"
                        class="key"><?php echo Text::_('COM_REDSHOP_SYNCHRONIZE_INTERVAL'); ?>:
                    </td>
                    <td><?php echo $this->lists['auto_sync_interval']; ?></td>
                </tr>
                <tr>
                    <td valign="top" align="right" class="key"><?php echo Text::_('COM_REDSHOP_PUBLISHED'); ?>:</td>
                    <td><?php echo $this->lists['xmlpublished']; ?></td>
                </tr>
                <tr>
                    <td width="100" align="right"
                        class="key"><?php echo Text::_('COM_REDSHOP_OVERRIDE_EXISTING_IF_EXISTS'); ?>:
                    </td>
                    <td><?php echo $this->lists['override_existing']; ?></td>
                </tr>
                <tr>
                    <td width="100" align="right"
                        class="key"><?php echo Text::_('COM_REDSHOP_ADD_PREFIX_FOR_EXISTING'); ?>:
                    </td>
                ...
                <tr>
                    ...
                    <td><input type="submit" name="readxmlfile" id="readxmlfile"
                               value="<?php echo Text::_('COM_REDSHOP_READ_XMLFILE'); ?>"
    ...
    if ($this->detail->section_type != "") {
        ...
        <fieldset class="adminform">
            <legend><?php echo Text::_('COM_REDSHOP_XMLEXPORT_FILE_DETAIL'); ?></legend>
            <table class="admintable table">
                <tr>
                    <th><?php echo Text::_('COM_REDSHOP_FIELD_NAME'); ?></th>
                    <th><?php echo Text::_('COM_REDSHOP_XMLEXPORT_FILE_TAG_NAME'); ?></th>
                    <th><?php echo Text::_('COM_REDSHOP_UPDATE_IMPORT_FIELD'); ?></th>
                </tr>
                <?php if (count($this->xmlfiletag) > 0) {
                    if ($this->detail->section_type == "order") {
                        ?>
                        <tr>
                            <th><?php echo Text::_('COM_REDSHOP_ORDER_INFORMATION'); ?></th>
                            <th><?php echo Text::_('COM_REDSHOP_ORDER_IMPORT_NOTE'); ?></th>
                        </tr>
                        <?php
                    } elseif ($this->detail->section_type == "product") {
                        ?>
                        <tr>
                            <th><?php echo Text::_('COM_REDSHOP_PRODUCT'); ?></th>
                            <th><?php echo Text::_('COM_REDSHOP_PRODUCT_IMPORT_NOTE'); ?></th>
                        </tr>
                        <?php
                    }
                ...
                if (count($this->xmlbillingtag) > 0) {
                    ?>
                    <tr>
                        <th><?php echo Text::_('COM_REDSHOP_BILLING_INFORMATION'); ?></th>
                        <th>&nbsp;</th>
                    </tr>
                    <?php for ($i = 0; $i < count($this->xmlbillingtag); $i++) {
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" name="updatebillingtag[<?php echo $i; ?>]" value="1" <?php echo $chk; ?> />
                            </td>
                        </tr>
                        <?php
                    }
                ...
                if (count($this->xmlshippingtag) > 0) {
                    ?>
                    <tr>
                        <th><?php echo Text::_('COM_REDSHOP_SHIPPING_INFORMATION'); ?></th>
                        <th>&nbsp;</th>
                    </tr>
                    <?php for ($i = 0; $i < count($this->xmlshippingtag); $i++) {
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" name="updateshippingtag[<?php echo $i; ?>]" value="1" <?php echo $chk; ?> /></td>
                        </tr>
                        <?php
                    }
                }
                if (count($this->xmlitemtag) > 0) {
                    ?>
                    <tr>
                        <th><?php echo Text::_('COM_REDSHOP_ORDER_ITEM_ADDED'); ?></th>
                        <th><?php echo Text::_('COM_REDSHOP_ORDER_ITEM_IMPORT_NOTE'); ?></th>
                    </tr>
                    <?php for ($i = 0; $i < count($this->xmlitemtag); $i++) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->lists["item_" . $this->xmlitemtag[$i]]; ?>
                                <input type="hidden" name="xmlitemtag[]" value="<?php echo $this->xmlitemtag[$i]; ?>"/>
                            </td>
                ...
                if (count($this->xmlstocktag) > 0) {
                    ?>
                    <tr>
                        <th><?php echo Text::_('COM_REDSHOP_PRODUCT_STOCK_DETAIL_ADDED'); ?></th>
                        <th><?php echo Text::_('COM_REDSHOP_STOCK_IMPORT_NOTE'); ?></th>
                    </tr>
                    <?php for ($i = 0; $i < count($this->xmlstocktag); $i++) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->lists["stock_" . $this->xmlstocktag[$i]]; ?>
                                <input type="hidden" name="xmlstocktag[]"
                                       value="<?php echo $this->xmlstocktag[$i]; ?>"/>
                            </td>
                ...
                if (count($this->xmlprdextrafieldtag) > 0) {
                    ?>
                    <tr>
                        <th><?php echo Text::_('COM_REDSHOP_PRODUCT_EXTRA_FIELD_ADDED'); ?></th>
                        <th><?php echo Text::_('COM_REDSHOP_PRDEXTRA_IMPORT_NOTE'); ?></th>
                    </tr>
                    <?php for ($i = 0; $i < count($this->xmlprdextrafieldtag); $i++) {
                        $chk = ($this->updateprdexttag[$i] == 1) ? "checked" : ""; ?>
                        <tr>
                            <td width="100" align="right" class="key"><?php echo $this->xmlprdextrafieldtag[$i]; ?>:
                            </td>
        ...
        <fieldset class="adminform">
            ...
            <table class="admintable table">
                <tr>
                    <td id="tdNodata"><?php echo Text::_('COM_REDSHOP_NO_DATA_TO_IMPORT'); ?></td>
                </tr>
            </table>
        </fieldset>
        </div><?php
