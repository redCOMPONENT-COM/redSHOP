...
class xmlimport_detailVIEWxmlimport_detail extends JView
{
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('xmlimport') );
		...
		JToolBarHelper::title(JText::_( 'XML_IMPORT_MANAGEMENT' ).': <small><small>[ '.$text.' ]</small></small>', 'redshop_import48' );
		JToolBarHelper::custom( 'xmlimport','redshop_import_import32.png',JText::_('XML_IMPORT') , JText::_('XML_IMPORT'), false, false);
		JToolBarHelper::save();
		if ($isNew)  {
