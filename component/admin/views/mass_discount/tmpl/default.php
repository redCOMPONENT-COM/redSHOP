...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th class="title">
				<?php echo JHTML::_('grid.sort', 'DISCOUNT_NAME', 'discount_name', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th class="title">
			...
			<th width="5%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort', 'ID', 'mass_discount_id', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
