        ...
        <table class="adminlist table table-striped" width="100%">
            ...
            <tr>
                ...
                <th width="10%">
                    <?php echo JHTML::_(
                        'grid.sort',
                        'COM_REDSHOP_USE_TO_ALL_PRODUCT',
                        'w.wrapper_use_to_all',
                        $this->lists['order_Dir'],
                        $this->lists['order']
                    ); ?>
                </th>
            ...
            for ($i = 0; $i < count($this->data); $i++) {
                ...
                $link = JRoute::_(
                    'index.php?option=com_redshop&view=wrapper_detail&task=edit&product_id=' . $this->product_id . '&cid[]=' . $row->wrapper_id . $tmpl . '&showall=' . $showall
                ); ?>
                <tr class="<?php echo "row$k"; ?>">
                    ...
                    <td><a href="<?php echo $link; ?>"
                           title="<?php echo JText::_(
                               'COM_REDSHOP_EDIT_WRAPPER'
                           ); ?>"><?php echo $row->wrapper_name; ?></a>
                    </td>
                    <td>
