...
<?php }	?>
<form action="<?php echo 'index'.$page.'.php?option='.$option; ?>" method="post" name="adminForm" >
<div id="editcell">
<table class="adminlist" width="100%">
<thead><tr><th width="5%"><?php echo JText::_( 'NUM' ); ?></th>
		<th width="5%"><input type="checkbox" name="toggle" onclick="checkAll(<?php echo count( $this->data ); ?>);" /></th>
		<th width="20%"><?php echo JText::_( 'WRAPPER_NAME' ); ?></th>
		<th width="10%"><?php echo JText::_( 'WRAPPER_IMAGE' ); ?></th>
		<th width="10%"><?php echo JText::_( 'WRAPPER_PRICE' ); ?></th>
		<th width="10%"><?php echo JText::_( 'USE_TO_ALL_PRODUCT' ); ?></th>
		<th width="5%"><?php echo JText::_( 'PUBLISHED' ); ?></th>
		<th width="5%"><?php echo JText::_( 'ID' ); ?></th></tr></thead>
	<?php	$k = 0;
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td><a href="<?php echo $link; ?>" title="<?php echo JText::_( 'EDIT_WRAPPER' ); ?>"><?php echo $row->wrapper_name;?></a></td>
			<td>
			<?php $wimage_path = 'components/'.$option.'/assets/images/wrapper/'.$row->wrapper_image;
				if(is_file(JPATH_SITE.DS.$wimage_path)) {	?>
				<a class="modal" href="<?php echo $url.$wimage_path;?>"	title="<?php echo JText::_ ( 'VIEW_IMAGE' );?>"  rel="{handler: 'image', size: {}}">
