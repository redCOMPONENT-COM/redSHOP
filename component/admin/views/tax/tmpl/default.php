...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th class="title">
				<?php echo JHTML::_('grid.sort', 'TAX_COUNTRY', 'tax_country', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th>
				<?php echo JHTML::_('grid.sort',  'TAX_STATE', 'tax_state', $this->lists['order_Dir'], $this->lists['order'] ); ?>
		 	</th>
			<th width="5%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort', 'TAX_RATE', 'tax_rate', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
	...
	for ($i=0;$i<count($this->media); $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td align="center">
			<a href="<?php echo $link; ?>" title="<?php echo JText::_( 'EDIT_TAX' ); ?>"><?php echo $row->tax_country; ?></a>
			</td>
			<td align="center">
				<?php
				echo $state_code; ?>
