	...
	for ($i=0, $n=count( $this->categories ); $i < $n; $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
				...
				{
				?>
					<a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_REDSHOP_EDIT_CATEGORY' ); ?>"><?php echo $row->treename; ?></a>
				<?php 
				} else {
				?>	
				<a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_REDSHOP_EDIT_CATEGORY' ); ?>"><?php echo $row->category_name; ?></a>
				<?php 
				}
				?>
			</td>
