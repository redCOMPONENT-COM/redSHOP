...
<form action="index.php?option=com_redshop&task=category.edit&id=<?php echo $this->item->id; ?>" method="post"
    name="adminForm" id="adminForm" class="form-validate form-horizontal" enctype="multipart/form-data">
    <?php
