    ...
    <div class="col-sm-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <?php echo Text::_('COM_REDSHOP_ACCESSORY_PRODUCT'); ?>
                </h3>
            </div>
            <div class="box-body">
                <?php
                echo RedshopLayoutHelper::render(
                    ...
                    array(
                        'msgList'     => array(
                            'info' => array(
                                Text::_('COM_REDSHOP_CATEGORY_ACCESSORY_PRODUCT_INFO')
                            )
                        ),
                        'showHeading' => false,
                        'allowClose'  => false
                            ...
                            <table id="accessory_table" class="adminlist table table-striped" border="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="75">
                                            <?php echo Text::_('COM_REDSHOP_PRODUCT_NORMAIL_PRICE'); ?>
                                        </th>
                                        <th width="50">
                                            <?php echo Text::_('COM_REDSHOP_OPRAND'); ?>
                                        </th>
                                        <th width="75">
                                            <?php echo Text::_('COM_REDSHOP_ADDED_VALUE'); ?>
                                        </th>
                                        <th width="15%">
                                ...
                                <tbody>
                                    ...
                                    for ($f = 0, $fn = count($accessoryProduct); $f < $fn; $f++):
                                        ...
                                        if ($accessoryProduct[$f]->product_id && $accessoryProduct[$f]->accessory_id):
                                            $accessoryMainPrice = \Redshop\Product\Accessory::getPrice(
                                                $accessoryProduct[$f]->product_id,
                                                $accessoryProduct[$f]->newaccessory_price,
                                                $accessoryProduct[$f]->accessory_main_price,
                                                1
                                            );
                                        endif;
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <input type="hidden"
                                                    value="<?php echo $accessoryProduct[$f]->child_product_id; ?>"
                                                    class="childProductAccessory"
                                                    name="product_accessory[<?php echo $f; ?>][child_product_id]">
                                                <input type="hidden"
                                                    value="<?php echo $accessoryProduct[$f]->accessory_id; ?>"
                                                    name="product_accessory[<?php echo $f; ?>][accessory_id]">
                                            </td>
                                            <td>
                                                <?php echo $accessoryMainPrice[1]; ?>
                                            </td>
                                            <td>
                                                <input size="1" maxlength="1" class="text_area input-small text-center"
                                                    type="text" value="<?php echo $accessoryProduct[$f]->oprand; ?>"
                                            ...
                                            <td>
                                                <input type="text" name="product_accessory[<?php echo $f; ?>][ordering]"
                                                    size="5" value="<?php echo $accessoryProduct[$f]->ordering; ?>"
