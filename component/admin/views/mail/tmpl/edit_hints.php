...
<div class="row">
    <div class="panel panel-default">
        <div class="panel-heading">
            <?php echo Text::_('COM_REDSHOP_MAIL_CENTER_HELPFUL_HINT'); ?>
        </div>
                    ...
                    <ul class="nav nav-stacked nav-pills" style="border-right: 1px solid #ddd">
                        <li role="presentation" class="active">
                            <a href="#registrationmail" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_REGISTRATION_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#order" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_ORDER_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#invoicemail" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_INVOICE_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#orderstatusmail" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_ORDER_STATUS_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#catalogmail" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_CATALOG_SEND_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#catalogfirstreminder" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_CATALOG_FIRST_REMINDER') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#catalogsecreminder" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_CATALOG_SECOND_REMINDER') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#catalogcouponreminder" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_CATALOG_COUPON_REMINDER') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#catalogsamplefirstreminder" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_CATALOG_SAMPLE_FIRST_REMINDER') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#catalogsamplesecreminder" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_CATALOG_SAMPLE_SECOND_REMINDER') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#catalogsamplethirdreminder" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_CATALOG_SAMPLE_THIRD_REMINDER') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#catalogsamplecouponreminder" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_CATALOG_SAMPLE_COUPON_REMINDER') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#economicbookinvoice" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_ECONOMIC_INVOICE') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#askquestion" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_ASK_QUESTION_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#quotationmail" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_QUOTATION_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#downloadableproductmail" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_DOWNLOADABLE_PRODUCT_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#review_product" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_REVIEW_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#first_after_order_purchased" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_FIRST_MAIL_AFTER_ORDER_PURCHASED') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#giftcard" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_GIFTCARD_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#wishlist" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_WISHLIST_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#newsletter_confirmation" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_NEWSLETTER_CONFIRMATION') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#send_friend" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_SEND_FRIEND') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#quotation_registration" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_QUOTATION_REGISTRATION_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#request_tax_exempt" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_REQUEST_TAX_EXEMPT_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#product_subscription" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_PRODUCT_SUBSCRIPTION_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#tax_exempt_approval_disapproval" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_TAX_EXEMPT_APPROVAL_DISAPPROVAL_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#catalog_order" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_CATALOG_ORDER_MAIL') ?>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#send_discount_code" role="tab" data-toggle="tab">
                                <?php echo Text::_('COM_REDSHOP_SEND_DISCOUNT_CODE') ?>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="registrationmail">
                            <table class="adminlist table table-striped">
                                <tr>
                                    <td>
                                        <?php echo RedshopHelperTemplate::getTemplateValues(
                                            'registration',
                                            'mail'
                                        ); ?>
                                    </td>
                        ...
                        <div role="tabpanel" class="tab-pane" id="order">
                            ...
                            <table class="adminlist table table-striped">
                                <tr>
                                    <td>
                                        <?php echo RedshopHelperTemplate::getTemplateValues('order', 'mail'); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        if (count($tags) == 0) {
                                            echo Text::_("COM_REDSHOP_NO_FIELDS_AVAILABLE");
                                        } else {
                                            echo Text::_("COM_REDSHOP_CUSTOMER_SHIPPING_ADDRESS");
                                        }
                                ...
                                <tr>
                                    <td>
                                        ...
                                        if (count($tags) == 0) {
                                            ...
                                            echo Text::_("COM_REDSHOP_COMPANY_SHIPPING_ADDRESS");
                                        }
                                        for ($i = 0, $in = count($tags); $i < $in; $i++) {
                                            echo '<span style="margin-left:10px;">{' . $tags[$i]->name . '} -- ' . $tags[$i]->title . '</span>';
                                        } ?>
                                ...
                                <tr>
                                    <td>
                                        <?php echo htmlentities($newbillingtag) . "<br><br>" . htmlentities(
                                            $newshippingtag
                                        ); ?>
                                    </td>
                                </tr>
                        ...
                        <div role="tabpanel" class="tab-pane" id="invoicemail">
                            <table class="adminlist table table-striped">
                                <tr>
                                    <td>
                                        <?php echo RedshopHelperTemplate::getTemplateValues('invoice', 'mail'); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                        ...
                        <div role="tabpanel" class="tab-pane" id="catalogsamplesecreminder">
                            <table class="adminlist table table-striped">
                                <tr>
                                    <td>
                                        <?php echo RedshopHelperTemplate::getTemplateValues(
                                            'catalog_sample_second_reminder',
                                            'mail'
                                        ); ?>
                                    </td>
                                </tr>
                        ...
                        <div role="tabpanel" class="tab-pane" id="catalogsamplecouponreminder">
                            <table class="adminlist table table-striped">
                                <tr>
                                    <td>
                                        <?php echo RedshopHelperTemplate::getTemplateValues(
                                            'catalog_sample_coupon_reminder',
                                            'mail'
                                        ); ?>
                                    </td>
                                </tr>
                        ...
                        <div role="tabpanel" class="tab-pane" id="giftcard">
                            <table class="adminlist table table-striped">
                                <tr>
                                    <td>
                                        <?php echo RedshopHelperTemplate::getTemplateValues('giftcard', 'mail'); ?>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div role="tabpanel" class="tab-pane" id="wishlist">
                            <table class="adminlist table table-striped">
                                <tr>
                                    <td>
                                        <?php echo RedshopHelperTemplate::getTemplateValues('wishlist', 'mail'); ?>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="tax_exempt_approval_disapproval">
                            <table class="adminlist table table-striped">
                                <tr>
                                    <td>
                                        <?php echo RedshopHelperTemplate::getTemplateValues(
                                            'tax_exempt_approval_disapproval',
                                            'mail'
                                        ); ?>
                                    </td>
                                </tr>
