...
class mailViewmail extends JView
{
	...
	{	
		...
		$document->setTitle( JText::_('MAIL') );
   		jimport('joomla.html.pagination');
   		
   		JToolBarHelper::title(   JText::_( 'MAIL_MANAGEMENT' ), 'redshop_mailcenter48' );
		...
		$filter_order     = $mainframe->getUserStateFromRequest( $context.'filter_order',      'filter_order', 	  'mail_id' );
