...
$print_l=JRoute::_ ( 'index3.php?option=' . $option . '&view=container&id=0&showbuttons=1' );
if($showbuttons==1)
{
...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th class="title">
				<?php echo JHTML::_('grid.sort', 'CONTAINER_NAME', 'container_name', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			...
			<th width="5%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort', 'ID', 'container_id', $this->lists['order_Dir'], $this->lists['order'] ); ?>	
			</th>
	...
	for ($i=0, $n=count( $this->containers ); $i < $n; $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td width="30%">
			<a href="<?php echo $link; ?>" title="<?php echo JText::_( 'EDIT_CONTAINER' ); ?>"><?php echo $row->container_name; ?></a>
			</td>
