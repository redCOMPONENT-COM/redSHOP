...
class category_detailVIEWcategory_detail extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'CATEGORY_MANAGEMENT_DETAIL' ), 'redshop_categories48' );
		...
		$text = $isNew ? JText::_( 'NEW' ) : $detail->category_name." - ".JText::_( 'EDIT' );
		JToolBarHelper::title(   JText::_( 'CATEGORY' ).': <small><small>[ ' . $text.' ]</small></small>' , 'redshop_categories48' );
	...
	//	$append_to_global_seo[] = JHTML::_('select.option','select',JText::_( 'SELECT') );
		...
		$temp[0]->template_name=JText::_('SELECT');
