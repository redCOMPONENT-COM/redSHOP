...
class fields_detailVIEWfields_detail extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'FIELDS_MANAGEMENT_DETAIL' ), 'redshop_fields48' );
		...
		JToolBarHelper::title(   JText::_( 'FIELDS' ).': <small><small>[ ' . $text.' ]</small></small>' , 'redshop_fields48' );
