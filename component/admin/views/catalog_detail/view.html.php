...
class catalog_detailVIEWcatalog_detail extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'CATALOG_MANAGEMENT_DETAIL' ), 'redshop_catalogmanagement48' );
		...
		JToolBarHelper::title(   JText::_( 'CATALOG' ).': <small><small>[ ' . $text.' ]</small></small>' , 'redshop_catalogmanagement48');
