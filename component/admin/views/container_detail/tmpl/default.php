...
<script language="javascript" type="text/javascript">
	function submitbutton(pressbutton) {
		...
		if (form.container_name.value == ""){
			alert( "<?php echo JText::_( 'CONTAINER_ITEM_MUST_HAVE_A_NAME', true ); ?>" );
		} else if (form.min_del_time.value == ""){
			alert( "<?php echo JText::_( 'YOU_MUST_HAVE_A_DELIVERY_TIME', true ); ?>" );
...
<fieldset>
	...
	<div class="configuration"><?php echo JText::_( 'ADD_CONTAINER' ); ?></div>
</fieldset>
<?php } ?>
...
<!--<div style="width:100%; text-align:right; font-weight:bold; font-size:14px;">
	<a class="modal" href="index3.php?option=com_redshop&amp;view=product_detail&amp;task=edit&showbuttons=1&container=1&container_id=<?php echo $this->detail->container_id;?>" rel="{handler: 'iframe', size: {x: 900, y: 500}}">
...
//Create 1st Tab
echo $output .= $myTabs->startPanel(JText::_('CONTAINER_INFO'), 'tab1' );
?>
<div class="col50">
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="container_name" id="container_name" size="32" maxlength="250" value="<?php echo $this->detail->container_name;?>" />
		...
		<tr>
			<td valign="top" align="right" class="key">
				<label for="deliverytime">
					<?php echo JText::_( 'CONTAINER_START_DATE' ); ?>:
				</label>
			</td>
			<td>
				<?php
		...
		<tr>
			<td valign="top" align="right" class="key">
				<label for="deliverytime">
					<?php echo JText::_( 'MINIMUM_DELIVERY_TIME' ); ?>:
				</label>
			</td>
			<td>
				<input class="text_area" type="text" name="min_del_time" id="min_del_time" value="<?php echo $this->detail->min_del_time; ?>" size="32" maxlength="250" />
				<?php echo JHTML::tooltip( JText::_( 'TOOLTIP_MINIMUM_DELIVERY_TIME' ), JText::_( 'MINIMUM_DELIVERY_TIME' ), 'tooltip.png', '', '', false); ?>
			</td>
		</tr>
		<tr>
			<td valign="top" align="right" class="key">
				<label for="deliverytime">
					<?php echo JText::_( 'MAXIMUM_DELIVERY_TIME' ); ?>:
				</label>
			</td>
			<td>
				<input class="text_area" type="text" name="max_del_time" id="max_del_time" value="<?php echo $this->detail->max_del_time; ?>" size="32" maxlength="250" />
				<?php echo JHTML::tooltip( JText::_( 'TOOLTIP_MAXIMUM_DELIVERY_TIME' ), JText::_( 'MAXIMUM_DELIVERY_TIME' ), 'tooltip.png', '', '', false); ?>
			</td>
		</tr>
		<tr>
			<td valign="top" align="right" class="key">
				<label for="volume">
					<?php echo JText::_( 'VOLUME_SIZE' ); ?>:
				</label>
			</td>
			<td>
				<input class="text_area" type="text" name="container_volume" id="container_volume" value="<?php echo $this->detail->container_volume; ?>" size="32" maxlength="250" />
				<?php echo JHTML::tooltip( JText::_( 'TOOLTIP_VOLUME_SIZE' ), JText::_( 'VOLUME_SIZE' ), 'tooltip.png', '', '', false); ?>
			</td>
		</tr>
		<tr>
			<td valign="top" align="right" class="key">
				<label for="volume">
					<?php echo JText::_( 'CONTAINER_MOVE_TO' ); ?>:
				</label>
			</td>
			<td>
			<?php if($showbuttons) {
			...
			<?php
				...
				?>
				<?php echo JHTML::tooltip( JText::_( 'TOOLTIP_CONTAINER_MOVE_TO' ), JText::_( 'CONTAINER_MOVE_TO' ), 'tooltip.png', '', '', false); ?>
			</td>
		</tr>
		<!--<tr>
		<td width="100" align="right" class="key">
		<label for="name"><?php echo JText::_( 'MANUFACTURER' ); ?></td>
		<td><?php echo $this->lists['manufacturers']; ?></td>
		</tr>
		--><tr>
		<td width="100" align="right" class="key">
		<label for="name"><?php echo JText::_( 'SUPPLIER' ); ?></td>
...
//Create 2nd Tab
echo  $myTabs->startPanel(JText::_('CONTAINER_PRODUCT'), 'tab2' );
?>
<div class="col50">
 <table width="100%"><tr><td valign="top">
<table class="admintable" border="0">
<tr><td VALIGN="TOP" class="key" align="center"  style="width: 250px" >
<?php echo JText::_( 'PRODUCT_SOURCE' ); ?> <br /><br />
...
<td>
	...
	<a class="modal" href="index3.php?option=com_redshop&amp;view=product_detail&amp;task=edit&showbuttons=1&container=1&container_id=<?php echo $this->detail->container_id;?>" rel="{handler: 'iframe', size: {x: 900, y: 500}}">
		<?php echo JText::_( 'CONTAINER_NEW_PRODUCT'); ?>
	</a>


</td>
</tr>
<tr align="left"><td><input type="checkbox" onclick="chk_newproduct(this);" value="1" <?php if($this->chk_new!=1) { ?>  <?php } ?> /></td>
<td><?php echo JText::_( 'EXISTING_PRODUCTS'); ?> </td>
</tr>
<tr align="left"><td>
<input type="checkbox" name="porder" id="porder1" onclick="chk_preorder();" <?php if($this->chk_new==1) { ?>   <?php } ?> value="0"  />
</td><td><?php echo JText::_( 'CONTAINER_PRE_ORDER_PRODUCT'); ?></td></tr>

</table>
</td>
<td>
<?php //echo JHTML::tooltip( JText::_( 'TOOLTIP_VOLUME_SIZE' ), JText::_( 'PLEASE_SELECT_MANUFACTURER_FIRST' ), 'tooltip.png', '', '', false); ?>
</td> <td colspan="2"></td>
</tr>
<tr>
...
<tr>
<!--<td>&nbsp;</td>-->
<th class="title" width="200"><?php echo JText::_( 'PRODUCT_NAME' ); ?></th>
<th  width="20"><?php echo JText::_( 'PRODUCT_QUANTITY' ); ?></th>
<th  width="20"><?php echo JText::_( 'PRODUCT_VOLUME_UNIT' ); ?></th>
<!--<th  width="50"><?php echo JText::_( 'DELETE' ); ?></th>
-->
 <th  width="50"><?php echo JText::_( 'PRODUCT_QUANTITY' ); ?></th>
 </tr>
</thead>
<tbody>
<?php
...
?>
 ...
 </table><div id="existingproduct_div"  ></div><div id="newproduct_div"></div>
 <div id="preorder_div"></div>
 <div align="right">
<input type="button" onclick="savecontainer();" value="<?php echo JText::_( 'ADD_TO_CONTAINER' );?>">
</div>
</td>
...
function chk_existingproduct(obj)
{
	if(obj.checked)
	{
		...
		var rand_no = Math.random();
		 xmlHttp.open("GET","index3.php?option=com_redshop&view=product_container&showbuttons=1&print_display=1&preorder=1&existingproducts=1&rand_no="+rand_no+"&container_id=<?php echo $this->detail->container_id; ?>",true);
		 xmlHttp.send(null);
...
function chk_newproduct(obj)
{
	if(obj.checked)
	{
		...
		var rand_no = Math.random();
		 xmlHttp.open("GET","index3.php?option=com_redshop&view=product_container&showbuttons=1&print_display=1&preorder=1&rand_no="+rand_no+"&newproducts=1",true);
		 xmlHttp.send(null);
...
function savecontainer(){
    ...
    str += '<h2><?php echo JText::_('SELECTED_PRODUCTS'); ?></h2><br> ';

    str += '</div>';
    str += '<table id="tbl_selected" class="adminlist" border="0" ><thead><tr><th class="title" width="200"><?php echo JText::_( 'PRODUCT_NAME' ); ?></th><th  width="20"><?php echo JText::_( 'PRODUCT_QUANTITY' ); ?></th><th  width="20"><?php echo JText::_( 'PRODUCT_VOLUME_UNIT' ); ?></th><th  width="50"><?php echo JText::_( 'DELETE' ); ?></th></tr></thead>';
    	...
    	str += str2;
		str += '<tr>';
		str += '<td><b><?php echo JText::_('TOTAL_VOLUME_IN_CONTAINER'); ?></b></td>';
		...
		str += '<tr>';
		str += '<td><b><?php echo JText::_('VOLUME_LEFT_IN_CONTAINER'); ?></b></td>';
		str += '<td>&nbsp;</td>';
...
function displaycontainerproducts(){
	...
	var rand_no = Math.random();
	request.open("GET", "index2.php?option=com_redshop&tmpl=component&layout=products&view=container_detail&rand_no="+rand_no+"&task=edit&cid[]=<?php echo $this->detail->container_id; ?>", true);
	request.send(null);
}
function deleteProduct(obj){
	...
	request.onreadystatechange = viewProducts;
	var rand_no = Math.random();
	request.open("GET", "index2.php?option=com_redshop&tmpl=component&no_html=1&view=container_detail&task=deleteproduct&rand_no="+rand_no+"&container_id="+container_id+"&product_id="+product_id, true);
	request.send(null);
}
...
var rand_no = Math.random();
var options = {
		script:"index3.php?option=com_redshop&view=search&json=true&rand_no="+rand_no+"&container_id=<?php echo $this->detail->container_id;?>&alert=container&",
		varname:"input",
		json:true,
		shownoresults:false,
		...
		if(maid!=0)
		{
			...
			{
				alert("<?php echo JText::_( 'PLEASE_SELECT_SAME_SUPPLIER_PRODUCT_ONLY' );?>");
			}
		}
		else
		{
			alert("<?php echo JText::_( 'PLEASE_SELECT_SUPPLIER' );?>");
		}
