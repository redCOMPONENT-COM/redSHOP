...
<table width="100%">
	<tr>
		<td valign="top" align="left" class="key">
			...
			<?php echo JText::_('COM_REDSHOP_FIELD_SECTION' ); ?>&nbsp;:&nbsp;<?php echo $this->lists['section'];?>
			...
			<button onclick="document.getElementById('filter').value='';document.getElementById('filtertype').value='0';document.getElementById('filtersection').value='0';this.form.submit();"><?php echo JText::_('COM_REDSHOP_RESET' ); ?></button>
		</td>
	</tr>
</table>
	...
	for ($i=0, $n=count( $this->fields ); $i < $n; $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td width="30%">
			<a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_REDSHOP_EDIT_FIELDS' ); ?>"><?php echo JText::_($row->field_title); ?></a>
			</td>
			<td width="30%">
