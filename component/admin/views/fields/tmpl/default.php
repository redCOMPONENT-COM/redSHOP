            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="fieldsAssignGroupLabel">
                        <?php echo Text::_('COM_REDSHOP_FIELDS_MASS_ASSIGN_GROUP_MODAL_TITLE') ?>
                    </h4>
                </div>
                        ...
                        <ul class="list-group no-margin">
                            <li class="list-group-item">
                                <label>
                                    ...
                                    <?php echo Text::_('COM_REDSHOP_FIELDS_MASS_ASSIGN_GROUP_CLEAR') ?>
                                </label>
                            </li>
                            <?php foreach ($this->fieldGroups as $fieldGroup): ?>
                                <li class="list-group-item">
                                    <label>
                                        <input type="radio" name="field_assign_group" value="<?php echo $fieldGroup->id ?>" />
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="fieldsAssignGroupBtn">
                        <?php echo Text::_('COM_REDSHOP_FIELDS_MASS_ASSIGN_GROUP_ASSIGN_BTN') ?>
                    </button>
                </div>
            </div>
        </div>
