	...
	{	
		...
		$document->setTitle( JText::_('PRODUCT') );
   		...
   		if($task=='assignCategory')
   			JToolBarHelper::custom( 'saveProduct_Category', 'save.png', 'save_f2.png',JText :: _('ASSIGN_CATEGORY'),false);
   		else 
   			JToolBarHelper::custom( 'removeProduct_Category', 'delete.png', 'delete.png',JText :: _('REMOVE_CATEGORY'),false);
