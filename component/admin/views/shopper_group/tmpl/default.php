...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th class="title">
				<?php echo JHTML::_('grid.sort', 'SHOPPER_GROUP_NAME', 'shopper_group_name', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>		 		
			<th width="5%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort', 'PUBLISHED', 'published', $this->lists['order_Dir'], $this->lists['order'] ); ?>	
			</th>
			<th width="5%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort', 'ID', 'shopper_group_id', $this->lists['order_Dir'], $this->lists['order'] ); ?>	
			</th>
	...
	for ($i=$this->pagination->limitstart,$j=0, $n=count( $this->media ); $i < ($this->pagination->limitstart+$this->pagination->limit); $i++,$j++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td><a href="<?php echo $link; ?>" title="<?php echo JText::_( 'EDIT_SHOPPER_GROUP' ); ?>"><?php echo $row->shopper_group_name; ?></a>
			</td>					
			<td align="center">
				<?php echo $published;?>
			</td>
