...
<div id="editcell">
	...
	for ($i=$this->pagination->limitstart,$j=0, $n=count( $this->media ); $i < ($this->pagination->limitstart+$this->pagination->limit); $i++,$j++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td><a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_REDSHOP_EDIT_SHOPPER_GROUP' ); ?>"><?php echo $row->shopper_group_name; ?></a>
			<td align="center"><a href="<?php echo $link_adddis; ?>"><?php echo JText::_('COM_REDSHOP_ADD_DISCOUNT' ); ?></a>
			</td>					
			<td align="center">
				<?php echo $published;?>
			</td>
