...
<script language="javascript" type="text/javascript">
    Joomla.submitbutton = function (pressbutton) {
        ...
        if ((pressbutton != 'question.cancel') && (form.jform_product_id.value == 0)) {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_SELECT_PRODUCT_NAME', true); ?>");
        } else {
    ...
    function isChecked() {
        if (jQuery('[name="aid[]"]').is(':checked') == false) {
            alert("<?php echo Text::_('JLIB_HTML_PLEASE_MAKE_A_SELECTION_FROM_THE_LIST', true); ?>");
            return false;
        }
...
<form
    action="<?php echo Redshop\IO\Route::_('index.php?option=com_redshop&task=question.edit&id=' . $this->detail->id) ?>"
    ...
    <div class="row">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2">
                            <?php echo Text::_('COM_REDSHOP_USER_NAME'); ?>
                        </label>
                        <div class="col-md-10">
                            <p>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2">
                            <?php echo Text::_('COM_REDSHOP_USER_EMAIL'); ?>
                        </label>
                        <div class="col-md-10">
        ...
        <div class="col-sm-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <?php echo Text::_('COM_REDSHOP_PREVIOUS_ANSWERS') ?>
                    </h3>
                </div>
                <div class="box-body">
                    <?php if (empty($this->answers)): ?>
                        <div class="alert alert-info">
                            <?php echo Text::_('COM_REDSHOP_QUESTION_NO_ANSWERS') ?>
                        </div>
                    <?php else: ?>
                        <?php
                        $k = 0;
                            ...
                            <table class="adminlist table table-striped">
                                <thead>
                                    <tr class="row<?php echo $k; ?>">
                                        ...
                                        <th class="title">
                                            <?php echo Text::_('COM_REDSHOP_ANSWERS'); ?>
                                        </th>
                                        <th class="title">
                                            <?php echo Text::_('COM_REDSHOP_USER_NAME'); ?>
                                        </th>
                                        ...
                                        <th class="title">
                                            <?php echo Text::_('COM_REDSHOP_TIME') ?>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            <input type="button" class="btn btn-danger" name="btn_delete" id="btn_delete"
                                                value="<?php echo Text::_('COM_REDSHOP_DELETE') ?>"
                                                onclick="deleteAnswer();" />
                                            <input type="button" class="btn btn-info" name="btn_send" id="btn_send"
                                                value="<?php echo Text::_('COM_REDSHOP_SEND') ?>" onclick="sendAnswer();" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
