...
<fieldset>
	...
	<div class="configuration"><?php echo JText::_( 'ADD_ATTRIBUTE_PRICE' ); ?></div>
</fieldset>
...
<tr><td width="100" align="right" class="key"><?php echo JText::_( 'PROPERTY_NAME' ); ?>:</td>
	<td><?php echo $this->property->property_name;?></td></tr>
<tr><td valign="top" align="right" class="key"><?php echo JText::_( 'SHOPPER_GROUP_NAME' ); ?>:</td>
	<td><?php echo $this->lists['shopper_group_name'];?></td></tr>
<tr><td width="100" align="right" class="key"><?php echo JText::_( 'PRODUCT_PRICE_LBL' ); ?>:</td>
...
<tr><td width="100" align="right" class="key"><?php echo JText::_( 'QUANTITY_START_LBL' ); ?>:</td>
...
<tr><td width="100" align="right" class="key"><?php echo JText::_( 'QUANTITY_END_LBL' ); ?>:</td>
...
<tr><td width="100" align="right" class="key"><?php echo JText::_( 'DISCOUNT_PRICE' ); ?>:</td>
...
<tr><td width="100" align="right" class="key"><?php echo JText::_( 'DISCOUNT_START_DATE' ); ?>:</td>
	<td><?php $sdate = "";
...
<tr><td width="100" align="right" class="key"><?php echo JText::_( 'DISCOUNT_END_DATE' ); ?>:</td>
	<td><?php $sdate = "";
