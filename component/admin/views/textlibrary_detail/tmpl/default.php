...
<script language="javascript" type="text/javascript">
	function submitbutton(pressbutton) {
		...
		if (form.text_name.value == ""){
			alert( "<?php echo JText::_( 'TAG_NAME_MUST_HAVE_A_ENTER', true ); ?>" );
		} else if (form.text_desc.value == ""){
			alert( "<?php echo JText::_( 'TAG_DESCRIPTION_MUST_HAVE_A_ENTER', true ); ?>" );
		} else if (form.section.value == 0 || form.section.value == '0'){
			alert( "<?php echo JText::_( 'PLEASE_SELECT_TEXT_LIBRARY_SECTION', true ); ?>" );
		} else {
			submitform( pressbutton );
		}
	}
	...
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				...
				<?php echo JHTML::tooltip( JText::_( 'TOOLTIP_TEXT_FIELD' ), JText::_( 'TEXT_FIELD' ), 'tooltip.png', '', '', false); ?>
			</td>
		</tr>
		<tr>
			<td valign="top" align="right" class="key">
...
<div class="col50">
	<fieldset class="adminform">
		<legend><?php echo JText::_( 'TEXT_FIELD' ); ?></legend>
