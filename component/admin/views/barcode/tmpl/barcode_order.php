...
<div id="editcell" style="background-color: ">
 <fieldset class="adminform">
	...
	<tr>
	    ...
	    <td width="20%"> <input type="text" name="barcode" value="<?php echo JText::_('COM_REDSHOP_ENTER_BARCODE')?>" id= "barcode" onclick = this.value="";>  </td>
	    <td> <span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_BARCODE_TOOLTIP')?>"><input type="submit" name="changestsbtn" value="<?php echo JText::_( 'COM_REDSHOP_CHANGE_ORDER_STATUS' );?>" >  </span></td>
	</tr>
</table>
</fieldset>
</div>
