...
<div id="editcell" style="background-color: ">
 <fieldset class="adminform">
	...
	<tr>
	    ...
	    <td> <span class="editlinktip hasTip" title="<?php echo JText::_('BARCODE_TOOLTIP')?>"><input type="submit" name="searchbtn" value="<?php echo JText::_( 'CHECK_BARCODE' );?>" >  </span></td>
	</tr>
</table>
</fieldset>
</div>
...
<div>
<fieldset class="adminform">
   <legend><?php echo JText::_( 'BARCODE_INFO' ); ?></legend>
...
<div>
<fieldset class="adminform">
   <legend><?php echo JText::_( 'BARCODE_INFO_LOG' ); ?></legend>
