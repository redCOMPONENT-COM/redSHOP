            ...
            <table class="admintable table">
                <tr>
                    ...
                    <td>
                        ...
                        $userObject->text  = ($this->detail->user_id != 0) ? $model->getuserfullname2(
                            $this->detail->user_id
                        ) : $this->detail->name;
                        ...
                        <?php echo JHTML::tooltip(
                            JText::_('COM_REDSHOP_TOOLTIP_NEWSLETTER_SELECT_USER'),
                            JText::_('COM_REDSHOP_NEWSLETTER_SELECT_USER'),
                            'tooltip.png',
                            '',
                            '',
                            false
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo JHTML::tooltip(
                            JText::_('COM_REDSHOP_TOOLTIP_NEWSLETTER_SELECT_NEWSLETTER'),
                            JText::_('COM_REDSHOP_NEWSLETTER_SELECT_NEWSLETTER'),
                            'tooltip.png',
                            '',
                            '',
                            false
                ...
                <tr>
                    ...
                    <td>
                        <input type="email" name="email" id="email" value="<?php echo $this->detail->email; ?>"
                               size="75"/>
                        <?php echo JHTML::tooltip(
                            JText::_('COM_REDSHOP_TOOLTIP_NEWSLETTER_SUBSCR_EMAIL'),
                            JText::_('COM_REDSHOP_NEWSLETTER_SUBSCR_EMAIL'),
                            'tooltip.png',
                            '',
                            '',
                            false
