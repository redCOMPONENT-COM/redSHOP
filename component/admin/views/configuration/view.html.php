...
class configurationViewconfiguration extends JView
{
	public function display($tpl = null)
	{
		...
		$lists['enable_sef_number_name'] = JHTML::_('select.booleanlist', 'enable_sef_number_name',
			'class="inputbox"', ENABLE_SEF_NUMBER_NAME, 'COM_REDSHOP_NAME', 'COM_REDSHOP_ID'
		);
		$lists['category_in_sef_url'] = JHTML::_('select.booleanlist', 'category_in_sef_url',
			'class="inputbox"', CATEGORY_IN_SEF_URL, 'COM_REDSHOP_No', 'COM_REDSHOP_Yes'
		);
