...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_SEO_PAGE_TITLE_MANUFACTUR_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_SEO_PAGE_TITLE_MANUFACTUR_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_SEO_PAGE_HEADING_MANUFACTUR_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_SEO_PAGE_HEADING_MANUFACTUR'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_SEO_PAGE_DESCRIPTION_MANUFACTUR_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_SEO_PAGE_DESCRIPTION_MANUFACTUR_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_SEO_PAGE_KEYWORDS_MANUFACTUR_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_SEO_PAGE_KEYWORDS_MANUFACTUR_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_SEO_PAGE_CANONICAL_MANUFACTUR_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_SEO_PAGE_CANONICAL_MANUFACTUR_LBL'),
