...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_CATALOG_REMAINDER_1_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_CATALOG_REMAINDER_1'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_CATALOG_REMAINDER_2_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_CATALOG_REMAINDER_2'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_DISCOUNT_DURATION_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_DISCOUNT_DURATION'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_DISCOUNT_PERCENTAGE_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_DISCOUNT_PERCENTAGE'),
...
echo '<div class="hidden">' . RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_CATALOG_DAYS_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_CATALOG_DAYS_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_SEND_CATALOG_REMINDER_MAIL_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_SEND_CATALOG_REMINDER_MAI_LBL'),
        'line'  => false,
