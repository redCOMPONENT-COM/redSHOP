...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_IMPORT_SETTINGS_MIN_FILE_SIZE'),
        'desc'  => Text::_('COM_REDSHOP_IMPORT_SETTINGS_MIN_FILE_SIZE_DESC'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_IMPORT_SETTINGS_MAX_FILE_SIZE'),
        'desc'  => Text::_('COM_REDSHOP_IMPORT_SETTINGS_MAX_FILE_SIZE_DESC'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_IMPORT_SETTINGS_FILE_MIME'),
        'desc'  => Text::_('COM_REDSHOP_IMPORT_SETTINGS_FILE_MIME_DESC'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_IMPORT_SETTINGS_FILE_EXTENSION'),
        'desc'  => Text::_('COM_REDSHOP_IMPORT_SETTINGS_FILE_EXTENSION_DESC'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_IMPORT_SETTINGS_MAX_LINE'),
        'desc'  => Text::_('COM_REDSHOP_IMPORT_SETTINGS_MAX_LINE_DESC'),
