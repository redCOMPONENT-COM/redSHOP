...
<div class="row adminform">
    <div class="col-sm-6">
        <div class="panel panel-primary form-vertical">
            <div class="panel-heading"><h3><?php echo JText::_('COM_REDSHOP_RELATED_PRODUCT_SETTINGS'); ?></h3></div>
    ...
    <div class="col-sm-6">
        <div class="panel panel-primary form-vertical">
            <div class="panel-heading"><h3><?php echo JText::_('COM_REDSHOP_RELATED_PRODUCT_IMAGE_SETTINGS'); ?></h3></div>
            <div class="panel-body">
                <div class="row">
