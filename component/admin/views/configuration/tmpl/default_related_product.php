            ...
            <div class="box-body">
                <div class="form-group row-fluid">
                    <label class="col-md-4 hasPopover"
                           data-content="<?php echo JText::_('COM_REDSHOP_TOOLTIP_RELATED_PRODUCT_THUMB_WIDTH'); ?>">
                        <?php echo JText::_('COM_REDSHOP_RELATED_PRODUCT_THUMB_WIDTH_HEIGHT'); ?>
                    </label>
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="number" name="related_product_thumb_width" id="related_product_thumb_width"
                                       class="form-control"
                                       value="<?php echo $this->config->get('RELATED_PRODUCT_THUMB_WIDTH'); ?>"/>
                            </div>
                            <div class="col-sm-6">
                                <input type="number" name="related_product_thumb_height"
                                       id="related_product_thumb_height" class="form-control"
                ...
                <div class="form-group row-fluid">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="number" name="related_product_thumb_width_2"
                                       id="related_product_thumb_width_2" class="form-control"
                                       value="<?php echo $this->config->get('RELATED_PRODUCT_THUMB_WIDTH_2'); ?>"/>
                            </div>
                            <div class="col-sm-6">
                                <input type="number" name="related_product_thumb_height_2"
                                       id="related_product_thumb_height_2"
                                       class="form-control"
                ...
                <div class="form-group row-fluid">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="number" name="related_product_thumb_width_3"
                                       id="related_product_thumb_width_3" class="form-control"
                                       value="<?php echo $this->config->get('RELATED_PRODUCT_THUMB_WIDTH_3'); ?>"/>
                            </div>
                            <div class="col-sm-6">
                                <input type="number" name="related_product_thumb_height_3"
                                       id="related_product_thumb_height_3"
                                       class="form-control"
