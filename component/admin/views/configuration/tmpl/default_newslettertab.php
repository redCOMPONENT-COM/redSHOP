                ...
                echo RedshopLayoutHelper::render(
                    ...
                    array(
                        ...
                        'field' => '<button type="button" class="btn btn-success btn-large"
                            onclick="if(document.getElementById(\'newsletter_test_email\').value != \'\'){document.adminForm.task.value=\'apply\';form.submit();}else{alert(\'' . JText::_(
                                'COM_REDSHOP_PLEASE_ENTER_EMAIL_ADDRESS'
                            ) . '\');}"><i class="fa fa-envelope"></i>&nbsp;&nbsp;' . JText::_(
                                'COM_REDSHOP_SEND'
                            ) . '</button>',
                        'line'  => false
                    )
