...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_CAT_IS_LIGHTBOX'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_CAT_IS_LIGHTBOX'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_TOOLTIP_WATERMARK_CATEGORY_IMAGE_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_WATERMARK_CATEGORY_IMAGE'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_TOOLTIP_WATERMARK_CATEGORY_THUMB_IMAGE_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_WATERMARK_CATEGORY_THUMB_IMAGE'),
...
<div class="form-group row-fluid">
    <label class="col-md-4">
        <?php echo Text::_('COM_REDSHOP_CATEGORY_THUMB_WIDTH_HEIGHT'); ?>
    </label>
    <div class="col-md-8">
        <div class="row">
            <div class="col-md-6">
...
<div class="form-group row-fluid">
    <label class="col-md-4">
        <?php echo Text::_('COM_REDSHOP_CATEGORY_THUMB_WIDTH_HEIGHT_TWO'); ?>
    </label>
    <div class="col-md-8">
        <div class="row">
            <div class="col-md-6">
...
<div class="form-group row-fluid">
    <label class="col-md-4">
        <?php echo Text::_('COM_REDSHOP_CATEGORY_THUMB_WIDTH_HEIGHT_THREE'); ?>
    </label>
    <div class="col-md-8">
        <div class="row">
            <div class="col-md-6">
...
<div class="form-group row-fluid">
    <label class="col-md-4">
        <?php echo Text::_('COM_REDSHOP_CATEGORY_PRODUCT_THUMB_WIDTH_HEIGHT_LBL'); ?>
    </label>
    <div class="col-md-8">
        <div class="row">
            <div class="col-md-6">
...
<div class="form-group row-fluid">
    <label class="col-md-4">
        <?php echo Text::_('COM_REDSHOP_CATEGORY_PRODUCT_THUMB_WIDTH_HEIGHT_TWO'); ?>
    </label>
    <div class="col-md-8">
        <div class="row">
            <div class="col-md-6">
...
<div class="form-group row-fluid">
    <label class="col-md-4">
        <?php echo Text::_('COM_REDSHOP_CATEGORY_PRODUCT_THUMB_WIDTH_HEIGHT_THREE'); ?>
    </label>
    <div class="col-md-8">
        <div class="row">
            <div class="col-md-6">
