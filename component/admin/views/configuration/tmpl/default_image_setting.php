...
<div class="panel panel-primary form-vertical">
    <div class="panel-heading">
        <h3><?php echo JText::_('COM_REDSHOP_IMAGE_SETTINGS'); ?></h3>
    </div>
	...
	<span class="editlinktip hasTip"
        ...
        <div class="form-group">
	        <span class="editlinktip hasTip"
		        ...
		        <label for="name"><?php echo JText::_('COM_REDSHOP_CATEGORY_THUMB_WIDTH_HEIGHT'); ?></label>
            </span>
            <div class="row">
                <div class="col-md-6">
                    <input type="text" class="form-control" name="thumb_width" id="thumb_width"
                           value="<?php echo $this->config->get('THUMB_WIDTH'); ?>"/>
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="thumb_height" id="thumb_height"
        ...
        <div class="form-group">
	        <span class="editlinktip hasTip"
		        ...
		        <label for="name"><?php echo JText::_('COM_REDSHOP_CATEGORY_THUMB_WIDTH_HEIGHT_TWO'); ?></label>
            </span>
            <div class="row">
                <div class="col-md-6">
                    <input type="text" class="form-control" name="thumb_width_2" id="thumb_width_2"
                           value="<?php echo $this->config->get('THUMB_WIDTH_2'); ?>"/>
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="thumb_height_2" id="thumb_height_2"
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <input type="text" class="form-control" name="thumb_width_3" id="thumb_width_3"
                           value="<?php echo $this->config->get('THUMB_WIDTH_3'); ?>"/>
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="thumb_height_3" id="thumb_height_3"
        ...
        <div class="form-group">
            <span class="editlinktip hasTip"
                ...
                <label for="name"><?php echo JText::_('COM_REDSHOP_CATEGORY_PRODUCT_THUMB_WIDTH_HEIGHT_LBL'); ?></label>
            </span>
            <div class="row">
                <div class="col-md-6">
                    <input type="text" class="form-control" name="category_product_thumb_width" id="category_product_thumb_width"
                           value="<?php echo $this->config->get('CATEGORY_PRODUCT_THUMB_WIDTH'); ?>"/>
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="category_product_thumb_height" id="category_product_thumb_height"
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <input type="text" class="form-control" name="category_product_thumb_width_2" id="category_product_thumb_width_2"
                           value="<?php echo $this->config->get('CATEGORY_PRODUCT_THUMB_WIDTH_2'); ?>"/>
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="category_product_thumb_height_2" id="category_product_thumb_height_2"
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <input type="text" class="form-control" name="category_product_thumb_width_3" id="category_product_thumb_width_3"
                           value="<?php echo $this->config->get('CATEGORY_PRODUCT_THUMB_WIDTH_3'); ?>"/>
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="category_product_thumb_height_3" id="category_product_thumb_height_3"
