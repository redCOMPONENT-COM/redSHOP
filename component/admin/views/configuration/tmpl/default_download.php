...
<tr><td class="config_param"><?php echo JText::_( 'COM_REDSHOP_DOWNLOAD' ); ?></td></tr>
<tr>
		<td width="100" align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_PRODUCT_DOWNLOAD_LIMIT_LBL' ); ?>::<?php echo JText::_( 'TOOLTIP_PRODUCT_DOWNLOAD_LIMIT_LBL' ); ?>">
...
<tr>
		<td width="100" align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_PRODUCT_DOWNLOAD_DAYS_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_PRODUCT_DOWNLOAD_DAYS_LBL' ); ?>">
...
<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_PRODUCT_DOWNLOAD_ROOT_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_PRODUCT_DOWNLOAD_ROOT_LBL' ); ?>">
		<label for="product_download_root"><?php echo JText::_ ( 'COM_REDSHOP_PRODUCT_DOWNLOAD_ROOT_LBL' );?></label></span>
		</td>
		<td>
			<?php
