...
<tr><td class="config_param"><?php echo JText::_( 'COM_REDSHOP_DEFAULT_IMAGES' ); ?></td></tr>
	<tr>
		<td align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_CATEGORY_DEFAULT_IMAGE_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_CATEGORY_DEFAULT_IMAGE' ); ?>">
		...
		<div>
		    ...
		    <a href="#123"   onclick="delimg('<?php echo CATEGORY_DEFAULT_IMAGE?>','catdiv','<?php echo $cat_path?>');"><?php echo JText::_('COM_REDSHOP_REMOVE_FILE');?></a>
		</div>
	...
	<tr>
		<td align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_PRODUCT_DEFAULT_IMAGE_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_DEFAULT_IMAGE_LBL' ); ?>">
		...
		<input type="hidden" name="product_default_image" id="product_default_image" value="<?php echo PRODUCT_DEFAULT_IMAGE;?>" />
		 <a href="#123"   onclick="delimg('<?php echo PRODUCT_DEFAULT_IMAGE?>','proddiv','<?php echo $prod_path?>');"><?php echo JText::_('COM_REDSHOP_REMOVE_FILE');?></a>
		</div>
			<?php
	...
	<tr>
		<td align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_WATERMARK_IMAGE_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_WATERMARK_IMAGE' ); ?>">
	<?php echo JText::_('COM_REDSHOP_WATERMARK_IMAGE_LBL' ); ?>:</span></td>
		...
		<input type="hidden" name="watermark_image" id="watermark_image" value="<?php echo WATERMARK_IMAGE;?>" />
		 <a href="#123"   onclick="delimg('<?php echo WATERMARK_IMAGE?>','prodwaterdiv','<?php echo $prod_path?>');"><?php echo JText::_('COM_REDSHOP_REMOVE_FILE');?></a>
		</div>
			<?php
	...
	<tr>
		<td align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_OUTOFSTOCK_IMAGE_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_OUTOFSTOCK_IMAGE' ); ?>">
<?php
...
?>:
		...
		<input type="hidden" name="product_outofstock_image" id="product_outofstock_image" value="<?php echo PRODUCT_OUTOFSTOCK_IMAGE;?>" />
		 <a href="#123"   onclick="delimg('<?php echo PRODUCT_OUTOFSTOCK_IMAGE?>','prodstockdiv','<?php echo $prod_path?>');"><?php echo JText::_('COM_REDSHOP_REMOVE_FILE');?></a>
		</div>
			<?php
	...
	<tr>
		<td align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_DETAIL_LIGHTBOX_CLOSE_BUTTON_IMAGE_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_DETAIL_LIGHTBOX_CLOSE_BUTTON_IMAGE' ); ?>">
<?php
...
?>:
		...
		<div id="slimboximglinkdiv">
				<div style='float:right'>
					<a href="#123"   onclick="delimg('<?php echo PRODUCT_DETAIL_LIGHTBOX_CLOSE_BUTTON_IMAGE?>','slimboximglinkdiv','<?php echo $slimbox_img_path; ?>');"><?php echo JText::_('COM_REDSHOP_REMOVE_FILE');?></a></span>
				</div>
				<div><a class="modal" href="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH.'slimbox/' . PRODUCT_DETAIL_LIGHTBOX_CLOSE_BUTTON_IMAGE; ?>" title="<?php echo PRODUCT_DETAIL_LIGHTBOX_CLOSE_BUTTON_IMAGE; ?>" rel="{handler: 'image', size: {}}"><img alt="<?php echo PRODUCT_DETAIL_LIGHTBOX_CLOSE_BUTTON_IMAGE; ?>" src="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH.'slimbox/' . PRODUCT_DETAIL_LIGHTBOX_CLOSE_BUTTON_IMAGE; ?>" /></a></div>
			</div><?php } ?>
		</div>
		</td>
	</tr>
