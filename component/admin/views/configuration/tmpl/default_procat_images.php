...
<div class="form-group row-fluid">
    <label class="col-md-4 hasPopover"
        data-bs-content="<?php echo Text::_('COM_REDSHOP_TOOLTIP_CATEGORY_DEFAULT_IMAGE') ?>">
        <?php echo Text::_('COM_REDSHOP_CATEGORY_DEFAULT_IMAGE_LBL'); ?>
    </label>
    <div class="col-md-8">
...
<div class="form-group row-fluid">
    <label class="col-md-4 hasPopover"
        data-bs-content="<?php echo Text::_('COM_REDSHOP_TOOLTIP_PRODUCT_DEFAULT_IMAGE_LBL') ?>">
        <?php echo Text::_('COM_REDSHOP_PRODUCT_DEFAULT_IMAGE_LBL'); ?>
    </label>
    <div class="col-md-8">
...
<div class="form-group row-fluid">
    <label class="col-md-4 hasPopover" data-bs-content="<?php echo Text::_('COM_REDSHOP_TOOLTIP_WATERMARK_IMAGE') ?>">
        <?php echo Text::_('COM_REDSHOP_WATERMARK_IMAGE_LBL'); ?>
    </label>
    <div class="col-md-8">
...
<div class="form-group row-fluid">
    <label class="col-md-4 hasPopover"
        data-bs-content="<?php echo Text::_('COM_REDSHOP_TOOLTIP_PRODUCT_OUTOFSTOCK_IMAGE') ?>">
        <?php echo Text::_('COM_REDSHOP_PRODUCT_OUTOFSTOCK_IMAGE_LBL'); ?>
    </label>
    <div class="col-md-8">
...
<div class="form-group row-fluid">
    <label class="col-md-4 hasPopover"
        data-bs-content="<?php echo Text::_('COM_REDSHOP_TOOLTIP_PRODUCT_DETAIL_LIGHTBOX_CLOSE_BUTTON_IMAGE') ?>">
        <?php echo Text::_('COM_REDSHOP_PRODUCT_DETAIL_LIGHTBOX_CLOSE_BUTTON_IMAGE_LBL'); ?>
    </label>
    <div class="col-md-8">
