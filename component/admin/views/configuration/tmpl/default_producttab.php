...
<tr valign="top" align="left"><td colspan="2"><fieldset>
		<legend><?php echo JText::_( 'PRODUCT_INTRO_TAB' ); ?></legend>
			<?php echo JText::_( 'PRODUCT_INTRO' );?>
		</fieldset></td></tr>
</table>
<?php
echo $this->pane->startPane( 'stat-pane' );
echo $this->pane->startPanel( JText::_( 'PRODUCT' ), 'events' );
?>
...
echo $this->pane->startPanel( JText::_( 'ACCESSORY_PRODUCT_TAB' ), 'events');
echo $this->loadTemplate('accessory_product');
echo $this->pane->endPanel();
echo $this->pane->startPanel( JText::_( 'RELATED_PRODUCTS' ), 'events');
