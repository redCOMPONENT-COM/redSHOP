...
<form action="<?php echo 'index.php?option=com_redshop'; ?>" method="post" name="adminForm" id="adminForm"
    ...
    ?>
    <input type="hidden" name="backward_compatible_js"
           value="<?php echo $this->config->get('BACKWARD_COMPATIBLE_JS') ?>"/>
    <input type="hidden" name="backward_compatible_php"
           value="<?php echo $this->config->get('BACKWARD_COMPATIBLE_PHP') ?>"/>
