...
function submitform(pressbutton)
{
	...
	if (pressbutton=='save' || pressbutton=='apply')
	{
		...
		if(sel_discount_flag)
		{
			...
			{
				alert("<?php
				echo JText::_ ( 'PLEASE_SELECT_DISCOUNT_TYPE' );
				?>");
				return false;
			}
		}
		...
		for(i=0;i<obj.length;i++)
		{
			if(form.economic_integration[i].value==1 && form.economic_integration[i].checked)
			{
				...
				{
					alert("<?php
					echo JText::_ ( 'SELECT_ECONOMIC_ACCOUNTING_GROUP' );
					?>");
				...
				{
					alert("<?php echo JText::_ ( 'SELECT_BOOK_INVOICE_ORDER_STATUS' );?>");
		...
		{
			alert("<?php echo JText::_ ( 'INVALID_THOUSAND_SEPERATOR' );?>");
		...
		{
			alert("<?php echo JText::_ ( 'INVALID_PRICE_SEPERATOR' );?>");
...
//Create 1st Tab
echo $output .= $myTabs->startPanel ( JText::_ ( 'GENERAL_CONFIGURATION' ), 'tab1' );
?>
...
# user tab
echo $myTabs->startPanel ( JText::_ ( 'USER' ), 'tab11' );
...
//End Pane
# category tab
echo $myTabs->startPanel ( JText::_ ( 'CATEGORY_TAB' ), 'tab5' );
...
# End tab
# category tab
echo $myTabs->startPanel ( JText::_ ( 'REDMANUFACTURER_TAB' ), 'tab5' );
...
# End tab
# product tab
echo $myTabs->startPanel ( JText::_ ( 'PRODUCT_TAB' ), 'tab5' );
...
# End tab
# Feature tab
echo $myTabs->startPanel ( JText::_ ( 'FEATURE_TAB' ), 'tab5' );
...
//Create *th Tab
echo $myTabs->startPanel ( JText::_ ( 'PRICE_TAB' ), 'tab5' );
...
# product tab
echo $myTabs->startPanel ( JText::_ ( 'CART_TAB' ), 'tab5' );
...
# product tab
echo $myTabs->startPanel ( JText::_ ( 'ORDER_TAB' ), 'tab5' );
...
# product tab
echo $myTabs->startPanel ( JText::_ ( 'NEWSLETTER_TAB' ), 'tab5' );
...
//Create 4th Tab
echo $myTabs->startPanel ( JText::_ ( 'INTEGRATION' ), 'tab4' );
...
//Create 8th Tab
echo $myTabs->startPanel ( JText::_ ( 'SEO' ), 'tab7' );
...
//Create 8th Tab
echo $myTabs->startPanel ( JText::_ ( 'DASHBOARD' ), 'tab8' );
...
//Create 9th Tab
echo $myTabs->startPanel ( JText::_ ( 'ABOUT' ), 'tab9' );
...
function clearsef(){
	...
	request.open("GET", "index3.php?option=com_redshop&view=configuration&rand_no="+rand_no+"&task=clearsef", true);
	request.send(null);
}
function cleardata(){
...
echo JText::_ ( 'NO_DATA_DELETE' );
?>";
}else{
document.getElementById('responce_clear').style.color = "green";
document.getElementById('responce_clear').innerHTML = output + " <?php echo JText::_('RECORDS_DELETED');?>";
}
}
}
