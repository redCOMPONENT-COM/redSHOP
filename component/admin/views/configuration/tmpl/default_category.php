...
<tr><td class="config_param"><?php echo JText::_( 'COM_REDSHOP_MAIN_CATEGORY_SETTINGS' ); ?></td></tr>
	<tr>
		<td width="100" align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_DEFAULT_CATEGORY_ORDERING_METHOD_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_DEFAULT_CATEGORY_ORDERING_METHOD_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_MAXCATEGORY_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_MAXCATEGORY_LBL' ); ?>">
	...
	<tr>
		...
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_PRODUCT_EXPIRE_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_PRODUCT_EXPIRE' ); ?>">
	...
	<tr>
		<td align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_FRONTPAGE_CATEGORY_PAGE_INTROTEXT' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_FRONTPAGE_CATEGORY_PAGE_INTROTEXT' ); ?>">
