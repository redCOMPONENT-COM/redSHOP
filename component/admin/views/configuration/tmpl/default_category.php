...
<div class="panel panel-primary form-vertical">
    <div class="panel-heading">
        <h3><?php echo JText::_('COM_REDSHOP_MAIN_CATEGORY_SETTINGS'); ?></h3>
    </div>
    <div class="panel-body">
        <div class="form-group">
            <span class="editlinktip hasTip"
                ...
                <label for="name"><?php echo JText::_('COM_REDSHOP_DEFAULT_CATEGORY_ORDERING_METHOD_LBL'); ?>
                </label>
            </span>
        ...
        <div class="form-group">
            <span class="editlinktip hasTip"
                ...
                <label><?php echo JText::_('COM_REDSHOP_MAXCATEGORY_LBL'); ?></label>
            </span>
            <input type="text" class="form-control" name="maxcategory" id="maxcategory" value="<?php echo $this->config->get('MAXCATEGORY'); ?>" />
        </div>

        <div class="form-group">
            <span class="editlinktip hasTip"
                  title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_EXPIRE_LBL'); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_EXPIRE'); ?>">
                <label><?php echo JText::_('COM_REDSHOP_PRODUCT_EXPIRE_LBL'); ?>:</label>
            </span>
