...
<tr><td class="config_param"><?php echo JText::_( 'COM_REDSHOP_REGISTRATION' ); ?></td></tr>
	<tr>
		<td width="100" align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_REGISTER_METHOD_LBL' ); ?>::<?php echo JText::_( 'TOOLTIP_REGISTER_METHOD_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_CREATE_ACCOUNT_CHECKBOX_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CREATE_ACCOUNT_CHECKBOX' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_SHOW_REGISTER_CHECKOUT_CAPTCHA' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_SHOW_REGISTER_CHECKOUT_CAPTCHA' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_SHOW_REGISTER_CHECKOUT_CAPTCHA' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_SHOW_REGISTER_EMAIL_VERIFICATION' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_NEW_CUSTOMER_SELECTION_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_NEW_CUSTOMER_SELECTION_LBL' ); ?>">
	...
	<tr><td width="100" align="right" class="key">
			<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_SHOW_TERMS_AND_CONDITIONS_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_SHOW_TERMS_AND_CONDITIONS_LBL' ); ?>">
			<label for="showprice"><?php echo JText::_ ( 'COM_REDSHOP_SHOW_TERMS_AND_CONDITIONS_LBL' );?></label></span>
		</td>
		<td><?php echo $this->lists ['show_terms_and_conditions'];?><input type="button" onclick="javascript:resetTermsCondition();" value="<?php echo JText::_('COM_REDSHOP_RESET_FOR_ALL_USER');?>" /></td>
	</tr>
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_ALLOW_CUSTOMER_REGISTRATION_TYPE_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_ALLOW_CUSTOMER_REGISTRATION_TYPE_LBL' ); ?>">
		<label for="allow_customer_register_type"><?php echo JText::_ ( 'COM_REDSHOP_ALLOW_CUSTOMER_REGISTRATION_TYPE_LBL' );?></label>
		</td>
		<td><?php echo $this->lists ['allow_customer_register_type'];?></td>
	</tr>
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_DEFAULT_CUSTOMER_REGISTRATION_TYPE_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_DEFAULT_CUSTOMER_REGISTRATION_TYPE_LBL' ); ?>">
		<label for="default_customer_register_type"><?php echo JText::_ ( 'COM_REDSHOP_DEFAULT_CUSTOMER_REGISTRATION_TYPE_LBL' );?></label>
		</td>
	...
	<tr>
		...
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_WELCOMEPAGE_INTROTEXT_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_WELCOMEPAGE_INTROTEXT_LBL' ); ?>">
	...
	<tr>
		<td align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_REGISTRATION_PAGE_INTRO_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_REGISTRATION_PAGE_INTRO_LBL' ); ?>">
	...
	<tr>
		<td align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_REGISTRATION_PAGE_COMP_INTRO_LBL' ); ?>::<?php echo JText::_( 'TOOLTIP_REGISTRATION_PAGE_COMP_INTRO_LBL' ); ?>">
