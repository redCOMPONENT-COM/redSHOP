...
<div class="form-group row-fluid">
    <label class="col-md-4 hasPopover"
        data-bs-content="<?php echo Text::_('COM_REDSHOP_TOOLTIP_DEFAULT_WRAPPER_THUMB_WIDTH_LBL'); ?>">
        <?php echo Text::_('COM_REDSHOP_DEFAULT_WRAPPER_THUMB_WIDTH_HEIGHT'); ?>
    </label>
    <div class="col-md-8">
        <div class="row">
            <div class="col-md-6">
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_AUTO_SCROLL_FOR_WRAPPER_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_AUTO_SCROLL_FOR_WRAPPER_LBL'),
