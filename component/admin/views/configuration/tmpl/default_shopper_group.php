...
<div class="panel panel-primary form-vertical">
    <div class="panel-heading">
        <h3><?php echo JText::_('COM_REDSHOP_SHOPPER_GROUP_TAB') ?></h3>
    </div>
	...
	<span class="editlinktip hasTip"
        ...
        <div class="form-group">
            <span class="editlinktip hasTip"
                ...
                <label><?php echo JText::_('COM_REDSHOP_DEFAULT_PORTAL_NAME_LBL') ?></label>
            </span>
            <input type="text" name="default_portal_name" id="default_portal_name" class="form-control"
                   value="<?php echo $this->config->get('DEFAULT_PORTAL_NAME'); ?>"/>
        </div>
