...
<table class="admintable">
	<tr>
		...
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_SEO_PAGE_TITLE_CATEGORY_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_SEO_PAGE_TITLE_CATEGORY_LBL' ); ?>">
		<label
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_SEO_PAGE_HEADING_CATEGORY_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_SEO_PAGE_HEADING_CATEGORY_LBL' ); ?>">
		<label
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_SEO_PAGE_DESCRIPTION_CATEGORY_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_SEO_PAGE_DESCRIPTION_CATEGORY_LBL' ); ?>">
		<label
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_SEO_PAGE_KEYWORDS_CATEGORY_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_SEO_PAGE_KEYWORDS_CATEGORY_LBL' ); ?>">
		<label
