...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_COLOUR_SAMPLE_REMAINDER_1_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_COLOUR_SAMPLE_REMAINDER_1_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_COLOUR_SAMPLE_REMAINDER_2_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_COLOUR_SAMPLE_REMAINDER_2_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_COLOUR_SAMPLE_REMAINDER_3_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_COLOUR_SAMPLE_REMAINDER_3_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_COLOUR_COUPON_DURATION_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_COLOUR_COUPON_DURATION_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_COLOUR_DISCOUNT_PERCENTAGE_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_COLOUR_DISCOUNT_PERCENTAGE_LBL'),
        'line'  => false,
...
<div class="hidden">
    ...
    echo RedshopLayoutHelper::render(
        'config.config',
        array(
            'title' => Text::_('COM_REDSHOP_TOOLTIP_COLOUR_SAMPLE_DAYS_LBL'),
            'desc'  => Text::_('COM_REDSHOP_TOOLTIP_COLOUR_SAMPLE_DAYS'),
