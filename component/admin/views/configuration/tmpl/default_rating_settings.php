...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_RATING_DONE_MSG'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_RATING_DONE_MSG'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_FAVOURED_REVIEWS_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_FAVOURED_REVIEWS_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_RATING_THUMB_IMAGE_WIDTH_LBL'),
        'desc'  => Text::_('COM_REDSHOP_RATING_THUMB_IMAGE_WIDTH_DESC'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_RATING_THUMB_IMAGE_HEIGHT_LBL'),
        'desc'  => Text::_('COM_REDSHOP_RATING_THUMB_IMAGE_HEIGHT_DESC'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_RATING_REVIEW_LOGIN_REQUIRED_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_RATING_REVIEW_LOGIN_REQUIRED_LBL'),
        'line'  => false,
