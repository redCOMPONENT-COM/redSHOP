...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_SHOW_PRICE_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_SHOW_PRICE_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title'  => Text::_('COM_REDSHOP_CURRENCY_NAME'),
        'desc'   => Text::_('COM_REDSHOP_TOOLTIP_CURRENCY_NAME'),
        'id'     => 'currency_data',
        'showOn' => 'show_price:1',
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title'  => Text::_('COM_REDSHOP_CURRENCY_SYMBOL'),
        'desc'   => Text::_('COM_REDSHOP_TOOLTIP_CURRENCY_SYMBOL'),
        'id'     => 'currency_symbol',
        'showOn' => 'show_price:1',
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title'  => Text::_('COM_REDSHOP_CURRENCY_SYMBOL_POSITION_LBL'),
        'desc'   => Text::_('COM_REDSHOP_TOOLTIP_CURRENCY_SYMBOL_POSITION'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title'  => Text::_('COM_REDSHOP_PRICE_SEPERATOR_LBL'),
        'desc'   => Text::_('COM_REDSHOP_TOOLTIP_PRICE_SEPERATOR_LBL'),
        'id'     => 'price_seperator',
        'showOn' => 'show_price:1',
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title'  => Text::_('COM_REDSHOP_THOUSAND_SEPERATOR_LBL'),
        'desc'   => Text::_('COM_REDSHOP_TOOLTIP_THOUSAND_SEPERATOR_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title'  => Text::_('COM_REDSHOP_PRICE_DECIMAL_LBL'),
        'desc'   => Text::_('COM_REDSHOP_TOOLTIP_PRICE_DECIMAL_LBL'),
        'id'     => 'price_decimal',
        'showOn' => 'show_price:1',
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title'  => Text::_('COM_REDSHOP_CALCULATION_PRICE_DECIMAL_LBL'),
        'desc'   => Text::_('COM_REDSHOP_TOOLTIP_CALCULATION_PRICE_DECIMAL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title'  => Text::_('COM_REDSHOP_ZERO_PRICE_REPLACEMENT_LBL'),
        'desc'   => Text::_('COM_REDSHOP_TOOLTIP_ZERO_PRICE_REPLACEMENT_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_USE_TAX_EXEMPT_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_USE_TAX_EXEMPT_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title'  => Text::_('COM_REDSHOP_SHOW_TAX_EXEMPT_INFRONT_LBL'),
        'desc'   => Text::_('COM_REDSHOP_TOOLTIP_SHOW_TAX_EXEMPT_INFRONT_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title'  => Text::_('COM_REDSHOP_TAX_EXEMPT_APPLY_VAT_LBL'),
        'desc'   => Text::_('COM_REDSHOP_TOOLTIP_TAX_EXEMPT_APPLY_VAT_LBL'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_USE_AS_CATALOG_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_USE_AS_CATALOG_LBL'),
        'line'  => false,
