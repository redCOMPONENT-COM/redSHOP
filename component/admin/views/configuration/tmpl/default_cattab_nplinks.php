...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_RETURN_TO_CATEGORY_PREFIX'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_RETURN_TO_CATEGORY_PREFIX'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_DEFAULT_NP_LINK_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_DEFAULT_NP_LINK'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_DAFULT_PREVIOUS_PREFIX_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_DAFULT_PREVIOUS'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_DAFULT_NEXT_SUFFIX_LBL'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_DAFULT_NEXT_SUFFIX'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_CUSTOM_PREVIOUS_LINK'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_CUSTOM_PREVIOUS_LINK'),
...
echo RedshopLayoutHelper::render(
    'config.config',
    array(
        'title' => Text::_('COM_REDSHOP_CUSTOM_NEXT_LINK'),
        'desc'  => Text::_('COM_REDSHOP_TOOLTIP_CUSTOM_NEXT_LINK'),
...
<div class="form-group row-fluid">
    <label class="col-md-4 hasPopover"
        data-bs-content="<?php echo Text::_('COM_REDSHOP_TOOLTIP_IMAGE_PREVIOUS_LINK'); ?>">
        <?php echo Text::_('COM_REDSHOP_IMAGE_PREVIOUS_LINK'); ?>
    </label>
    <div class="col-md-8">
        ...
        <div>
            <div>
                ...
                <a href="#123"
                    onclick="delimg('<?php echo $imagePreviousLinkFind ?>','prvlinkdiv','<?php echo $link_path ?>');">
                    <?php echo Text::_(
                        'COM_REDSHOP_REMOVE_FILE'
                    ); ?>
                </a>
            </div>
...
<div class="form-group row-fluid">
    <label class="col-md-4 hasPopover" data-bs-content="<?php echo Text::_('COM_REDSHOP_TOOLTIP_IMAGE_NEXT_LINK'); ?>">
        <?php echo Text::_('COM_REDSHOP_IMAGE_NEXT_LINK'); ?>
    </label>
    <div class="col-md-8">
        ...
        <div>
            <div>
                ...
                <a href="#123"
                    onclick="delimg('<?php echo $imageNextLinkFind ?>','nxtlinkdiv','<?php echo $link_path ?>');">
                    <?php echo Text::_(
                        'COM_REDSHOP_REMOVE_FILE'
                    ); ?>
                </a>
