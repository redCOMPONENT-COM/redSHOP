    ...
    <div class="col-md-8">
        ...
        <div>
            <div>
                ...
                <a href="#123"
                   onclick="delimg('<?php echo $imagePreviousLinkFind ?>','prvlinkdiv','<?php echo $link_path ?>');"><?php echo JText::_(
    ...
    <div class="col-md-8">
        ...
        <div>
            <div>
                ...
                <a href="#123"
                   onclick="delimg('<?php echo $imageNextLinkFind ?>','nxtlinkdiv','<?php echo $link_path ?>');"><?php echo JText::_(
                        'COM_REDSHOP_REMOVE_FILE'
                    ); ?></a>
            </div>
