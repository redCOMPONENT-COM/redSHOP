...
<div class="panel panel-primary form-vertical">
    <div class="panel-heading">
        <h3><?php echo JText::_('COM_REDSHOP_NEXT_PREVIOUS'); ?></h3>
    </div>
	...
	<span class="editlinktip hasTip"
    	...
    	<label><?php echo JText::_('COM_REDSHOP_RETURN_TO_CATEGORY_PREFIX'); ?>:</label></span>
            <input type="text" name="return_to_category_prefix" id="return_to_category_prefix" class="form-control"
	...
	<span class="editlinktip hasTip"
    	...
    	<label><?php echo JText::_('COM_REDSHOP_DAFULT_PREVIOUS_PREFIX_LBL'); ?>:</label></span>
            <input type="text" name="default_previous_prefix" id="default_previous_prefix" class="form-control"
	...
	<span class="editlinktip hasTip"
    	...
    	<label><?php echo JText::_('COM_REDSHOP_DAFULT_NEXT_SUFFIX_LBL'); ?>:</label></span>
            <input type="text" name="default_next_suffix" id="default_next_suffix" class="form-control"
	...
	<span class="editlinktip hasTip"
        ...
        <label><?php echo JText::_('COM_REDSHOP_CUSTOM_PREVIOUS_LINK'); ?>:</label></span>
            <input type="text" name="custom_previous_link" id="custom_previous_link" class="form-control"
	...
	<span class="editlinktip hasTip"
        ...
        <label><?php echo JText::_('COM_REDSHOP_CUSTOM_NEXT_LINK'); ?>:</label></span>
            <input type="text" name="custom_next_link" id="custom_next_link" class="form-control"
