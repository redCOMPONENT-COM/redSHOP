...
<tr><td class="config_param"><?php echo JText::_( 'COM_REDSHOP_NEXT_PREVIOUS' ); ?></td></tr>
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_CATEGORY_DESC_MAX_CHARS_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CATEGORY_DESC_MAX_CHARS_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_CATEGORY_DESC_END_SUFFIX_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CATEGORY_DESC_END_SUFFIX_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CATEGORY_SHORT_DESC_MAX_CHARS_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CATEGORY_SHORT_DESC_MAX_CHARS' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_CATEGORY_SHORT_DESC_END_SUFFIX_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CATEGORY_SHORT_DESC_END_SUFFIX_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_CATEGORY_TITLE_MAX_CHARS_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CATEGORY_TITLE_MAX_CHARS_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_CATEGORY_TITLE_END_SUFFIX_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CATEGORY_TITLE_END_SUFFIX_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_CATEGORY_PRODUCT_TITLE_MAX_CHARS_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CATEGORY_PRODUCT_TITLE_MAX_CHARS_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_CATEGORY_PRODUCT_TITLE_END_SUFFIX_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CATEGORY_PRODUCT_TITLE_END_SUFFIX_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_CATEGORY_PRODUCT_DESC_MAX_CHARS_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CATEGORY_PRODUCT_DESC_MAX_CHARS_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_CATEGORY_PRODUCT_DESC_MAX_SUFFIX_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CATEGORY_PRODUCT_DESC_MAX_SUFFIX_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_CATEGORY_PRODUCT_SHORT_DESC_MAX_CHARS_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CATEGORY_PRODUCT_SHORT_DESC_MAX_CHARS_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_CATEGORY_PRODUCT_SHORT_DESC_END_SUFFIX_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_CATEGORY_PRODUCT_SHORT_DESC_END_SUFFIX_LBL' ); ?>">
		<label for="name"><?php echo JText::_ ( 'COM_REDSHOP_CATEGORY_PRODUCT_SHORT_DESC_END_SUFFIX_LBL' );?></label></span>
		</td>
