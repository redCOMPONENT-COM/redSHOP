                ...
                <div class="box-body">
                    <table border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td><?php echo $quotation->quotation_number; ?><input name="quotation_number"
                                                                                  id="quotation_number"
                                                                                  type="hidden"
                    ...
                    <table border="0" cellspacing="0" cellpadding="0"
                        ...
                        if ($quotation->user_id != 0) {
                            ...
                            <tr>
                                ...
                                <td><?php echo RedshopHelperOrder::getStateName(
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table border="0" cellspacing="0" cellpadding="0"
                        ...
                        for ($i = 0, $in = count($quotation_item); $i < $in; $i++) {
                            ...
                            if ($quo->is_giftcard == 1) {
                                $giftcardData = Redshop\Entity\GiftCard::getInstance($quo->product_id)->getItem();
                            ...
                            <tr id="trPrd<?php echo $unq; ?>">
                                ...
                                <td align="right">
                                    <div
                                            id="tdprdpricep<?php echo $unq; ?>"><?php echo RedshopHelperProductPrice::formattedPrice(
                                            $quo->product_price
                                        ); ?></div>
                                ...
                                <td align="center"><input type="number" name="quantityp<?php echo $unq; ?>"
                                                          ...
                                                          size="<?php echo Redshop::getConfig()->get(
                                                              'DEFAULT_QUANTITY'
                                                          ); ?>"
                                ...
                                <td align="right">
                                    <div
                                            id="tdtotalpricep<?php echo $unq; ?>"><?php echo RedshopHelperProductPrice::formattedPrice(
                                            $product_total
                                        ); ?></div>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" class="adminlist table-striped table-condensed"
                        ...
                        <tbody>
                        <tr align="left">
                            <td align="right" width="85%"><strong><?php echo JText::_(
                            ...
                            <td align="right">
                                <div
                                        id="divMainSubTotal"><?php echo RedshopHelperProductPrice::formattedPrice(
                        ...
                        <tr align="left">
                            <td align="right" width="85%">
                                <strong><?php echo JText::_('COM_REDSHOP_QUOTATION_SUBTOTAL_WITH_DISCOUNT'); ?></strong>
                            </td>

                            <td align="right">
                                <div
                                        id="divMainSubTotalwithDiscount"><?php echo RedshopHelperProductPrice::formattedPrice(
                        ...
                        <tr align="left">
                            ...
                            <td align="right">
                                <div id="divMainTax"><?php echo RedshopHelperProductPrice::formattedPrice(
                                        $tax
                                    ); ?></div>
                        ...
                        <tr align="left">
                            ...
                            <td align="right">
                                <div
                                        id="divMainFinalTotal"><?php echo RedshopHelperProductPrice::formattedPrice(
