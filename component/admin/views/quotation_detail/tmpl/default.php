    ...
    Joomla.submitbutton = submitbutton = function (pressbutton) {
        ...
        if (pressbutton == 'add') {
            if (form.product1.value == 0) {
                alert("<?php echo Text::_('COM_REDSHOP_SELECT_PRODUCT'); ?>");
                return;
            }

            if (form.quantityproduct1.value == "" || parseInt(form.quantityproduct1.value) <= 0) {
                alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_VALID_QUANTITY'); ?>");
        ...
        if ((pressbutton == 'save') || (pressbutton == 'send') || (pressbutton == 'aplly')) {
            if (form.user_id.value == 0 && form.quotation_email.value == "") {
                alert("<?php echo Text::_('COM_REDSHOP_CREATE_ACCOUNT_FOR_QUOTATION'); ?>");
                return false;
            }
            ...
            if (form.quotation_total.value == 0) {
                if (!confirm("<?php echo Text::_('COM_REDSHOP_CONFIRM_WITH_QUOTATION_TOTAL_ZERO'); ?>")) {
                    return false;
                }
            }
        }
...
<form action="<?php echo Redshop\IO\Route::_($this->request_url) ?>" method="post" name="adminForm" id="adminForm">
    ...
    <?php if (!$quotation->quotation_id) {
        ...
        <a class="joom-box btn btn-primary" href="<?php echo $edit_addlink; ?>"
            ...
            <?php echo Text::_('COM_REDSHOP_ADD_USER'); ?>
        </a>
        <?php
    }
    ?>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <?php echo Text::_('COM_REDSHOP_QUOTATION_INFORMATION'); ?>
                    </h3>
                </div>
                <div class="box-body">
                    <table border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr>
                            <td>
                                <?php echo Text::_('COM_REDSHOP_QUOTATION_NUMBER'); ?>
                            </td>
                            <td>
                                <?php echo $quotation->quotation_number; ?><input name="quotation_number"
                                    id="quotation_number" type="hidden"
                                    value="<?php echo $quotation->quotation_number; ?>" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <?php echo Text::_('COM_REDSHOP_QUOTATION_IPADDRESS'); ?>
                            </td>
                            <td>
                                <?php echo $quotation->quotation_ipaddress; ?><input name="quotation_ipaddress"
                        ...
                        <tr>
                            <td>
                                <?php echo Text::_('COM_REDSHOP_QUOTATION_NOTE'); ?>
                            </td>
                        ...
                        <tr>
                            <td>
                                <?php echo Text::_('COM_REDSHOP_QUOTATION_CUSTOMER_NOTE'); ?>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <?php echo Text::_('COM_REDSHOP_QUOTATION_STATUS'); ?>
                            </td>
                            <td>
                                <?php echo $this->lists['quotation_status']; ?>
                            </td>
                        </tr>
                    </table>
                </div>
        ...
        <div class="col-sm-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <?php echo Text::_('COM_REDSHOP_ACCOUNT_INFORMATION'); ?>
                    </h3>
                </div>
                        ...
                        <tbody>
                            ...
                            if ($quotation->user_id != 0) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $this->quotationuser->firstname; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <?php echo $this->quotationuser->lastname; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <?php echo $this->quotationuser->address; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <?php echo $this->quotationuser->zipcode; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <?php echo $this->quotationuser->city; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <?php echo Text::_(
                                            RedshopHelperOrder::getCountryName($this->quotationuser->country_code)
                                        ); ?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo RedshopHelperOrder::getStateName(
                                            $this->quotationuser->state_code,
                                            $this->quotationuser->country_code
                                        ); ?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $this->quotationuser->phone; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?php echo Text::_('COM_REDSHOP_EMAIL'); ?>:
                                    </td>
                                    <td>
                                        <?php echo $this->quotationuser->user_email; ?>
                                    </td>
                                </tr>
                                <?php
                                if ($this->quotationuser->is_company) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $this->quotationuser->vat_number; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <?php echo $this->quotationuser->tax_exempt; ?>
                                        </td>
                                    </tr>
                                    <?php $fields = RedshopHelperExtrafields::listAllFieldDisplay(
                                        8,
                                        $quotation->user_info_id
                                    );
                                } else {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $quotation->user_email; ?>
                                    </td>
                                </tr>
                                <?php
                            }

                            echo $fields = RedshopHelperExtrafields::listAllFieldDisplay(
                                16,
                                $quotation->user_info_id,
                                0,
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <?php echo Text::_('COM_REDSHOP_FIELDS'); ?>
                    </h3>
                </div>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tbody>
                            ...
                            <?php foreach ($rowData as $rowDataItem): ?>
                                ...
                                <?php $dataValue = RedshopHelperExtrafields::getSectionFieldDataList(
                                    $rowDataItem->id,
                                    16,
                                ...
                                <tr>
                                    <td width="25%">
                                        <?php echo $rowDataItem->title; ?>:
                                    </td>
                                    <td>
                                        <?php echo $dataValue->data_txt; ?>
                                    </td>
                                </tr>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <?php echo Text::_('COM_REDSHOP_QUOTATION_DETAILS'); ?>
                    </h3>
                </div>
                <div class="box-body">
                    <table border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr>
                            <th width="5%">
                                <?php echo Text::_('COM_REDSHOP_ACTION'); ?>
                            </th>
                            <th width="35%">
                                <?php echo Text::_('COM_REDSHOP_PRODUCT_NAME'); ?>
                            </th>
                            <th width="25%">
                                <?php echo Text::_('COM_REDSHOP_ORDER_PRODUCT_NOTE'); ?>
                            </th>
                            <th width="10%">
                                <?php echo Text::_('COM_REDSHOP_PRODUCT_PRICE_WITHOUT_VAT'); ?>
                            </th>
                            <th width="10%">
                                <?php echo Text::_('COM_REDSHOP_PRODUCT_PRICE'); ?>
                            </th>
                            <th width="5%">
                                <?php echo Text::_('COM_REDSHOP_PRODUCT_QUANTITY'); ?>
                            </th>
                            <th width="10%" align="right">
                                <?php echo Text::_('COM_REDSHOP_TOTAL_PRICE'); ?>
                            </th>
                        </tr>
                        <?php
                        $unq = 1;
                        ...
                        for ($i = 0, $in = count($quotation_item); $i < $in; $i++) {
                            ...
                            if ($quo->is_giftcard == 1) {
                                ...
                                if ($quo->product_excl_price > 0) {
                                    $vat = RedshopHelperProduct::getProductTax(
                                        $quo->product_id,
                                        $quo->product_excl_price,
                                        $quotation->user_id
                                    );
                                }
                            ...
                            $product_userfield = RedshopHelperQuotation::displayQuotationUserField(
                                $quo->quotation_item_id,
                                $section
                            );

                            $product_attribute = "<br/>" . RedshopHelperProduct::makeAttributeQuotation(
                                $quo->quotation_item_id,
                                0,
                                $quo->product_id
                            );
                            $product_accessory = "<br/>" . RedshopHelperProduct::makeAccessoryQuotation(
                                $quo->quotation_item_id
                            );
                            ...
                            if ($quo->product_wrapperid) {
                                $wrapper = RedshopHelperProduct::getWrapper($quo->product_id, $quo->product_wrapperid);

                                if (count($wrapper) > 0) {
                                    $wrapper_name = $wrapper[0]->wrapper_name . " (" . RedshopHelperProductPrice::formattedPrice(
                                        $quo->wrapper_price
                                    ) . ")";
                                }
                            }
                            ...
                            <tr id="trPrd<?php echo $unq; ?>">
                                <td align="center">
                                    <a href="<?php echo $delete_itemlink; ?>"
                                        title="<?php echo Text::_('COM_REDSHOP_DELETE_QUOTATION_ITEM'); ?>">
                                        <img class="delete_item" src="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH; ?>cross.png"
                                            title="<?php echo Text::_('COM_REDSHOP_DELETE'); ?>"
                                            alt="<?php echo Text::_('COM_REDSHOP_DELETE'); ?>"
                                            onclick="Joomla.submitbutton('deleteitem');">
                                    </a>
                                </td>
                                <td>
                                    <?php echo $product_title; ?><input type="hidden"
                                ...
                                <td><input type="number" name="product_excl_pricep<?php echo $unq; ?>"
                                        id="product_excl_pricep<?php echo $unq; ?>" size="10" maxlength="50" value="<?php echo RedshopHelperProduct::redpriceDecimal(
                                               $quo->product_excl_price
                                           ); ?>" onchange="getQuotationDetail('p<?php echo $unq; ?>');"></td>
                                <td align="right">
                                    <div id="tdprdpricep<?php echo $unq; ?>">
                                        <?php echo RedshopHelperProductPrice::formattedPrice(
                                            $quo->product_price
                                        ); ?>
                                    </div>
                                    <input type="hidden" name="product_pricep<?php echo $unq; ?>"
                                        value="<?php echo $quo->product_price; ?>" id="product_pricep<?php echo $unq; ?>" />
                                </td>
                                ...
                                <td align="center"><input type="number" name="quantityp<?php echo $unq; ?>"
                                        ...
                                        onchange="getQuotationDetail('p<?php echo $unq; ?>');" size="<?php echo Redshop::getConfig()->get(
                                               'DEFAULT_QUANTITY'
                                           ); ?>" maxlength="<?php echo Redshop::getConfig()->get(
                                                'DEFAULT_QUANTITY'
                                            ); ?>" />
                                    <input type="hidden" name="hiddenqntp<?php echo $unq; ?>"
                                        value="<?php echo $quo->product_quantity; ?>" id="hiddenqntp<?php echo $unq; ?>" />
                                </td>

                                <td align="right">
                                    <div id="tdtotalpricep<?php echo $unq; ?>">
                                        <?php echo RedshopHelperProductPrice::formattedPrice(
                                            $product_total
                                        ); ?>
                                    </div>
                                    ...
                                    <input type="hidden" name="taxpricep<?php echo $unq; ?>"
                                        value="<?php echo $product_tax; ?>" id="taxpricep<?php echo $unq; ?>">
                                </td>
                            </tr>
                            <?php $unq++;
                        } ?>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" class="adminlist table-striped table-condensed"
                        width="100%">
                        <tbody>
                            <tr align="left">
                                <td align="right" width="85%"><strong>
                                        <?php echo Text::_(
                                            'COM_REDSHOP_QUOTATION_SUBTOTAL'
                                        ); ?>
                                    </strong>
                                </td>

                                <td align="right">
                                    <div id="divMainSubTotal">
                                        <?php echo RedshopHelperProductPrice::formattedPrice(
                                            $quotation->quotation_subtotal
                                        ); ?>
                                    </div>
                            ...
                            if ($quotation->quotation_total) {
                                ...
                                <tr align="left">
                                    <td align="right" width="85%">
                                        <strong>
                                            <?php echo Text::_('COM_REDSHOP_DISCOUNT_EXCL_VAT'); ?>
                                        </strong>
                                    </td>
                                    <td align="right">
                                        <?php
                                        ...
                                        if ((float) Redshop::getConfig()->get('VAT_RATE_AFTER_DISCOUNT')) {
                                            ...
                                            ) * $quotation->quotation_discount) / (1 + (float) Redshop::getConfig(
                                        ...
                                        if ((float) Redshop::getConfig()->get('VAT_RATE_AFTER_DISCOUNT')) {
                                            ...
                                            $Discountspvat       = ($sp_discount * (float) Redshop::getConfig()->get(
                                                'VAT_RATE_AFTER_DISCOUNT'
                                            )
                                ...
                                <tr align="left">
                                    <td align="right" width="85%">
                                        <strong>
                                            <?php echo Text::_('COM_REDSHOP_DISCOUNT_INCL_VAT'); ?>
                                        </strong>
                                    </td>
                                    <td align="right">
                                        <input type="number" name="quotation_discount" size='10' value="<?php echo RedshopHelperProduct::redpriceDecimal(
                                ...
                                <tr align="left">
                                    <td align="right" width="85%">
                                        <strong>
                                            <?php echo Text::_('COM_REDSHOP_QUOTATION_SPECIAL_DISCOUNT'); ?>
                                        </strong>
                                    </td>
                                    <td align="right">
                                        ...
                                        <div style="float: right;">
                                            <input type="number" name="quotation_special_discount" size='10' value="<?php echo RedshopHelperProduct::redpriceDecimal(
                                                $quotation->quotation_special_discount
                            ...
                            <tr align="left">
                                <td align="right" width="85%">
                                    <strong>
                                        <?php echo Text::_('COM_REDSHOP_QUOTATION_SUBTOTAL_WITH_DISCOUNT'); ?>
                                    </strong>
                                </td>

                                <td align="right">
                                    <div id="divMainSubTotalwithDiscount">
                                        <?php echo RedshopHelperProductPrice::formattedPrice(
                                            $quotation->quotation_subtotal - $DiscountWithotVat - $DiscountspWithotVat
                                        ); ?>
                                    </div>
                                    <input name="quotation_subtotal_with_discount" id="quotation_subtotal_with_discount"
                                        type="hidden"
                            ...
                            <tr align="left">
                                ...
                                <td align="right">
                                    ...
                                    <input name="quotation_tax" id="quotation_tax" type="hidden"
                                        value="<?php echo $quotation->quotation_tax; ?>" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr align="left">
                                <td align="right"><strong>
                                        <?php echo Text::_('COM_REDSHOP_QUOTATION_TOTAL'); ?>
                                    </strong>
                                </td>
                                <td align="right">
                                    <div id="divMainFinalTotal">
                                        <?php echo RedshopHelperProductPrice::formattedPrice(
                                    ...
                                    <input type="hidden" name="Discountvat" id="Discountvat"
                                        value="<?php echo $Discountvat ?>">
                ...
                <div class="box-body">
                    <table border="0" cellspacing="0" cellpadding="0" class="adminlist table">
                        <tr>
                            ...
                            <th width="5%">
                                <?php echo Text::_('COM_REDSHOP_PRODUCT_QTY'); ?>
                                </td>
                            <th width="10%" align="right">
                                <?php echo Text::_('COM_REDSHOP_TOTAL_PRICE'); ?>
                                </td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" name="prdexclpriceproduct1" id="prdexclpriceproduct1"
                                    style="display: none;" onchange="changeOfflinePriceBox('product1');" value="0"
                                    size="10"></td>
                            ...
                            <td align="right">
                                ...
                                <input name="productpriceproduct1" id="productpriceproduct1" type="hidden"
                                    value="0" /><input name="taxpriceproduct1" id="taxpriceproduct1" type="hidden"
                                    value="0" />
                            </td>
                            <td><input type="number" name="quantityproduct1" id="quantityproduct1"
                                    style="display: none;" onchange="changeOfflineQuantityBox('product1');" value="1"
                            ...
                            <td><input type="submit" name="add" id="add" style="display: none;"
                                    ...
                                    onclick="return submitbutton('add');" />
                            </td>
                        </tr>
                    </table>
                </div>
