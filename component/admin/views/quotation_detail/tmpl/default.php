...
<form action="<?php echo JRoute::_($this->request_url) ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php if (!$quotation->quotation_id): ?>
		<?php $edit_addlink = JRoute::_('index.php?tmpl=component&option=com_redshop&view=quotation_detail&layout=account'); ?>
				...
				<div class="box-body">
					<table border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td><?php echo RedshopHelperDatetime::convertDateFormat($quotation->quotation_cdate); ?></td>
						</tr>
						<tr>
							<td><?php echo JText::_('COM_REDSHOP_QUOTATION_NUMBER'); ?></td>
							<td><?php echo $quotation->quotation_number; ?>
								<input name="quotation_number" id="quotation_number" type="hidden" value="<?php echo $quotation->quotation_number; ?>"/>
							</td>
						</tr>
						<tr>
							<td><?php echo JText::_('COM_REDSHOP_QUOTATION_IPADDRESS'); ?></td>
							<td><?php echo $quotation->quotation_ipaddress; ?>
								<input name="quotation_ipaddress" id="quotation_ipaddress" type="hidden" value="<?php echo $quotation->quotation_ipaddress; ?>"/>
							</td>
						</tr>
						<tr>
							<td><?php echo JText::_('COM_REDSHOP_QUOTATION_NOTE'); ?></td>
							<td>
								<textarea cols="50" rows="5" name="quotation_note" id="quotation_note"><?php echo $quotation->quotation_note; ?></textarea>
							</td>
						</tr>
						<tr>
					...
					<table border="0" cellspacing="0" cellpadding="0" class="adminlist table table-striped table-condensed">
						...
						<?php if ($quotation->user_id != 0): ?>
							...
							<?php if ($this->quotationuser->is_company): ?>
								...
								<?php echo RedshopHelperExtrafields::listAllFieldDisplay(8, $quotation->user_info_id); ?>
							<?php else: ?>
								<?php echo RedshopHelperExtrafields::listAllFieldDisplay(7, $quotation->user_info_id); ?>
							<?php endif; ?>
						<?php else: ?>
							<?php if (!isset($quotation->user_info_id)): ?>
								<?php $quotation->user_info_id = 0; ?>
								<tr>
									<td><?php echo JText::_('COM_REDSHOP_EMAIL'); ?>:</td>
							...
							<?php endif; ?>
						<?php endif; ?>
						<?php echo RedshopHelperExtrafields::listAllFieldDisplay(16, $quotation->user_info_id, 0, $quotation->user_email); ?>
						...
						for ($i = 0, $in = count($quotation_item); $i < $in; $i++)
						{
							...
							<tr id="trPrd<?php echo $unq; ?>">
								...
								<td>
									<input
											type="number"
											name="product_excl_pricep<?php echo $unq; ?>"
											id="product_excl_pricep<?php echo $unq; ?>"
											size="10"
											maxlength="50"
								...
								<td align="right">
									<div id="tdprdpricep<?php echo $unq; ?>">
										<?php echo RedshopHelperProductPrice::formattedPrice($quo->product_price); ?>
									</div>
									<input
											type="hidden"
											name="product_pricep<?php echo $unq; ?>"
											value="<?php echo $quo->product_price; ?>"
											id="product_pricep<?php echo $unq; ?>"
									/>
								</td>
								...
								<td align="center">
									...
									<input
											type="hidden"
											name="hiddenqntp<?php echo $unq; ?>"
											value="<?php echo $quo->product_quantity; ?>"
											id="hiddenqntp<?php echo $unq; ?>"
									/>
								</td>

								<td align="right">
									<div id="tdtotalpricep<?php echo $unq; ?>">
										<?php echo RedshopHelperProductPrice::formattedPrice($product_total); ?>
									</div>
									<input
											type="hidden"
											name="totalpricep<?php echo $unq; ?>"
											value="<?php echo $product_total; ?>"
											id="totalpricep<?php echo $unq; ?>"
									>
									<input
											type="hidden" name="taxpricep<?php echo $unq; ?>"
											value="<?php echo $product_tax; ?>"
											id="taxpricep<?php echo $unq; ?>"
									>
								</td>
							</tr>
							<?php $unq++;
					...
					<table border="0" cellspacing="0" cellpadding="0" class="adminlist table-striped table-condensed" width="100%">
						...
						<tr align="left">
							<td align="right" width="85%">
								<strong><?php echo JText::_('COM_REDSHOP_QUOTATION_SUBTOTAL'); ?></strong>
							</td>

							<td align="right">
								<div id="divMainSubTotal"><?php echo RedshopHelperProductPrice::formattedPrice($quotation->quotation_subtotal); ?></div>
								<input name="quotation_subtotal" id="quotation_subtotal" type="hidden" value="<?php echo $quotation->quotation_subtotal; ?>"/>
							</td>
						</tr>
						<?php
