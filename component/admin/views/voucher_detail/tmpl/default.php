...
<script language="javascript" type="text/javascript">
	function submitbutton(pressbutton) {
		...
		if (form.amount.value == ""){
			alert( "<?php echo JText::_( 'VOUCHER_AMOUNT_MUST_FILLED', true ); ?>" );
		} else {
			submitform( pressbutton );
		}
	}
	...
	<fieldset class="adminform">
		...
		<tr>
				...
				<td>
					...
					<?php echo JHTML::tooltip( JText::_( 'TOOLTIP_VOUCHER_CODE' ), JText::_( 'VOUCHER_CODE' ), 'tooltip.png', '', '', false); ?>
				</td>
			</tr>
			<tr>
				<td width="100" align="right" class="key">
					<label for="name">
						<?php echo JText::_( 'VOUCHER_AMOUNT' ); ?>:
					</label>
				</td>
				<td>
					...
					<?php echo JHTML::tooltip( JText::_( 'TOOLTIP_VOUCHER_AMOUNT' ), JText::_( 'VOUCHER_AMOUNT' ), 'tooltip.png', '', '', false); ?>
				</td>
			</tr>
			<tr>
				<td valign="top" align="right" class="key">
					<?php echo JText::_( 'VOUCHER_TYPE' ); ?>:
				</td>
				<td>
					<?php echo $this->lists['voucher_type']; ?>
					<?php echo JHTML::tooltip( JText::_( 'TOOLTIP_VOUCHER_TYPE' ), JText::_( 'VOUCHER_TYPE' ), 'tooltip.png', '', '', false); ?>
				</td>
			</tr>
			<tr>
				<td width="100" align="right" class="key">
			...
			<td valign="top" align="right" class="key">
				<label for="voucher_left">
					<?php echo JText::_( 'LBL_VOUCHER_LEFT' ); ?>:
				</label>
			</td>
			<td>
				<input class="text_area" type="text" name="voucher_left" id="voucher_left" size="20" value="<?php echo $this->detail->voucher_left;?>" />
				<?php echo JHTML::tooltip( JText::_( 'TOOLTIP_VOUCHER_LEFT' ), JText::_( 'LBL_VOUCHER_LEFT' ), 'tooltip.png', '', '', false); ?>
			</td>
		</tr>
			<tr>
				<td valign="top" align="right" class="key">
...
//Create 2nd Tab
echo  $myTabs->startPanel(JText::_('VOUCHER_PRODUCT'), 'tab2' );
?>
<div class="col50">
...
<?php echo JText::_( 'VOUCHER_PRODUCT' ); ?><br /><br />
<?php
...
<script type="text/javascript">
	...
	var options = {
		script:"index3.php?option=com_redshop&view=search&json=true&voucher_id=<?php echo $this->detail->voucher_id;?>&alert=voucher&",
		varname:"input",
		json:true,
		shownoresults:false,
