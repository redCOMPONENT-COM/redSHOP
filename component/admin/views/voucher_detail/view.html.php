...
class voucher_detailVIEWvoucher_detail extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'VOUCHER_MANAGEMENT_DETAIL' ), 'redshop_voucher48' );
		...
		JToolBarHelper::title(   JText::_( 'VOUCHER' ).': <small><small>[ ' . $text.' ]</small></small>' , 'redshop_voucher48' );
		...
		$voucher_type          = array (JHTML::_('select.option', 'Total', JText::_('TOTAL')), JHTML::_('select.option', 'Percentage', JText::_('PERCENTAGE')));
