	...
	<div id="j-main-container">
		...
		<?php else: ?>
			<table class="adminlist table table-striped" id="manufacturerList">
				...
				<tr>
					<!-- Ordering -->
					<th class="order" width="">
						<?php echo JHTML::_('grid.sort', 'COM_REDSHOP_MANUFACTURER_ORDERING', 'm.ordering', $listDirn, $listOrder); ?>
					</th>
					<!-- Check all -->
				...
				<?php foreach ($this->items as $i => $item) : ?>
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<!-- Manufacturer name -->
						<td width="50%">
							<a href="<?php echo JText::_('index.php?option=com_redshop&view=manufacturer&manufacturer_id=' . $item->manufacturer_id . '&layout=edit'); ?>"
						...
						<!-- Media box -->
						<td align="center">
							<?php $media = RedshopHelperManufacturer::getMedia($item->manufacturer_id); ?>
							<?php if ($media): ?>
								<a class="modal"
								   href="index.php?tmpl=component&option=com_redshop&amp;view=media_detail&amp;cid[]=<?php echo $media->media_id; ?>&amp;section_id=<?php echo $item->manufacturer_id; ?>&amp;showbuttons=1&amp;media_section=manufacturer&amp;section_name=<?php echo $item->manufacturer_name; ?>"
