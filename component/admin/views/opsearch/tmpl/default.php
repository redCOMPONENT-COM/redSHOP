        ...
        <?php if ($showbuttons != 1) {
            ...
            <div class="filterTool">
                <div class="filterItem">
                    ...
                    if ($this->state->get('filter_product') && ($productData = \Redshop\Product\Product::getProductById(
                    ...
                    ?>
                    <button class="btn"
                            onclick="document.getElementById('filter_product').value='0';document.getElementById('filter_user').value='0';document.getElementById('filter_status').value='0';this.form.submit();"><?php echo JText::_(
                            'COM_REDSHOP_RESET'
                        ); ?></button>
                </div>
            ...
            for ($i = 0, $n = count($this->products); $i < $n; $i++) {
                ...
                <tr class="<?php echo "row$k"; ?>">
                    ...
                    <td><a href="<?php echo $link; ?>"
                           ...
                           ); ?>"><?php echo $row->order_item_name; ?></a>
                    </td>
