...
<?php 	echo JText::_("COM_REDSHOP_PRODUCT_NAME").": ";?>
	...
	<button onclick="document.getElementById('filter_product').value='0';document.getElementById('filter_product_opsearch').value='0';document.getElementById('parent').value='';document.getElementById('filter_user').value='0';document.getElementById('filter_status').value='0';this.form.submit();"><?php echo JText::_('COM_REDSHOP_RESET' ); ?></button></td>
...
<?php
	...
	for ($i=0, $n=count( $this->products ); $i < $n; $i++)
	{
		...
		<td><a href="<?php echo $link; ?>"
			title="<?php echo JText::_('COM_REDSHOP_EDIT_PRODUCT' ); ?>"><?php echo $row->order_item_name; ?></a></td>
