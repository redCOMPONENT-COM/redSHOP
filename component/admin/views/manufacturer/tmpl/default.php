...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th class="title">
				<?php
				echo JHTML::_ ( 'grid.sort', 'MANUFACTURER_NAME', 'manufacturer_name', $this->lists ['order_Dir'], $this->lists ['order'] );
				?>
			...
			<th>
				<?php
				echo JHTML::_ ( 'grid.sort', 'MANUFACTURER_DESCRIPTION', 'manufacturer_desc', $this->lists ['order_Dir'], $this->lists ['order'] );
				?>
		 	</th>
			...
			<th width="5%" nowrap="nowrap">
				<?php
				echo JHTML::_ ( 'grid.sort', 'ID', 'manufacturer_id', $this->lists ['order_Dir'], $this->lists ['order'] );
				?>	
			</th>
	...
	for($i = 0, $n = count ( $this->manufacturer ); $i < $n; $i ++) {
		...
		?>"
			title="<?php
		echo JText::_ ( 'EDIT_MANUFACTURER' );
		?>"><?php
		...
		<?php $media_id = $model->getMediaId($row->manufacturer_id);?>			 
			<a class="modal" href="index3.php?option=<?php echo $option;?>&amp;view=media_detail&amp;cid[]=<?php echo $media_id;?>&amp;section_id=<?php echo $row->manufacturer_id;?>&amp;showbuttons=1&amp;media_section=manufacturer&amp;section_name=<?php echo $row->manufacturer_name;?>" rel="{handler: 'iframe', size: {x: 1050, y: 450}}" title=""><img src="components/<?php echo $option;?>/assets/images/media16.png" align="absmiddle" alt="media" ></a>
		</td>
		<td width="30%">
		<?php
