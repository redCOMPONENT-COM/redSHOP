...
class Redtemplate
{
	...
	public function getTemplateView($section)
	{
		...
		switch ($section)
		{
			...
			case 'subscription_template_overview':
				$view = "subscription";
				break;

			case 'subscription_template_detail':
				$view = "subscription";
				break;

			case 'subscription_template_download':
				$view = "subscription";
				break;
	...
	public function getTemplateSections($sectionvalue = "")
	{
		...
		$optionsection[] = JHTML::_('select.option', 'subscription_template_overview', JText::_('COM_REDSHOP_SUBSCRIPTION_TEMPLATE_OVERVIEW'));
		$optionsection[] = JHTML::_('select.option', 'subscription_template_detail', JText::_('COM_REDSHOP_SUBSCRIPTION_TEMPLATE_DETAIL'));
		$optionsection[] = JHTML::_('select.option', 'subscription_template_download', JText::_('COM_REDSHOP_SUBSCRIPTION_TEMPLATE_DOWNLOAD'));
