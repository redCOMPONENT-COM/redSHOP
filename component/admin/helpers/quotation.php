...
class quotationHelper 
{
	...
	{
	  	$status		= array();		
		$status[]	= JHTML::_('select.option', 0,	JText::_('SELECT'));
		$status[]  	= JHTML::_('select.option', 1,	JText::_('REQUESTED'));
		$status[]  	= JHTML::_('select.option', 2,	JText::_('REPLIED'));
		$status[]  	= JHTML::_('select.option', 3,	JText::_('ACCEPTED'));
		$status[]  	= JHTML::_('select.option', 4, 	JText::_('REJECTED'));
		$status[]  	= JHTML::_('select.option', 5, 	JText::_('ORDERED'));
		return $status;
	}
	...
	{		
		...
		{
			case 1:
				$name=JText::_('REQUESTED');
				break;
			case 2:
				$name=JText::_('REPLIED');
				break;
			case 3:
				$name=JText::_('ACCEPTED');
				break;	
			case 4:
				$name=JText::_('REJECTED');
				break;
			case 5:
				$name=JText::_('ORDERED');
				break;
		}
		return $name;
	}
	...
	function displayQuotationUserfield($quotation_item_id=0,$section_id=12)
	{
		...
		{
//			$resultstr = "<br/>".JText::_("PRODUCT_USERFIELD");
