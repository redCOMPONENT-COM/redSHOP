...
class extra_field
{
     ...
     */
    public function list_all_field_display(
        $field_section = 0,
        $section_id = 0,
        $flag = 0,
        $user_email = "",
        ...
        return RedshopHelperExtrafields::listAllFieldDisplay(
            $field_section,
            $section_id,
            $flag,
            $user_email,
     ...
     */
    public function list_all_user_fields(
        $fieldSection = "",
     ...
     */
    public function rs_booleanlist(
        $name,
        $attribs = null,
        $selected = null,
        $yes = 'yes',
        ...
        return RedshopHelperExtrafields::rsBooleanList(
            $name,
            $attribs,
            $selected,
            $yes,
