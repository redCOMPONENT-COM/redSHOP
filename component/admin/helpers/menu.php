...
class leftmenu
{
	function  __construct()
	{
       ...
       <table ><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_PRODUCT_MANAGEMENT');?></td></tr></table><?php
	...
	<?php	echo $pane->endPanel();
		...
		echo $pane->endPanel();
		?>
		  <table><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_ORDER' );?></td></tr></table>
...
?>
		  <table><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_DISCOUNT' );?></td></tr></table>
		...
		?>
		  <table><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_COMMUNICATION' );?></td></tr></table>
	...
	<?php	echo $pane->endPanel();
		...
		?>
		  <table><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_SHIPPING' );?></td></tr></table>
	...
	$title = JText::_('COM_REDSHOP_SHIPPING_METHOD' );
		...
		echo $pane->endPanel();?>
		  <table><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_USER' );?></td></tr></table>
		...
		echo $pane->endPanel();
		  ...
		  <table><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_VAT_AND_CURRENCY' );?></td></tr></table>	<?php
       ...
       $title = JText::_('COM_REDSHOP_COUNTRY' );
		...
		echo $pane->endPanel();?>
		  <table><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_IMPORT_EXPORT' );?></td></tr></table><?php
		...
		echo $pane->endPanel();   ?>
		  <table><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_CUSTOMIZATION' );?></td></tr></table><?php
        ...
        <?php
		echo $pane->endPanel();   ?>
		  <table><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_CUSTOMER_INPUT' );?></td></tr></table><?php
		...
		if(ECONOMIC_INTEGRATION && $ecoIsenable)
		{	?>
		<table><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_ACCOUNTING' );?></td></tr></table><?php
		  ...
		  <table><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_STATISTIC' );?></td></tr></table><?php
	$title = JText::_('COM_REDSHOP_STATISTIC' );
		...
		echo $pane->endPanel();	?>
		  <table><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_CONFIG' );?></td></tr></table><?php
		...
		if(JPluginHelper::isEnabled('redshop_custom_views','rs_custom_views_date') || JPluginHelper::isEnabled('redshop_custom_views','rs_custom_views_person') || JPluginHelper::isEnabled('redshop_custom_views','rs_custom_views_company'))
		{		?>
		  <table><tr><td class="distitle"><?php echo JText::_('COM_REDSHOP_CUSTOM_VIEWS' );?></td></tr></table>	<?php
				...
				{	?>
					<tr>
						<td><?php
							...
							echo '<a href="'.$link.'" title="'.JText::_('COM_REDSHOP_CUSTOM_VIEWS_DATE' ).'">'.JText::_('COM_REDSHOP_CUSTOM_VIEWS_DATE' ).'</a>'; ?>
						</td>
					</tr><?php
				}
				...
				{	?>
					<tr>
						<td><?php
							...
							echo '<a href="'.$link.'" title="'.JText::_('COM_REDSHOP_CUSTOM_VIEWS_PERSON' ).'">'.JText::_('COM_REDSHOP_CUSTOM_VIEWS_PERSON' ).'</a>'; ?>
						</td>
					</tr><?php
				}
				...
				{	?>
					<tr>
						<td><?php
							...
							echo '<a href="'.$link.'" title="'.JText::_('COM_REDSHOP_CUSTOM_VIEWS_COMPANY' ).'">'.JText::_('COM_REDSHOP_CUSTOM_VIEWS_COMPANY' ).'</a>'; ?>
						</td>
					</tr><?php
				}	?>
			</table>
