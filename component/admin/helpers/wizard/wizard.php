...
class redSHOPWizard{
	...
	function initialize(){
		...
		else
		{
			...
			$status 	= true;
			$title 		= JText::_('REDSHOP_CONFIGURATION_WIZARD');
			$install 	= 1;
			$substep	= 0;
		}
...
class redSHOPWizardHelper
{
	...
	function install($step=1)
	{
		switch($step)
		{
			...
			default:
				...
				$status->step 		= '-99';
				$status->title 		= JText::_('REDSHOP_CONFIGURATION_WIZARD');
				$status->install 	= 1;
				break;
		}
		return $status;
	...
	function general( $step )
	{
		...
		$drawdata->step 	= $step;
		$drawdata->title 	= JText::_('REDSHOP_GENERAL_CONFIGURATION_WIZARD');
		$drawdata->install 	= 1;
	...
	function terms($step){
		...
		$status				= true;
		$this->pageTitle 	= JText::_('REDSHOP_CONFIGURATION_WIZARD');
		...
		$drawdata->status 	= $status;
		$drawdata->step 	= $step;
		$drawdata->title 	= JText::_('REDSHOP_TERMS_CONFIGURATION_WIZARD');
		$drawdata->install 	= 1;
	...
	function user($step){
		...
		$drawdata->status 	= $status;
		$drawdata->step 	= $step;
		$drawdata->title 	= JText::_('REDSHOP_USER_CONFIGURATION_WIZARD');
		$drawdata->install 	= 1;
	...
	function price($step){
		...
		$drawdata->status 	= $status;
		$drawdata->step 	= $step;
		$drawdata->title 	= JText::_('REDSHOP_PRICE_CONFIGURATION_WIZARD');
		$drawdata->install 	= 1;
	...
	function finish($step){
		...
		$drawdata->status 	= $status;
		$drawdata->step 	= $step;
		$drawdata->title 	= JText::_('REDSHOP_FINISH_WIZARD');
		$drawdata->install 	= 1;
...
class redSHOPWizardTemplate
{
	...
	function setHTMLSidebar($activeSteps)
	{
		...
		<div id="stepbar">
			...
			<div class="m">
				<h1 class="steps"><?php echo JText::_('WIZARD_STEPS');?></h1>
				<div id="stepFirst" class="steps<?php if($activeSteps == 1) echo " on"; ?>"><?php echo JText::_('WIZARD_WELCOME_STEP1');?></div>
				<div class="steps<?php if($activeSteps == 2) echo " on"; ?>"><?php echo JText::_('WIZARD_GENERAL_STEP2');?></div>
				<div class="steps<?php if($activeSteps == 3) echo " on"; ?>"><?php echo JText::_('WIZARD_TERM_STEP3');?></div>
				<div class="steps<?php if($activeSteps == 4) echo " on"; ?>"><?php echo JText::_('WIZARD_USER_STEP3');?></div>
				<div class="steps<?php if($activeSteps == 5) echo " on"; ?>"><?php echo JText::_('WIZARD_PRICE_STEP4');?></div>
				<div id="stepLast" class="steps<?php if($activeSteps == 0) echo " on"; ?>"><?php echo JText::_('WIZARD_FINISH');?></div>
				<div class="box"></div>
		  	</div>
			<div class="b">
				<div class="b">
						...
						<div id="Container">
							<div class="button1-right">
								<div id="div-button-prev" class="prev">
									<?php $vaule = JText::_('WIZARD_PREVIOUS_BUTTON'); ?>
						...
						<div id="Container">
							<div class="button1-left">
								<div id="div-button-next" class="next">
									<?php $vaule = ($step == 0) ? JText::_('WIZARD_FINISH_BUTTON') : JText::_('WIZARD_NEXT_BUTTON'); ?>
						...
						<div id="Container">
							<div class="button1-left">
								<div id="div-button-next" class="exit">
									<?php $vaule = JText::_('SKIP_DO_IT_LATER')?>
