...
class order_functions
{
	...
	public function getpaymentinformation($row, $post)
	{
		...
		if ($is_creditcard == 0)
		{
			if ($values['payment_plugin'] == "rs_payment_banktransfer" || $values['payment_plugin'] == "rs_payment_banktransfer2" || $values['payment_plugin'] == "rs_payment_banktransfer3" || $values['payment_plugin'] == "rs_payment_banktransfer_discount")
			{
