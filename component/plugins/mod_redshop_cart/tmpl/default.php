...
<div class="mod_cart_main">
	...
	if (is_file(REDSHOP_FRONT_IMAGES_RELPATH . ADDTOCART_BACKGROUND))
	{
		...
		<div class="mod_cart_checkout" id="mod_cart_checkout_ajax"
		     style="cursor:pointer;background:url('<?php echo REDSHOP_FRONT_IMAGES_ABSPATH . ADDTOCART_BACKGROUND; ?>');background-position:bottom;background-repeat:no-repeat; <?php echo $styledis; ?>">
