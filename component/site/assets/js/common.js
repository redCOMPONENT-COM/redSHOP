...
function getShippingrate()
{
	...
	var url= site_url+'index.php?option=com_redshop&view=cart&tmpl=component&task=getShippingrate&'+args;
	var total;
...
function add_to_compare(pid,cid,cmd)
{
	...
	var url= site_url+'index.php?option=com_redshop&view=product&task=addtocompare&tmpl=component&'+args;
...
function onestepCheckoutProcess(objectname)
{
	var newparam = "";
	...
	if(document.getElementById('responceonestep'))
	{
		if(objectname=="payment_method_id")
		{
			...
			var url1= site_url+'index.php?option=com_redshop&view=checkout&tmpl=component&task=displaycreditcard';
			url1 = url1 + newparam;
		...
		params = params + "option=com_redshop&view=checkout&tmpl=component&task=oneStepCheckoutProcess";
