	...
	public function display($tpl = null)
	{
		...
		if ($layout != 'default')
		{
			...
			if ($manufacturer->manufacturer_id)
			{
				...
				if (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_TITLE_MANUFACTUR') != '')
				{
				...
				if ($manufacturer->pagetitle != '' && AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_TITLE_MANUFACTUR') != '')
				{
				...
				else
				{
					...
					elseif (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_TITLE_MANUFACTUR') != '')
					{
						$document->setTitle($pagetitletag);
					}
					else
				...
				// For meta keyword
				if (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_KEYWORDS_MANUFACTUR') != '')
				{
				...
				if ($manufacturer->metakey != '' && AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_KEYWORDS_MANUFACTUR') != '')
				{
				...
				else
				{
					...
					elseif (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_KEYWORDS_MANUFACTUR') != '')
					{
						$document->setMetaData('keywords', $pagekeywordstag);
					}
					else
				...
				if (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_DESCRIPTION_MANUFACTUR') != '')
				{
				...
				if ($manufacturer->metadesc != '' && AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_DESCRIPTION_MANUFACTUR') != '')
				{
				...
				else
				{
					...
					elseif (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_DESCRIPTION_MANUFACTUR') != '')
					{
						$document->setMetaData('description', $pagedesctag);
					}
					else
				...
				// For page heading
				if (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_HEADING_MANUFACTUR') != '')
				{
				...
				if (trim($manufacturer->pageheading) != '' && AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_HEADING_MANUFACTUR') != '')
				{
				...
				else
				{
					...
					elseif (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_HEADING_MANUFACTUR') != '')
					{
				...
				if (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_CANONICAL_MANUFACTUR') != '' && $layout != "products")
				{
