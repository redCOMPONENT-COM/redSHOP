    ...
    public function display($tpl = null)
    {
        ...
        if ($layout != 'default') {
            ...
            if (null !== $manufacturer && $manufacturer->id) {
                ...
                if (Redshop::getConfig()->get('AUTOGENERATED_SEO') && Redshop::getConfig()->get(
                        'SEO_PAGE_DESCRIPTION_MANUFACTUR'
                    ) != '') {
        ...
        if ($layout == "products") {
            $filter_order    = $params->get(
                'order_by',
                Redshop::getConfig()->get('DEFAULT_MANUFACTURER_PRODUCT_ORDERING_METHOD')
            );
        ...
        $lists['order_select'] = JHTML::_(
            ...
            $order_data,
            'order_by',
            'class="inputbox" size="1" onchange="document.orderby_form.submit();" ' . $disabled . ' ',
            'value',
            'text',
            $order_by_select
        );
        ...
        $lists['filter_select'] = JHTML::_(
            ...
            $categorylist,
            'filter_by',
            'class="inputbox" size="1" onchange="document.filter_form.submit();" ' . $disabled . ' ',
            'value',
            'text',
            $filter_by_select
        );
