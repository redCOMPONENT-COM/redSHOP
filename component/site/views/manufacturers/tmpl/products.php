...
// Page Title
$pagetitle = JText::_('MANUFACTURER_PRODUCTS');
...
//		}
		...
		$cart_mdata =str_replace("{product_id_lbl}",JText::_('PRODUCT_ID_LBL'),$cart_mdata);
		...
		$redmore ="<a href='".$link."'>".JText::_( 'READ_MORE' )."</a>";
...
{
	$filterby_form = "<form name='filter_form' action='' method='post'>".JText::_( 'SELECT_FILTER_BY' ).$this->lists['filter_select'];
...
{
	$orderby_form = "<form name='orderby_form' action='' method='post'>".JText::_( 'SELECT_ORDER_BY' ).$this->lists['order_select'];
