...
<tr><td align="right"><input type="button" class="button" name="back" value="<?php echo JText::_ ( 'CANCEL' );?>" onclick="javascript:cancelForm(this.form);"></td>
	<td align="left"><input type="submit" class="button" name="submitbtn" value="<?php echo JText::_ ( 'SAVE' );?>"></td></tr>
</table>
</fieldset>
</div>
...
<input type="hidden" name="requesting_tax_exempt" value="<?php  echo $this->billingaddresses->requesting_tax_exempt;?>"/>
<input type="hidden" name="tax_exempt_approved" value="<?php  echo $this->billingaddresses->tax_exempt_approved;?>"/>
