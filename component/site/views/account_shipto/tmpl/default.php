...
$pagetitle = JText::_('SHIPPING_ADDRESS_INFO_LBL');
if($this->params->get('show_page_title',1)) 
{
	if ( $this->params->get('page_title') != $pagetitle)
	{	 ?>
		<h1 class="componentheading<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
		        <?php echo $this->escape(JText::_('SHIPPING_ADDRESS_INFO_LBL')); ?>
		</h1>
<?php
	}
	else 
...
<?php	if(OPTIONAL_SHIPPING_ADDRESS)
		{	?>	
		<tr><td>- <?php echo JText::_( 'DEFAULT_SHIPPING_ADDRESS' ); ?></td></tr>
<?php	}
...
<?php	} ?>
	<tr><td>&nbsp;</td></tr>
	<tr><td><a href="<?php echo JRoute::_($add_addlink); ?>"><?php echo JText::_('ADD_ADDRESS'); ?></a>&nbsp;
			<a href="<?php echo JRoute::_($backlink); ?>"><?php echo JText::_('BACK'); ?></a></td></tr>
	</table>
</fieldset>