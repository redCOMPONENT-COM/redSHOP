...
<script type="text/javascript">
    ...
    setTimeout(function () {
        window.parent.location.href = '<?php echo JRoute::_(
            "index.php?option=com_redshop&view=" . $return . "&Itemid=" . $itemId,
            false
        ); ?>';
    }, 2000);
                    ...
                    <tr>
                        <td>
                            - <?php echo "<a href='" . JRoute::_(
                                    $editLink,
                                    false
                                ) . "'>" . $this->shippingAddresses[$i]->text . "</a>"; ?>
                        </td>
                        <td>
                            <a onclick="return confirm('<?php echo JText::_('COM_REDSHOP_DO_YOU_WANT_TO_DELETE') ?>');"
                               href="<?php echo JRoute::_($deleteLink, false) ?>"><?php echo JText::_(
