...
<div  class="componentheading<?php echo $this->params->get( 'pageclass_sfx' ) ?>">
	<?php echo $this->escape(JText::_('ORDER_LIST'));?>
</div>
<?php } ?>
<div>
...
if(strstr($template_desc,"{product_loop_start}") && strstr($template_desc,"{product_loop_end}"))
{
	...
	for($i=0;$i<count($this->detail);$i++)
	{
		...
		$order_detail_link ="<div class='order_detail_link'><a href='".$orderdetailurl."'>".JText::_( 'ORDER_DETAIL' )."</a></div>";
		
		$reorder_link = "<div class='reorder_link'><a href='javascript:if(confirm(\"".Jtext::_('CONFIRM_CART_EMPTY')."\")){window.location=\"".$reorderurl."\";}'>".JText::_( 'REORDER' )."</a></div>";
