...
<table cellpadding="3" cellspacing="0" border="0">
	<tr>
		<td colspan="2">
			<?php echo JText::_( 'ORDER_ID' ); ?>:
		</td>
		<td>
			<input type="text" class="inputbox" name="order_id" id="order_id" value="">
		</td>
		<td><input type="submit" id="go" name="go" value="<?php echo JText::_('GO'); ?>"></td>
	</tr>
</table>
...
{	?>
		...
		<th><?php echo JTEXT::_('ORDER_ITEM');  ?></th>
		...
		<th><?php echo JTEXT::_('ORDER_DETAIL'); ?></th></tr>
<?php	$order_item_name = array();
		...
		<tr class="rblOrderDetailItem">
			...
			<td><?php echo $producthelper->getProductFormattedPrice($order_detail->order_total);?></td>
	  		...
	  		<td><a href="<?php echo $orderdetailurl;?>"><?php echo JText::_( 'ORDER_DETAIL' );?></a></td></tr>
<?php
}
else
{	?>
<td><?php
if($order_id!=0)
echo JTEXT::_('ORDER_NOT_FOUND'); ?></td>
<?php } ?>
</tr></table>