...
<div class="componentheading<?php echo $this->params->get( 'pageclass_sfx' ) ?>">
	<?php echo $this->escape(JText::_('ORDER_RECEIPT')); ?>
</div>
<?php } ?>
<hr/>
...
<tr><td width="33%" class="checkout-bar-1"><?php echo JText::_( 'ORDER_INFORMATION' ); ?></td>
	...
	<td width="33%" class="checkout-bar-3-active"><?php echo JText::_( 'RECEIPT' ); ?></td></tr>
</table>
<hr/>
<div>
...
$ReceiptTemplate = str_replace("{product_name_lbl}",JText::_('PRODUCT_NAME_LBL'),$ReceiptTemplate);
$ReceiptTemplate = str_replace("{price_lbl}",JText::_('PRICE_LBL'),$ReceiptTemplate);
$ReceiptTemplate = str_replace("{quantity_lbl}",JText::_('QUANTITY_LBL'),$ReceiptTemplate);
$ReceiptTemplate = str_replace("{total_price_lbl}",JText::_('TOTAL_PRICE_LBL'),$ReceiptTemplate);
