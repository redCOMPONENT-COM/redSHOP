...
class RedshopViewProduct extends RedshopView
{
	...
	public function display($tpl = null)
	{
		...
		else
		{
			...
			// For page title
			if (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_TITLE') != '')
			{
			...
			if ($this->data->pagetitle != '' && AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_TITLE') != '')
			{
			...
			else
			{
				...
				elseif (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_TITLE') != '')
				{
					$this->document->setTitle($pagetitletag);
					$this->document->setMetaData("og:title", $pagetitletag);
				}
			...
			if (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_KEYWORDS') != '')
			{
			...
			if (trim($this->data->metakey) != '' && AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_KEYWORDS') != '')
			{
				if ($this->data->append_to_global_seo == 'append')
				{
			...
			if (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_DESCRIPTION') != '')
			{
			...
			if (trim($this->data->metadesc) != '' && AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_DESCRIPTION') != '')
			{
				if ($this->data->append_to_global_seo == 'append')
				{
			...
			else
			{
				...
				elseif (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_DESCRIPTION') != '')
				{
					$this->document->setMetaData('description', $pagedesctag);
					$this->document->setMetaData("og:description", $pagedesctag);
				}
			...
			// For page heading
			if (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_HEADING') != '')
			{
			...
			if (trim($this->data->pageheading) != '' && AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_HEADING') != '')
			{
