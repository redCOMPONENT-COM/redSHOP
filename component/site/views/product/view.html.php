...
class RedshopViewProduct extends RedshopView
{
    ...
    public function display($tpl = null)
    {
        ...
        if ($layout == "downloadproduct") {
            ...
            if (
                $this->data->pagetitle != '' && Redshop::getConfig()->get('AUTOGENERATED_SEO') && Redshop::getConfig(
                )->get('SEO_PAGE_TITLE') != ''
            ) {
                ...
                if ($this->data->pagetitle != '') {
                    ...
                    Redshop::getConfig()->get('AUTOGENERATED_SEO') && Redshop::getConfig()->get(
                        'SEO_PAGE_TITLE'
                    ) != ''
                ) {
                    $this->document->setTitle($pagetitletag);
            ...
            if (
                $this->data->product_thumb_image && file_exists(
                ...
                $this->data->product_full_image && file_exists(
            ...
            if (
                trim($this->data->metakey) != '' && Redshop::getConfig()->get(
                    'AUTOGENERATED_SEO'
            ...
            if (
                trim($this->data->metadesc) != '' && Redshop::getConfig()->get(
                    'AUTOGENERATED_SEO'
            ...
            if (
                trim($this->data->pageheading) != '' && Redshop::getConfig()->get(
                    'AUTOGENERATED_SEO'
