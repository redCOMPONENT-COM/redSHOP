...
if(count($ajaxdetal_template)>0)
{
    ...
    {
	    if ($this->data->product_full_image && file_exists(JPATH_BASE."/components/".$option."/assets/images/product/".$this->data->product_full_image))
	    {
	    	$productsrcPath="<a href='".$url."components/".$option."/assets/images/product/".$this->data->product_full_image."' title='".$this->data->product_name."' rel='lightbox[product7]'>";
