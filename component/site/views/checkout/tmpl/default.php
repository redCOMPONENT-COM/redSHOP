...
<tr><td width="33%" class="checkout-bar-1-active"><?php echo JText::_('COM_REDSHOP_ORDER_INFORMATION' );?></td>
...
<?php	if(strstr($login_template_desc,"{rs_username}"))
	...
	<tr><td><span <?php echo $allowCustomer;?>><h4><input type="radio" name="togglerchecker" id="toggler1" class="toggler"
		...
		<?php echo JText::_('COM_REDSHOP_COMPANY_REGISTRATION' );?></h4></span></td></tr>
<?php	if(count($telesearch)>0 && $telesearch[0]->enabled)
		{	?>
		<tr><td colspan="2"><?php echo JText::_('COM_REDSHOP_GET_ADDRESS_BY_PHONE').':<input name="searchphone" id="searchphone" type="text" value="" /><input type="button" name="searchaddbyphone" id="searchaddbyphone" value="'.JText::_('COM_REDSHOP_SEARCH').'" onclick="return searchByPhone();" />';?>
		<br/>
		<div id="divSearchPhonemsg" style="display:none"><?php echo JText::_('COM_REDSHOP_NO_RESULT_FOUND_BY_SEARCHPHONE');?></div></td></tr>
<?php 	}	?>
	</table>
...
<?php 	}	?>
	...
	<tr><td align="right"><input type="button" class="blackbutton" name="back" value="<?php echo JText::_('COM_REDSHOP_BACK' );?>" onclick="javascript:window.history.go(-1);"></td>
		<td align="left">
			<input type="submit" class="greenbutton" name="submitbtn" onclick="return checkveisvalid();" value="<?php echo JText::_('COM_REDSHOP_PROCEED' );?>">
	    </td>
	</tr>	
	<?php 
	} else {
	...
	<tr><td align="right"><input type="button" class="blackbutton" name="back" value="<?php echo JText::_('COM_REDSHOP_BACK' );?>" onclick="javascript:window.history.go(-1);"></td>
		<td align="left">
			<input type="submit" class="greenbutton" name="submitbtn" id="submitbtn"  value="<?php echo JText::_('COM_REDSHOP_PROCEED' );?>">
	    </td>
	</tr>	
	<?php 
	}
