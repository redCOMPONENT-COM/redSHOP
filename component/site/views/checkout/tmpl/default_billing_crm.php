...
?>
<tr>
	<td width="100" align="left"><label for="address"><?php echo JText::_('COM_REDSHOP_ADDRESS' );?>:</label></td>
...
?>
<tr>
	<td width="100" align="left"><label for="contact_info"><?php echo JText::_('COM_REDSHOP_COUNTRY' );?>:</label></td>
...
?>
<tr>
	<td width="100" align="left"><label for="city"><?php echo JText::_('COM_REDSHOP_MOBILE_PHONE' );?>:</label></td>
...
if ($billingaddresses->is_company == 1)
{	?>
<tr><td width="100" align="left"><label><?php echo JText::_('COM_REDSHOP_EAN_NUMBER' );?>:</label></td>
...
?>
<tr>
	<td width="100" align="left"><label for="vat_number"><?php echo JText::_('COM_REDSHOP_VAT_NUMBER' );?>:</label></td>
	<td><?php echo $billingaddresses->vat_number;?></td>
</tr>
<?php if(SHOW_TAX_EXEMPT_INFRONT){ ?>
<tr>
	<td width="100" align="left"><label for="tax_exempt"><?php echo JText::_('COM_REDSHOP_TAX_EXEMPT' );?>:</label></td>
	<td><?php
...
<tr>
	<td width="100" align="left"><label for="debitor_money_transfer_number"><?php echo JText::_('COM_REDSHOP_DEBITOR_MONEY_TRANSFER_NUMBER' );?>:</label></td>
