...
<form action="<?php echo JRoute::_('index.php?option=com_redshop&view=checkout&Itemid=' . $Itemid . '') ?>"
        ...
        <div class="col-sm-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					<?php if ($billingaddresses): ?>
                        <a
                                class="modal btn btn-primary"
                                href="<?php echo $editbill; ?>"
                                rel="{handler: 'iframe', size: {x: 720, y: 470}}">
	...
	<?php if (Redshop::getConfig()->get('SHIPPING_METHOD_ENABLE') && $cart['free_shipping'] != 1): ?>
    ...
    <div align="right">
        <input type="submit" class="greenbutton btn btn-primary" name="checkoutnext" value="<?php echo JText::_("COM_REDSHOP_CHECKOUT") ?>"/>
    </div>
</form>
