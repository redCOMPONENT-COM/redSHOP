...
if ($billingaddresses)
{
	...
	{	?>
	<a class="modal" href="<?php echo $editbill; ?>" rel="{handler: 'iframe', size: {x: 720, y: 470}}"><?php echo JText::_('COM_REDSHOP_EDIT');?></a>
<?php
	}
...
{	?>
	...
	<a class="modal" href="<?php echo $editbill;?>" rel="{handler: 'iframe', size: {x: 800, y: 550}}"> <?php echo JText::_('COM_REDSHOP_ADD');?></a>
<?php
}	?>
</fieldset>
<?php
...
<?php
	...
	{?>
			<input onclick="document.adminForm.task.value = '';document.adminForm.submit();" type="radio" name="users_info_id" value="<?php echo $billingaddresses->users_info_id;?>" <?php echo $checked;?> />
	<?php }?>
	 - <?php echo JText::_('COM_REDSHOP_DEFAULT_SHIPPING_ADDRESS' );?></td></tr>
<?php
	}
	...
	<?php if (!$session->get('isredcrmuser'))
	 ...
	 echo $shippingaddresses [$i]->text;
		if (!$session->get('isredcrmuser'))
		{	?>
			<a class="modal" href="<?php echo $edit_addlink; ?>" rel="{handler: 'iframe', size: {x: 570, y: 470}}">(<?php echo JText::_('COM_REDSHOP_EDIT_LBL' );	?>)</a>
			<a href="<?php echo $delete_addlink;?>" title="">(<?php echo JText::_('COM_REDSHOP_DELETE_LBL' );	?>)</a>
<?php	}	?>
</td>
</tr>
<?php
...
<?php
	if (!$session->get('isredcrmuser'))
	{	?>
	<tr><td><a class="modal" href="<?php echo $add_addlink; ?>" rel="{handler: 'iframe', size: {x: 570, y: 470}}"><?php echo JText::_('COM_REDSHOP_ADD_ADDRESS' );?> </a></td></tr>
<?php
	}	?>
</table>
</fieldset>
...
<div align="right"><input type="submit" class="greenbutton" name="checkoutnext" value="<?php echo JText::_("COM_REDSHOP_CHECKOUT" )?>" /></div>
</form>