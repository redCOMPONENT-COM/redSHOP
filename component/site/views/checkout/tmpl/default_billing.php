...
{	?>
<tr><td width="100" align="left"><?php echo JText::_('COM_REDSHOP_ADDRESS' );?>:</td>
	<td><?php echo $billingaddresses->address;?></td></tr>
<?php
}
if ($billingaddresses->zipcode != "")
{	?>
<tr><td width="100" align="left"><?php echo JText::_('COM_REDSHOP_ZIP' );?>:</td>
	<td><?php echo $billingaddresses->zipcode;?></td></tr>
<?php
}
if ($billingaddresses->city != "")
{	?>
<tr><td width="100" align="left"><?php echo JText::_('COM_REDSHOP_CITY' );?>:</td>
	<td><?php echo $billingaddresses->city;?></td></tr>
<?php
}
if (trim($billingaddresses->country_code)!= "")
{	?>
<tr><td width="100" align="left"><?php echo JText::_('COM_REDSHOP_COUNTRY' );?>:</td>
...
if ($state!="")
{	?>
<tr><td width="100" align="left"><?php echo JText::_('COM_REDSHOP_STATE' );?>:</td>
	<td><?php echo $state;?></td></tr>
<?php
}
if ($billingaddresses->phone != "")
{	?>
<tr><td width="100" align="left"><?php echo JText::_('COM_REDSHOP_PHONE' );?>:</td>
...
{	
  if($billingaddresses->ean_number!="") {?>
	<tr><td width="100" align="left"><?php echo JText::_('COM_REDSHOP_EAN_NUMBER' );?>:</td>
...
{	?>
<tr><td width="100" align="left"><?php echo JText::_('COM_REDSHOP_VAT_NUMBER' );?>:</td>
...
<tr><td width="100" align="left"><?php echo JText::_('COM_REDSHOP_TAX_EXEMPT' );?>:</td>
