...
<?php
	...
	$pagetitle  = JText ::_('LOGIN_NEWWISHLIST');
	?>
	<br />
...
$pagetitle = JText::_('LOGIN_PROMPTWISHLIST');
?>
<br />
<h1 class="componentheading<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
      <?php echo $pagetitle; ?>
		...
		<tbody>
			<tr>
				<td colspan="3"  align="center" class="wishlist_prompt_button_wrapper">
					<input type="button" class="wishlist_prompt_button_login" value="<?php echo JText::_('ADD_TO_LOGINWISHLIST');?>" onclick="window.parent.location.href='index.php?option=com_redshop&view=login&wishlist=1'" />&nbsp;
					<input type="button" class="wishlist_prompt_button_create" value="<?php echo JText::_('CREATE_LOGINACCOUNT');?>" onclick="window.parent.location.href='index.php?option=com_redshop&view=registration&Itemid=<?php echo $Itemid?>&wishlist=1'" />
				</td>
			</tr>
		</tbody>
	</table>
