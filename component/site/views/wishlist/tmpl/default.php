...
?>
<?php if($flage) : ?>
<input type="checkbox" name="chkNewwishlist" id="chkNewwishlist" onchange="changeDiv(this);"  /><?php echo JText::_('CREATE_NEW_WISHLIST');?>
<?php endif;
?>
<div id="newwishlist" style="display:<?php echo $flage ? 'none' : 'block'; ?>">
<?php
if($this->params->get('show_page_title',1)) {
	$pagetitle  = JText ::_('CREATE_NEWWISHLIST');
	?>
	<br />
...
<?php } ?>
	...
	<table>
		<tr>
			<td>
				<label for="txtWishlistname"><?php echo JText::_('WISHLIST_NAME');?> : </label>
			</td>
			<td>
		...
		<tr>
			<td colspan="2" align="center">
				<input type="button" value="<?php echo JText::_('CREATE_SAVE');?>" onclick="checkValidation()" />&nbsp;
				...
				?>
					<a href="<?PHP echo $mywishlist_link;?>"><input type="button" value="<?php echo JText::_('CANCEL');?>" /></a>
				<?PHP
				}else{
				?>
				<input type="button" value="<?php echo JText::_('CANCEL');?>" onclick="window.parent.document.getElementById('sbox-window').close();" />
				<?
				}
				?>
			</td>
...
<?php } ?>
	...
	<table class="adminlist">
		...
		<tr>
			...
			<th class="title"  width="30%">
				<?php echo JTEXT::_('WISHLIST_NAME'); ?>
			</th>
		</tr>
	</thead>
	<tbody>
	...
	<tr>
		<td colspan="3"  align="center">
			<input type="button" value="<?php echo JText::_('ADD_TO_WISHLIST');?>" onclick="submitform();" />&nbsp;
			<input type="button" value="<?php echo JText::_('CANCEL');?>" onclick="window.parent.document.getElementById('sbox-window').close();" />
		</td>
	</tr>
	</tbody>
...
function submitform()
{
	if(!document.adminForm.boxchecked.value)
		alert("<?php echo JText::_('PLEASE_SELECT_WISHLIST')?>");
	else
...
function checkValidation()
{
	if(trim(document.newwishlistForm.txtWishlistname.value)=="")
		alert("<?php echo JText::_('PLEASE_ENTER_WISHLIST_NAME')?>");
	else
