...
<div class="componentheading<?php echo $this->params->get('pageclass_sfx') ?>">
	<?php echo $this->escape(JText::_('SPLIT_PAYMENT')); ?>
</div>
<?php } ?>
<?php 
...
<form action="<?php echo JRoute::_('index.php?option='.$option.'&view=split_payment') ?>" method="post" name="adminForm" id="adminForm"   >
  ...
  <?php 
		...
		for($p=0;$p<count($paymentmethod);$p++)
		{
			$paymentpath=$adminpath.DS.'helpers'.DS.'payments'.DS.$paymentmethod[$p]->plugin.DS.$paymentmethod[$p]->plugin.'.php';
			 ...
			 ?>
 			 <input  type="radio" name="payment_method_id" value="<?php echo $paymentmethod[$p]->payment_method_id ;?>"  <?php if($this->payment_method_id == $paymentmethod[$p]->payment_method_id || !$this->payment_method_id ){ ?> checked="checked" <?php } ?>  />
  			<?php
  ...
  <table cellpadding="2" cellspacing="2" border="0">
	...
	<tr>
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2">
						  <tr>
							<td align="center"><img src="<?php echo $url;?>components/com_redshop/assets/images/checkout/visa.jpg" alt="" border="0" /></td>
							<td align="center"><img src="<?php echo $url;?>components/com_redshop/assets/images/checkout/master.jpg" alt="" border="0" /></td>
							<td align="center"><img src="<?php echo $url;?>components/com_redshop/assets/images/checkout/mastero.jpg" alt="" border="0" /></td>
							<td align="center"><img src="<?php echo $url;?>components/com_redshop/assets/images/checkout/jcb.jpg" alt="" border="0" /></td>
							<td align="center"><img src="<?php echo $url;?>components/com_redshop/assets/images/checkout/blue.jpg" alt="" border="0" /></td>
							<td align="center"><img src="<?php echo $url;?>components/com_redshop/assets/images/checkout/dinnersclub.jpg" alt="" border="0" /></td>
						  </tr>
						  <tr>
							<td align="center"> <input  type="radio" name="creditcard_code" value="Visa"  <?php if(empty($_SESSION['ccdata']['creditcard_code']) || $_SESSION['ccdata']['creditcard_code'] == 'Visa') { ?>  checked="checked" <?php } ?>  /></td>
							<td align="center"> <input  type="radio" name="creditcard_code" value="MC"  <?php if(!empty($_SESSION['ccdata']['creditcard_code']) && $_SESSION['ccdata']['creditcard_code'] == 'MC') { ?>  checked="checked" <?php } ?> /></td>
							<td align="center"> <input  type="radio" name="creditcard_code" value="Maestro" <?php if(!empty($_SESSION['ccdata']['creditcard_code']) && $_SESSION['ccdata']['creditcard_code'] == 'MasterCard') { ?>  checked="checked" <?php } ?>  /></td>
							<td align="center"> <input  type="radio" name="creditcard_code" value="JCB" <?php if(!empty($_SESSION['ccdata']['creditcard_code']) && $_SESSION['ccdata']['creditcard_code'] == 'JCB') { ?>  checked="checked" <?php } ?>  /></td>
							<td align="center"> <input  type="radio" name="creditcard_code" value="amex"  <?php if(!empty($_SESSION['ccdata']['creditcard_code']) && $_SESSION['ccdata']['creditcard_code'] == 'amex') { ?>  checked="checked" <?php } ?> /></td>
							<td align="center"> <input  type="radio" name="creditcard_code" value="diners"  <?php if(!empty($_SESSION['ccdata']['creditcard_code']) && $_SESSION['ccdata']['creditcard_code'] == 'diners') { ?>  checked="checked" <?php } ?> /></td>
						  </tr>
						</table>
   ...
   <tr valign="top">
					...
					<tr valign="top">
						<td align="right" nowrap="nowrap" width="10%">
							<label for="credit_card_code">
								<?php echo JText::_( 'REMAININGTOPAY' ); ?>
							</label>
						</td>		        		
						<td>
