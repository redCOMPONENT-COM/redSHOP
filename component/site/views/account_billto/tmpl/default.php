...
{	?>
	<h1 class="componentheading<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
		<?php echo $this->escape(JText::_('BILLING_ADDRESS_INFORMATION_LBL')); ?></h1>
<?php
}	 ?>

<form action="<?php echo JRoute::_($this->request_url);?>" method="post" name="adminForm" id="billinfo_adminForm" enctype="multipart/form-data">
