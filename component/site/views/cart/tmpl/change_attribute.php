...
//	if(WANT_TO_SHOW_ATTRIBUTE_IMAGE_INCART && isset($cart[$cart_index]['hidden_attribute_cartimage'.$product_id]))
//	{
//		$product_image = $cart[$cart_index]['hidden_attribute_cartimage'.$product_id];
//	}
}
...
$applybutton = "<input type='button' name='apply' value='".JText::_('APPLY')."' onclick='javascript:submitChangeAttribute();' />";
...
$cancelbutton = "<input type='button' name='cancel' value='".JText::_('CANCEL')."' onclick='javascript:cancelForm(this.form);' />";
...
{
	echo JText::_("NO_ATTRIBUTE_TO_CHANGE");
}