...
//   	$pathway->addItem(JText::_('ORDER_DETAILS'),'');
		...
		$quoid = JRequest::getInt('quoid');
   		...
   		{
   			JError::raiseWarning(404,JText::_('NOACCESS_QUOTATION'));
			echo JText::_('NOACCESS_QUOTATION');
			return;
   		}
   		if(!$user->id)
   		{
	   		if(isset($encr))
	   		{
	   			...
	   			if(!$authorization)
	   			{
	   				JError::raiseWarning(404,JText::_('QUOTATION_ENCKEY_FAILURE'));
	   				echo JText::_('QUOTATION_ENCKEY_FAILURE');
	   				return false;
	   			}
	   		} else {
