	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
			<td colspan="5" height="40">
				<p><?php echo JText::_('LOGIN_DESCRIPTION'); ?></p>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td colspan="5">
				<a href="<?php echo JRoute::_($newuser_link); ?>"><?php echo JText::_('CREATE_USER_LINK'); ?></a>&nbsp;/&nbsp;<a href="<?php echo JRoute::_($forgotpwd_link); ?>"><?php echo JText::_('FORGOT_PWD_LINK'); ?></a>
			</td>
		</tr>
	</table>
