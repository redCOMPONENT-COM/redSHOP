...
if ($this->designtype_detail->reddesign_autotemplate)
{
	...
	<form name="addtocart0" action="" id="addtocartdesign" method="post">
		...
		<table>
			<tr>
				<td>
					<div id="divImageSelection"><?php echo $this->lists['selimage']; ?></div>
				</td>
				<td>
					<div id="divProductName"><?php echo $this->product_detail->product_name; ?></div>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td valign="top">
					...
					<input name="product_price" value="<?php echo $this->product_detail->product_price; ?>"
					       type="hidden">
				</td>
			</tr>
			<tr>
