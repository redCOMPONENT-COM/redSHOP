...
if (!$app->input->getInt('questionSend', 0))
{
	...
	if ($user->id)
	{
		$this->form->setValue('your_name', null, $this->form->getValue('your_name', null, $user->name));
		$this->form->setValue('your_email', null, $this->form->getValue('your_email', null, $user->email));
	}
	...
	<form name="askQuestionForm" action="<?php echo JRoute::_('index.php?option=com_redshop'); ?>" method="post"
		...
		<?php
		$template_desc = str_replace('{user_name_lbl}', $this->form->getLabel('your_name'), $template_desc);
		$template_desc = str_replace('{user_email_lbl}', $this->form->getLabel('your_email'), $template_desc);
		$template_desc = str_replace('{user_question_lbl}', $this->form->getLabel('your_question'), $template_desc);
		$template_desc = str_replace('{user_telephone_lbl}', $this->form->getLabel('telephone'), $template_desc);
		$template_desc = str_replace('{user_address_lbl}', $this->form->getLabel('address'), $template_desc);
		$template_desc = str_replace('{user_name}', $this->form->getInput('your_name'), $template_desc);
		$template_desc = str_replace('{user_email}', $this->form->getInput('your_email'), $template_desc);
		$template_desc = str_replace('{user_question}', $this->form->getInput('your_question'), $template_desc);
		$template_desc = str_replace('{user_address}', $this->form->getInput('address'), $template_desc);
		$template_desc = str_replace('{user_telephone}', $this->form->getInput('telephone'), $template_desc);
