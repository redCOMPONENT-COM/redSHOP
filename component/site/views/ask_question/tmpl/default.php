...
function validateQuestion(){
	...
	if(frm.your_name.value == '')
	{
		...
		alert("<?php echo JText::_('PLEASE_ENTER_YOUR_EMAIL_ADDRESS');?>");
		return false;
	} else if(frm.your_question.value == '') {
		alert("<?php echo JText::_('PLEASE_ENTER_YOUR_QUESTION_ABOUT_THIS_PRODUCT');?>");
		return false;
	} else if(frm.security_code.value == '') {
		alert("<?php echo JText::_('PLEASE_ENTER_SECURITY_CODE');?>");
		return false;
	}else {
		return true;
	}
...
<?php
	$template_desc = str_replace ( "{user_name_lbl}", JText::_('YOUR_NAME' ), $template_desc );
	$template_desc = str_replace ( "{user_email_lbl}", JText::_('YOUR_EMAIL' ), $template_desc );
	$template_desc = str_replace ( "{user_question_lbl}", JText::_('YOUR_QUESTION' ), $template_desc );
	$template_desc = str_replace ( "{user_telephone_lbl}", JText::_('TELEPHONE' ), $template_desc );
	$template_desc = str_replace ( "{user_address_lbl}", JText::_('ADDRESS' ), $template_desc );
	...
	$sendbutton = '<input type="submit" value="'.JText::_('SEND' ).'" onclick="return validateQuestion();" />';
	...
	$template_desc = str_replace ( "{captcha_lbl}", JText::_('CAPTCHA' ), $template_desc );
