...
class RedshopViewCategory extends RedshopView
{
	...
	public function display($tpl = null)
	{
		...
		if ($this->catid)
		{
			...
			if ($maincat->pagetitle != "" && AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_TITLE_CATEGORY') != '')
			{
			...
			elseif (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_TITLE_CATEGORY') != '')
			{
				$document->setTitle($pagetitletag);
			}
			else
			...
			if (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_KEYWORDS_CATEGORY') != '')
			{
			...
			if (trim($maincat->metakey) != '' && AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_KEYWORDS_CATEGORY') != '')
			{
				if ($maincat->append_to_global_seo == 'append')
				{
			...
			if (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_DESCRIPTION_CATEGORY') != '')
			{
			...
			if ($maincat->metadesc != '' && AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_DESCRIPTION_CATEGORY') != '')
			{
				if ($maincat->append_to_global_seo == 'append')
				{
			...
			{
				if (AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_ROBOTS') != '')
				{
					$pagerobotstag = Redshop::getConfig()->get('SEO_PAGE_ROBOTS');
			...
			$pageheadingtag = str_replace("{categoryname}", $maincat->category_name, Redshop::getConfig()->get('SEO_PAGE_HEADING_CATEGORY'));

			if ($maincat->pageheading != "" && AUTOGENERATED_SEO && Redshop::getConfig()->get('SEO_PAGE_HEADING_CATEGORY') != '')
			{
