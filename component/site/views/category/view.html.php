   	...
   	function display ($tpl=null)
   	{
		...
		if($catid)
		{
			...
			if($maincat->published == 0){
				JError::raiseError(404,sprintf(JText::_('CATEGORY_IS_NOT_PUBLISHED'),$maincat->category_name,$maincat->category_id));
			}
		...
		if(count($manufacturers) > 0)
		{
			...
			$temps[0]->manufacturer_name = JText::_('SELECT_MANUFACTURE');
