...
$city       = $detail->city;
$country    = Text::_(RedshopHelperOrder::getCountryName($detail->country_code));
...
<script>
    ...
    function validateInfo() {
        ...
        if (frm.username.value == '') {
            alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_USERNAME') ?>");
            return false;
        }
        ...
        if ($regtype == 1) {
            ...
            if (frm.company_name.value == '') {
                alert("<?php echo Text::_('COM_REDSHOP_PLEASE_ENTER_COMPANY_NAME') ?>");
                return false;
            }
...
<form action="<?php echo Redshop\IO\Route::_($this->request_url); ?>" method="post" name="adminForm" id="adminForm"
    ...
    <fieldset class="adminform">
        <legend>
            <?php echo Text::_('COM_REDSHOP_ACCOUNT_CREATION'); ?>
        </legend>
        <table class="admintable">
            ...
            <tr>
                <td align="center" colspan="2"><input type="submit" class="greenbutton btn btn-primary" name="btnsubmit"
                        value="<?php echo Text::_('COM_REDSHOP_SUBMIT'); ?>" onclick="return validateInfo();">
                    <input type="submit" class="greenbutton btn btn-primary" name="cancel"
                        value="<?php echo Text::_("COM_REDSHOP_CANCEL"); ?>"
