...
else
{
	...
	<tr><td width="100" align="right">'.JText::_ ( 'EMAIL' ).':</td>
	...
	$template_desc = str_replace("{billing_address_information_lbl}", JText::_('BILLING_ADDRESS_INFORMATION_LBL'), $template_desc );
	$template_desc = str_replace("{billing_address}", $billing, $template_desc);
}

$cancel_btn = '<input type="submit" class="greenbutton" name="cancel" value="'.JText::_("CANCEL").'" onclick="javascript:document.adminForm.task.value=\'cancel\';"/>';
$quotation_btn = '<input type="submit" class="greenbutton" name="addquotation" value="'.JText::_("REQUEST_QUOTATION").'" onclick="return validateInfo();"/>';
...
$template_desc = str_replace("{order_detail_lbl}", JText::_('ORDER_DETAIL_LBL'), $template_desc);
