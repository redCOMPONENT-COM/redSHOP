    ...
    <tr>
        ...
        <td class="carttotal_right">
            <table class="cart_calculations">
                ...
                <tr>
                    <td colspan="2"><div class="newsletter_signup">{newsletter_signup_chk}{newsletter_signup_lbl}</div></td>
                </tr>
                <tr>
                    <td colspan="2"> <div class="terms_and_conditions">{terms_and_conditions:width=500 height=450}</div></td>
                </tr>
