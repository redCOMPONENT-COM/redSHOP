...
class rsCarthelper
{
	...
	{
		return RedshopHelperCartTag::replaceDiscount($data, $discount, $subtotal, $quotation_mode);
	}
	 ...
	 * @return  string
	 *
	 * @deprecated   2.0.7  Use RedshopHelperCartTag::replacePayment() instead.
	 */
	public function replacePayment($data = '', $amount = 0, $cart = 0, $payment_oprand = '-')
	{
		return RedshopHelperCartTag::replacePayment($data, $amount, $cart, $payment_oprand);
	}
	 ...
	 * @return   string
	 *
	 * @deprecated   2.0.7  Use RedshopHelperCartTag::replaceBillingAddress() instead.
	 */
	public function replaceBillingAddress($data, $billingaddresses, $sendmail = false)
	{
		return RedshopHelperCartTag::replaceBillingAddress($data, $billingaddresses, $sendmail);
	}
	 ...
	 * @return  string
	 *
	 * @deprecated   2.0.7  Use RedshopHelperCartTag::replaceCartItem() instead.
	 */
	...
	{
		return RedshopHelperCartTag::replaceOrderItems($data, $rowItem);
	}
	...
	{
		return RedshopHelperCartTag::replaceLabel($data);
	}
