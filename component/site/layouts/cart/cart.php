	...
	<?php if ($displayData['totalQuantity']):
		...
		<?php for($i = 0; $i < $cart['idx']; $i++):
			...
			<div class="mod_cart_product">
				...
				<?php if (!Redshop::getConfig()->get('DEFAULT_QUOTATION_MODE') || (Redshop::getConfig()->get('DEFAULT_QUOTATION_MODE') && SHOW_QUOTATION_PRICE)):
...
<?php endif; ?>
<?php if ((!Redshop::getConfig()->get('DEFAULT_QUOTATION_MODE') || (Redshop::getConfig()->get('DEFAULT_QUOTATION_MODE') && SHOW_QUOTATION_PRICE)) && $displayData['totalQuantity']): ?>
