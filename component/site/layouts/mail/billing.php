...
<table border="0">
    ...
    <?php if ($billingAddresses->is_company == 1): ?>
        ...
        <?php if ($billingAddresses->ean_number != ""): ?>
            ...
            <tr>
                <td>
                    <?php echo Text::_('COM_REDSHOP_REQUISITION_NUMBER'); ?>:
                </td>
                <td>
                    <?php echo $billingAddresses->requisition_number; ?>
                </td>
            </tr>
        <?php endif; ?>
        ...
        <?php if (Redshop::getConfig()->get('SHOW_TAX_EXEMPT_INFRONT')): ?>
            ...
            if ($billingAddresses->tax_exempt == 1) {
                $tax_exempt = Text::_('COM_REDSHOP_TAX_YES');
            } else {
                $tax_exempt = Text::_('COM_REDSHOP_TAX_NO');
            }
            ?>
    ...
    <?php endif; ?>
    <?php echo $extrafields = RedshopHelperExtrafields::listAllFieldDisplay(
        $extra_section,
