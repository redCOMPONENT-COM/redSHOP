    ...
    <div class="checkout_attribute_title">
        ...
        <?php foreach ($propData as $property) : ?>
            <div class="checkout_attribute_price">
                ...
                <?php if ($quotationStatus != 1 || ($quotationStatus == 1 && Redshop::getConfig()->get(
                    ...
                    $propertyPriceWithVat = RedshopHelperProductPrice::formattedPrice(
                        $property->section_price + $property->section_vat
                    );
            ...
            <?php foreach ($subpropdata as $subProperty) : ?>
                <div class="checkout_subattribute_price">
                    ...
                    <?php if ($quotation_status != 1 || ($quotation_status == 1 && Redshop::getConfig()->get(
                                'SHOW_QUOTATION_PRICE'
                            ) == 1)) : ?>
                        <?php
                        ...
                        $subpropertyPriceWithVat = RedshopHelperProductPrice::formattedPrice(
                            $subProperty->section_price + $subProperty->section_vat
                        );
