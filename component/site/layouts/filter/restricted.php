        ...
        <div id='manu'>
            ...
            <ul class='taglist' id="manufacture-list">
				<?php if (!empty($manufacturers)) : ?>
					<?php $manufacturersValue = isset($formData['redform']['manufacturers']) ? $formData['redform']['manufacturers'] : array(); ?>
...
<input type="hidden" name="redform[mid]"
       value="<?php echo !empty($formData['redform']['mid']) ? $formData['redform']['mid'] : 0; ?>"/>
...
<input type="hidden" name="redform[keyword]"
       value="<?php echo $formData['redform']['keyword'] ? $formData['redform']['keyword'] : $keyword; ?>"/>
...
<input type="hidden" name="redform[template_id]"
       value="<?php echo $formData['redform']['template_id'] ? $formData['redform']['template_id'] : $template; ?>"/>
<input type="hidden" name="redform[root_category]" value="<?php echo $params->root_category; ?>"/>
<input type="hidden" name="redform[category_for_sale]"
       value="<?php echo $formData['redform']['category_for_sale']; ?>"/>
