...
class account_shiptoController extends JController
{
	...
	function save()
	{
		...
		if ($reduser = $model->store ( $post ))
		{
			...
			$msg = JText::_( 'SHIPPING_INFORMATION_SAVE');
		}else{
			$msg = JText::_( 'ERROR_SAVING_SHIPPING_INFORMATION');
		}
		$return = JRequest::getVar('return');
...
?>
	...
	function remove()
	{
		...
		$msg = JText::_ ( 'ACCOUNT_SHIPPING_DELETED_SUCCESSFULLY' );
		$return = JRequest::getVar('return');
	...
	function cancel()
	{
		...
		$msg = JText::_( 'SHIPPING_INFORMATION_EDITING_CANCELLED');
