...
class RedshopControllerRegistration extends RedshopController
{
    ...
    public function searchUserdetailByCVR()
    {
        ...
        if ( empty($vat) ) {
            ...
            curl_setopt($ch, CURLOPT_USERAGENT, 'CVR Lookup Feature - Print.dk');
            ...
            if (count($return)>0) {
                ...
                $returnSt = $return['name'].":_:".$return['address'].":_:".$return['zipcode'].":_:".$return['city'].":_:".$return['phone'].":_:".$return['phone'].":_:".$name_sp[0].":_:".$name_sp1.":_:".$return['email'].":_:".$return['vat'];
            }
        } 
