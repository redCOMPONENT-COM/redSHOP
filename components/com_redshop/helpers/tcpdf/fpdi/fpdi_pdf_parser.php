...
class fpdi_pdf_parser extends pdf_parser
{
    ...
    function getPageBox($page, $box_index)
    {
        ...
        {
            $b =& $box[1];
            return array('x' => $b[0][1] / $this->fpdi->k, 'y' => $b[1][1] / $this->fpdi->k, 'w' => abs($b[0][1] - $b[2][1]) / $this->fpdi->k, 'h' => abs($b[1][1] - $b[3][1]) / $this->fpdi->k, 'llx' => min($b[0][1], $b[2][1]) / $this->fpdi->k, 'lly' => min($b[1][1], $b[3][1]) / $this->fpdi->k, 'urx' => max($b[0][1], $b[2][1]) / $this->fpdi->k, 'ury' => max($b[1][1], $b[3][1]) / $this->fpdi->k,);
        }
