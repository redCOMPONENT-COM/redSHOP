...
if ($user->id != 0)
{
    if (isset($tagid))
    {
        ...
        <form id="tags_name" name="tags_name" action="<?php echo $link;?>" method="post">
            <table border="0" cellpadding="5" cellspacing="0" width="100%" class="adminlist">
                <tr>
                    ...
                    <td width="70%"><input type="text" name="tags_name" value="<?php echo $model->getMytag($tagid);?>"
                                           id="tags_name" size="50"/></td>
                    <td width="20%">
        ...
        <div>&nbsp;</div>
        <div><a
            href="<?php echo 'index.php?option=com_redshop&view=account&layout=mytags&tagid=' . $tagid . '&Itemid=' . $Itemid;?>"
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td>
                    <div><a
                        href="<?php echo 'index.php?option=com_redshop&view=account&layout=mytags&Itemid=' . $Itemid;?>"
                        title="<?php echo JText::_('COM_REDSHOP_BACK_TO_TAG_LIST');?>"><?php echo JText::_('COM_REDSHOP_BACK_TO_TAG_LIST');?></a>
                    </div>
                </td>
