...
else
{
    ...
    $data .= '<input type="hidden" name="option" value="' . $option . '" />' . '<input type="hidden" name="window" value="1" />' . '<input type="hidden" name="task" value="sendWishlist" />' . '<input type="hidden" name="Itemid" value="' . $Itemid . '" />' . '<input type="hidden" name="wishlist_id" value="' . $wishlist_id . '" />' . '<input type="hidden" name="view" value="account" />';
    $data .= '</form>';
    echo eval("?>" . $data . "<?php ");
