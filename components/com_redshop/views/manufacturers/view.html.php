        ...
        if ($layout != 'default')
        {
            ...
            if ($manufacturer->manufacturer_id)
            {
            	...
            	if(AUTOGENERATED_SEO && SEO_PAGE_CANONICAL_MANUFACTUR != '' && $layout!="products")
				{
					...
					$manufacturer_products_url = substr_replace(JURI::root(),"",-1).JRoute::_( 'index.php?option='.$option.'&view=manufacturers&layout=products&mid='.$manufacturer->manufacturer_id.'&Itemid='.$Itemid);
