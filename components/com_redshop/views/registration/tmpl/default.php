...
<div><span id="customer_registrationintro" <?php echo $showCustomerdesc;?>><?php echo JText::_('COM_REDSHOP_REGISTRATION_INTROTEXT'); ?></span><span id="company_registrationintro" <?php echo $showCompanydesc;?>><?php echo JText::_('COM_REDSHOP_REGISTRATION_COMPANY_INTROTEXT'); ?></span></div>
...
<?php	}	?>
	<tr><td><input type="submit" class="button" name="submit" value="<?php echo JText::_('COM_REDSHOP_SEND_REGISTRATION' ); ?>" /></td></tr>
	</table>
