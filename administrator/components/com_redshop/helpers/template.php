...
class Redtemplate
{
    ...
    function getTemplate($section = '', $tid = 0, $name = "")
    {
        ...
        $query = "SELECT * " . "FROM #__" . TABLE_PREFIX . "_template " . "WHERE template_section " . "LIKE '" . $section . "' AND published=1 " . $and . "ORDER BY template_id ASC ";
        $db->setQuery($query);
    ...
    function getMailSections($sectionvalue = "")
    {
        ...
        $optiontype[] = JHTML::_('select.option', 'order_imglobal', JText::_('COM_REDSHOP_ORDER_MAIL_IMGLOBAL'));
        $optiontype[] = JHTML::_('select.option', 'order_bank', JText::_('COM_REDSHOP_ORDER_MAIL_BANK'));
