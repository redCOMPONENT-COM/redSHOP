...
class opsearchModelopsearch extends RedshopCoreModel
{
    public $_total = null;

    public $_pagination = null;

    public $_context = 'order_item_name';
    ...
    public function _buildQuery()
    {
        ...
        $query = 'SELECT op.*, CONCAT(ouf.firstname," ",ouf.lastname) AS fullname, ouf.company_name FROM ' . $this->_table_prefix . 'order_item AS op ' . 'LEFT JOIN ' . $this->_table_prefix . 'order_users_info as ouf ON ouf.order_id=op.order_id AND ouf.address_type="BT" ' . 'WHERE 1=1 ' . $where . $orderby;
        return $query;
    }
