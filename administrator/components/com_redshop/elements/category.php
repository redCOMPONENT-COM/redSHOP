...
class JFormFieldcategory extends JFormField
{
    ...
    public function getCategoryListArray($category_id = "", $cid = '0', $level = '0')
    {
        ...
        $q = "SELECT c.category_id, cx.category_child_id, cx.category_parent_id " . ",c.category_name,c.category_description,c.published,ordering " . "FROM #__redshop_category AS c " . " ,#__redshop_category_xref AS cx " . "WHERE c.category_id=cx.category_child_id " . $and;
