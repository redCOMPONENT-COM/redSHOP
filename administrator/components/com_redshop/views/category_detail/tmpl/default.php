...
<tr><td width="100" align="right" class="key"><label for="name"><?php echo JText::_('COM_REDSHOP_CATEGORY_NAME' ); ?>:</label></td>
	<td><input class="text_area" type="text" name="category_name" id="category_name" size="32" maxlength="250" value="<?php echo $this->detail->category_name;?>" /><?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_CATEGORY_NAME' ), JText::_('COM_REDSHOP_CATEGORY_NAME' ), 'tooltip.png', '', '', false); ?></td></tr>
<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_CATEGORY_PARENT' ); ?>:</td>
	<td><?php echo $this->lists['categories']; ?><?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_CATEGORY_PARENT' ), JText::_('COM_REDSHOP_CATEGORY_PARENT' ), 'tooltip.png', '', '', false); ?></td></tr>
<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PUBLISHED' ); ?>:</td>
	<td><?php echo $this->lists['published']; ?></td></tr>
<tr><td width="100" align="right" class="key"><label for="name"><?php echo JText::_('COM_REDSHOP_SHOW_PRODUCT_PER_PAGE' ); ?>:</label></td>
	<td><input class="text_area" type="text" name="products_per_page" id="products_per_page" size="32" maxlength="250" value="<?php echo $this->detail->products_per_page;?>" /><?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_SHOW_PRODUCT_PER_PAGE' ), JText::_('COM_REDSHOP_CATEGORY_NAME' ), 'tooltip.png', '', '', false); ?></td></tr>
<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_CATEGORY_TEMPLATE' ); ?>:</td>
	<td><?php echo $this->lists['category_template']; ?><?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_CATEGORY_TEMPLATE' ), JText::_('COM_REDSHOP_CATEGORY_TEMPLATE' ), 'tooltip.png', '', '', false); ?></td></tr>
<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_CATEGORY_MORE_TEMPLATE' ); ?>:</td>
	<td><?php echo $this->lists['category_more_template']; ?><?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_CATEGORY_MORE_TEMPLATE' ), JText::_('COM_REDSHOP_CATEGORY_MORE_TEMPLATE' ), 'tooltip.png', '', '', false); ?></td></tr>
<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_COMPARE_TEMPLATE_FOR_CATEGORY' ); ?>:</td>
	<td><?php echo $this->lists['compare_template_id']; ?><?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_COMPARE_TEMPLATE_FOR_CATEGORY_LABEL' ), JText::_('COM_REDSHOP_TOOLTIP_PRODUCT_COMPARE_TEMPLATE_FOR_CATEGORY' ), 'tooltip.png', '', '', false); ?></td></tr>
...
<table class="adminform">
	<tr><td valign="top" align="right" class="key" width="100"><?php echo JText::_('COM_REDSHOP_CATEGORY_IMAGE' ); ?>:
			</td>
			<td>
	...
	<div id="image_dis">
		...
		<tr>
			<td></td>
			<td>
				<a class="modal" href="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH;?>category/<?php echo $this->detail->category_full_image ?>"  title="" rel="{handler: 'image', size: {}}"><img src="<?php echo $url?>/components/com_redshop/helpers/thumb.php?filename=category/<?php echo $this->detail->category_full_image ?>&newxsize=<?php echo THUMB_WIDTH;?>&newysize=<?php echo THUMB_HEIGHT;?>"></a>
			</td>
		</tr>
<?php	}
	} ?>
	<tr><td valign="top" align="right" class="key" width="100"><?php echo JText::_('COM_REDSHOP_CATEGORY_BACK_IMAGE' ); ?>:
			</td>
			<td>
