...
<tr><th width="5%"><?php echo JText::_('COM_REDSHOP_NUM' );; ?></th>
	...
	<th width="5%"><?php echo JText::_('COM_REDSHOP_ORDER_TOTAL'); ?></th></tr></thead>
<tbody>
<?php
	$k = 0;
	for ($i=0; $i<count( $this->userorders );$i++)
	{
		...
		<tr>
			...
			<td align="center">
				<a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_REDSHOP_EDIT_ORDER');?>"><?php echo $row->order_id;?></a></td>
