...
<table class="admintable" width="90%">
	<tr><td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_WRAPPER_NAME' );?></td>
		<td><input class="text_area" type="text" name="wrapper_name" id="wrapper_name" size="32" maxlength="250" value="<?php echo $this->detail->wrapper_name;?>" />
			<?php echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_WRAPPER_NAME' ), JText::_('COM_REDSHOP_WRAPPER_NAME' ), 'tooltip.png', '', '', false); ?></td></tr>
	<tr><td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_WRAPPER_PRICE' );?></td>
		<td><input class="text_area" type="text" name="wrapper_price" id="wrapper_price" size="10" maxlength="10" value="<?php echo $producthelper->redpriceDecimal($this->detail->wrapper_price);?>" />
			<?php echo JHTML::tooltip(JText::_('COM_REDSHOP_TOOLTIP_WRAPPER_PRICE' ), JText::_('COM_REDSHOP_WRAPPER_PRICE' ), 'tooltip.png', '', '', false); ?> </td></tr>
	<?php if(!$showall) {	?>		
	<tr><td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_CATEGORY_NAME' );?></td>
...
echo $this->lists['product_name'];?>
	...
	<tr><td width="100" align="right" class="key" valign="top"><?php echo JText::_('COM_REDSHOP_WRAPPER_IMAGE' );?></td>
...
<!--				<div align="right" class="image"><img src="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH.$wimage_path;?>" alt="wrapper" title="Wrapper" border="0" width="200" /></div>-->
			<?php }	?>	</td></tr>
	<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_USE_TO_ALL_PRODUCT' ); ?>:</td>
