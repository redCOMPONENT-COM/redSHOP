...
<table class="adminlist">
	...
	for($i = 0, $n = count ( $this->manufacturer ); $i < $n; $i ++) {
		...
		<?php $media_id = $model->getMediaId($row->manufacturer_id);?>			 
			<a class="modal" href="index.php?tmpl=component&option=<?php echo $option;?>&amp;view=media_detail&amp;cid[]=<?php echo $media_id;?>&amp;section_id=<?php echo $row->manufacturer_id;?>&amp;showbuttons=1&amp;media_section=manufacturer&amp;section_name=<?php echo $row->manufacturer_name;?>" rel="{handler: 'iframe', size: {x: 1050, y: 450}}" title=""><img src="<?php echo REDSHOP_ADMIN_IMAGES_ABSPATH;?>media16.png" align="absmiddle" alt="media" ></a>
		</td>
		<td width="30%">
		<?php
