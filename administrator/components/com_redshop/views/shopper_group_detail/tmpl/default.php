...
<fieldset class="adminform">
	...
	<tr><td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_SHOPPER_GROUP_NAME' ); ?>:</td>
	...
	<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_SHOPPER_GROUP_TYPE' ); ?>:</td>
		<td><?php  echo $this->lists['groups']; ?></td></tr>
	<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_SHOPPER_GROUP_CUSTOMER_TYPE' ); ?>:</td>
		<td><?php  echo $this->lists['customertype']; ?></td></tr>
	<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_SHOPPER_GROUP_PORTAL' ); ?>:</td>
	...
	<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_SHOPPER_GROUP_CART_ITEMID_LBL' ); ?>:</td>
	...
	<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_USE_DEFAULT_SHIPPING' ); ?>:</td>
		<td><?php echo $this->lists['default_shipping'];?></td></tr>
	<tr>
		<td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_CHOOSE_DEFAULT_SHIPPING_RATE' ); ?>:</td>
		<td>
	...
	<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_DEFAULT_SHOPPER_GROUP_CART_CHECKOUT_ITEMID' ); ?>:</td>
	...
	<tr style="display: none;">
		<td valign="top" align="right" class="key" ><?php echo JText::_('COM_REDSHOP_USE_VAT_GROUP_LBL' ); ?>:</td>
		<td><?php echo $this->lists['tax_group_id'];
			echo JHTML::tooltip( JText::_('COM_REDSHOP_TOOLTIP_USE_VAT_GROUP' ), JText::_('COM_REDSHOP_USE_VAT_GROUP_LBL' ), 'tooltip.png', '', '', false); ?></td></tr>
	<tr style="display: none;">
	...
	<tr >
		<td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_SHOW_PRICE_WITHOUT_VAT' ); ?>:</td>
	...
	<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_SHOW_PRICE_LBL' ); ?>:</td>
		<td><?php  echo $this->lists['show_price']; ?></td></tr>

    	<tr><td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_USE_AS_CATALOG_LBL' ); ?>:</td>
	...
	<tr style="display: none;">
		<td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_PRODUCT_PRICE_VAT_LBL' ); ?>:</td>
...
<!--	<tr>
	...
	<tr >
		<td valign="top" align="right" class="key"><?php echo JText::_('COM_REDSHOP_QUOTATION_MODE_LBL' ); ?>:</td>
