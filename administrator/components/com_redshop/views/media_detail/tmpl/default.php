    ...
    <fieldset class="adminform">
        ...
        if ($media_section != 'manufacturer' || $media_section != 'catalog')
        {
            if ($this->detail->media_id == 0)
            {
                ...
                <table>
                    <tr>
                        <td><span id="uploadbulk"><?php echo JText::_('COM_REDSHOP_YOU_WANT_TO_UPLOAD_ZIP_FILE');  ?>
                            ?</span></td>
                        <td><span
                ...
                <tr>
                    ...
                    <td><input type="file" name="file[]" id="file" size="75">
                        <input type="button" name="addvalue" id="addvalue" class="button"
                               Value="<?php echo JText::_('COM_REDSHOP_ADD'); ?>" onclick="addNewRow('extra_table');"/>
                    </td>
        ...
        <table class="admintable">
            ...
            <tr>
                ...
                <td>
                    ...
                    {
                        ?>
                        <input type="text" value="<?php echo $media_section;?>" disabled="disabled"><input type="hidden"
                                                                                                           name="media_section"
                                                                                                           value="<?php echo $media_section;?>">
                    ...
                    else
                    {
                        ...
                        if ($this->detail->media_id != 0)
                        {
                            echo '<input type="hidden" name="media_section" value="' . $this->detail->media_section . '">';
                        }
                    }
                    ?>
                ...
                <td>
                    ...
                    if ($showbuttons)
                    {
                        ...
                        <input type="text" name="section_name" id="section_name" value="<?php echo $section_name;?>"
                               disabled="disabled" size="75"/><input type="hidden" name="section_id" id="section_id"
                                                                     value="<?php echo $section_id;?>"/><input
