...
<div id="editcell">
			...
			<table width="100%">
				<tr>
					<td valign="top" align="left" class="key">
						...
						<button onclick="document.getElementById('filter').value='';document.getElementById('template_section').value=0;this.form.submit();"><?php echo JText::_('COM_REDSHOP_RESET' ); ?></button>
					</td>
				</tr>
			</table>
			</td>
	...
	for ($i=0, $n=count( $this->templates ); $i < $n; $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			?>
				<a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_REDSHOP_EDIT_TEMPLATES' ); ?>"><?php echo $row->template_name; ?></a>
			<?php
			}
			?>
			</td>
