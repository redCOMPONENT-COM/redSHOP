            ...
            <table border="0" cellspacing="0" cellpadding="0" class="adminlist">
                ...
                <tr>
                    <th align="right" colspan="2">
                        ...
                        &nbsp;<?php if ($tmpl) { ?><a
                            href="<?php echo JRoute::_('index.php?option=' . $option . '&view=order_detail&task=send_downloadmail&cid[]=' . $order_id);?>&tmpl=<?php echo $tmpl;?>"><?php } else { ?><a
                            href="<?php echo JRoute::_('index.php?option=' . $option . '&view=order_detail&task=send_downloadmail&cid[]=' . $order_id);?>"><?php }
                        echo JText::_('COM_REDSHOP_SEND_DOWNLOEADMAIL'); ?></a>
						&nbsp;<?php if ($tmpl) { ?><a
                            href="<?php echo JRoute::_('index.php?option=' . $option . '&view=order_detail&task=send_invoicemail&cid[]=' . $order_id);?>&tmpl=<?php echo $tmpl;?>"><?php } else { ?><a
                            href="<?php echo JRoute::_('index.php?option=' . $option . '&view=order_detail&task=send_invoicemail&cid[]=' . $order_id);?>"><?php }
                        echo JText::_('COM_REDSHOP_SEND_INVOICEMAIL'); ?></a>
						&nbsp;
                        <?php }    ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php } ?>
                        <input type="checkbox" value="true" name="order_sendordermail"
                ...
                <td>
                    <table class="adminlist" border="0">
                        ...
                        <tr>
                            ...
                            <td><a
                                href="mailto:<?php echo $billing->user_email; ?>"><?php echo $billing->user_email; ?></a>
                            </td>
                        </tr>
                        <?php
                        if ($is_company) {
                    ...
                    <form action="<?php echo 'index.php?option=' . $option; ?>" method="post"
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" class="adminlist" width="100%">
                            <tr>
                                ...
                                <td width="5%">
                                    <img class="delete_item" src="<?php echo REDSHOP_FRONT_IMAGES_ABSPATH;?>cross.jpg"
                                    ...
                                    foreach ($downloadarray as $downloads) {
                                        ...
                                        <tr id="clock_<?php echo $download_id; ?>" <?php echo $td_style;?>>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" name="clock_min_<?php echo $download_id; ?>" size="2"
                                                       maxlength="2" value="<?php echo $minite;?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
    ...
    <td>
        <form action="<?php echo 'index.php?option=' . $option; ?>" method="post" name="updateshippingrate"
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="adminlist">
                ...
                <tr>
                    <td><input type="submit" name="add" id="add" value="<?php echo JText::_('COM_REDSHOP_ADD');?>"/>
        ...
        <tr>
            <td colspan="2">
                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="adminlist">
                    ...
                    <tr valign="top">
                        <td>
                            <a href="../components/com_reddesign/assets/order/pdf/<?php echo $RedDesignpro[$design_i]->reddesignfile; ?>.pdf">
                                <img src="<?php echo $live_site; ?>components/com_reddesign/assets/images/design.png"
                                     border="0" alt=""/> Download PDF</a>
                        </td>
                    </tr>
                    <tr valign="top">
                        <td>
                            <a href="../components/com_reddesign/assets/order/eps/<?php echo $RedDesignpro[$design_i]->reddesignfile; ?>.eps">
                                <img src="<?php echo $live_site; ?>components/com_reddesign/assets/images/design.png"
                                     border="0" alt=""/> Download EPS</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
