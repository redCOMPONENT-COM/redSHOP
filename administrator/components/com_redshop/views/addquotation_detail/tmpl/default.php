...
?>
    <table width="100%" class="adminlist">
        ...
        <tr>
            ...
            <td><input type="text" name="firstname" id="firstname" value="<?php echo $billing->firstname; ?>"/></td>
        </tr>
        <tr>
            <td><?php echo JText::_('COM_REDSHOP_LASTNAME'); ?>:</td>
            <td><input type="text" name="lastname" id="lastname" value="<?php echo $billing->lastname; ?>"/></td>
        </tr>
        <tr>
            <td><?php echo JText::_('COM_REDSHOP_ADDRESS'); ?>:</td>
            <td><input type="text" name="address" id="address" value="<?php echo $billing->address; ?>"/></td>
        </tr>
        <tr>
            <td><?php echo JText::_('COM_REDSHOP_ZIP'); ?>:</td>
            <td><input type="text" name="zipcode" id="zipcode" value="<?php echo $billing->zipcode; ?>"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="user_email" id="user_email" value="<?php echo $billing->user_email; ?>"/></td>
        </tr>
        <tr>
...
{ ?>
    <table id="tblcreat" style="display:<?php echo $style;?>;">
        <tr>
            ...
            <td><input class="inputbox" type="text" name="username" id="username" size="32" maxlength="250" value=""
                       onblur="validate(1);"/><span id="user_valid"></span></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input class="inputbox" type="password" name="password2" id="password2" size="32" maxlength="250"
                       value=""/></td>
        </tr>
    </table>
    <?php
