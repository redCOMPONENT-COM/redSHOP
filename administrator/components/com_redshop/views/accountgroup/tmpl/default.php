...
<tr class="<?php echo "row$k"; ?>">
	...
	<td><a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_REDSHOP_EDIT_ACCOUNTGROUP' ); ?>"><?php echo $row->accountgroup_name; ?></a></td>
...
<tfoot><td colspan="12"><?php echo $this->pagination->getListFooter(); ?></td></tfoot>
</table>
