...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
	<tr>
		...
		<table class="adminlist">
		    ...
		    <tr><td class ="distitle"><?php echo JText::_('COM_REDSHOP_PRODUCT_MANAGEMENT');?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
				<?php
			...
			<tr><td class ="distitle"><?php echo JText::_('COM_REDSHOP_ORDER')?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
			<?php
            ...
            <tr><td class ="distitle"><?php echo JText::_('COM_REDSHOP_DISCOUNT' );?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
			<?php
			 ...
			 <tr><td class ="distitle"> <?php echo JText::_('COM_REDSHOP_COMMUNICATION' );?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
			<?php
			...
			<tr><td class ="distitle"><?php echo JText::_('COM_REDSHOP_SHIPPING' );?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
			<?php
			...
			<tr><td class ="distitle"><?php echo JText::_('COM_REDSHOP_USER' );?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
			<?php
			...
			<tr><td class ="distitle"><?php echo JText::_('COM_REDSHOP_VAT_AND_CURRENCY' );?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
			<?php
			...
			<tr><td class ="distitle"><?php echo JText::_('COM_REDSHOP_IMPORT_EXPORT' );?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
			<?php
			...
			<tr><td class ="distitle"><?php echo JText::_('COM_REDSHOP_CUSTOMIZATION' );?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
			<?php
			...
			<tr><td class ="distitle"><?php echo JText::_('COM_REDSHOP_CUSTOMER_INPUT' );?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
			<?php
   ...
   <?php if(ECONOMIC_INTEGRATION != 0)
		{?>
			...
			<tr><td class ="distitle"><?php echo JText::_('COM_REDSHOP_ACCOUNTING' );?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
			<?php
...
<?php    $title = JText::_('COM_REDSHOP_QUICK_LINKS' ); ?>
       ...
       ?>
         ...
         <div id="newcustomericons_content">
		    ...
		    <tr><td class ="distitle"><?php echo JText::_('COM_REDSHOP_NEWEST_CUSTOMERS');?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
        ...
        $title = JText::_('COM_REDSHOP_NEWEST_ORDERS' ); ?>
         ...
         <div id="newestordericons_content">
            <table class="adminlist">
		    <tr><td class ="distitle"><?php echo JText::_('COM_REDSHOP_NEWEST_ORDERS');?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
        ...
        ?>
         ...
         <div id="charticons_content">
            <table class="adminlist">
		    <tr><td class ="distitle"><?php echo JText::_('COM_REDSHOP_PIE_CHART_FOR_LASTMONTH_SALES');?></td></tr>
			<tr>
				<td>
				<div id="cpanel">
