...
<table width="100%">
	...
	<thead>
		<tr><th align="center"><?php echo JText::_('COM_REDSHOP_HASH' ); ?></th>
			...
			<th align="center"><?php echo JText::_('COM_REDSHOP_PRICE' ); ?></th></tr></thead>
<?php 	$disdate = "";
		...
		<tr><td colspan="4"><?php echo JText::_("COM_REDSHOP_DATE").": ".$disdate;?></td></tr>
	<?php 	}
			$link 	= JRoute::_( 'index.php?option='.$option.'&view=order_detail&task=edit&cid[]='. $row->order_id );?>
		<tr><td align="center"><?php echo $i+1; ?></td>
			<td align="center"><a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_REDSHOP_EDIT_ORDER' ); ?>">
