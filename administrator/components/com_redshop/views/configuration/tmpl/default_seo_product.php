...
<table class="admintable">
	<tr>
		...
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_SEO_PAGE_TITLE_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_SEO_PAGE_TITLE' ); ?>">
...
?>
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_SEO_PAGE_HEADING_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_SEO_PAGE_HEADING_LBL' ); ?>">
		<label
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_SEO_PAGE_DESCRIPTION_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_SEO_PAGE_DESCRIPTION' ); ?>">
		<label
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_SEO_PAGE_KEYWORDS_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_SEO_PAGE_KEYWORDS' ); ?>">
		<label
