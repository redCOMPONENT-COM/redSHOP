...
<tr><td class="config_param" colspan="2"><?php echo JText::_( 'COM_REDSHOP_SHOPPER_GROUP_TAB' ); ?></td></tr>
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_PORTAL_SHOP' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_PORTAL_SHOP_LBL' ); ?>">
		<?php
	...
	<tr>
		<td width="100" align="right" class="key">
	<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_URL_AFTER_PORTAL_LOGIN_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_URL_AFTER_PORTAL_LOGIN' ); ?>">
		<?php
	...
	<tr>
		<td width="100" align="right" class="key">
	<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_URL_AFTER_PORTAL_LOGOUT_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_URL_AFTER_PORTAL_LOGOUT' ); ?>">
		<?php
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_DEFAULT_PORTAL_NAME_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_DEFAULT_PORTAL_NAME' ); ?>">
		<?php
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_DEFAULT_PORTAL_LOGO' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_DEFAULT_PORTAL_LOGO_LBL' ); ?>">
		<?php
		...
		<div><input type="file" name="default_portal_logo"
			...
			?>" /><a href="#123"   onclick="delimg('<?php echo DEFAULT_PORTAL_LOGO?>','usrdiv','<?php echo $shopperlogo_path?>');"><?php echo JText::_('COM_REDSHOP_REMOVE_FILE');?></a></div>
			<div id="usrdiv">
		<?php
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_SHOPPER_GROUP_DEFAULT_PRIVATE' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_SHOPPER_GROUP_DEFAULT_PRIVATE_LBL' ); ?>">
		<?php
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_SHOPPER_GROUP_DEFAULT_COMPANY' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_SHOPPER_GROUP_DEFAULT_COMPANY_LBL' ); ?>">
		<?php
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_SHOPPER_GROUP_DEFAULT_UNREGISTERED_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_SHOPPER_GROUP_DEFAULT_UNREGISTERED_LBL' ); ?>">
		<?php
