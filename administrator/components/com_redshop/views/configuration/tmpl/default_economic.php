...
<table class="admintable">
	...
	<tr>
		...
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_ECONOMIC_INTEGRATION_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_ECONOMIC_INTEGRATION_LBL' ); ?>">
		<label for="name">
<?php
...
?>
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_ECONOMIC_CHOICE_OF_BOOK_INVOICE_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_ECONOMIC_CHOICE_OF_BOOK_INVOICE_LBL' ); ?>">
		<label for="name">
<?php
...
?>
	...
	<tr><td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_REDSHOP_ECONOMIC_BOOK_INVOICE_NUMBER_LBL' ); ?>::<?php echo JText::_( 'COM_REDSHOP_TOOLTIP_ECONOMIC_BOOK_INVOICE_NUMBER_LBL' ); ?>">
...
?>
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_DEFAULT_ECONMOMIC_ACCOUNT_GROUP_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_DEFAULT_ECONMOMIC_ACCOUNT_GROUP_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_ATTRIBUTE_AS_PRODUCT_IN_ECONOMIC_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_ATTRIBUTE_AS_PRODUCT_IN_ECONOMIC_LBL' ); ?>">
	...
	<tr>
		<td width="100" align="right" class="key">
		<span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_TOOLTIP_DETAIL_ERROR_MESSAGE_ON_LBL' ); ?>::<?php echo JText::_('COM_REDSHOP_TOOLTIP_DETAIL_ERROR_MESSAGE_ON' ); ?>">
