...
<div class="col50">
	...
	<tr><td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_QUESTION_OWNER_NAME' ); ?>:</td>
		<td><?php echo $this->qdetail->user_name;	?></td></tr>
	<tr><td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_QUESTION_OWNER_EMAIL' ); ?>:</td>
