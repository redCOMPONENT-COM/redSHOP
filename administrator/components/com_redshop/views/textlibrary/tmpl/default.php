...
<table class="adminlist">		 
		<tr>		
			...
			<button onclick="this.form.getElementById('section').value='0';this.form.submit();"><?php echo JText::_('COM_REDSHOP_RESET');?></button>
	...
	for ($i=0, $n=count( $this->textlibrarys ); $i < $n; $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
			<a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_REDSHOP_EDIT_TAG' ); ?>">{<?php echo $row->text_name; ?>}</a>
			</td>			
			<td>
