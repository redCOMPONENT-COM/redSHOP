...
<div class="col50">
	...
	<legend><?php echo JText::_('COM_REDSHOP_DETAILS' ); ?></legend>
		...
		<tr><td width="100" align="right" class="key"><?php echo JText::_('COM_REDSHOP_SHIPPING_LOCATION' ); ?>:</td>
		...
		<td width="100" align="right" valign="top" class="key"><?php echo JText::_('COM_REDSHOP_SHIPPING_LOCATION_INFORMATION' ); ?>:</td>
