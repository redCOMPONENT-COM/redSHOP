...
<thead><tr><th width="5%"><?php echo JText::_('COM_REDSHOP_NUM' ); ?></th>
		...
		<th width="5%"><?php echo JText::_('COM_REDSHOP_ID' ); ?></th></tr></thead>
	<?php	$k = 0;
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td><a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_REDSHOP_EDIT_WRAPPER' ); ?>"><?php echo $row->wrapper_name;?></a></td>
			<td>
