...
</td><td><?php echo JText::_('COM_REDSHOP_CONTAINER_PRE_ORDER_PRODUCT'); ?></td></tr>
...
?>
 ...
 <div align="right">
<input type="button" onclick="savecontainer();" value="<?php echo JText::_('COM_REDSHOP_ADD_TO_CONTAINER' );?>">
</div>
</td>
