...
<div id="editcell">
	...
	for ($i=0, $n=count( $this->newslettersubscrs ); $i < $n; $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
			<a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_REDSHOP_EDIT_NEWSLETTER_SUBSCR' ); ?>"><?php $row->user_id == 0 ?  $name = $row->name : $name = $order_function->getUserFullname($row->user_id);  echo $name;?></a>
			</td>
