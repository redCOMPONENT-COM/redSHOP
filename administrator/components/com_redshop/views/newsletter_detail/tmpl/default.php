		...
		<tr>
	 	...
	 	<tr>
			...
			<td>
				...
				?>
				<span style="width:10%;">
					<a class="modal" href="index.php?tmpl=component&option=<?php echo $option ?>&view=template_detail&task=edit&showbuttons=1&cid[]=<?php echo $this->detail->template_id; ?>" rel="{handler: 'iframe', size: {x: 900, y: 500}}">
