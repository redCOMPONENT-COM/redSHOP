...
<table width="100%"> 
	<tr>
		<td valign="top" align="left" class="key">
			...
			<button onclick="document.getElementById('filter').value='';document.getElementById('filter_section').value=0;this.form.submit();"><?php echo JText::_('COM_REDSHOP_RESET' ); ?></button>
		</td>
	</tr>
</table>
	...
	for ($i=0;$i<count($this->media); $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td><a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_REDSHOP_EDIT_MAIL' ); ?>"><?php echo $row->mail_name; ?></a></td>
