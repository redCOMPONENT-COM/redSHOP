...
<div id="editcell" style="background-color: ">
 <fieldset class="adminform">
	...
	<tr>
	    ...
	    <td> <span class="editlinktip hasTip" title="<?php echo JText::_('COM_REDSHOP_BARCODE_TOOLTIP')?>"><input type="submit" name="searchbtn" value="<?php echo JText::_('COM_REDSHOP_CHECK_BARCODE' );?>" >  </span></td>
	</tr>
</table>
</fieldset>
</div>
