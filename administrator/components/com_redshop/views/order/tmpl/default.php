...
<tr class="<?php echo "row$k"; ?>">
    ...
    <td>
        <table cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td><textarea
                    name="customer_note<?php echo $row->order_id;?>"><?php echo $row->customer_note;?></textarea></td>
                <!--<td>
            ...
            <tr>
                <td>
                    <input type="checkbox" value="" name="sendordermail<?php echo $row->order_id; ?>"
    ...
    <td><?php if ($row->invoice_no != '' && $row->is_booked == 0)
    {
        ...
        if (strstr($details[0], 'default_shipping') && POSTDK_INTEGRATION)
        {
            ...
            if (!$row->track_no)
            {
                ...
                <input type="button" class="button" value="<?php echo JTEXT::_("CREATE LABEL");?>"
