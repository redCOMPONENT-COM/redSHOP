	...
	<?php 	}?>
			...
			<td>
				<table cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						<td>
							<input type="checkbox"  value="" name="sendordermail<?php echo $row->order_id ; ?>" id="sendordermail<?php echo $row->order_id ; ?>" /><?php echo JText::_('COM_REDSHOP_SEND_ORDER_MAIL' ); ?>
						</td>
					</tr>
					<tr>
						<!-- <td></td>-->
