...
echo $output .= $myTabs->startPanel(JText::_('COM_REDSHOP_PRODUCT_INFORMATION'), 'tab1');?>
  <div class="col50">
      ...
      <tr valign="top">
        <td width="50%"><table>
            <tr>
                ...
                <td><input class="text_area" type="text" name="product_name" id="product_name" size="32" maxlength="250"
    ...
    <tr>
        ...
        <td><input class="text_area" type="text" name="product_number" id="product_number" size="32" maxlength="250"
    ...
    <tr>
        ...
        <td><?php $list  = $producthelper->getProductByID($this->detail->product_parent_id);
            ...
            <input class="text_area" type="hidden" name="product_parent_id" id="product_parent_id" size="32"
                   maxlength="250" value="<?php echo $this->detail->product_parent_id;?>"/>
        </td>
...
?>
  ...
  <?php }else
{
echo '<input type="hidden" name="container_id" value="" />';
} ?>
