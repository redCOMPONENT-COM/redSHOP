...
<table class="admintable" border="0" width="100%" id="admintable">
	<tr>
		...
		<td align="left" colspan="1" class="key">
		<input type="button" name="addvalue" id="addvalue" class="button" Value="<?php echo JText::_('COM_REDSHOP_ADD' ); ?>" onclick="addNewRowOfsub('admintable');" />
		</td>
	</tr>
	<?php
	if(count($images) >0){
	...
	<tr>
		...
		<td>
		<input value="<?php echo JText::_('COM_REDSHOP_DELETE' ); ?>" onclick="deleteRowOfsub(this)" class="button" type="button" />
		</td>
	</tr>
	<?php
	}
