...
?>
 <input  type="hidden" name="plugin" id="plugin" size="32" maxlength="250" value="<?php echo $this->detail->plugin;?>"  />
        ...
        <label for="payment_discount_is_percent0"><?php echo  JText::_('COM_REDSHOP_PAYMENT_DISCOUNT_ISPERCENT' ) ;  ?></label>&nbsp;&nbsp;&nbsp;
  		<br>
        ...
        <label for="payment_discount_is_percent1"><?php echo JText::_('COM_REDSHOP_PAYMENT_DISCOUNT_ISTOTAL' ); ?></label>
      </td>
	</tr>
