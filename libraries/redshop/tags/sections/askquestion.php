...
{
	public $tags = array(
		'{user_name_lbl}', '{user_email_lbl}', '{user_question_lbl}', '{user_telephone_lbl}', '{user_address_lbl}',
		'{user_name}', '{user_email}', '{user_question}', '{user_address}', '{user_telephone}', '{send_button}', '{captcha}'
	);
