...
class RedshopTagsSectionsWishlist extends RedshopTagsAbstract
{
    ...
    public function replaceProduct($wishlist, $templateProduct)
    {
        ...
        $wishlistuserfielddata = RedshopHelperWishlist::getUserFieldData(
        ...
        $thumbImage = Redshop\Product\Image\Image::getImage(
            $wishlist->product_id,
            $link,
            $imageThumbProduct['width'],
            $imageThumbProduct['height']
        );
            ...
            foreach ($attributes as $key => $attribute) {
                ...
                foreach ($attribute->properties as $property) {
                    ...
                    if (empty($property->sub_properties)) {
                        $property->sub_properties = RedshopHelperProduct_Attribute::getAttributeSubProperties(
                            0,
                            $property->value
                        );
                    }
        ...
        $templateProduct = Redshop\Product\Stock::replaceInStock(
            $wishlist->product_id,
            $templateProduct,
            $attributes,
            $attributeTemplate
        ...
        $templateProduct = RedshopHelperProductAccessory::replaceAccessoryData(
            $wishlist->product_id,
            0,
            $accessory,
            $templateProduct,
        ...
        if (strstr($templateProduct, "{if product_userfield}") && strstr(
                $templateProduct,
        ...
        // Extra field display
        $templateProduct = RedshopHelperProductTag::getExtraSectionTag(
            $this->extraFieldName,
            $wishlist->product_id,
            "1",
            $templateProduct,
