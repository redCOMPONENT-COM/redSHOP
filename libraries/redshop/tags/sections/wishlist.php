...
class RedshopTagsSectionsWishlist extends RedshopTagsAbstract
{
    ...
    public function replace()
    {
        if ($this->view == 'product' || $this->view == 'category') {
            ...
            RHtml::script('com_redshop/redshop.wishlist.min.js', false, true);
            ...
            if (count($wishlistSesions) > 0) {
                if (isset($user->id) && $user->id != 0) {
                    ...
                    $link             = Redshop\IO\Route::_(
                        "index.php?wishlist=1&option=com_redshop&view=login&Itemid=" . $this->itemId
                    );
                    $myProductId      = '';
                    $countNoUserField = 0;
            ...
            if (!empty($wishlists) && count((array)$wishlists) > 0) {
                foreach ($wishlists as $wishlist) {
                    ...
                    $delWishlist    = Redshop\IO\Route::_(
    ...
    public function replaceProduct($wishlist, $templateProduct)
    {
        ...
        if (isset($wishlist->wishlist_id)) {
            $linkRemove = Redshop\IO\Route::_($linkRemove . '&Itemid=' . $this->itemId, false);
        } else {
            $linkRemove = Redshop\IO\Route::_(
