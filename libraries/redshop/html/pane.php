 ...
 */
abstract class RedshopPane extends JObject
{
	public $useCookies = false;

	/**
	 * Returns a RedshopPanel object.
	 *
	...
	{
		// Deprecation warning.
		JLog::add('RedshopPane::getInstance is deprecated.', JLog::WARNING, 'deprecated');

		$classname = 'RedshopPane' . $behavior;
...
/**
 * RedshopPanelTabs class to to draw parameter panes.
 *
 * @package     Joomla.Platform
 * @subpackage  HTML
 * @since       11.1
 ...
 */
class RedshopPaneTabs extends RedshopPane
{
	/**
	 * Constructor.
	 *
	...
	{
		// Deprecation warning.
		JLog::add('RedshopPaneTabs is deprecated.', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('RedshopPane::startPane is deprecated.', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('RedshopPaneTabs::endPane is deprecated.', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('RedshopPaneTabs::startPanel is deprecated.', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('RedshopPaneTabs::endPanel is deprecated.', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('RedshopPaneTabs::_loadBehavior is deprecated.', JLog::WARNING, 'deprecated');
...
/**
 * RedshopPanelSliders class to to draw parameter panes.
 *
 * @package     Joomla.Platform
 * @subpackage  HTML
 * @since       11.1
 ...
 * @deprecated  Use JHtml::_ static helpers
 */
class RedshopPaneSliders extends RedshopPane
{
	/**
	 * Constructor.
	 *
	...
	{
		// Deprecation warning.
		JLog::add('RedshopPanelSliders::__construct is deprecated.', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('RedshopPaneSliders::startPane is deprecated.', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('RedshopPaneSliders::endPane is deprecated.', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('RedshopPaneSliders::startPanel is deprecated.', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('RedshopPaneSliders::endPanel is deprecated.', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('RedshopPaneSliders::_loadBehavior is deprecated.', JLog::WARNING, 'deprecated');
