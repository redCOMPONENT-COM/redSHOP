...
class RedshopModel extends JModelLegacy
{
    ...
    public function getUserStateFromRequest($key, $request, $default = null, $type = 'none', $resetPage = true)
    {
        ...
        $curState = $oldState ?? $default;
        $newState = $input->get($request, null, $type);

        if (($curState != $newState) && $resetPage && $newState) {
    ...
    {
        $db              = JFactory::getDbo();
        $filterOrder_Dir = $this->getState('list.direction');
        $filterOrder     = $this->getState('list.ordering');

        return ' ORDER BY ' . $db->escape($filterOrder . ' ' . $filterOrder_Dir);
    }
    ...
    protected function renameToUniqueValue($fieldName, $fieldValue, $style = 'default', $tableName = '')
    {
        ...
        while ($table->load(array($fieldName => $fieldValue))) {
            $fieldValue = \Joomla\String\StringHelper::increment($fieldValue, $style);
        }
    ...
    protected function populateState($ordering = null, $direction = null)
    {
        ...
        $filterOrder = $app->getUserStateFromRequest($this->context . 'filter_order', 'filter_order', $ordering);
        $this->setState('list.ordering', $filterOrder);
