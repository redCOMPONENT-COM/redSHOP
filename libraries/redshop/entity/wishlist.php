...
class RedshopEntityWishlist extends RedshopEntity
{
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'wishlist_id', $keyValue = null)
	{
		if ($key == 'wishlist_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'wishlist_id' ? $this->id : $keyValue))))
		{
