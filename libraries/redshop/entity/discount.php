...
class RedshopEntityDiscount extends RedshopEntity
{
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'discount_id', $keyValue = null)
	{
		if ($key == 'discount_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'discount_id' ? $this->id : $keyValue))))
		{
