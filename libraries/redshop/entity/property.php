...
class RedshopEntityProperty extends RedshopEntity
{
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'property_id', $keyValue = null)
	{
		if ($key == 'property_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'property_id' ? $this->id : $keyValue))))
		{
