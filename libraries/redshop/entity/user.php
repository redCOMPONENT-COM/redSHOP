 ...
 * @since       2.0.6
 */
class RedshopEntityUser extends RedshopEntity
{
	/**
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'users_info_id', $keyValue = null)
	{
		if ($key == 'users_info_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'users_info_id' ? $this->id : $keyValue))))
		{
