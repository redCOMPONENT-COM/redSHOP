...
class RedshopEntityProduct_Compare extends RedshopEntity
{
	...
	{
		return JTable::getInstance('Product_Compare', 'Table');
	}
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'compare_id', $keyValue = null)
	{
		if ($key == 'compare_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'compare_id' ? $this->id : $keyValue))))
		{
