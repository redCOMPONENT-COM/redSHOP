...
class RedshopEntityGiftcard extends RedshopEntity
{
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'giftcard_id', $keyValue = null)
	{
		if ($key == 'giftcard_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'giftcard_id' ? $this->id : $keyValue))))
		{
