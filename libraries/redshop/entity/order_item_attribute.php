 ...
 * @since       2.0.6
 */
class RedshopEntityOrder_Item_Attribute extends RedshopEntity
{
	/**
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'order_att_item_id', $keyValue = null)
	{
		if ($key == 'order_att_item_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'order_att_item_id' ? $this->id : $keyValue))))
		{
