 ...
 * @since       2.0.6
 */
class RedshopEntityProduct_Subscription_Renewal extends RedshopEntity
{
	/**
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'renewal_id', $keyValue = null)
	{
		if ($key == 'renewal_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'renewal_id' ? $this->id : $keyValue))))
		{
