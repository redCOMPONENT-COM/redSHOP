 ...
 * @since       2.0.6
 */
class RedshopEntityShipping_Rate extends RedshopEntity
{
	/**
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'shipping_rate_id', $keyValue = null)
	{
		if ($key == 'shipping_rate_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'shipping_rate_id' ? $this->id : $keyValue))))
		{
