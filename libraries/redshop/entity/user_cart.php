...
class RedshopEntityUser_Cart extends RedshopEntity
{
	...
	{
		return JTable::getInstance('Usercart', 'Table');
	}
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'cart_id', $keyValue = null)
	{
		if ($key == 'cart_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'cart_id' ? $this->id : $keyValue))))
		{
