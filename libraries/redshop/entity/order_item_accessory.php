 ...
 * @since       2.0.6
 */
class RedshopEntityOrder_Item_Accessory extends RedshopEntity
{
	/**
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'order_item_acc_id', $keyValue = null)
	{
		if ($key == 'order_item_acc_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'order_item_acc_id' ? $this->id : $keyValue))))
		{
