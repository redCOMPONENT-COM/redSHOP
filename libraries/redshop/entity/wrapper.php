 ...
 * @since       2.0.6
 */
class RedshopEntityWrapper extends RedshopEntity
{
	/**
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'wrapper_id', $keyValue = null)
	{
		if ($key == 'wrapper_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'wrapper_id' ? $this->id : $keyValue))))
		{
