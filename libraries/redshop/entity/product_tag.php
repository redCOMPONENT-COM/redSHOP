 ...
 * @since       2.0.6
 */
class RedshopEntityProduct_Tag extends RedshopEntity
{
	/**
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'tags_id', $keyValue = null)
	{
		if ($key == 'tags_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'tags_id' ? $this->id : $keyValue))))
		{
