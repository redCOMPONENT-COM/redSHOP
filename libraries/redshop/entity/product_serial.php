...
class RedshopEntityProduct_Serial extends RedshopEntity
{
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'serial_id', $keyValue = null)
	{
		if ($key == 'serial_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'serial_id' ? $this->id : $keyValue))))
		{
