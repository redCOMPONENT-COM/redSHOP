 ...
 * @since       2.0.6
 */
class RedshopEntityAccount_Group extends RedshopEntity
{
	/**
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'accountgroup_id', $keyValue = null)
	{
		if ($key == 'accountgroup_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'accountgroup_id' ? $this->id : $keyValue))))
		{
