...
class RedshopEntityQuotation_Item extends RedshopEntity
{
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'quotation_item_id', $keyValue = null)
	{
		if ($key == 'quotation_item_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'quotation_item_id' ? $this->id : $keyValue))))
		{
