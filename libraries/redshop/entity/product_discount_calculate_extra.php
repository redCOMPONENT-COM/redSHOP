...
class RedshopEntityProduct_Discount_Calculate_Extra extends RedshopEntity
{
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'pdcextra_id', $keyValue = null)
	{
		if ($key == 'pdcextra_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'pdcextra_id' ? $this->id : $keyValue))))
		{
