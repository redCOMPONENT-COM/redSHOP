...
class RedshopEntityAttribute_Set extends RedshopEntity
{
	 ...
	 * @return  self
	 */
	public function loadItem($key = 'attribute_set_id', $keyValue = null)
	{
		if ($key == 'attribute_set_id' && !$this->hasId())
		{
			return $this;
		}

		if (($table = $this->getTable()) && $table->load(array($key => ($key == 'attribute_set_id' ? $this->id : $keyValue))))
		{
