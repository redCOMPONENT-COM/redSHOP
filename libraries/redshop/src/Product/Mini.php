...
class Mini
{
     ...
     */
    public static function getQueryObject($keyword = null, $categoryId = null, $searchField = '',
                                          $limit = 0, $orderBy = null)
    {
        $db = \JFactory::getDbo();
        ...
        if ($where) {
            $query->select('COUNT(DISTINCT('
                ...
                ->leftJoin($db->qn('#__redshop_product_category_xref', 'x')
     ...
     * @throws \Exception
     */
    public static function getCountDistinctProduct($keyword = null, $categoryId = null, $searchField = '',
                                                   $limit = 0, $orderBy = null )
    {
        try {
            $db = \JFactory::getDbo();
