...
class Install
{
    ...
    public static function demoManufacturers()
    {
        ...
        if (File::exists($file)) {
            ...
            File::copy($file, REDSHOP_MEDIA_IMAGE_RELPATH . 'manufacturer/1/redweb-logo.jpg');
        }
        ...
        if (File::exists($file)) {
            ...
            File::copy($file, REDSHOP_MEDIA_IMAGE_RELPATH . 'manufacturer/2/redhost-logo.jpg');
        }
        ...
        if (File::exists($file)) {
            ...
            File::copy($file, REDSHOP_MEDIA_IMAGE_RELPATH . 'manufacturer/3/redcomponent-logo.jpg');
        }
    }
}