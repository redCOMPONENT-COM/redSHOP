    ...
    public function replaceTemplate($cart, $cartData, $checkout = 1)
    {
        ...
        if (!\Redshop::getConfig()->get('DEFAULT_QUOTATION_MODE') || (\Redshop::getConfig()->get(
            ...
            if (!empty($checkVat)) {
                ...
                $replacement['{product_subtotal}'] = \RedshopHelperProductPrice::formattedPrice(
                    $productSubtotalExclVat
                );
            }
            ...
            $replacement['{product_subtotal_excl_vat}'] = \RedshopHelperProductPrice::formattedPrice(
                $productSubtotalExclVat
            );
                ...
                $replacement['{shipping_excl_vat}'] =
                    \RedshopLayoutHelper::render(
                        ...
                        array(
                            ...
                            'id'        => 'spnShippingrate',
                            'htmlPrice' => \RedshopHelperProductPrice::formattedPrice(
