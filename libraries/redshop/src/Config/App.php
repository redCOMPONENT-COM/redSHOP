...
class App
{
    ...
    public function prepareConfigData($data)
    {
        ...
        $configs = array(
            ...
            "REQUIRED_POSTAL_CODE"                         => $data["required_postal_code"],
            "REQUIRED_EAN_NUMBER"                          => $data["required_ean_number"],
            "REQUIRED_ADDRESS"                             => $data["required_address"],
            "REQUIRED_COUNTRY_CODE"                        => $data["required_country_code"],
            "REQUIRED_PHONE"                               => $data["required_phone"],
            ...
            'CLICKATELL_SENDER_ID'                         => $data["clickatell_sender_id"],
            'CLICKATELL_COUNTRY_PREFIX'                    => $data["clickatell_country_prefix"],
            'CLICKATELL_CUSTOM_MESSAGE'                    => $data["clickatell_custom_message"],
