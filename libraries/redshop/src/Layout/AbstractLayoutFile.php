 ...
 * @since       1.4
 */
abstract class AbstractLayoutFile
{
	/**
	 * Options object
	 *
	 ...
	 *
	 * @return  self             An instance of itself for chaining
	 */
	public function setOptions($options = null)
	{
		// Received JRegistry
		if ($options instanceof \JRegistry || $options instanceof Registry)
		{
