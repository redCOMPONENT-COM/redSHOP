...
class Label
{
    ...
    public static function replace($content)
    {
        ...
        self::checkTag(
            ...
            $content,
            'totalpurchase_lbl',
            \JText::_('COM_REDSHOP_CART_TOTAL_PURCHASE_TBL')
        );
        self::checkTag(
            $search,
            $replace,
            ...
            \JText::_('COM_REDSHOP_SUBTOTAL_EXCL_VAT_LBL')
        );
        ...
        self::checkTag(
            ...
            $content,
            'total_price_exe_lbl',
            \JText::_('COM_REDSHOP_TOTAL_PRICE_EXEL_LBL')
        );
        ...
        self::checkTag(
            ...
            \JText::_('COM_REDSHOP_REQUISITION_NUMBER')
        );
        ...
        self::checkTag(
            ...
            \JText::_('COM_REDSHOP_ORDER_STAUS_LBL')
        );
        self::checkTag(
            $search,
            $replace,
            ...
            \JText::_('COM_REDSHOP_PAYMENT_STAUS_LBL')
        );
        self::checkTag(
            $search,
            $replace,
            ...
            \JText::_('COM_REDSHOP_ORDER_INFORMATION_LBL')
        );
        ...
        self::checkTag(
            ...
            $content,
            'discount_type_lbl',
            \JText::_('COM_REDSHOP_CART_DISCOUNT_CODE_TBL')
        );
        ...
        self::checkTag(
            ...
            \JText::_('COM_REDSHOP_QUOTATION_INFORMATION')
        );
        self::checkTag(
            $search,
            $replace,
            ...
            \JText::_('COM_REDSHOP_ACCOUNT_INFORMATION')
        );
        ...
        self::checkTag(
            ...
            \JText::_('COM_REDSHOP_QUOTATION_SUBTOTAL')
        );
        self::checkTag(
            $search,
            $replace,
            ...
            \JText::_('COM_REDSHOP_QUOTATION_DISCOUNT_LBL')
        );
        self::checkTag(
            $search,
            $replace,
        ...
        if (\Redshop::getConfig()->getBool('SHIPPING_METHOD_ENABLE')) {
            ...
            self::checkTag(
                ...
                $content,
                'shipping_method_lbl',
                \JText::_('COM_REDSHOP_SHIPPING_METHOD_LBL')
            );
        } else {
