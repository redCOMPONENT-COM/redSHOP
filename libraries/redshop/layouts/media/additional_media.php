        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs" id="g-tab" role="tablist">
                    <li role="presentation"><a href="#upload-media" aria-controls="upload-media" role="tab"
                                               data-toggle="tab">Upload Files</a></li>
                    <li role="presentation" class="active"><a href="#upload-lib" aria-controls="upload-lib" role="tab"
                                                              data-toggle="tab">Library Media</a></li>
                </ul>
...
<div id="alertGModal" class="modal fade in" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer btn-toolbar text-center">
                <button type="button" class="btn btn-small btn-danger float-none btn-confirm-del-g" data-url=""
                        data-id="">Yes
                </button>
