            ...
            <thead>
                <tr>
                    ...
                    <th id="aclactionth<?php echo $group->value ?>">
                        <span class="acl-action">
                            <?php echo Text::_('JLIB_RULES_CALCULATED_SETTING') ?>
                        </span>
                    </th>
                </tr>
            </thead>
                ...
                <?php foreach ($actions as $action): ?>
                    <tr>
                        <td headers="actions-th<?php echo $group->value ?>">
                            <label for="<?php echo $field->id . '_' . $action->name . '_' . $group->value ?>" class="hasTooltip"
                                title="<?php echo htmlspecialchars(
                                    Text::_($action->title) . ' ' . Text::_($action->description),
                                    ENT_COMPAT,
                                    'UTF-8'
                                ) ?>">
                        ...
                        <td headers="settings-th<?php echo $group->value ?>">
                            <select class="input-small input-sm"
                                name="<?php echo $field->name . '[' . $action->name . '][' . $group->value . ']' ?>"
                                id="<?php echo $field->id . '_' . $action->name . '_' . $group->value ?>" title="<?php echo JText::sprintf(
                        ...
                        <td headers="aclactionth<?php echo $group->value ?>">
                            ...
                            ?>
                            <span class="<?php echo $result['class'] ?>">
