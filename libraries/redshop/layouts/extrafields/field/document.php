    ...
    (function ($) {
        $(document).ready(function () {
            $("a#add_<?php echo $rowData->name ?>").on('click', function (e) {
                ...
                extra_field_doc_html += '<a class="btn btn-danger pull-left" href="#" class="rsDocumentDelete" title="' + extra_field_name + '" id="remove_' + extra_field_name + total_elm + '"><?php echo Text::_(
                    'COM_REDSHOP_DELETE'
                ) ?></a>';
