 ...
 * @param   array  $rowData         Extra field data
    ...
    (function ($) {
        $(document).ready(function () {
            $("a#add_<?php echo $rowData->name ?>").on('click', function (e) {
                ...
                var extra_field_doc_html = '<div id="div_' + extra_field_name + total_elm + '" class="ui-helper-clearfix">';
                ...
                extra_field_doc_html += '<a href="#" class="rsDocumentDelete" style="float:left;" title="' + extra_field_name + '" id="remove_' + extra_field_name + total_elm + '"><?php echo JText::_('COM_REDSHOP_DELETE') ?></a>';
    ...
    <div id="html_<?php echo $rowData->name; ?>">
		<?php if (!empty($dataTxt)) : ?>
			...
			<?php foreach ($dataTxt as $text => $value) : ?>
				<?php $idx++; ?>
                <div id="div_<?php echo $rowData->name . $idx; ?>">
					...
					<?php if (JFile::exists($mediaImage)): ?>
						...
						<?php if ($mediaType == 'jpg' || $mediaType == 'jpeg' || $mediaType == 'png' || $mediaType == 'gif') : ?>
                            <div id="docdiv<?php echo $idx; ?>">
                                ...
                                <a href="#" onclick="delimg('<?php echo $value ?>',
