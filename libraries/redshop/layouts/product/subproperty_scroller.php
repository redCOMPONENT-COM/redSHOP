...
<table cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td>
            <a class="leftButton" id="FirstButton"
               href="javascript:isFlowers<?php echo $commonId; ?>.scrollReverse();"></a>
        </td>

        <td>
            <div id="isFlowersFrame<?php echo $commonId; ?>" name="isFlowersFrame<?php echo $commonId; ?>"
                 style="margin: 0px; padding: 0px;position: relative; overflow: hidden;">
                <div id="isFlowersImageRow<?php echo $commonId; ?>" name="isFlowersImageRow<?php echo $commonId; ?>"
                    ...
                    <script type="text/javascript">
                        ...
                        isFlowers<?php echo $commonId; ?>.setThumbsShown(<?php echo Redshop::getConfig()->get(
                    ...
                    <div id="divsubimgscroll<?php echo $commonId; ?>" style="display: none"><?php echo implode(
                            '#_#',
                            $subPropertyArray
                        ) ?></div>
                </div>
        ...
        <td>
            <a class='rightButton' id="FirstButton"
               href="javascript:isFlowers<?php echo $commonId; ?>.scrollForward();"></a>
        </td>
    </tr>
</table>
