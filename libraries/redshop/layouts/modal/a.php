 ...
 * @var  string $params['aContent']   // Text for the button
...
<a class="<?php echo $params['aClass'] ?> <?php echo $selector ?>" id="<?php echo $params['aId'] ?>"
    data-bs-toggle="modal" data-bs-target="#<?php echo $selector ?>">
    <?php echo $params['aContent'] ?>
</a>
