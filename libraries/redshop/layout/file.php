...
class RedshopLayoutFile extends RedshopLayoutBase
{
    ...
    protected function refreshIncludePaths()
    {
        ...
        if (!empty($component)) {
            ...
            $this->addIncludePath(
                JPATH_THEMES . '/' . JFactory::getApplication()->getTemplate() . '/html/layouts/' . $component
            );
        }
        ...
        if (!empty($plugin)) {
            ...
            $this->addIncludePath(
                JPATH_THEMES . '/' . JFactory::getApplication()->getTemplate() . '/html/layouts/plugins/' . $plugin
            );
        }
        ...
        if (!empty($module)) {
            ...
            $this->addIncludePath(
                JPATH_THEMES . '/' . JFactory::getApplication()->getTemplate() . '/html/layouts/modules/' . $module
            );
        }
