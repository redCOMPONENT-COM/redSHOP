...
class RedshopHelperCatalog
{
    ...
    public static function sendFirstReminder($catalog = null, $currentDate = '', $from = '', $fromName = '')
    {
        ...
        $sendDate    = date(
            "Y-m-d",
            $catalog->registerDate + (Redshop::getConfig()->get('CATALOG_REMINDER_1') * (60 * 60 * 24))
        );
    ...
    public static function sendSecondReminder($catalog = null, $currentDate = '', $from = '', $fromName = '')
    {
        ...
        $sendDate    = date(
            "Y-m-d",
            $catalog->registerDate + (Redshop::getConfig()->get('CATALOG_REMINDER_2') * (60 * 60 * 24))
        );
    ...
    public static function sendThirdReminder($catalog = null, $currentDate = '', $from = '', $fromName = '')
    {
        ...
        $sendDate = date(
            "Y-m-d",
            $catalog->registerDate + (Redshop::getConfig()->get(
                    'DISCOUNT_DURATION'
                ) * (60 * 60 * 24)) + (4 * 60 * 60 * 24)
        );
